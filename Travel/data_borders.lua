...
data.basenodes.borders = --[[LIBROVER]] {
	...
	-- Kalimdor
		...
		"Tanaris/0 25.98,66.23 -x- Uldum New/0 70.51,22.43 {cond:not QC.InPhase('OldUldum')}",
	...
	-- Pandaria
		...
		"Kun-Lai Summit/0 55.54,92.77 -x- Vale of Eternal Blossoms New/0 44.12,10.42 {cond:not QC.InPhase('OldVale')}",
