...
local function IsQuestFlaggedCompleted(questID)
	...
	if QL and QL.IsComplete then
		return QL.IsComplete(questID) and true or false
	end
	if _G.C_QuestLog and _G.C_QuestLog.IsQuestFlaggedCompleted then
		return _G.C_QuestLog.IsQuestFlaggedCompleted(questID) and true or false
	end
	if _G.IsQuestFlaggedCompleted then
		return _G.IsQuestFlaggedCompleted(questID) and true or false
	end
	return false
end
...
data.taxipoints[12]={
	...
	['Darkshore']={
		...
		{name="Lor'danel",faction="A",npc="Teldira Moonfeather",npcid=3841,x=51.72,y=17.65,cond_fun=function() return QC.InPhase("Old Darnassus") end},
		{name="Lor'danel",faction="A",npc="Nightsaber Rider",npcid=33359,x=52.22,y=22.27,taxinodeID=-1,taxioperator="blackcat",cond_fun=function() return QC.InPhase("Old Darnassus") end},
		{name="Lor'danel",faction="A",npc="Nightsaber Rider",npcid=33359,x=51.03,y=22.75,taxinodeID=-2,taxioperator="blackcat",cond_fun=function() return QC.InPhase("Old Darnassus") end},
		{name="Ruins of Mathystra",faction="A",npc="Nightsaber Rider",npcid=33359,x=58.57,y=19.99,taxinodeID=-3,taxioperator="blackcat",cond_fun=function() return QC.InPhase("Old Darnassus") end},
		{name="Shatterspear Vale",faction="A",npc="Nightsaber Rider",npcid=33359,x=69.11,y=18.87,taxinodeID=-4,taxioperator="blackcat",cond_fun=function() return QC.InPhase("Old Darnassus") end},
		{name="Bashal'Aran",faction="A",npc="Nightsaber Rider",npcid=33359,x=46.85,y=33.18,taxinodeID=-5,taxioperator="blackcat",cond_fun=function() return QC.InPhase("Old Darnassus") end},
	},

	['Darnassus']={
		{name="Darnassus",faction="A",npc="Leora",npcid=40552,x=36.61,y=47.83,cond_fun=function() return QC.InPhase("Old Darnassus") end},
	},
	...
	['Dustwallow Marsh']={
		{name="Theramore",faction="A",npc="Baldruc",npcid=4321,x=67.48,y=51.30,cond_fun=function() return QC.InPhase("Old Dustwallow") end},
	...
	['Silithus']={
		{name="Cenarion Hold",faction="A",npc="Cloud Skydancer",npcid=15177,x=54.40,y=32.72,cond_fun=function() return QC.InPhase("Old Silithius") end},
		{name="Cenarion Hold",faction="H",npc="Runk Windtamer",npcid=15178,x=52.78,y=34.64,cond_fun=function() return QC.InPhase("Old Silithius") end},
	},
	...
	['Teldrassil']={
		{name="Dolanaar",faction="A",npc="Fidelio",npcid=40553,x=55.47,y=50.42,cond_fun=function() return QC.InPhase("Old Darnassus") end},
		{name="Rut'theran Village",faction="A",npc="Vesprystus",npcid=3838,x=55.41,y=88.40,cond_fun=function() return QC.InPhase("Old Darnassus") end},
	},
...
data.taxipoints[13]={
	...
	['Blasted Lands']={
		{name="Nethergarde Keep",faction="A",npc="Alexandra Constantine",npcid=8609,x=61.25,y=21.58,cond_fun=function() return QC.InPhase("Old Blasted Lands") end},
		{name="Surwich",faction="A",npc="Graham McAllister",npcid=43107,x=47.13,y=89.36,cond_fun=function() return QC.InPhase("Old Blasted Lands") end},
		{name="Shattered Beachhead",faction="A",npc="Araazi",npcid=85731,x=67.64,y=27.97,cond_fun=function() return QC.InPhase("New Blasted Lands") end},
		{name="Sunveil Excursion",faction="H",npc="Salena",npcid=43114,x=50.92,y=72.88,cond_fun=function() return QC.InPhase("Old Blasted Lands") end},
		{name="Dreadmaul Hold",faction="H",npc="Preda",npcid=43121,x=43.71,y=14.25,cond_fun=function() return QC.InPhase("Old Blasted Lands") end},
		{name="Shattered Landing",faction="H",npc="Ameri Windblade",npcid=85734,x=72.95,y=48.63,cond_fun=function() return QC.InPhase("New Blasted Lands") end},
	},
	...
	['Ruins of Gilneas']={
		{name="Forsaken Forward Command",faction="H",npc="Bat Handler Doomair",npcid=45479,x=57.28,y=17.75,cond_fun=function() return QC.Parser.ConditionEnv.completedq(27290) and not QC.Parser.ConditionEnv.completedq(27405) end},
	},

	['Tirisfal Glades']={
		{name="Brill",faction="H",npc="Anette Williams",npcid=43124,x=58.84,y=51.94,cond_fun=function() return QC.InPhase("Old Undercity") or QC.InPhase("UndercityOoze") end},
		{name="The Bulwark",faction="H",npc="Timothy Cunningham",npcid=37915,x=83.58,y=69.95,cond_fun=function() return QC.InPhase("Old Undercity") end},
	},

	['Tirisfal Glades L']={
		{name="Brill",faction="H",npc="Anette Williams",npcid=185948,x=58.76,y=51.88,cond_fun=function() return QC.InPhase("UndercityCharred") end},
	},

	['Undercity']={
		{name="Undercity",faction="H",npc="Michael Garrett",npcid=4551,x=63.26,y=48.55,cond_fun=function() return QC.InPhase("Old Undercity") end},
	},
...
-----------------------------------------------
-----     MIDNIGHT FREEFLOATING ZONES     -----
-----------------------------------------------
data.taxipoints[2413]={
	['Harandar']={
		-- NEUTRAL --
...
data.taxipoints[2405]={
	...
	['Naigtal']={
		...
		-- NEUTRAL --
		{name="Umbral Base Camp",faction="B",npc="Manaforge Translocator",npcid=266515,x=46.69,y=82.90,quest=96809},
		{name="Nexus Port",faction="B",npc="Manaforge Translocator",npcid=266518,x=55.02,y=46.99,quest=96809},
		{name="Sporeforge",faction="B",npc="Manaforge Translocator",npcid=266517,x=77.29,y=42.92,quest=96809},
		{name="Extraction Coast",faction="B",npc="Manaforge Translocator",npcid=266519,x=32.27,y=46.01,quest=96809},
	},
}

--/dump select(6, strsplit("-", UnitGUID("mouseover") or ""))
-------------------------------------------------
...
data.taxipoints[994]={				-- CHANGED, USED TO BE 905
	['Krokuun']={
		{name="Vindicaar, Krokuun",faction="B",x=42.58,y=22.78,f=1,taxioperator="argusportal",argushub=true, known_fun=function() return LibTaxi:AnyTaxiKnown(1928,1967,1976) or QC.Parser.ConditionEnv.completedq(47224) end},
	...
	['Eredath']={
		{name="Vindicaar, Eredath",faction="B",x=48.98,y=23.13,f=3,taxioperator="argusportal",argushub=true, known_fun=function() return LibTaxi:AnyTaxiKnown(1977,1978,1982,1991,2003) or QC.Parser.ConditionEnv.completedq(48081) end}, 
	...
	['Antoran Wastes']={
		{name="Vindicaar, Antoran Wastes",faction="B",x=32.32,y=56.57,f=5,taxioperator="argusportal",argushub=true, known_fun=function() return LibTaxi:AnyTaxiKnown(1988,1992,1993) or QC.Parser.ConditionEnv.completedq(48199) end}, 
...
data.taxipoints[1550]={
	...
	['Bastion']={
		...
		{name="Aspirant's Rest",faction="B",npc="Rheus",npcid=159127,x=48.10,y=74.25,taxinodeID=2519},
			...
			-- TRANSPORT NETWORK FPATHS --
				{name="Hero's Rest",faction="B",npc="Eternal Gateway",npcid="eg",x=51.75,y=46.81,region="heros_rest",taxioperator="eternalgateway",taxinodeID=2626,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 1 end},
				{name="Aspirant's Rest",faction="B",npc="Eternal Gateway",npcid="eg",x=48.33,y=72.85,taxioperator="eternalgateway",taxinodeID=2630,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 1 end},
				{name="Xandria's Vigil",faction="B",npc="Eternal Gateway",npcid="eg",x=40.71,y=55.21,taxioperator="eternalgateway",taxinodeID=2631,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 1 end},
				{name="Sagehaven",faction="B",npc="Eternal Gateway",npcid="eg",x=44.16,y=33.02,taxioperator="eternalgateway",taxinodeID=2632,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 2 end},
				{name="Temple of Purity",faction="B",npc="Eternal Gateway",npcid="eg",x=59.42,y=77.12,taxioperator="eternalgateway",taxinodeID=2633,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 2 end},
				{name="Seat of Eternal Hymns",faction="B",npc="Eternal Gateway",npcid="eg",x=58.37,y=30.97,taxioperator="eternalgateway",taxinodeID=2634,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 2 end},
				{name="Temple of Humility",faction="B",npc="Eternal Gateway",npcid="eg",x=66.59,y=47.90,taxioperator="eternalgateway",taxinodeID=2635,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() == 3 end},
				{name="Terrace of the Collectors",faction="B",npc="Eternal Gateway",npcid="eg",x=35.40,y=21.93,taxioperator="eternalgateway",taxinodeID=2636,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() == 3 end},
	...
	['Elysian Hold']={
		...
		-- NEUTRAL --
		{name="Elysian Hold",faction="B",npc="Cassius",npcid=159421,x=50.94,y=49.03,taxinodeID=2528,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian or not (c.Kyrian or c.NightFae or c.Venthyr) end},
		{name="Elysian Hold",faction="B",npc="Eternal Gateway",npcid="eg",x=48.67,y=61.68,taxioperator="eternalgateway",taxinodeID=2625,quest=63052,known_fun=function() local c=QC.Parser.ConditionEnv return c.Kyrian and c.covenantnetwork() >= 1 end},
	},
	...
	['Maldraxxus']={
		...
		{name="Bleak Redoubt",faction="B",npc="Wing Guard Buurkin",npcid=157514,x=52.47,y=67.65,recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return c.Necrolord or not (c.Kyrian or c.NightFae or c.Venthyr) or c.level < 60 end},--Usable by all below 60
	},
	...
	['Ardenweald']={
		...
		{name="Refugee Camp",faction="B",npc="Derwynnthlmn",npcid=167255,x=49.35,y=51.82,recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return not c.NightFae end},
		...
		{name="Heart of the Forest",faction="B",npc="Ceridwyn",npcid=165701,x=46.26,y=50.81,recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return c.NightFae end},
	},
	...
	['Sinfall']={
		...
		-- NEUTRAL --
		{name="Sinfall",faction="B",npc="Courier Snaggle",npcid=162702,x=67.31,y=21.42,recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return c.Venthyr end},
	},

	['Korthia']={

		-- NEUTRAL --
		{name="Keeper's Respite",faction="B",npc="Animaflow Teleporter",x=64.97,y=23.67,taxioperator="animaflow",taxinodeID=2698,unlocked_fun=function() local c=QC.Parser.ConditionEnv return c.haveq(63855) or c.completedq(999999) end},
	...
	['The Maw']={
		...
		-- NEUTRAL --
		{name="Ve'nari's Refuge",faction="B",npc="Animaflow Teleporter",x=47.29,y=43.67,taxioperator="animaflow",taxinodeID=2700,unlocked_fun=function() local c=QC.Parser.ConditionEnv return c.haveq(63855) or c.completedq(999999) end},
...
data.taxipoints[1970] = {
	['Zereth Mortis']={
		...
		{name="Primus Locus",  faction="B",npc="Locus Shift",npcid=184386,x=48.43,y=26.35,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,3)  and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889) and not c.achieved(15514)) end},
		{name="Secundus Locus",faction="B",npc="Locus Shift",npcid=184387,x=47.96,y=27.91,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,5)  and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889) and not c.achieved(15514)) end},
		{name="Tertius Locus", faction="B",npc="Locus Shift",npcid=184388,x=51.91,y=27.11,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,7)  and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889) and not c.achieved(15514)) end},
		{name="Quartus Locus", faction="B",npc="Locus Shift",npcid=184385,x=48.52,y=29.70,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,9)  and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889) and not c.achieved(15514)) end},
		{name="Quintus Locus", faction="B",npc="Locus Shift",npcid=184384,x=50.67,y=32.60,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,11) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889) and not c.achieved(15514)) end},
		{name="Ultimus Locus", faction="B",npc="Locus Shift",npcid=184364,x=48.89,y=31.43,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,13) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889) and not c.achieved(15514)) end},
	},
	['Gravid Repose']={
		{name="Gravid Repose Locus",faction="B",npc="Locus Shift",npcid=184329,x=59.35,y=41.51,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return c.haveq(64889) or (c.specialtalent(1907) and c.completedq(64889)) end}, -- known_fun=function() local c=QC.Parser.ConditionEnv return c.haveq(123456) or c.completedq(123456) end
		{name="Interior Locus",	    faction="B",npc="Locus Shift",npcid=184356,x=40.33,y=34.34,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
		{name="Arcae Locus",	      faction="B",npc="Locus Shift",npcid=184356,x=40.33,y=34.34,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
		{name="Rondure Alcove",	    faction="B",npc="Locus Shift",npcid=184356,x=43.00,y=39.89,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
		{name="Dormant Alcove",	    faction="B",npc="Locus Shift",npcid=184356,x=40.33,y=34.34,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
		{name="Fulgor Alcove",      faction="B",npc="Locus Shift",npcid=184356,x=40.33,y=34.34,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
		{name="Repertory Alcove",   faction="B",npc="Locus Shift",npcid=184356,x=40.33,y=34.34,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
		{name="Camber Alcove",      faction="B",npc="Locus Shift",npcid=184356,x=40.33,y=34.34,taxioperator="zerethlocus",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.completedq(64889,1) and c.haveq(64889)) or (c.specialtalent(1907) and c.completedq(64889)) end},
	},
}
...
data.taxipoints[1978]={
	...
	['The Waking Shores']={
		...
		{name="Skytop Observatory",faction="B",npc="Ancient Waygate",npcid="aw",x=75.28,y=57.02,taxinodeID=2841,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(71157) or c.completedq(71157)) and not c.hasbuff(392960) end},
		{name="Rubyscale Outpost", faction="B",npc="Ancient Waygate",npcid="aw",x=47.28,y=90.30,taxinodeID=2842,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(70156) or c.completedq(70156)) and not c.hasbuff(392960) end},
	},
	...
	['Ohn\'ahran Plains']={
		...
		{name="Rusza'thar Reach",faction="B",npc="Ancient Waygate",npcid="aw",x=81.31,y=38.98,taxinodeID=2839,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(71138) or c.completedq(71138)) and not c.hasbuff(392960) end},
		{name="Shady Sanctuary", faction="B",npc="Ancient Waygate",npcid="aw",x=30.66,y=55.48,taxinodeID=2840,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(71178) or c.completedq(71178)) and not c.hasbuff(392960) end},
	...
	['The Azure Span']={
		...
		{name="Cobalt Assembly",faction="B",npc="Ancient Waygate",npcid="aw",x=48.33,y=30.13,taxinodeID=2838,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(70156) or c.completedq(70156)) and not c.hasbuff(392960) end},
		{name="Vakthros",       faction="B",npc="Ancient Waygate",npcid="aw",x=77.59,y=30.79,taxinodeID=2837,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(71161) or c.completedq(71161)) and not c.hasbuff(392960) end},
	...
	['Thaldraszus']={
		...
		{name="Algeth'era",  faction="B",npc="Ancient Waygate",npcid="aw",x=62.42,y=40.47,taxinodeID=2836,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(71162) or c.completedq(71162)) and not c.hasbuff(392960) end},
		{name="Eon's Fringe",faction="B",npc="Ancient Waygate",npcid="aw",x=52.34,y=78.54,taxinodeID=2834,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(71165) or c.completedq(71165)) and not c.hasbuff(392960) end},
	},
	...
	['The Forbidden Reach/5']={ -- The Forbidden Reach/5
		...
		{name="Morqut Islet",faction="B",npc="Ancient Waygate",npcid="aw",x=29.08,y=62.45,taxinodeID=2862,taxioperator="ancientwaygate",recheck=true,cond_fun=function() local c=QC.Parser.ConditionEnv return (c.readyq(75154) or c.completedq(75154)) and not c.hasbuff(392960) end},
	},
...
local function is_phase_conduit_available()
	return QC.Parser.ConditionEnv.hasbuff(1214374)
	--return QC.Parser.ConditionEnv.completedq(89561)
end
...
data.taxipoints[2274]={
	...
	['Tazavesh']={ 
		{name="Tazavesh",faction="B",npc="Om'thenai",npcid=234692,x=34.75,y=10.03,taxinodeID=3029,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},
	...
	['K\'aresh']={ 
		-- NEUTRAL --
		{name="Hosaas' Rest",faction="B",npc="Om'Dodaf",npcid=234701,x=54.21,y=62.83,taxinodeID=3035,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="Eco-Dome: Rhovan",faction="B",npc="Om'Toya",npcid=234722,x=70.19,y=60.91,taxinodeID=3030,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},
		{name="The Oasis",faction="B",npc="Om'Khell",npcid=234718,x=76.66,y=34.94,taxinodeID=3031,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},--3146
		{name="Shan'dorah",faction="B",npc="Sellyna",npcid=234721,x=60.61,y=29.20,taxinodeID=3032,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},--3147
		{name="Overlook Zo'Shuul",faction="B",npc="Om'Qaxxi",npcid=234724,x=47.81,y=37.26,taxinodeID=3034,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},--3157
		{name="Shadow Point",faction="B",npc="Lossain",npcid=234719,x=42.24,y=22.71,taxinodeID=3033,cond_fun=function() return not QC.Parser.ConditionEnv.hasbuff(1214374) end},--3155
		-- NEUTRAL --
...
data.flightcost[13]={
	...
	},
	{
		...
		neighbors = {
			[3126] = 56, -- Torntusk Overlook
			[3128] = 56, -- Atal'Aman
			[3129] = 91, -- Shadebasin Watch
		},
	},
	{
		tag = "481:626",
	...
	},
	{
		...
		name = "Atal'Aman",
		neighbors = {
			[3126] = 53, -- Torntusk Overlook
			[3127] = 56, -- Amani'Zar Village
			[3129] = 74, -- Shadebasin Watch
			[3130] = 73, -- Witherbark Bluffs
			[3134] = 97, -- Tranquillien
		},
	},
	{
		tag = "454:154",
	...
	},
	{
		...
		name = "Camp Stonewash",
		neighbors = {
			[3129] = 22, -- Shadebasin Watch
			[3130] = 55, -- Witherbark Bluffs
		},
	},
	{
		tag = "475:606",
		...
		neighbors = {
			...
			[650] = 27, -- Andorhal, Western Plaguelands
	...
	},
	{
		...
		neighbors = {
			[3130] = 0, -- Witherbark Bluffs
			[3131] = 51, -- Sanctum of Light
			[3132] = 0, -- The Royal Exchange
			[3134] = 58, -- Tranquillien
		},
	},
	{
		tag = "573:794",
	...
	},
	{
		...
		neighbors = {
			[3125] = 101, -- Terrace of the Sun
			[3130] = 0, -- Witherbark Bluffs
			[3132] = 0, -- The Royal Exchange
			[3133] = 51, -- Fairbreeze Village
		},
	},
	{
		tag = "290:389",
	...
	},
	{
		...
		neighbors = {
			[3106] = 22, -- Camp Stonewash
			[3127] = 59, -- Amani'Zar Village
			[3128] = 74, -- Atal'Aman
			[3130] = 42, -- Witherbark Bluffs
		},
	},
	{
		tag = "546:239",
	...
	},
	{
		...
		neighbors = {
			[672] = 79, -- Hearthglen, Western Plaguelands
			[3134] = 88, -- Tranquillien
		},
	},
	{
		tag = "591:816",
	...
	},
	{
		...
		neighbors = {
			...
			[645] = 0, -- Forsaken High Command, Silverpine Forest
	...
	{
		nodeID = 3126,
		name = "Torntusk Overlook",
		neighbors = {
			[3127] = 51, -- Amani'Zar Village
			[3128] = 53, -- Atal'Aman
		},
	},
	{
	...
	},
	{
		...
		neighbors = {
			...
			[3128] = 0, -- Atal'Aman
			[3133] = 58, -- Fairbreeze Village
			[3190] = 88, -- Silverglade Refuge
		},
	},
	{
		tag = "578:754",
	...
	{
		nodeID = 3130,
		name = "Witherbark Bluffs",
		neighbors = {
			[3106] = 43, -- Camp Stonewash
			[3128] = 0, -- Atal'Aman
			[3129] = 0, -- Shadebasin Watch
			[3131] = 0, -- Sanctum of Light
			[3132] = 0, -- The Royal Exchange
			[3133] = 0, -- Fairbreeze Village
		},
...
data.flightcost[113]={
	...
	},
	{
		...
		neighbors = {
			[226] = 26, -- Transitus Shield, Coldarra
	...
	},
	{
		...
		neighbors = {
			[244] = 35, -- Wintergarde Keep, Dragonblight
...
data.flightcost[1550]={
	{
		...
		neighbors = {
			[2625] = 3, -- Elysian Hold
			[2626] = 3, -- Hero's Rest
			[2631] = 3, -- Xandria's Vigil
			[2632] = 3, -- Sagehaven
			[2633] = 3, -- Temple of Purity
			[2634] = 3, -- Seat of Eternal Hymns
			[2635] = 3, -- Temple of Humility
			[2636] = 3, -- Sagehaven
		},
	},
	{
	...
	},
	{
		...
		neighbors = {
			[2626] = 3, -- Hero's Rest
			[2630] = 3, -- Aspirant's Rest
			[2631] = 3, -- Xandria's Vigil
			[2632] = 3, -- Sagehaven
			[2633] = 3, -- Temple of Purity
			[2634] = 3, -- Seat of Eternal Hymns
			[2635] = 2, -- Temple of Humility
			[2636] = 3, -- Sagehaven
		},
	},
	{
...
data.flightcost[2405]={
	{
		...
		neighbors = {
			[3119] = 41, -- The Ingress
			[3120] = 51, -- Locus Point
			[3123] = 52, -- Master's Perch. Voidstorm
		},
	},
	{
		nodeID = 3120,
		...
		neighbors = {
			[3119] = 0, -- The Ingress
			[3121] = 35, -- Howling Ridge
			[3123] = 51, -- Master's Perch. Voidstorm
		},
	},
	{
		nodeID = 3123,
	...
	},
	{
		...
		neighbors = {
			[3120] = 27, -- Locus Point
			[3121] = 38, -- Howling Ridge
			[3123] = 35, -- Master's Perch. Voidstorm
		},
	},
}

data.flightcost[3047]={
        {
                nodeID = 3267,
                name = "Umbral Base Camp",
                axioperator = "phaseconduit",
                neighbors = {
			[3268] = 1, -- The Devouring Ingress
			[3269] = 1, -- Void Acropolis
			[3270] = 1, -- Steam Ravine
                }
        },
        {
                nodeID = 3268,
                name = "The Devouring Ingress",
                axioperator = "phaseconduit",
                neighbors = {
			[3267] = 1, -- Umbral Base Camp
			[3269] = 1, -- Void Acropolis
			[3270] = 1, -- Steam Ravine
                }
        },
...
data.flightcost[3075]={
        {
                nodeID = 3277,
                name = "Umbral Base Camp",
                axioperator = "phaseconduit",
                neighbors = {
			[3280] = 1, -- Extraction Coast
			[3279] = 1, -- Nexus Port
			[3278] = 1, -- Sporeforge
                }
        },
