...
data.basenodes.inns = {
	...
	["Silvermoon City M"]={
		{name="Wayfarer's Rest",faction="B",npc="Innkeeper Jovia",npcid=239630,x=56.46,y=70.35},
		{name="Silvermoon City Inn",faction="H",npc="Innkeeper Delaniel",npcid=247804,x=66.91,y=62.05},
	},

	["Eversong Woods M"]={
		{name="Fairbreeze Village",faction="B",npc="Sylmara Dawnpetal",npcid=242949,x=46.27,y=45.94},
		{name="Tranquillien",faction="B",npc="Innkeeper Kalarin",npcid=236149,x=48.97,y=68.59},
	},

	["Zul Aman M"]={
		{name="Witherbark Bl",faction="B",npc="Gav'jan",npcid=253042,x=36.89,y=23.54},
		{name="Camp Stonewash",faction="B",npc="Provisioner Jok",npcid=255184,x=46.54,y=25.75},
		{name="Amani'Zar Village",faction="B",npc="Tavikko",npcid=240274,x=45.44,y=65.00},
	},

	["Harandar"]={
		{name="The Den",faction="B",npc="Yonaa",npcid=258499,x=65.43,y=61.93},
		{name="Har'alnor Den",faction="B",npc="Narou",npcid=241791,x=31.10,y=65.10},
		{name="Har'mara",faction="B",npc="Gnu'la",npcid=258354,x=35.07,y=22.95},
		{name="Har'kuai",faction="B",npc="Innkeeper Mugi",npcid=254942,x=66.29,y=24.57},
		{name="Har'athir",faction="B",npc="Tla'nith",npcid=251988,x=69.13,y=51.50},
	},

	["Voidstorm"]={
		{name="Dusk's Repose",faction="B",npc="Hospitus",npcid=235701,x=53.16,y=68.17},
		{name="Locus Point",faction="B",npc="Darkhearth Kein",npcid=244912,x=41.71,y=74.64},
		{name="The Ingress",faction="B",npc="240578",npcid=240578,x=35.68,y=58.68},
	},
