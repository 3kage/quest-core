...
-- DUNGEON ENTRANCE/EXITS --
	...
	----------------
		...
		"Uldum New/0 76.84,84.61 -x- The Vortex Pinnacle/1 0.00,0.00 {autotype:portal_dungeon} {cond:not QC.InPhase('OldUldum')}",

		-- Halls of Origination --
		"Uldum 69.09,52.97 -x- Halls of Origination 49.91,93.73 {autotype:portal_dungeon}",
		"Uldum New/0 69.09,53.15 -x- Halls of Origination/1 0.00,0.00 {autotype:portal_dungeon} {cond:not QC.InPhase('OldUldum')}",

		-- Lost City of the Tol'vir --
		"Uldum 60.55,64.32 -x- Lost City of the Tol'vir 31.78,16.78 {autotype:portal_dungeon}",
		"Uldum New/0 60.55,64.32 -x- Lost City of the Tol'vir/0 0.00,0.00 {autotype:portal_dungeon} {cond:not QC.InPhase('OldUldum')}",

		-- Ny'alotha, The Waking City --
		"Uldum New/0 55.17,43.93 -x- Ny'alotha, the Waking City/10 0.00,0.00 {autotype:portal_dungeon} {cond:QC.InPhase('UldumInvasionCenter')}",
	...
	--------------------
		...
		-- Mogu'shan Palace --
		"Vale of Eternal Blossoms 80.9,32.6 -x- Mogu'shan Palace/1 0.00,0.00 {autotype:portal_dungeon} {cond:QC.InPhase('OldVale')}",
		"Vale of Eternal Blossoms New/0 81.60,29.88 -x- Mogu'shan Palace/1 0.00,0.00 {autotype:portal_dungeon} {cond:not QC.InPhase('OldVale')}",
	...
	----------------
		...
		-- Maisara Caverns --
		"Zul Aman M/0 43.74,39.43 -x- Maisara Caverns/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Den of Nalorakk --
		"Zul Aman M/0 31.30,83.97 <radius:15> <title:Enter the building>",
		"@+ -x- Zul Aman M/0 29.79,84.51 <dark:1> <onlyhardwire:1> <title:Enter the Portal to the\nDen of Nalorakk>",
		"@+ -x- Den of Nalorakk/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Windrunner Spire --
		"Eversong Woods M/0 35.37,78.82 -x- Windrunner Spire/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Murder Row --
		"Silvermoon City M/0 57.20,61.06 -x- Murder Row/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Magisters Terrace --
		"Isle of Quel Danas M/0 63.53,15.48 -x- Magisters Terrace M/1 0.00,0.00 {autotype:portal_dungeon}",

		-- The Blinding Vale --
		"Harandar/0 26.24,78.09 -x- The Blinding Vale/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Voidscar Arena --
		"Slayers Rise/0 53.67,33.08 -x- Voidscar Arena/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Nexus Point Xenas --
		"Voidstorm/0 64.93,61.78 -x- Nexus Point Xenas/0 0.00,0.00 {autotype:portal_dungeon}",
...
-- LEGION INVASION POINTS --
	...
	-------------------------------
		...
		"Krokuun/0 73.44,33.84 -x- Invasion Point Sangua/0 24.18,50.61 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5350)}",
		"Invasion Point Sangua/0 50.91,48.01 -x- Krokuun/0 73.44,33.84 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5350)}",

		-- Invasion Point: Sangua (Antoran Wastes) --
		"Antoran Wastes/0 67.03,33.31 -x- Invasion Point Sangua/0 24.18,50.61 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5369)}",
		"Invasion Point Sangua/0 50.91,48.01 -x- Antoran Wastes/0 67.03,33.31 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5369)}",

		-- Invasion Point: Val (Krokuun) --
		"Krokuun/0 38.49,60.97 -x- Invasion Point Val/0 38.78,74.46 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5360)}",
		"Invasion Point Val/0 55.07,35.85 -x- Krokuun/0 38.49,60.97 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5360)}",

		-- Invasion Point: Val (Antoran Wastes) --
		"Antoran Wastes/0 72.68,65.22 -x- Invasion Point Val/0 38.78,74.46 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5372)}",
		"Invasion Point Val/0 55.07,35.85 -x- Antoran Wastes/0 72.65,65.33 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5372)}",

		-- Invasion Point: Naigtal (Eredath) --
		"Eredath/0 70.51,38.47 -x- Invasion Point Naigtal/0 25.20,29.85 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5368)}",
		"Invasion Point Naigtal/0 71.95,57.46 -x- Eredath/0 70.51,38.47 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5368)}",

		-- Invasion Point: Naigtal (Antoran Wastes) --
		"Antoran Wastes/0 55.35,29.53 -x- Invasion Point Naigtal/0 25.20,29.85 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5374)}",
		"Invasion Point Naigtal/0 71.95,57.46 -x- Antoran Wastes/0 55.35,29.53 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5374)}",

		-- Invasion Point: Cen'gar (Antoran Wastes) --
		"Antoran Wastes/0 60.24,42.98 -x- Invasion Point Cen'gar/0 27.39,28.40 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5370)}",
		"Invasion Point Cen'gar/0 65.76,69.57 -x- Antoran Wastes/0 60.24,42.98 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5370)}",

		-- Invasion Point: Cen'gar (Krokuun) --
		"Krokuun/0 68.66,81.80 -x- Invasion Point Cen'gar/0 27.39,28.40 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5359)}",
		"Invasion Point Cen'gar/0 65.76,69.57 -x- Krokuun/0 68.66,81.80 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5359)}",

		-- Invasion Point: Bonich (Eredath) --
		"Eredath/0 61.01,18.74 -x- Invasion Point Bonich/0 69.54,63.16 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5366)}",
		"Invasion Point Bonich/0 45.39,48.18 -x- Eredath/0 61.01,18.74 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5366)}",

		-- Invasion Point: Bonich (Antoran Wastes) --
		"Antoran Wastes/0 55.75,19.28 -x- Invasion Point Bonich/0 69.54,63.16 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5371)}",
		"Invasion Point Bonich/0 45.39,48.18 -x- Antoran Wastes/0 55.75,19.28 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5371)}",

		-- Invasion Point: Aurinor (Antoran Wastes) --
		"Antoran Wastes/0 64.59,69.16 -x- Invasion Point Aurinor/0 81.75,39.02 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5373)}",
		"Invasion Point Aurinor/0 20.45,52.72 -x- Antoran Wastes/0 64.59,69.16 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5373)}",

		-- Invasion Point: Aurinor (Eredath) --
		"Eredath/0 38.82,12.52 -x- Invasion Point Aurinor/0 81.75,39.02 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5367)}",
		"Invasion Point Aurinor/0 20.45,52.72 -x- Eredath/0 38.82,12.52 <subtype:portalclick> {mode:PORTAL} {cond:QC:IsPOIActive(5367)}",
...
-- RAID ENTRANCE/EXITS --
	...
	--------------------------
		...
		"Uldum New/0 38.25,80.69 -x- Throne of the Four Winds/1 0.00,0.00 {autotype:portal_dungeon} {cond:not QC.InPhase('OldUldum')}",
	...
	--------------------
		...
		-- Siege of Orgrimmar
		"Vale of Eternal Blossoms/0 73.96,42.15 -x- Siege of Orgrimmar/1 0.00,0.00 {autotype:portal_dungeon} {cond:QC.InPhase('OldVale')}",
		"Vale of Eternal Blossoms New/0 72.86,41.91 -x- Siege of Orgrimmar/1 0.00,0.00 {autotype:portal_dungeon} {cond:not QC.InPhase('OldVale')}",
		...
		-- Ny'alotha, The Waking City --
		"Vale of Eternal Blossoms New/0 40.08,45.52 -x- Ny'alotha, the Waking City/10 0.00,0.00 {autotype:portal_dungeon} {cond:QC.InPhase('ValeInvasionRight')}",
	...
	----------------
		...
		-- Dreamrift --
		"Harandar/0 61.33,63.01 -x- Dreamrift/0 0.00,0.00 {autotype:portal_dungeon}",

		-- The Voidspire --
		"Voidstorm/0 45.21,64.79 -x- The Voidspire/0 0.00,0.00 {autotype:portal_dungeon}",

		-- March on Quel Danas --
		"Isle of Quel Danas M/0 52.60,85.11 -x- March on Quel Danas/0 0.00,0.00 {autotype:portal_dungeon}",

		-- Sporefall --
		"Harandar/0 73.67,66.34 -x- Sporefall/0 24.20,8.25 {autotype:portal_dungeon}",
...
-- DELVE ENTRANCE/EXITS
	...
	----------------
		...
		-- Twilight Crypts --
		"Zul Aman M/0 25.41,84.51 -x- Twilight Crypts/0 49.12,10.46 {autotype:portal_dungeon}",

		-- Atal Aman --
		"Eversong Woods M/0 63.79,80.01 -x- Atal Aman M/0 24.83,49.41 {autotype:portal_dungeon} {title_atob:Enter the Portal to Atal'Aman\nInside the Building} {title_btoa:Enter the Portal to Leave Atal'Aman}",

		-- Voidholme --
		"Eversong Woods M/0 45.54,86.35 -x- Voidholme/0 16.36,59.76 {autotype:portal_dungeon} {title_atob:Enter the Portal to Voidholme\nInside the Cave} {title_btoa:Enter the Portal to Leave Voidholme}",

		-- Collegiate Calamity --
		"Silvermoon City M/0 40.27,53.05 -x- Collegiate Calamity/0 69.40,82.10 {autotype:portal_dungeon} {title_atob:Enter the Portal to Collegiate Calamity\nInside the Building} {title_btoa:Enter the Portal to Leave Collegiate Calamity}",

		-- The Darkway --
		"Silvermoon City M/0 39.32,31.68 -x- The Darkway/0 44.71,15.45 {autotype:portal_dungeon} {title_atob:Click Enter Delve to Enter\nThe Darkway} {title_btoa:Enter the Portal to Leave The Darkway}",

		-- Parhelion Plaza --
		"Isle of Quel Danas M/0 46.38,40.62 -x- Parhelion Plaza/0 82.63,34.13 {autotype:portal_dungeon} {title_atob:Enter the Portal to Parhelion Plaza\nDownstairs Inside the Building} {title_btoa:Enter the Portal to Leave Parhelion Plaza\nUpstairs Inside the Building}",

		-- Gulf Of Memory --
		"Harandar/0 36.71,49.74 -x- Gulf Of Memory/1 51.50,8.56 {autotype:portal_dungeon} {title_atob:Enter the Portal to The Gulf of\nMemory Down Inside the Cave} {title_btoa:Enter the Portal to Leave The Gulf of Memory}",

		-- Shadowguard Point --
		"Voidstorm/0 37.19,49.12 <radius:10> <title:Enter the building>",
		"@+ -x- Voidstorm/0 37.38,47.74 <dark:1> <onlyhardwire:1> <title:Enter the Portal to\nShadowguard Point>",
		"@+ -x- Shadowguard Point/0 46.43,87.96 {autotype:portal_dungeon}",

		-- Sunkiller Sanctum --
		"Voidstorm/0 54.78,47.28 -x- Sunkiller Sanctum/1 65.11,28.37 {autotype:portal_dungeon} {title_atob:Enter the Portal to Sunkiller\nSanctum Inside the Building} {title_btoa:Enter the Portal to Leave\nSunkiller Sanctum}",
}
...
-- DUNGEON FLOORS --
	...
	----------------
		...
		-- Den of Nalorakk --
		["Den of Nalorakk"] = {
			"Den of Nalorakk/0 50.84,34.71 -x- Den of Nalorakk/1 19.54,55.31",
			"Den of Nalorakk/0 49.31,20.27 -x- Den of Nalorakk/2 52.18,88.13",
			"Den of Nalorakk/1 39.98,24.10 -x- Den of Nalorakk/0 50.84,34.71",
		},

		-- Murder Row --
		["Murder Row"] = {
			"Murder Row/0 45.18,15.29 -x- Murder Row/1 77.52,66.97",
			"Murder Row/1 46.56,82.21 -x- Murder Row/2 30.18,53.26",
		},

		-- Magisters Terrace --
		["Magisters Terrace"] = {
			"Magisters Terrace M/1 51.46,55.67 -x- Magisters Terrace M/0 77.52,66.97",
			"Magisters Terrace M/0 56.24,38.38 -x- Magisters Terrace M/2 22.60,78.98",
			"Magisters Terrace M/0 44.81,68.43 -x- Magisters Terrace M/3 32.57,44.83",
			"Magisters Terrace M/3 70.47,52.98 -x- Magisters Terrace M/4 45.96,19.19",
			"Magisters Terrace M/4 30.66,33.90 -x- Magisters Terrace M/5 44.29,38.63",
			"Magisters Terrace M/5 51.94,49.21 -x- Magisters Terrace M/6 62.22,22.78",
		},

		-- Voidscar Arena --
		["Voidscar Arena"] = {
			"Voidscar Arena/0 39.02,30.38 -x- Voidscar Arena/1 41.30,41.97",
			"Voidscar Arena/0 59.23,30.56 -x- Voidscar Arena/1 55.76,41.79",
			"Voidscar Arena/1 48.83,29.41 -x- Voidscar Arena/2 47.99,97.05",
		},
...
-- RAID FLOORS --
	...
	----------------
		...
		-- March on Quel Danas --
		["March on Quel Danas"] = {
			"March on Quel Danas/0 50.62,12.02 -x- March on Quel Danas/1 50.62,94.58",
		},

		-- The Dreamrift --
		["Dreamrift"] = {
			"Dreamrift/0 50.50,80.60 -x- Dreamrift/1 50.26,22.78",
		},

		-- The Voidspire --
		["The Voidspire"] = {
			"The Voidspire/0 66.76,29.41 -x- The Voidspire/1 47.15,51.00",
		},
...
-- DELVE FLOORS --
	...
	----------------
		...
		-- Twilight Crypts --
		["Twilight Crypts"] = {
			"Twilight Crypts/0 49.16,89.38 -x- Twilight Crypts/1 74.99,41.51 {title_atob:Run down the stairs} {title_btoa:Run up the stairs}",
		},

		-- Windrunner Spire --
		["Windrunner Spire"] = {
			"Windrunner Spire/0 58.51,20.98 -x- Windrunner Spire/1 36.27,33.25",
			"Windrunner Spire/1 48.47,82.39 -x- Windrunner Spire/2 42.49,85.72",
			"Windrunner Spire/2 84.70,42.14 -x- Windrunner Spire/0 58.51,20.98",
			"Windrunner Spire/1 50.05,86.26 -x- Windrunner Spire/5 73.34,22.13",
			"Windrunner Spire/0 59.47,86.62 -x- Windrunner Spire/3 36.99,71.74",
			"Windrunner Spire/3 49.19,24.03 -x- Windrunner Spire/4 51.94,24.46",
			"Windrunner Spire/4 46.08,87.41 -x- Windrunner Spire/0 59.47,86.62",
			"Windrunner Spire/3 51.10,17.93 -x- Windrunner Spire/5 73.82,81.31",
			"Windrunner Spire/5 72.98,56.85 -x- Windrunner Spire/6 65.81,35.94",
		},

		-- Collegiate Calamity --
		["Collegiate Calamity"] = {
			"Collegiate Calamity/0 35.48,32.68 -x- Collegiate Calamity/1 50.43,26.14 {title_atob:Run up the stairs} {title_btoa:Run down the stairs}",
		},

		-- Gulf Of Memory --
		["Gulf Of Memory"] = {
			"Gulf Of Memory/1 44.40,77.65 -x- Gulf Of Memory/0 51.22,60.15",
		},

		-- Sunkiller Sanctum --
		["Sunkiller Sanctum"] = {
			"Sunkiller Sanctum/1 39.50,47.06 -x- Sunkiller Sanctum/0 37.95,46.09",
			"Sunkiller Sanctum/1 43.69,18.54 -x- Sunkiller Sanctum/0 43.93,18.29",
		},
