...
if type(addon.LibRoverData) ~= "table" then addon.LibRoverData = {} end
...
---------------------
	...
	----------------------------
		...
		---------------------------
			--## ALLIANCE ##--
				...
				-- Silvermoon City -to- Stormwind City
					...
					"{cond:PlayerCompletedQuest(86852) or QC.Parser.ConditionEnv.achieved(41806)}",
			...
			--## HORDE ##--
				...
				-- Orgrimmar -to- Silvermoon City
					"Orgrimmar/1 55.98,88.20 -to- Silvermoon City M/0 52.85,65.51 {fac:H} {mode:PORTAL}"..
					"{title:Click the Portal to Silvermoon\n Upstairs Inside the Portal Room}"..
					"{cond:PlayerCompletedQuest(86852) or QC.Parser.ConditionEnv.achieved(41806)}",
			...
			--## Neutral ##--
				...
				-- Silvermoon City -to- Harandar
					...
					"{cond:QC.Parser.ConditionEnv.achieved(41804)}",
				...
				-- Silvermoon City -to- Voidstorm
					...
					"{cond:QC.Parser.ConditionEnv.achieved(41806) or PlayerCompletedQuest(86510) or PlayerIsOnQuest(86510)}",

				-- Silvermoon City -to- The Timeways
				"Silvermoon City M/0 41.97,58.29 -to- Millenia's Threshold/0 38.31,48.18 {fac:B} {mode:PORTAL} {title_atob:Click the Portal to The Timeways} {title_btoa:Click the Portal to Silvermoon City\nnear the big gate}"..
				"{cond:PlayerLevel() >= 90}",
		...
		--------------------
			...
			--## Neutral ##--
				...
				-- Harandar -to- Silvermoon City (The Den)
					...
					"{title:Click the Eversong Rootway\nInside The Den}"..
					"{cond:QC.Parser.ConditionEnv.achieved(41804) or PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
					--"{cond:PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
				
				-- Harandar -to- Voidstorm (The Den)
					"Harandar/2 61.78,73.48 -to- Voidstorm/0 51.64,70.20 {mode:PORTAL}"..
					"{title:Click the Portal to Voidstorm\nInside The Den}"..
					"{cond:QC.Parser.ConditionEnv.achieved(41806)}",
					--"{cond:PlayerCompletedQuest(86899) or PlayerIsOnQuest(86899)}",
		...
		---------------------
			...
			--## Neutral ##--
				-- Silvermoon City -to- Voidstorm  --PRIOR TO UNLOCKING PERMANENT PORTAL
				...
				-- Voidstorm -to- Silvermoon City  --PRIOR TO UNLOCKING PERMANENT PORTAL
				...
				-- Voidstorm -to- Val (Howling Ridge)
					"Voidstorm/0 51.42,71.32 -x- Val/0 63.61,15.91 {mode:PORTAL}"..
					"{title_atob:Click the Greater Void Portal and Choose a Difficulty}"..
					"{title_btoa:Click the Void Particle Rift}"..
					"{cond:(PlayerCompletedQuest(96051) or PlayerIsOnQuest(96051)) and not PlayerCompletedQuest(97071)}",
				
				-- Voidstorm -to- Val (Howling Ridge)
					"Voidstorm/0 51.42,71.32 -x- Val/0 61.83,15.98 {mode:PORTAL}"..
					"{title_atob:Click the Greater Void Portal and Choose a Difficulty}"..
					"{title_btoa:Click the Lightforged Beacon and Select \"Teleport to the Voidstorm\"}"..
					"{cond:PlayerIsOnQuest(97071) or PlayerCompletedQuest(97071)}",
				
				-- Silvermoon City -to- Val
					"Silvermoon City M/0 47.93,48.08 -to- Val/0 61.83,15.98 {mode:PORTAL}"..
					"{title_atob:Click the Lightforged Beacon and Choose a Difficulty}"..
					"{title_btoa:Click the Lightforged Beacon and Select \"Teleport to Silvermoon\"}"..
					"{cond:PlayerIsOnQuest(97071) or PlayerCompletedQuest(97071)}",
				
				-- Voidstorm -to- Naigtal (Howling Ridge)
					"Voidstorm/0 51.42,71.32 -x- Naigtal/0 46.55,83.60 {mode:PORTAL}"..
					"{title_atob:Click the Greater Void Portal and Choose a Difficulty}"..
					"{title_btoa:Click the Void Particle Rift}"..
					"{cond:(PlayerCompletedQuest(96052) or PlayerIsOnQuest(96052)) and not PlayerCompletedQuest(97072)}",
				
				-- Voidstorm -to- Naigtal (Howling Ridge)
					"Voidstorm/0 51.42,71.32 -x- Naigtal/0 48.65,82.79 {mode:PORTAL}"..
					"{title_atob:Click the Greater Void Portal and Choose a Difficulty}"..
					"{title_btoa:Click the Lightforged Beacon and Select \"Teleport to the Voidstorm\"}"..
					"{cond:PlayerIsOnQuest(97072) or PlayerCompletedQuest(97072)}",
				
				-- Silvermoon City -to- Naigtal
					"Silvermoon City M/0 47.93,48.08 -to- Naigtal/0 48.65,82.79 {mode:PORTAL}"..
					"{title_atob:Click the Lightforged Beacon and Choose a Difficulty}"..
					"{title_btoa:Click the Lightforged Beacon and Select \"Teleport to Silvermoon\"}"..
					"{cond:PlayerIsOnQuest(97072) or PlayerCompletedQuest(97072)}",
		...
		---------------
			...
			--## Neutral ##--
				-- Val -to- Void Acropolis
					"Val/0 49.46,97.49 -x- Void Acropolis/0 63.49,78.53 {mode:PORTAL}"..
					"{title_atob:Click the Portal to Void Acropolis Interior}"..
					"{title_btoa:Click the Portal to Void Acropolis Exterior}"..
					"{cond:PlayerCompletedQuest(96051) or PlayerIsOnQuest(96051)}",


				-- Val -to- The Forgotten Depths
					"Val/0 42.91,71.57 -x- Forgotten Depths/0 71.97,19.95 {mode:PORTAL}"..
					"{title_atob:Click the Portal to the Forgotten Depths}"..
					"{title_btoa:Click the Portal to The Devouring Ingress}"..
					"{cond:PlayerCompletedQuest(96051) or PlayerIsOnQuest(96051)}",


				-- Val -to- Void Acropolis Top
					"Val/0 33.76,75.48 -x- Void Acropolis/2 39.88,31.99 {mode:PORTAL}"..
					"{title_atob:Click the Portal to Transit Platform}"..
					"{title_btoa:Click the Portal to The Devouring Ingress}"..
					"{cond:PlayerCompletedQuest(96051) or PlayerIsOnQuest(96051)}",
	...
	--## Neutral ##--
		...
		"Dalaran L/10 47.56,70.31 -x- Dalaran L/10 46.48,113.78 {mode:PORTAL} {title_atob:Click the Portal to the Infinite Bazaar} {cost:3}"..			-- Legion Remix Dalaran Island Portal
			"{title_btoa:Click the Portal to Dalaran} {cond:PlayerCompletedQuest(91962) and QC.IsLegionRemix()}",
	...
	--## ALLIANCE ##--
		...
		"Dornogal/0 48.61,48.62 -to- Elwynn Forest/0 34.48,51.42 {mode:PORTAL} {fac:A} {title:Click the Scenic Getaway Portal and choose The Gala of Gifts}"..
			"{cond:QC.Parser.ConditionEnv.isevent('Love is in the Air')}",
	...
	--## Neutral ##--
		...
		-- The Timeways -to- Spires of Arak (Skyreach)
		"Millenia's Threshold/0 64.54,43.67 -to- Spires of Arak/0 35.83,20.21 {mode:PORTAL} {title:Click the portal to Spires of Arak (Skyreach)}",

		-- The Timeways -to- Icecrown Citadel (Pit of Saron)
		"Millenia's Threshold/0 74.39,47.09 -to- Icecrown/0 49.28,89.86 {mode:PORTAL} {title:Click the portal to Icecrown Citadel (Pit of Saron)}",

		-- The Timeways -to- Dragon Isles (Algeth'ar Academy)
		"Millenia's Threshold/0 70.44,72.85 -to- Thaldraszus/0 57.78,45.84 {mode:PORTAL} {title:Click the portal to Dragon Isles (Algeth'ar Academy)}",

		-- The Timeways -to- Eredath (Seath of the Triumvirate)
		"Millenia's Threshold/0 60.53,69.47 -to- Eredath/0 20.60,59.47 {mode:PORTAL} {title:Click the portal to Eredath (Seat of the Triumvirate)}",
	...
	--## Neutral ##--
		...
		"{cond:(PlayerIsOnQuest(83137) or PlayerCompletedQuest(83137) or QC.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
		...
		"{cond:(PlayerIsOnQuest(83151) or PlayerCompletedQuest(83151) or QC.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
		...
		"{cond:(PlayerIsOnQuest(83933) or PlayerCompletedQuest(83933) or QC.Parser.ConditionEnv.achieved(40900,1)) and PlayerLevel() >= 80}",
	...
	--## Neutral ##--
		...
		"Oribos/1 60.86,68.36 -to- Bastion/0 37.85,76.52    {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Bastion.'}    {cond:PlayerCompletedQuest(60156) and not QC.Parser.ConditionEnv.achieved(14281)}", -- went to Bas, not completed it yet
		-- Oribos to Revendreth (pre-taxi)
		"Oribos/1 60.86,68.36 -to- Revendreth/0 70.00,84.00 {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Revendreth.'} {cond:PlayerCompletedQuest(57025) and not QC.Parser.ConditionEnv.achieved(13878)}", -- went to Rev, not completed it yet
		-- Oribos to Ardenweald (pre-taxi)
		"Oribos/1 60.86,68.36 -to- Ardenweald/0 68.00,18.00 {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Ardenweald.'} {cond:PlayerCompletedQuest(60338) and not QC.Parser.ConditionEnv.achieved(14164)}", -- went to Ard, not completed it yet
		-- Oribos to Maldraxxus (pre-taxi)
		"Oribos/1 60.86,68.36 -to- Maldraxxus/0 50.00,41.00 {mode:PORTAL} {cost:53} {title:Talk to Pathscribe Roh-Avonavi\nTell him 'I need to get back to Maldraxxus.'} {cond:PlayerCompletedQuest(57386) and not QC.Parser.ConditionEnv.achieved(14206)}", -- went to Mal, not completed it yet
	...
	--## Neutral ##--
		...
		"Elysian Hold/0 41.17,71.10 -x- Bastion/0 58.73,28.96 {mode:PORTAL} {cost:18} {title:Click the |cfff0e081\"Tamed Larion\"|r} "..
			"{cond:covenant('Kyrian') and PlayerLevel() >= 60}",

		-- Elysian Hold (Tamed Larion), Bastion -x- Everdrawn Commons (Tamed Larion), Bastion --
		"Elysian Hold/0 63.00,93.81 -x- Bastion/0 67.90,27.34 {mode:PORTAL} {cost:10} {title:Click the |cfff0e081\"Tamed Larion\"|r} "..
			"{cond:covenant('Kyrian') and PlayerLevel() >= 60}",

		-- Elysian Hold (Tamed Larion), Bastion -x- Fate's Precipice (Tamed Larion), Bastion --
		"Elysian Hold/0 22.38,29.10 -x- Bastion/0 59.00,11.63 {mode:PORTAL} {cost:12} {title:Click the |cfff0e081\"Tamed Larion\"|r} "..
			"{cond:covenant('Kyrian') and PlayerLevel() >= 60}",
	...
	--## Neutral ##--
		...
		"The Maw/0 48.29,41.45 -to- The Maw/0 68.89,36.60 {mode:PORTAL} {title:Talk to the Animaflow Teleporter\nChoose |cfff0e081\"Desmotaeron\"|r} "..
			"{cond:PlayerCompletedQuest(61600) and QC.Parser.ConditionEnv.achieved(15126)}",
	...
	--## ALLIANCE ##--
		...
		"Darkshore/0 48.02,36.28 -to- Boralus/0 66.81,25.06 {fac:A} {mode:PORTAL} {title:Click the Portal to Boralus Harbor} "..
			"{cond:PlayerCompletedQuest(54871) and not QC.InPhase('Old Darnassus') and QC.InPhase('Warfront Darkshore Control')}",
		...
		"Azuremyst Isle/0 20.40,54.17 -to- Darkshore/0 45.95,18.74 {fac:A} {mode:PORTAL} {title:Click the Portal to Darkshore} "..
			"{cond:not QC.InPhase('Old Darnassus')}",
		...
		"Silithus/0 41.48,44.85 -to- Boralus/0 70.18,15.87 {fac:A} {mode:PORTAL} {title:Click the Portal to Tiragarde} "..
			"{cond:QC.InPhase('BFA') and not QC.InPhase('Old Silithus') and PlayerLevel() >= 10}",
		...
		"Teldrassil/0 55.03,93.72 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:QC.InPhase('Old Darnassus')}",

		-- Rut'theran Village - Darnassus, Kalimdor -to- The Exodar - Azuremyst Isle, Kalimdor --CHECKED
		"Teldrassil/0 52.27,89.47 -to- Azuremyst Isle/0 20.52,54.16 {mode:PORTAL} {cond:QC.InPhase('Old Darnassus')}",

		-- Temple of the Moon - Darnassus, Kalimdor -to- The Exodar - Azuremyst Isle, Kalimdor --CHECKED
		"Darnassus/0 44.23,78.70 -to- The Exodar/0 47.62,59.82 {fac:A} {mode:PORTAL} {cond:QC.InPhase('Old Darnassus')}",

		-- Temple of the Moon - Darnassus, Kalimdor (Old Time) -to- Hellfire Peninsula, Outland (Portal Usable) --
		"Darnassus/0 43.99,78.18 -to- Hellfire Peninsula/0 89.17,50.86 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10 and QC.InPhase('Old Darnassus')}",
		...
		"Darnassus/0 43.99,78.18 <override_text:You must be at least 10 to enter Outland.> <override_icon:error> -to- Hellfire Peninsula/0 89.17,50.86 {fac:A} "..
			"{mode:PORTAL} {cond:not (PlayerLevel() >= 10 and QC.InPhase('Old Darnassus'))} {cost:999}",
	...
	--## HORDE ##--
		...
		"Darkshore/0 46.24,35.11 -to- Dazar'alor/0 51.66,93.82 {fac:H} {mode:PORTAL} {title:Click the Portal to Port of Zandalar} "..
			"{cond:PlayerCompletedQuest(54416) and not QC.InPhase('Old Darnassus') and QC.InPhase('Warfront Darkshore Control')}",
		...
		"Northern Stranglethorn/0 37.54,50.99 -to- Undercity/0 84.58,16.33 {fac:H} {mode:PORTAL} {cond:QC.InPhase('Old Undercity')}",

		-- Northern Stranglethorn Vale, Kalimdor -to- Tirisfal Glades, Eastern Kingdoms (After Destruction) --CHECKED
		"Northern Stranglethorn/0 37.54,50.99 -to- Tirisfal Glades/0 69.30,62.75 {fac:H} {mode:PORTAL} {cond:not QC.InPhase('Old Undercity') and not QC.InPhase('UndercityCharred') and not QC.InPhase('UndercityOoze')}",
		...
		"Orgrimmar/1 48.87,38.55 -to- Uldum New/0 54.90,34.25 {fac:H} {mode:PORTAL} {cond:not QC.InPhase('OldUldum') and PlayerLevel() >= 10}",
		...
		"Orgrimmar/1 50.74,55.57 -to- Tirisfal Glades L/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Portal to Ruins of Lordaeron on Top of the Zeppelin Tower} "..
			"{cond:QC.InPhase('UndercityCharred')}",
		...
		"Orgrimmar/1 48.23,62.17 -to- Mulgore/0 36.49,35.11 {fac:H} {mode:PORTAL} {cond:QC:FindEvent('DARKMOON FAIRE')} "..
		...
		-- Razorwind Shores -to- Orgrimmar
		"Razorwind Shores/0 53.92,49.37 -to- Orgrimmar/1 57.10,89.81 {mode:PORTAL} {fac:H} {title_atob:Click the Portal to Orgrimmar}",

		-- Razorwind Shores -to- Silvermoon City - Eversong Woods, Eastern Kingdoms
		--"Razorwind Shores/0 54.22,55.85 -to- Silvermoon City M/0 45.67,65.65 {fac:H} {mode:PORTAL}"..
			--"{title_atob:Click the Portal to Silvermoon City}",
	...
	--## NEUTRAL ##--
		...
		"Darnassus/0 36.79,50.44 -x- Teldrassil/0 55.07,88.38 {mode:PORTAL} {template:pinkportal} {cond:QC.InPhase('Old Darnassus')}",
		...
		"Silithus/0 43.20,44.50 -to- Chamber of Heart/0 50.22,35.92 {mode:PORTAL} {title:Click the Titan Translocator} "..
			"{cond:QC.InPhase('BFA') and not QC.InPhase('Old Silithus')}",

			-- Zidormi Phase -to- Present Day Silithus --CHECKED
			"Silithus/0 78.93,21.97 -to- Chamber of Heart/0 50.22,35.92 {mode:PORTAL} {cond:QC.InPhase('BFA') and QC.InPhase('Old Silithus')} "..
		...
		"Mulgore/0 36.85,35.86 -to- Darkmoon Island/0 51.29,23.86 {mode:PORTAL} {cond:QC:FindEvent('DARKMOON FAIRE')} "..
	...
	--## ALLIANCE ##--
		...
		"Blasted Lands/0 55.01,54.27 -to- Stormshield/0 31.71,52.48 {fac:A} {mode:PORTAL} {cond:PlayerLevel() >= 10 and not QC.InPhase('Old Blasted Lands')} "..
		...
		"Blasted Lands/0 55.01,54.27 <override_text:You must be at least 10 to enter Draenor.> <override_icon:error> -to- Stormshield/0 31.71,52.48 {fac:A} "..
			"{mode:PORTAL} {cond:PlayerLevel() < 10 and not QC.InPhase('Old Blasted Lands')} {template:darkportalred} {cost:999}",

		-- Goldshire - Elynn Forest, Eastern Kingdoms -to- Darkmoon Island --CHECKED
		"Elwynn Forest/0 41.79,69.48 -to- Darkmoon Island/0 51.29,23.86 {mode:PORTAL} {cond:QC:FindEvent('DARKMOON FAIRE')} "..
			"{title:Click the Portal to the Darkmoon Faire}",
		...
		"Stormwind City/0 75.24,20.50 -to- Uldum New/0 54.90,34.25 {fac:A} {mode:PORTAL} {cond:not QC.InPhase('OldUldum')}}",
		...
		"Arathi Highlands/0 21.96,65.15 -to- Boralus/0 66.81,25.06 {fac:A} {mode:PORTAL} {title:Click the Portal to Boralus Harbor} "..
			"{cond:PlayerCompletedQuest(53198) and not QC.InPhase('Old Arathi') and QC.InPhase('Warfront Arathi Control')}",

		-- Stormwind City - Elwynn Forest, Kalimdor -to- Darkmoon Island
		"Stormwind City/0 62.26,72.96 -to- Elwynn Forest/0 41.87,68.17 {fac:A} {mode:PORTAL} {cond:QC:FindEvent('DARKMOON FAIRE')} "..
			"{title:Talk to the Darkmoon Faire\nMystic Mage and tell her\n|cffaaffaa\"Take me to the staging area.\"|r}",

		-- Stormwind - Elwynn Forest, Eastern Kingdoms -to- Founder's Point
		...
		-- Founder's Point -to- Stormwind - Elwynn Forest, Eastern Kingdoms
		"Founder's Point/0 57.42,26.63 -to- Stormwind City/0 46.35,90.23 <region:magetower> {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(93057)}"..
			"{title_atob:Click the Portal to Stormwind}",

		-- Founder's Point -to- Silvermoon City - Eversong Woods, Eastern Kingdoms
		--"Founder's Point/0 53.18,38.02 -to- Silvermoon City M/0 45.67,65.65 {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(93057)}"..
			--"{title_atob:Click the Portal to Silvermoon City}",
	...
	--## HORDE ##--
		...
		"Arathi Highlands/0 27.44,29.38 -to- Dazar'alor/0 51.66,93.82 {fac:H} {mode:PORTAL} {title:Click the Portal to Port of Zandalar} "..
			"{cond:PlayerCompletedQuest(53212) and not QC.InPhase('Old Arathi') and QC.InPhase('Warfront Arathi Control')}",
		...
		"Blasted Lands/0 72.65,49.51 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and not QC.InPhase('Old Blasted Lands')}",
		...
		"Silvermoon City/0 49.49,14.80 -to- Tirisfal Glades/0 69.30,62.75 {fac:H} {mode:PORTAL} {title:Click the Orb of Translocation} "..
			"{cond:not QC.InPhase('Old Undercity') and not QC.InPhase('UndercityCharred') and not QC.InPhase('UndercityOoze')}",
		...
		"Tirisfal Glades/0 60.74,58.67 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:QC.InPhase('Old Undercity')}"..
		...
		"Undercity/0 85.25,17.04 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and QC.InPhase('Old Undercity')}",
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
			...
			"Tirisfal Glades L/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades L/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Silvermoon City) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Silvermoon City/0 49.49,14.80 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Grom'gol) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Northern Stranglethorn/0 37.23,50.48 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Ogrimmar) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",

			-- Zidormi Phase -to- Past Tirisfal Glades (Undercity) --CHECKED
			"Tirisfal Glades/0 69.45,62.80 -to- Undercity/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityOoze') and PlayerCompletedQuest(51443)} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?\"|r}",
		...
		-- Tirisfal Glades, Eastern Kingdoms (Old Time) -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Tirisfal Glades L/0 59.50,66.95 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityCharred')}",

		-- Tirisfal Glades, Eastern Kingdoms (Old Time) -to- Vengeance Landing - Howling Fjord, Northrend --CHECKED
		"Tirisfal Glades L/0 60.11,66.93 -to- Howling Fjord/0 79.00,28.92 {fac:H} {mode:PORTAL} {cond:QC.InPhase('UndercityCharred')}",
		...
		-- Undercity - Tirisfal Glades, Eastern Kingdoms -to- The Stair of Destiny - Hellfire Peninsula, Outland (Portal Usable) --CHECKED
		--"Undercity/0 85.25,17.04 -to- Hellfire Peninsula/0 89.16,49.56 {fac:H} {mode:PORTAL} {cond:PlayerLevel() >= 10 and QC.InPhase('UndercityCharred')}",
	...
	--## NEUTRAL ##--
		...
		"Blasted Lands/0 55.01,54.27 -to- Hellfire Peninsula/0 89.56,50.22 {mode:PORTAL} {cond:PlayerLevel() >= 10 and QC.InPhase('Old Blasted Lands')} "..
			"{template:darkportal}",
	...
	--## NEUTRAL ##--
		...
		--"{cond:not QC:RaceClassMatch('MAGE')}",
	...
	--## ALLIANCE ##--
		...
		"Vale of Eternal Blossoms New/0 91.59,64.30 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {cond:not QC.InPhase('OldVale')}",
	...
	--## HORDE ##--
		...
		"Durotar 66,1 <title:Hellscream's Fist Airship> -to- The Jade Forest 28.5,14.0 {fac:H} {mode:PORTAL} "..
			"{cond:PlayerLevel()>=10 and PlayerLevel() < 50  and not PlayerCompletedQuest(31769) and not QC.IsLegionOn()}",
		...
		"Vale of Eternal Blossoms New/0 63.72,9.89 -to- @org_tp_dst {fac:H} {mode:PORTAL} {cond:not QC.InPhase('OldVale')}",
	...
	--## NEUTRAL ##--
		...
		"Dalaran L/10 49.26,47.62 -to- Dalaran L/12 63.38,23.87 {mode:PORTAL} {title:Step on the glowing pad inside the building} {cond:QC.IsLegionOn()}",

		-- Chamber of the Guardian Interior - Dalaran, Broken Isles -to- Chamber of the Guardian Entrance - Dalaran, Broken Isles --
		"Dalaran L/12 64.88,21.12 -to- Dalaran L/10 49.04,48.04 {mode:PORTAL} {title:Step on the glowing pad inside the building} {cond:QC.IsLegionOn()}",
		...
		"Dalaran L/10 23.10,-11.40 <region:dalaran_margosss_retreat> -to- Dalaran L/10 60.92,44.72 {mode:PORTAL} {cond:QC.IsLegionOn()} "..
	...
	--## ALLIANCE ##--		
		...
		"Tiragarde Sound/0 74.38,23.41 -to- The Exodar/0 47.62,59.82 {fac:A} {mode:PORTAL} {title:Click the Portal to Exodar Inside the Building} {cond:QC.InPhase('BFA') or PlayerLevel() >= 50}}",

		-- Sanctum of the Sages - Boralus Harbor, Tiragarde Sound -to- Ironforge - Dun Morogh, Eastern Kingdoms --
		"Tiragarde Sound/0 74.49,23.50 -to- Ironforge/0 25.51,8.43 {fac:A} {mode:PORTAL} {title:Click the Portal to Ironforge Inside the Building} {cond:QC.InPhase('BFA') or PlayerLevel() >= 50}}",
		...
		"Boralus/0 69.65,15.92 -to- Silithus/0 41.41,45.19 {fac:A} {mode:PORTAL} {title:Click the Portal to Silithus Inside the Building} "..
			"{cond:QC.InPhase('BFA') and not QC.InPhase('Old Silithus') and PlayerLevel() >= 50}",
		...
		"Boralus/0 70.13,16.79 -to- @sw_tp_dst {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind Inside the Building} "..
			"{cond:QC.InPhase('BFA') or PlayerLevel() >= 50}",
	...
	--## ALLIANCE ##--
		...
		"Boralus/0 66.19,24.72 -to- Arathi Highlands/0 21.58,65.14 {fac:A} {mode:PORTAL} {title:Click the Portal to Arathi Highlands} "..
			"{cond:QC.InPhase('Warfront Arathi Control') and PlayerCompletedQuest(53194)}",
		...
		"Boralus/0 66.22,24.42 -to- Darkshore/0 46.72,34.73 {fac:A} {mode:PORTAL} {title:Click the Portal to Darkshore} "..
			"{cond:QC.InPhase('Warfront Darkshore Control') and PlayerCompletedQuest(53194)}",
	...
	--## HORDE ##--
		...
		--"Dazar'alor/0 49.94,43.85 -to- Orgrimmar/1 40.67,77.43 {fac:H} {mode:PORTAL} {cond:QC:RaceClassMatch('ZANDALARITROLL')}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Silvermoon City, Eversong Woods --
		"Dazar'alor/1 73.99,62.22 -to- Silvermoon City/0 58.26,19.24 {fac:H} {mode:PORTAL} {title:Click the Portal to Silvermoon City Inside the Building} {cond:QC.InPhase('BFA') or PlayerLevel() >= 50}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Orgrimmar - Durotar, Kalimdor --
		"Dazar'alor/1 74.05,69.75 -to- @org_tp_dst {fac:H} {mode:PORTAL} {title:Click the Portal to Orgrimmar Inside the Building} {cond:QC.InPhase('BFA') or PlayerLevel() >= 50}",

		-- Hall of Ancient Paths - Zuldazar, Zandalar -to- Thunder Bluff - Mulgore, Kalimdor --
		"Dazar'alor/1 73.60,77.38 -to- Thunder Bluff/0 22.21,16.87 {fac:H} {mode:PORTAL} {title:Click the Portal to Thunder Bluff Inside the Building} {cond:QC.InPhase('BFA') or PlayerLevel() >= 50}",
		...
		"Dazar'alor/0 51.92,94.59 -to- Arathi Highlands/0 27.40,29.95 {fac:H} {mode:PORTAL} {title:Click the Portal to Ar'gorok} "..
			"{cond:QC.InPhase('Warfront Arathi Control') and PlayerCompletedQuest(53208)}",
		...
		"Dazar'alor/0 51.99,94.55 -to- Darkshore/0 46.31,35.00 {fac:H} {mode:PORTAL} {title:Click the Portal to Darkshore} "..
			"{cond:QC.InPhase('Warfront Darkshore Control') and PlayerCompletedQuest(53208)}",
	...
	-- HIGHMOUNTAIN TAUREN
		"Thunder Totem/6 46.04,63.74 -to- Orgrimmar/1 40.24,78.12 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar} {cond:QC:RaceClassMatch('HIGHMOUNTAINTAUREN')}",

		"Orgrimmar/1 38.15,75.28 -to- Thunder Totem/6 44.18,64.07 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Thunder Totem} {cond:QC:RaceClassMatch('HIGHMOUNTAINTAUREN')}",


	-- NIGHTBORNE
		"Suramar/0 58.18,87.33 -to- Orgrimmar/1 40.24,78.12 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to Orgrimmar\non the Platform} {cond:QC:RaceClassMatch('NIGHTBORNE')}",

		"Orgrimmar/1 38.59,75.89 -to- Suramar/0 59.55,85.29 {fac:H} {mode:PORTAL} {title_atob:Click the Portal to The Nighthold} {cond:QC:RaceClassMatch('NIGHTBORNE')}",
...
-------------------------
	...
	--## ALLIANCE ##--
		...
		"Stormwind City/0 18.02,25.84 -x- Borean Tundra/0 59.68,69.41 {fac:A} {mode:SHIP} {cost:177}  {cond:not QC.IsLegionBoatLock()}",
	...
	--## HORDE ##--
		...
		"Zuldazar/0 58.02,65.07 -x- Echo Isles/0 70.90,38.23 {fac:H} {mode:SHIP} {cond:QC.InPhase('BFA')}",
...
------------------
		...
		-- Teleport: Darnassus --
		"Darkshore/0 45.95,18.74				<spell:3565>	<faction:A>	<cond:not QC.InPhase('Old Darnassus')>",
		"Darnassus/0 43.47,78.67				<spell:3565>	<faction:A>	<cond:QC.InPhase('Old Darnassus')>",
		-- Teleport: Ironforge --
		...
		"Vale of Eternal Blossoms/0 86.30,61.05			<spell:132621>	<faction:A>	<cond:QC.InPhase('Old Vale')>",
		"Vale of Eternal Blossoms New/0 86.85,59.09		<spell:132621>	<faction:A>	<cond:not QC.InPhase('Old Vale')>",
		...
		-- Teleport: Vale of Eternal Blossoms --
		"Vale of Eternal Blossoms/0 62.21,21.54			<spell:132627> <faction:H>	<cond:QC.InPhase('Old Vale')>",
		"Vale of Eternal Blossoms New/0 62.68,19.30		<spell:132627> <faction:H>	<cond:not QC.InPhase('Old Vale')>",
		-- Teleport: Warspear --
		...
		-- Teleport: Silvermoon City
		"Silvermoon City M/0 52.85,65.51			<spell:1259190>  <faction:B>",
		...
		-- DRUID
			"Emerald Dreamway/0 35.33,53.15 <spell:193753> <cond:QC.CurrentMapID~=715>",

		-- DEATHKNIGHT
			"Broken Shore/2 27.43,30.43 <spell:50977> <subtype:deathgate> <cond:(PlayerCompletedQuest(38990) or PlayerCompletedQuest(40935) or PlayerCompletedQuest(40740)) and QC.CurrentMapID~=647 and QC.CurrentMapID~=648  and QC.CurrentMapID~=646>",

		-- MONK (Zen Pilgrimage)
			"The Wandering Isle L/0 51.46,48.65 <spell:126892> <subtype:zenpilgrimage> <cond:PlayerCompletedQuest(40236) and QC.CurrentMapID~=709>",
