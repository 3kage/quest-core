...
patch='31200',
source='Promotion',
description="This battle pet is no longer available in-game, but look for him at celebration events, at the Trading Post, or in the Blizzard Store.",
keywords={"Aquatic","Merge","Account"},
pet=192,
},[[
step
{r}NO LONGER AVAILABLE{}
{r}He may become available in the future at celebration events, the Trading Post, or in the Blizzard Store
collect Unhatched Mr. Chilly##41133 |n
use the Unhatched Mr. Chilly##41133 |or
'|complete haspet(192) |or
step
|tip Check your mailbox when you log in after your merge your World of Warcraft account to your Blizzard.net account.
learnpet Mr. Chilly##192
]])
...
step
Follow the Walkway to the Left |goto Burning Steppes/14 65.46,43.94 < 5 |c |or
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Kun-Lai Runt",{
patch='unknown',
source='unknown',
