...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pet Quests\\Draenor Battle Pets Dailies",{
patch='unknown',
source='unknown',
...
step
label "tarrt"
_Enter_ the Gorian Proving Grounds |goto Nagrand D/0 57.00,19.00 < 30 |only if walking
_Go up_ the stone steps |goto Nagrand D/0 56.70,17.80 < 30 |only if walking
_Continue up_ the second set of stone steps |goto Nagrand D/0 56.90,11.50 < 20 |only if walking
...
Defeat the Pets in the Small Arena |q 37644/1 |or |only if hasbuilding(168) |goto Lunarfall/0 28.70,43.50
step
talk Lio the Lioness##85418
