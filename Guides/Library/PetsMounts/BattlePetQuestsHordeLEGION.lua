...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Battle Pet Dungeons\\Deadmines",{
patch='unknown',
source='unknown',
...
turnin Deadmines, Part Three?##46293 |goto Westfall/0 41.55,71.12 |only if not completedq(46291)
accept The Deadmines Strike Back##46291 |goto Westfall/0 41.55,71.12 |only if not completedq(46291)
accept Pet Battle Challenge: Deadmines##46292 |goto Westfall/0 41.55,71.12 |only if completedq(46291)
|tip This is a weekly quest! |only if completedq(46291)
step
This is a weekly account wide quest
|tip There are 9 pet battles in which you need to defeat to complete this dungeon.
|tip Get as many level 25 pets as you can before attempting this.
|tip You will not be able to heal your pets while inside the dungeon.
|confirm |next
|only if completedq(46291)
step
talk Marcus "Bagman" Brown##119390
Select _"Take me into the Deadmines."_ |gossip 47489 |goto Westfall/0 41.55,71.12
Begin the Deadmines Pet Battle Dungeon |scenariostart |q 46292
step
...
path	46.98,20.86
Follow the path avoiding the cannon shots |goto Deadmines Scenario/2 46.98,20.86
...
Follow the path |goto Deadmines Scenario/2 54.91,50.84
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
talk Marcus "Bagman" Brown##119390
turnin The Deadmines Strike Back##46291 |goto Westfall/0 41.55,71.12 |only if not completedq(46291)
turnin Pet Battle Challenge: Deadmines##46292 |goto Westfall/0 41.55,71.12 |only if completedq(46291)
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Battle Pet Dungeons\\Wailing Caverns",{
patch='unknown',
source='unknown',
...
Select _"Take me into the Wailing Caverns."_
Enter the Wailing Caverns Pet Battle Dungeon |scenariostart |goto Northern Barrens/20 23.51,81.33 |q 45539
step
...
|tip It walks around this area.
Defeat Deviate Chomper |scenariogoal 1/34862 |goto WC Pet Battle/0 60.90,70.17 |q 45539
step
clicknpc Deviate Flapper##116787
|tip It flies around this area.
Defeat Deviate Flapper |scenariogoal 1/34861 |goto WC Pet Battle/0 62.16,74.58 |q 45539
step
clicknpc Son of Skum##116789
Defeat Son of Skum |scenariogoal 2/34863 |goto WC Pet Battle/0 61.31,79.37 |q 45539
step
clicknpc Phyxia##116792
|tip It crawls around this area.
Defeat Phyxia |scenariogoal 3/34868 |goto WC Pet Battle/0 56.55,89.07 |q 45539
step
clicknpc Dreadcoil##116791
|tip It crawls up and down the path leading up.
Defeat Dreadcoil |scenariogoal 3/34867 |goto WC Pet Battle/0 56.39,78.53 |q 45539
step
clicknpc Vilefang##116790
Defeat Vilefang |scenariogoal 3/34866 |goto WC Pet Battle/0 55.43,72.10 |q 45539
step
Follow the path up |goto WC Pet Battle/0 50.79,63.86 < 20 |walk
clicknpc Hiss##116793
|tip It crawls around this area.
Defeat Hiss |scenariogoal 4/34865 |goto WC Pet Battle/0 63.53,59.18 |q 45539
step
Follow the path up |goto WC Pet Battle/0 72.41,66.27 < 20 |walk
Continue following the path |goto WC Pet Battle/0 69.32,83.37 < 20 |walk
clicknpc Growing Ectoplasm##116794
Defeat Growing Ectoplasm |scenariogoal 5/34864 |goto WC Pet Battle/0 60.68,81.67 |count 1 |q 45539
step
Follow the path up |goto WC Pet Battle/0 57.66,78.52 < 20 |walk
|tip Jump over the gap.
clicknpc Growing Ectoplasm##116794
Defeat Growing Ectoplasm |scenariogoal 5/34864 |goto WC Pet Battle/0 54.35,64.42 |count 2 |q 45539
step
Watch the Dialogue
Confront the Shadowy Figure |scenariogoal 6/34939 |goto WC Pet Battle/0 54.39,60.64 |q 45539
step
Follow the path up |goto WC Pet Battle/0 54.39,60.64 < 10 |walk
clicknpc Budding Everliving Spore##116795
Defeat Budding Everliving Spore |scenariogoal 7/34869 |goto WC Pet Battle/0 57.88,49.76 |q 45539
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pet Quests\\Uuna Storyline",{
...
Glide to the Island |goto Eredath/0 25.15,59.86 < 15 |c |q 50104 |future
step
Use a gliding ability to jump across the gap |goto Eredath/0 32.15,72.02 < 15
|tip You will need a Goblin Glider or the Emerald Winds toy. |only if not DemonHunter
...
Glide to the Island |goto Eredath/0 32.15,72.02 < 15 |c |q 50104 |future
step
Summon Uuna |complete activepet(2136) |goto Eredath/0 32.71,75.50 |q 50104 |future
|tip Summon Uuna from your Pet Journal interface panel.
step
Reunite Uuna with Her Doll |q 50104 |future |goto Eredath/0 32.71,75.50
|tip Inside the building on the island.
step
talk Zidormi##141489
Select _"Can you show me what Darkshore was like before the battle?"_
Travel to the Past |complete QC.InPhase('Old Darnassus') |goto Darkshore/0 48.86,24.46 |q 50105 |future
step
...
Wait for Uuna to Be Kidnapped |q 50107 |future |goto Shadowmoon Valley D/0 55.98,41.14
step
Kill Yourself |complete isdead() |goto Shadowmoon Valley D/0 52.10,47.69 |q 50108 |future
...
step
talk Spirit Healer##6491 |goto Shadowmoon Valley D/0 52.10,47.69
Select _"I'm looking for a little girl named Uuna, have you seen her?"_
Question the Spirit Healer |q 50108 |future
step
Return to Life |complete not isdead() |goto Shadowmoon Valley D/0 52.10,47.69 |q 50109 |future
...
Travel to the Past |complete QC.InPhase('OldVale') |goto Vale of Eternal Blossoms New/0 80.97,29.48 |q 50140 |future
step
...
Summon Uuna |complete activepet(2136) |goto Burning Steppes/14 37.69,66.68 |q 50146 |future
|tip Summon Uuna from your Pet Journal interface panel.
step
Watch the dialogue
|tip You may need to move around a small area to get it to trigger.
Give Uuna a Tour of Blackrock Mountains |q 50146 |future |goto Burning Steppes/14 37.69,66.68
step
