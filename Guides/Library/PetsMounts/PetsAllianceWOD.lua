...
step
talk Nat Pagle##85984 |goto Lunarfall 53.80,13.80
...
learnpet Left Shark##1687 |goto Shadowmoon Valley D/0 28.20,11.80
]])
...
accept Mastering the Menagerie##37248 |goto Lunarfall/0 28.60,39.20 |or
accept Mastering the Menagerie##37645 |goto Lunarfall/0 28.60,39.20 |or
accept Mastering the Menagerie##37644 |goto Lunarfall/0 28.60,39.20 |or
step
...
Defeat Erris the Collector |q 38299/1 |goto Lunarfall/0 30.99,40.20
step
talk Erris the Collector##91016
turnin Critters of Draenor##38299 |goto Lunarfall/0 30.99,40.20
step
...
Click Here to Open the "Garrison Leveling Guide" |confirm |loadguide "Leveling Guides\\Draenor (10-70)\\Garrisons\\Garrison Leveling Guide" |only if completedq(34586)
...
talk Naron Bloomthistle##85344 |goto Lunarfall/0 58.90,53.50
...
confirm
step
talk Gazrix Gearlock##88482 |goto Stormshield/0 43.10,77.80
...
_Click here_ if you need to do the quests leading up to the dailies. |next "Events Guides\\Brewfest\\Brewfest Quests" |confirm |confirm |only if QC.guidesets["DailiesACATA"]
_Click here_ if you have completed the quests and only need the dailies. |next "Events Guides\\Brewfest\\Brewfest Dailies" |confirm |confirm |only if QC.guidesets["DailiesACATA"]
step
talk Belbi Quikswitch##23710 |goto Dun Morogh/0 56.20,37.80
...
step
talk Noblegarden Vendor##32836 |goto Elwynn Forest 43.00,65.20
...
confirm
step
click Silver-Lined Arrow##237471 |goto Shadowmoon Burial Grounds 84.10,80.70
...
confirm
step
talk Maaria##85427 |goto Lunarfall/0 52.40,43.50
...
step
click the Teroclaw Nest##230643 |goto Talador 72.80,35.60
...
step
click Strange Spore##237511 |goto Shadowmoon Valley D/0 55.80,19.90
...
goto Stormwind City,85.80,25.90 |only if skillmax("Archaeology")<1
...
confirm
step
talk Vindicator Nuurem##85932 |goto Stormshield/0 46.60,76.80
...
learnpet Ghastly Rat##1741 |goto Lunarfall 44.50,55.80
]])
...
|tip After you activate this decoration this and 2 other pets will start spawning in your garrison.
Battle and capture it once it's weakened
learnpet Ghost Maggot##1740 |goto Lunarfall 45.20,47.80
]])
...
confirm
step
talk Shadow-Sage Brakoss##85946 |goto Stormshield 45.80,75.20
...
|tip After you activate this decoration this and 2 other pets will start spawning in your garrison.
Battle and capture it once it's weakened
learnpet Spectral Spinner##1730 |goto Lunarfall 48.80,52.20
]])
...
step
talk Dorothy##53728 |goto Elwynn Forest,31.80,50.00
