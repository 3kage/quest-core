...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Armored Frostboar",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Armored Frostwolf",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Blacksteel Battleboar",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Challenger's War Yeti",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Frostplains Battleboar",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Gorestrider Gronnling",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Infernal Direwolf",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Achievement Mounts\\Chauffeured Chopper",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Icehoof",{
...
accept Capturing a Clefthoof##36916 |goto Lunarfall 39.80,56.60
step
Use your _Clefthoof Lasso_ on the Young Icehoof in the area |use Clefthoof Lasso##118181 |q 36916/1 |goto Frostfire Ridge/0 54.00,20.50
step
talk Keegan Firebeard##86973
turnin Capturing a Clefthoof##36916 |goto Lunarfall 39.80,56.60
step
talk Keegan Firebeard##86973
You will only be able to _complete 1 of the following quests_ per day
accept Clefthoof Training: Riplash##36985 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36985)
accept Clefthoof Training: Gezz'ran##36986 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36986)
accept Clefthoof Training: Bulbapore##36987 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36987)
accept Clefthoof Training: Cruel Ogres##36988 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36988)
accept Clefthoof Training: Darkwing Roc##36989 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36989)
accept Clefthoof Training: Ironbore##36992 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36992)
accept Clefthoof Training: Moth of Wrath##36990 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36990)
accept Clefthoof Training: Orc Hunters##36993 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36993)
accept Clefthoof Training: The Garn##36994 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36994)
accept Clefthoof Training: Thundercall##36991 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36991)
accept Clefthoof Training: Great-Tusk##36983 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36983)
accept Clefthoof Training: Rakkiri##36984 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36984)
step
...
step
talk Keegan Firebeard##86973
turnin Clefthoof Training: Riplash##36985 |goto Lunarfall 39.80,56.60 |only if haveq(36985)
turnin Clefthoof Training: Gezz'ran##36986 |goto Lunarfall 39.80,56.60 |only if haveq(36986)
turnin Clefthoof Training: Bulbapore##36987 |goto Lunarfall 39.80,56.60 |only if haveq(36987)
turnin Clefthoof Training: Cruel Ogres##36988 |goto Lunarfall 39.80,56.60 |only if haveq(36988)
turnin Clefthoof Training: Darkwing Roc##36989 |goto Lunarfall 39.80,56.60 |only if haveq(36989)
turnin Clefthoof Training: Ironbore##36992 |goto Lunarfall 39.80,56.60 |only if haveq(36992)
turnin Clefthoof Training: Moth of Wrath##36990 |goto Lunarfall 39.80,56.60 |only if haveq(36990)
turnin Clefthoof Training: Orc Hunters##36993 |goto Lunarfall 39.80,56.60 |only if haveq(36993)
turnin Clefthoof Training: The Garn##36994 |goto Lunarfall 39.80,56.60 |only if haveq(36994)
turnin Clefthoof Training: Thundercall##36991 |goto Lunarfall 39.80,56.60 |only if haveq(36991)
turnin Clefthoof Training: Great-Tusk##36983 |goto Lunarfall 39.80,56.60 |only if haveq(36983)
turnin Clefthoof Training: Rakkiri##36984 |goto Lunarfall 39.80,56.60 |only if haveq(36984)
step
collect Trained Icehoof##116656
learnmount Trained Icehoof##171617 |use Trained Icehoof##116656
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Meadowstomper",{
...
step
talk Keegan Firebeard##86973
accept Entangling an Elekk##36915 |goto Lunarfall 39.80,56.60
step
Use your _Elekk Lasso_ on the Young Meadowstomper in the area |use Elekk Lasso##118184 |q 36915/1 |goto Nagrand D/0 84.80,39.60
step
talk Keegan Firebeard##86973
turnin Entangling an Elekk##36915 |goto Lunarfall 39.80,56.60
step
talk Keegan Firebeard##86973
You will only be able to _complete 1 of the following quests_ per day
accept Elekk Training: Cruel Ogres##37015 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37015)
accept Elekk Training: Darkwing Roc##37016 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37016)
accept Elekk Training: Ironbore##37019 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37019)
accept Elekk Training: Moth of Wrath##37017 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37017)
accept Elekk Training: Orc Hunters##37020 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37020)
accept Elekk Training: The Garn##37021 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37021)
accept Elekk Training: Thundercall##37018 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37018)
step
...
step
talk Keegan Firebeard##86973
turnin Elekk Training: Cruel Ogres##37015 |goto Lunarfall 39.80,56.60 |only if haveq(37015)
turnin Elekk Training: Darkwing Roc##37016 |goto Lunarfall 39.80,56.60 |only if haveq(37016)
turnin Elekk Training: Ironbore##37019 |goto Lunarfall 39.80,56.60 |only if haveq(37019)
turnin Elekk Training: Moth of Wrath##37017 |goto Lunarfall 39.80,56.60 |only if haveq(37017)
turnin Elekk Training: Orc Hunters##37020 |goto Lunarfall 39.80,56.60 |only if haveq(37020)
turnin Elekk Training: The Garn##37021 |goto Lunarfall 39.80,56.60 |only if haveq(37021)
turnin Elekk Training: Thundercall##37018 |goto Lunarfall 39.80,56.60 |only if haveq(37018)
step
collect Trained Meadowstomper##116662
learnmount Trained Meadowstomper##171623 |use Trained Meadowstomper##116662
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Riverwallow",{
...
step
Use your _Riverbeast Lasso_ on the Young Riverwallow in the area |use Riverbeast Lasso##118183 |q 36918/1 |goto Talador/0 63.80,54.90
step
talk Fanny Firebeard##86974
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Rocktusk",{
...
step
talk Keegan Firebeard##86973
accept Besting a Boar##36913 |goto Lunarfall 39.80,56.60
step
Use your _Boar Lasso_ on Young Rocktusks in the area |use Boar Lasso##118185 |q 36913/1 |goto Gorgrond/0 43.90,37.30
step
talk Keegan Firebeard##86973
turnin Besting a Boar##36913 |goto Lunarfall 39.80,56.60
step
talk Keegan Firebeard##86973
You will only be able to _complete 1 of the following quests_ per day
accept Boar Training: Riplash##36995 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36995)
accept Boar Training: Gezz'ran##36996 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36996)
accept Boar Training: Bulbapore##36997 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36997)
accept Boar Training: Cruel Ogres##36998 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36998)
accept Boar Training: Darkwing Roc##36999 |goto Lunarfall 39.80,56.60 |or |only if not completedq(36999)
accept Boar Training: Ironbore##37002 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37002)
accept Boar Training: Moth of Wrath##37000 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37000)
accept Boar Training: Orc Hunters##37003 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37003)
accept Boar Training: The Garn##37004 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37004)
accept Boar Training: Thundercall##37001 |goto Lunarfall 39.80,56.60 |or |only if not completedq(37001)
step
...
step
talk Keegan Firebeard##86973
turnin Boar Training: Riplash##36995 |goto Lunarfall 39.80,56.60 |only if haveq(36995)
turnin Boar Training: Gezz'ran##36996 |goto Lunarfall 39.80,56.60 |only if haveq(36996)
turnin Boar Training: Bulbapore##36997 |goto Lunarfall 39.80,56.60 |only if haveq(36997)
turnin Boar Training: Cruel Ogres##36998 |goto Lunarfall 39.80,56.60 |only if haveq(36998)
turnin Boar Training: Darkwing Roc##36999 |goto Lunarfall 39.80,56.60 |only if haveq(36999)
turnin Boar Training: Ironbore##37002 |goto Lunarfall 39.80,56.60 |only if haveq(37002)
turnin Boar Training: Moth of Wrath##37000 |goto Lunarfall 39.80,56.60 |only if haveq(37000)
turnin Boar Training: Orc Hunters##37003 |goto Lunarfall 39.80,56.60 |only if haveq(37003)
turnin Boar Training: The Garn##37004 |goto Lunarfall 39.80,56.60 |only if haveq(37004)
turnin Boar Training: Thundercall##37001 |goto Lunarfall 39.80,56.60 |only if haveq(37001)
step
collect Trained Rocktusk##116675
learnmount Trained Rocktusk##171637 |use Trained Rocktusk##116675
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Silverpelt",{
...
step
Use your _Talbuk Lasso_ on Young Silverpelts in the area |use Talbuk Lasso##118179 |q 36911/1 |goto Shadowmoon Valley D/0 50.30,30.10
step
talk Fanny Firebeard##86974
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dailies Mounts\\Trained Snarler",{
...
step
Use your _Wolf Lasso_ on the Young Snarler in the area |use Wolf Lasso##118182 |q 36914/1 |goto Nagrand D/0 55.60,60.90
step
talk Fanny Firebeard##86974
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Bloodhoof Bull",{
...
_Click_ here [Nagrand D 62.80,15.00]
_Click_ here [Nagrand D 64.00,19.90]
_Click_ here [Nagrand D 60.90,31.80]
_Click_ here [Nagrand D 54.50,34.90]
_Click_ here [Nagrand D 50.20,34.40]
kill Nakk the Thunderer##50990
collect Bloodhoof Bull##116659
learnmount Bloodhoof Bull##171620 |use Bloodhoof Bull##116659
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Garn Nighthowl",{
...
path	16.60,39.20	12.80,47.20	15.40,52.60
path	26.00,45.60	19.60,39.40
...
buy 1 Garn Nighthowl##116794 |goto Stormshield 53.80,65.00
step
label "done"
learnmount Garn Nighthowl##171851 |use Garn Nighthowl##116794
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Great Greytusk",{
...
|tip Press "I" on your keyboard, select "Premade Groups", and then "Questing" or "Custom" to start or join a farming raid to increase your chance of success.
_Click_ here [Frostfire Ridge 58.40,19.00]
_Click_ here [Frostfire Ridge 52.00,50.60]
_Click_ here [Frostfire Ridge 65.00,52.60]
_Click_ here [Frostfire Ridge 63.60,79.80]
_Click_ here [Frostfire Ridge 22.40,66.60]
kill Gorok##50992
collect Great Greytusk##116674
learnmount Great Greytusk##171636 |use Great Greytusk##116674
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Mottled Meadowstomper",{
...
|tip Press "I" on your keyboard, select "Premade Groups", and then "Questing" or "Custom" to start or join a farming raid to increase your chance of success.
_Click_ here [Nagrand D 76.00,30.60]
_Click_ here [Nagrand D 66.60,44.00]
_Click_ here [Nagrand D 72.20,53.60]
_Click_ here [Nagrand D 79.60,55.60]
_Click_ here [Nagrand D 84.60,63.80]
kill Luk'hok##50981
collect Mottled Meadowstomper##116661
learnmount Mottled Meadowstomper##171622 |use Mottled Meadowstomper##116661
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Sapphire Riverbeast",{
...
|tip Press "I" on your keyboard, select "Premade Groups", and then "Questing" or "Custom" to start or join a farming raid to increase your chance of success.
_Click_ here [Talador 62.00,32.40]
_Click_ here [Talador 67.80,58.20]
_Click_ here [Talador 79.90,54.80]
_Click_ here [Talador 54.50,82.50]
kill Silthide##51015
collect Sapphire Riverbeast##116767
learnmount Sapphire Riverbeast##171824 |use Sapphire Riverbeast##116767
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Sunhide Gronnling",{
...
_Click_ here [Gorgrond 42.00,25.00]
_Click_ here [Gorgrond 51.40,43.10]
_Click_ here [Gorgrond 45.40,47.50]
_Click_ here [Gorgrond 47.00,54.10]
_Click_ here [Gorgrond 43.20,55.50]
kill Poundfist##50985
collect Sunhide Gronnling##116792
learnmount Sunhide Gronnling##171849 |use Sunhide Gronnling##116792
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Swift Breezestrider",{
...
|tip Press "I" on your keyboard, select "Premade Groups", and then "Questing" to start or join a farming raid to increase your chance of success.
_Click_ here [Shadowmoon Valley D 43.00,31.60]
_Click_ here [Shadowmoon Valley D 39.40,36.60]
_Click_ here [Shadowmoon Valley D 53.80,30.40]
_Click_ here [Shadowmoon Valley D 56.20,52.40]
_Click_ here [Shadowmoon Valley D 44.80,43.40]
_Click_ here [Shadowmoon Valley D 46.00,67.80]
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Warsong Direfang",{
mounts={171837},
patch='60100',
mounttype='Ground',
model={59752},
...
kill Doomroller##95056 |goto Tanaan Jungle/0 47.00,52.60
|tip It's a huge metal cannon.
kill Vengeance##95054 |goto Tanaan Jungle/0 32.60,73.80
|tip She's a huge purple draenei with wings.
kill Terrorfist##95044 |goto Tanaan Jungle/0 14.60,63.00
|tip He's a huge purple and green gronn that patrols this area. You may need to search for him.
kill Deathtalon##95053 |goto Tanaan Jungle/0 23.60,40.00
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Armored Razorback",{
mounts={171630},
patch='60100',
mounttype='Ground',
model={59346},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Dropped Mounts\\Tundra Icehoof",{
mounts={171619},
patch='60100',
mounttype='Ground',
model={59324},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious War Steed",{
...
buy Reins of the Vicious War Steed##70909 |goto Stormwind City/0 77.00,65.80
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious Warsaber",{
...
step
talk Necrolord Sipe##73190
buy Reins of the Vicious Warsaber##102514 |goto Stormwind City/0 77.00,65.80
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious War Ram",{
...
step
talk Necrolord Sipe##73190
buy Vicious War Ram##116777 |goto Stormwind City 76.80,65.60
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Vicious War Mechanostrider",{
...
step
talk Necrolord Sipe##73190
buy Vicious War Mechanostrider##124089 |goto Stormwind City 76.80,65.60
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Event Mounts\\Minion of Grumpus",{
...
step
talk Almie##96451
accept What Horrible Presents!##39668 |goto Lunarfall 44.10,51.70
accept Grumpus##39651 |goto Lunarfall 44.10,51.70
accept Menacing Grumplings##39649 |goto Lunarfall 44.10,51.70
accept Where Are the Children##39648 |goto Lunarfall 44.10,51.70
stickystart "savethechildren"
stickystart "grumnplingkills"
step
kill Grumpus##96448 |q 39651/1 |goto Frostfire Ridge/0 45.70,28.20
...
Destroy #5# Unusual Gifts |q 39668/1 |goto Frostfire Ridge/0 45.70,27.60
step
label "savethechildren"
click Holding Cage##243905
Rescue #6# Children |q 39648/1 |goto Frostfire Ridge/0 46.40,26.20
step
label "grumnplingkills"
kill 8 Grumpling##96449 |q 39649/1 |goto Frostfire Ridge/0 46.90,27.80
step
talk Izzy Hollyfizzle##96362
turnin Where Are the Children?##39648 |goto Lunarfall 44.10,51.70
turnin Menacing Grumplings##39649 |goto Lunarfall 44.10,51.70
turnin What Horrible Presents!##39668 |goto Lunarfall 44.10,51.70
turnin Grumpus##39651 |goto Lunarfall 44.10,51.70
step
talk Izzy Hollyfizzle##96362
buy 1 Savage Gift##128670 |use Savage Gift##128670 |goto Lunarfall 44.10,51.70
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Profession Mounts\\Leatherworking\\Dustmane Direwolf",{
...
map Nagrand D
path follow loose; loop; ants curved
path	75.40,43.10	72.60,42.80	69.70,43.50
path	66.60,43.50	62.20,45.10	61.00,50.30
path	62.60,56.90	68.20,57.90	73.10,52.20
Kill any beasts you see on this path for skinning
|next "nextl"
step
label "buyl"
talk Auctioneer Chilton##8670 |goto Stormwind City 61.00,71.60
...
map Spires of Arak
path follow loose; loop; ants curved
path	31.90,26.30	30.70,33.30	37.60,45.60
path	42.60,52.30	46.60,49.20	51.90,59.70
path	52.00,71.90	54.20,79.80	56.30,94.10
path	60.40,70.10	65.80,53.90	57.00,47.40
path	54.00,38.80	45.00,36.80	41.20,26.00
path	49.50,22.90	52.60,33.30	63.90,38.10
path	66.50,36.10	67.90,46.10
|next "done"
step
label "buy"
talk Auctioneer Chilton##8670 |goto Stormwind City 61.00,71.60
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Raid Mounts\\Ironhoof Destroyer",{
mounts={171621},
patch='60100',
mounttype='Ground',
...
step
Enter the Blackrock Foundry _Mythic_ Dungeon |goto Gorgrond/0 51.30,28.70
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Raid Mounts\\Felsteel Annihilator",{
mounts={182912},
patch='62000',
mounttype='Flying',
...
step
Enter the Hellfire Citadel _Mythic_ Dungeon |goto Tanaan Jungle/0 45.40,53.70
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Armored Irontusk",{
...
buy Armored Irontusk##116665 |goto Lunarfall/0 34.20,149.20
learnmount Armored Irontusk##171626 |use Armored Irontusk##116665
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Domesticated Razorback",{
...
confirm
step
talk Gazrix Gearlock##88482 |goto Stormshield 43.20,77.40
buy Domesticated Razorback##116672
learnmount Domesticated Razorback##171634 |use Domesticated Razorback##116672
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Dusty Rockhide",{
...
|tip This mount costs 5,000 Gold and 5,000 Apexis Crystals.
buy Dusty Rockhide##116664 |goto Stormshield 46.60,76.20
learnmount Dusty Rockhide##171625 |goto Stormshield 46.60,76.20 |use Dusty Rockhide##116664
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Shadowmane Charger",{
...
learnmount Shadowmane Charger##171829 |goto Stormshield 45.00,75.80 |use Shadowmane Charger##116772
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Wild Goretusk",{
...
buy Wild Goretusk##116671 |complete hasmount(171633) |goto Tanaan Jungle/0 55.30,74.80
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Bristling Hellboar",{
...
step
talk Z'tenga the Walker##92805
buy Bristling Hellboar##128480 |complete hasmount(190690) |goto Tanaan Jungle/0 55.30,74.80
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Deathtusk Felboar",{
...
buy Deathtusk Felboar##128526 |complete hasmount(190977) |goto Tanaan Jungle/0 58.40,60.50
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Reputation Mounts\\Pale Thorngrazer",{
...
buy Pale Thorngrazer##116776 |goto Stormshield 44.20,74.00
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Mudback Riverbeast",{
...
learnmount Mudback Riverbeast##171826 |goto Shadowmoon Valley D/0 28.20,11.80
step
Congratulations, you earned the _Mudback Riverbeast_ mount!
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Coalfist Gronnling",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Garn Steelmaw",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Giant Coldsnout",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Shadowhide Pearltusk",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Garrison Mounts\\Smoky Direwolf",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Unavailable Mounts\\Core Hound",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Unavailable Mounts\\Primal Gladiator's Felblood Gronnling",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Warmongering Gladiator's Felblood Gronnling",{
startlevel=10.00,
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Player vs. Player Mounts\\Wild Gladiator's Felblood Gronnling",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Crimson Water Strider",{
...
learnmount Crimson Water Strider##127271 |goto Lunarfall 53.80,13.80 |use Reins of the Crimson Water Strider##87791
step
Congratulations, you earned the _Crimson Water Strider_ mount!
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Mosshide Riverwallow",{
...
buy Mosshide Riverwallow##116768 |n |goto Stormshield 50.40,61.60
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Rocktusk Battleboar",{
...
buy Rocktusk Battleboar##116667 |complete hasmount(171628) |goto Lunarfall/0 30.00,34.60
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Witherhide Cliffstomper",{
...
step
talk Trader Araanda##95470
buy Witherhide Cliffstomper##116655 |complete hasmount(171616) |goto Lunarfall/0 30.00,34.60
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Vendor Mounts\\Champion's Treadblade",{
...
step
talk Paulie##87501
buy Witherhide Cliffstomper##116789 |complete hasmount(171846) |goto Stormwind City 73.10,59
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Miscellaneous Mounts\\Voidtalon of the Dark Star",{
...
|tip Press "I" on your keyboard, select "Premade Groups", and then "Questing" or "Custom" to start or join a farming raid to increase your chance of success.
_Click_ here [Shadowmoon Valley D 50.90,72.50]
_Click_ here [Shadowmoon Valley D 49.60,71.60]
_Click_ here [Shadowmoon Valley D 41.90,75.70]
_Click_ here [Shadowmoon Valley D 48.70,69.90]
_Click_ here [Shadowmoon Valley D 43.20,71.00]
_Click_ here [Frostfire Ridge 51.00,19.90]
_Click_ here [Frostfire Ridge 52.30,18.30]
_Click_ here [Frostfire Ridge 53.00,17.00]
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Ground Mounts\\Miscellaneous Mounts\\Illidari Felstalker",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Felfire Hawk",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Soaring Skyterror",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Emerald Drake",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Achievement Mounts\\Reins of the Heavenly Azure Cloud Serpent",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Blizzard Store Mounts\\Grinning Reaver",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Blizzard Store Mounts\\Mystic Runesaber",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Dropped Mounts\\Solar Spirehawk",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Dropped Mounts\\Infinite Timereaver",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Miscellaneous Mounts\\Dread Raven",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Miscellaneous Mounts\\Cindermane Charger",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Miscellaneous Mounts\\Grove Warden",{
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Profession Mounts\\Tailoring\\Creeping Carpet",{
...
map Spires of Arak
path follow loose; loop; ants curved
path	45.80,66.60	46.40,69.60	47.80,74.00
path	49.60,76.00	52.40,77.40	47.80,69.60
path	46.60,68.00
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Reputation Mounts\\Corrupted Dreadwing",{
...
buy Reins of the Corrupted Dreadwing##123974 |complete hasmount(183117) |goto Tanaan Jungle/0 58.00,59.40
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Vendor Mounts\\Bridle of the Ironbound Wraithcharger",{
...
step
talk Auzin##98690
buy Bridle of the Ironbound Wraithcharger##129922 |complete hasmount(142910) |goto Dalaran 50.40,46.10
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Mounts\\Flying Mounts\\Vendor Mounts\\Reins of the Eclipse Dragonhawk",{
...
step
talk Auzin##98690
buy Reins of the Eclipse Dragonhawk##129923 |complete hasmount(194464) |goto Dalaran 50.40,46.10
|tip This costs 5,000 Timewarped Badges.
|tip These can only be obtained through completing timewalking dungeons during the timewalking events.
|tip These events only happen twice a month.
step
