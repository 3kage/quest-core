...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Glimmerpool Hatchling",{
patch='90001',
source='PetBattle',
...
learnpet Glimmerpool Hatchling##2930 |goto Bastion/0 45.82,34.27
You can find more around [Bastion/0 44.93,29.78]
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Silvershell Snapper",{
patch='90001',
source='Drop',
...
Continue following the path |goto Bastion/0 42.81,46.91 < 30 |walk
Enter the cave |goto Bastion/0 40.97,47.41 < 30 |walk
kill Dionae##163460
|tip Inside the cave.
|tip When she flies in to the air, click on the 4 Anima Spears around the room to break her shield and bring her to the ground.
click Stewart's Stewpendous Stew##344588
|tip It looks like a brown pot behind Stewart.
collect Silvershell Snapper##180856 |goto Bastion/0 41.41,49.13 |or
...
'|complete haspet(2932) |or
step
use Silvershell Snapper##180856
learnpet Silvershell Snapper##2932
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Bleak Skitterer",{
patch='90001',
source='PetBattle',
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Bleak Skitterer##3050 |goto Maldraxxus/0 63.31,35.11
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Bloodfeaster Spiderling",{
patch='90001',
source='Vendor',
...
step
Upgrade The Ember Court to Tier 3 |complete covenantfeature("Covenant Unique") >= 3 |only if Venthyr |or
Upgrade the Queen's Conservatory to Tier 2 |complete covenantfeature("Covenant Unique") >= 2 |only if NightFae |or
Upgrade the Path of Ascension to Tier 1 |complete covenantfeature("Covenant Unique") >=1 |only if Kyrian |or
Upgrade the Abomination Factory to Tier 1 |complete covenantfeature("Covenant Unique") >= 1 |only if Necrolord |or
...
|tip You may have to do this more than once.
...
|tip Complete battle pet world quests that offer Polished Pet Charm awards to earn this currency.
'|complete haspet(2965) |or
'|only if Kyrian
step
...
'|only if Necrolord
step
use Bloodfeaster Spiderling##181315
learnpet Bloodfeaster Spiderling##2965
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Blushing Spiderling",{
patch='90001',
source='Drop',
...
|tip You may have to do this more than once.
|tip You can also purchase this from the Auction House.
'|complete haspet(2891) |or
step
use Blushing Spiderling##180584
learnpet Blushing Spiderling##2891
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Boneweave Hatchling",{
patch='90001',
source='Drop',
...
|tip You may have to do this more than once.
|tip You can also purchase this from the Auction House.
'|complete haspet(2948) |or
step
use the Boneweave Hatchling##181172
learnpet Boneweave Hatchling##2948
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Copperfur Kit",{
patch='90001',
source='PetBattle',
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Copperfur Kit##2936 |goto Bastion/0 60.50,41.24
They can also be found around [Bastion/0 41.82,61.37]
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Corpulent Bonetusk",{
patch='90001',
source='Vendor',
description="This battle pet can be obtained several different ways depending on which covenant you are aligned with.",
keywords={"Beast","Venthyr","Night","Fae","Kyrian","Necrolord"},
...
learnpet Corpulent Bonetusk##2945
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Dodger",{
patch='90001',
source='Discovery',
...
[Ardenweald/0 72.87,31.33]
[Ardenweald/0 64.79,23.02]
[Ardenweald/0 40.82,28.10]
[Ardenweald/0 32.89,43.21]
[Ardenweald/0 41.51,51.21]
[Ardenweald/0 68.94,31.89]
'|learnpet Dodger##2905 |or
step
use Dodger##180645
learnpet Dodger##2905
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Goldenpaw Kit",{
patch='90001',
source='Vendor',
...
step
Reach Revered Reputation With The Ascended Faction |complete rep("The Ascended")>= Revered |or
|tip Use "The Ascended" reputation guide to accomplish this.
|tip You can also purchase this from the Auction House.
'|complete haspet(2934) |or
step
collect 250 Polished Pet Charm##163036 |or
|tip Complete battle pet world quests to earn this currency.
|tip Use the "World Quests" guides to accomplish this.
...
learnpet Goldenpaw Kit##2934
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Indigo",{
patch='90001',
source='Drop',
...
step
use Indigo##180871
learnpet Indigo##2941
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Jingles",{
patch='90001',
source='Discovery',
...
learnpet Jingles##2622
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Luminous Webspinner",{
patch='90001',
source='Discovery',
...
|tip You can also purchase this from the Auction House.
'|complete haspet(2947) |or
step
use the Luminous Webspinner##181171
learnpet Luminous Webspinner##2947
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Pernicious Bonetusk",{
patch='90001',
source='Quest',
...
'|complete haspet(2946) |or
step
use Pernicious Bonetusk##181170
learnpet Pernicious Bonetusk##2946
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Purity",{
patch='90001',
source='Discovery',
...
'|complete haspet(2935) |or
step
Run Through the Waterfall |havebuff Proof of Purity##332785 |goto Bastion/0 64.60,71.39 |or
'|complete haspet(2935) |or
step
click Gift of Vesiphone##353940
collect Purity##180859 |goto Bastion/0 64.85,71.15 |or
'|complete haspet(2935) |or
step
use Purity##180859
learnpet Purity##2935
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Renny",{
patch='90001',
source='Quest',
...
step
talk Clarion Song##163774
Select _"Grant me a boon to catch Renny the fox."_
havebuff Fox Hunting##318582 |q 59120 |future
step
clicknpc Renny##163826
|tip Keep clicking on Renny until you catch him, he will then teleport you to Bastion.
Catch Renny! |q 59087/2 |goto Ardenweald/0 50.41,33.41
step
...
Seriously, Catch that Fox |q 59087/5 |goto Maldraxxus/0 26.89,62.36
step
talk Clarion Song##163774
turnin That Darn Fox!##59087 |goto Ardenweald/0 50.92,33.79
step
talk Renny##163903
accept Renny the Vulpin##59120 |goto Ardenweald/0 49.30,51.89
turnin Renny the Vulpin##59120 |goto Ardenweald/0 49.30,51.89
step
use Renny##175114
learnpet Renny##2878
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Rocky",{
patch='90001',
source='Drop',
...
step
kill Macabre##164093
|tip This rare can spawn in multiple locations all around Ardenweald.
...
collect Rocky##180644 |goto Ardenweald/0 36.60,48.20 |or
|tip It may take several attempts to get this.
|tip You can also purchase this from the Auction House.
It can also be found around:
[Ardenweald/0 32.80,44.60]
[Ardenweald/0 47.80,40.20]
[Ardenweald/0 58.00,29.40]
'|complete haspet(2907) |or
step
use Rocky##180644
learnpet Rocky##2907
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Rosetipped Spiderling",{
patch='90001',
source='PetBattle',
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Rosetipped Spiderling##3007 |goto Revendreth/0 47.05,75.14
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Rustfur Kit",{
patch='90001',
source='PetBattle',
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Rusfur Kit##171703 |goto Bastion/0 43.84,42.44
You can find more around:
[Bastion/0 54.59,30.90]
[Bastion/0 59.12,85.96]
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Sable",{
patch='90001',
source='Vendor',
description="This battle pet can be obtained several different ways depending on which covenant you are aligned with.",
keywords={"Beast","Venthyr","Night","Fae","Kyrian","Necrolord"},
...
|tip Use the "Necrolord Abomination Factory" leveling guide to accomplish this. |only if Necrolord
|tip You can also purchase this from the Auction House.
'|complete haspet(2933) |or
step
click Kleia and Pelagos' Extravagant Tribute##356733
|tip This is awarded at the end of Ember Court when Kleia and Pelagos become your best friends.
|tip Use the "Venthyr Ember Court" guides to help you accomplish this.
...
Collect #1000# Reservoir Anima |complete curcount(1813) >= 1000 |or
|tip Complete covenant calling quests using the "Necrolords Daily Quests" guide.
|tip You can also kill rares and collect treasures in Maldraxxus.
'|complete haspet(2933) |or
|only if Necrolord
step
talk Atticus##159238
|tip Use the "Atticus (Abomination)" guide to unlock this vendor.
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Skittering Venomspitter",{
patch='90001',
source='Discovery',
description="If this species spits venom at its prey, is it still technically considered venom, or just really gross?",
keywords={"Beast","Maldraxxus"},
pet=2949,
},[[
step
...
|tip It may take several attempts to get this.
|tip You can also purchase this from the Auction House.
'|complete haspet(2949) |or
step
use the Skittering Venomspitter##181173
learnpet Skittering Venomspitter##2949
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Spirited Skyfoal",{
patch='90001',
source='Quest',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Starry Dreamfoal",{
patch='90001',
source='Discovery',
...
Continue up the ramp |goto Ardenweald/0 53.78,60.68 < 30 |walk
click Fae Ornament##180654
collect Fae Ornament##180654 |goto Ardenweald/0 51.57,61.60 |or
'|learnpet Starry Dreamfoal##2914 |or
step
click Enchanted Bough##180656
|tip Underneath the platform.
collect Enchanted Bough##180656	|goto Ardenweald/0 42.41,46.72 |or
'|learnpet Starry Dreamfoal##2914 |or
step
Follow the path up |goto Ardenweald/0 38.86,28.62 < 30 |walk
Continue following the path |goto Ardenweald/0 36.82,27.47 < 30
click Raw Dream Fibers##180655
collect Raw Dream Fibers##180655 |goto Ardenweald/0 36.99,29.83 |or
'|learnpet Starry Dreamfoal##2914 |or
step
...
'|learnpet Starry Dreamfoal##2914 |or
step
Cross the bridge |goto Ardenweald/0 35.07,62.20 < 30 |walk
Run up the ramp |goto Ardenweald/0 35.38,65.23 < 30
Enter the tree |goto Ardenweald/0 36.00,65.58 < 30
click Cache of the Night##355000
|tip Inside the tree.
collect Starry Dreamfoal##180637 |goto Ardenweald/0 36.21,65.29 |or
|tip This pet is cageable, meaning you can purchase it from the Auction House.
'|learnpet Starry Dreamfoal##2914 |or
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Verdant Kit",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Willowbreeze",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Ashen Chomper",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Bloodlouse Larva",{
patch='90001',
source='Discovery',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Corpselouse Larva",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Decay Grub",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Decaying Mawrat",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Deepwood Leaper",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Feasting Larva",{
patch='90001',
source='Drop',
description="This battle pet has a chance to drop after killing Smorgas the Feaster in Maldraxxus.",
keywords={"Critter","Maldraxxus"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Floofa",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Frenzied Mawrat",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Gloober, as G'hunn",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Grubby",{
patch='90001',
source='Quest',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Hissing Deathroach",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Hungry Burrower",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Lavender Nibbler",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Pulsating Maggot",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Runelight Leaper",{
patch='90001',
source='Quest',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Shimmerbough Hoarder",{
patch='90001',
source='Discovery',
...
collect Shimmerbough Hoarder##182673 |goto Ardenweald/0 49.71,55.89
|tip This pet is cageable, meaning you can purchase it from the Auction House.
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Spinemaw Gormling",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Tower Deathroach",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Undying Deathroach",{
patch='90001',
source='Drop',
description="This battle pet has a chance to drop from a Fallen Adventurer's Cache inside The Maw.",
keywords={"Critter","The","Maw"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Dragonkin Pets\\Moon-Touched Netherwhelp",{
patch='90001',
source='Unknown',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Char",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Dread",{
patch='90001',
source='Drop',
...
collect Contained Essence of Dread##183407 |goto The Maw/0 19.20,46.00
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Fun Guss",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Leafadore",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Mire Creeper",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Raw Emotion",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Sinheart",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Stemmins",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Trootie",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Withering Creeper",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Wrathling",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Amber Glitterwing",{
patch='90001',
source='Discovery',
...
step
Step on the Bounding Shroom |goto Ardenweald/0 41.42,31.62 < 10 |only if walking
...
Reach the Center of the Tree |goto Ardenweald/0 41.94,32.46 < 5 |c |or
'|learnpet Amber Glitterwing##2911 |or
step
...
collect Amber Glitterwing##180640 |goto Ardenweald/0 41.95,32.49 |or
'|learnpet Amber Glitterwing##2911 |or
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Battle",{
patch='90001',
source='Vendor',
...
|tip Inside the building.
|tip This costs 250 Polished Pet Charms.
buy Battle's Pendant##183854 |goto Revendreth/0 28.00,43.00 |or
'|learnpet Battle##173535 |or
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Chirpy Valeshrieker",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Cloudfeather Fledgling",{
patch='90001',
source='Discovery',
...
Continue following the path |goto Ardenweald/0 54.13,38.85 < 30 |only if walking
Continue following the path |goto Ardenweald/0 52.56,37.98 < 30 |only if walking
...
collect Cloudfeather Fledgling##180642 |goto Ardenweald/0 52.95,37.31
|tip This pet is cageable, meaning you can purchase it from the Auction House.
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Courage",{
patch='90001',
source='Discovery',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Crawbat",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Crimson Dredwing Pup",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Devoured Wader",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Devouring Animite",{
patch='90001',
source='Quest',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Dusky Dredwing Pup",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Fledgling Teroclaw",{
patch='90001',
source='PetBattle',
description="This battle pet can be tamed in the wild around Bastion.",
keywords={"Flying","Bastion"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Fluttering Glimmerfly",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Foulwing Buzzer",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Fuzzy Shimmermoth",{
patch='90001',
source='Vendor',
description="This battle pet can be purchased from a vendor after reaching friendly reputation with the Marasmius faction.",
keywords={"Flying","Ardenweald"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Gilded Wader",{
patch='90001',
source='Discovery',
...
collect Ripe Purian##178915 |q 62730/1 |goto Bastion/0 51.61,41.59
step
talk Elios##170284
turnin Fruit of the Gods##62730 |goto Bastion/0 53.21,46.35 |region heros_rest
step
talk Elios##170284
accept The Sweetest Tribute##62733 |goto Bastion/0 53.21,46.35 |region heros_rest
step
...
Open the Silver Strongbox |q 62733/1 |goto Bastion/0 52.84,45.23 |region heros_rest
step
talk Elios##170284
turnin The Sweetest Tribute##62733 |goto Bastion/0 53.21,46.35 |region heros_rest
step
click Ripe Purian##352239
|tip They look like small orange fruits around this area.
|tip They can be found all over Bastion.
collect Ripe Purian##178915 |goto Bastion/0 51.61,41.59
step
click Silver Strongbox##353205+
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Golden Cloudfeather",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Gorm Harrier",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Gorm Needler",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Gorm Rootstinger",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Helpful Glimmerfly",{
patch='90001',
source='Quest',
...
collect Ariella's Wing##175791 |q 59262/1 |goto Bastion/0 46.36,36.71
step
talk Kowalskos##164640
turnin Broken Wings##59262 |goto Bastion/0 42.83,42.72
accept Feathers of Flight##59263 |goto Bastion/0 42.83,42.72
step
kill Swiftwing Larion##160569+
collect 100 Larion Flight Feather##175792 |q 59263/1 |goto Bastion/0 46.25,35.90
step
talk Kowalskos##164640
...
Observe Kowalskos' Flight Test |q 60660/2 |goto Bastion/0 42.83,42.73
step
talk Kowalskos##164640
turnin Flight Test##60660 |goto Bastion/0 42.83,42.73
accept More Wings!##59348 |goto Bastion/0 42.83,42.73
...
collect Animyllis Bloom##175968 |q 59348/1 |goto Bastion/0 48.65,47.31
step
label "Collect_Etherwyrm_Filament"
Kill Etherwyrm enemies around this area
collect 10 Etherwyrm Filament##175967 |q 59351/1 |goto Bastion/0 46.62,47.62
step
talk Kowalskos##164640
turnin More Wings!##59348 |goto Bastion/0 42.83,42.73
...
Capture #5# Glimmerflies |q 59311/1 |goto Bastion/0 42.07,29.91
step
talk Kowalskos##164640
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Larion Cub",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Larion Pouncer",{
patch='90001',
source='Drop',
...
collect Larion Pouncer##184401 |goto Bastion/0 22.65,22.84
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Necroray Spawnling",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Pearlwing Heron",{
patch='90001',
source='Vendor',
description="This battle pet can be obtained several different ways depending on which covenant you are aligned with.",
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Starmoth",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Stoneskin Dredwing Pup",{
patch='90001',
source='Drop',
...
|tip Inside the building.
turnin Supplies from the Court of Harvesters##61100 |goto Revendreth/0 61.31,63.78 |future |or
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Stony",{
patch='90001',
source='Drop',
...
|tip This pet is cageable, meaning you can purchase it from the Auction House.
buy 3 Handcrafted Mirror Repair Kit##181363 |goto Sinfall/0 47.60,59.60
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\The Count",{
patch='90001',
source='Discovery',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Tranquil Wader",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Vibrant Glimmerfly",{
patch='90001',
source='PetBattle',
description="This battle pet can be tamed in the wild all around Bastion.",
keywords={"Flying","Bastion"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Wader Chick",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Wild Etherwyrm",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Court Messenger",{
patch='90001',
source='Vendor',
...
talk Mistress Mihaela##156822
|tip Inside the building.
buy Court Messenger Scroll##180593 |goto Revendreth/0 61.31,63.78
|tip This costs 250 Polished Pet Charms.
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Dal",{
patch='90001',
source='Discovery',
...
collect Dal's Courier Badge##183859 |goto Revendreth/0 45.22,47.84
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Dredger Butler",{
patch='90001',
source='Quest',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Glimr",{
patch='90001',
source='Quest',
...
accept Glimmerfin Welcome##60606 |goto Borean Tundra/0 43.50,13.97
step
...
turnin Glimmerfin Welcome##60606 |goto Grizzly Hills/0 17.81,93.21
accept A Big Horkin' Task##60614 |goto Grizzly Hills/0 17.81,93.21
step
kill Horker##169460
collect Pile of Blubberfat##180025 |q 60614/1 |goto Grizzly Hills/0 10.36,85.20
step
talk Glimmergut##169414
|tip He is downstairs inside of the sunken ship.
turnin A Big Horkin' Task##60614 |goto Grizzly Hills/0 17.82,93.22
accept Seer of the Waves##60615 |goto Grizzly Hills/0 17.82,93.22
step
talk Glimmerfin Oracle##169415
|tip He is down in the hull of the sunken ship.
turnin Seer of the Waves##60615 |goto Grizzly Hills/0 17.06,93.76
accept Pearl in the Deeps##60616 |goto Grizzly Hills/0 17.06,93.76
step
click Giant Pearl##352915
|tip It is underwater.
|tip This is a fatigue zone so move quickly.
|tip Avoid the giant snake.
collect Giant Pearl##180026 |q 60616/1 |goto Grizzly Hills/0 21.77,95.57
step
talk Glimmerfin Oracle##169415
|tip He is down in the hull of the sunken ship.
turnin Pearl in the Deeps##60616 |goto Grizzly Hills/0 17.05,93.77
accept Trainer's Test##60617 |goto Grizzly Hills/0 17.05,93.77
step
talk Trainer Grrglin##169417
_Tell him "Begin pet battle"_
|tip His team is all aquatic.
Defeat Trainer Grrglin |q 60617/1 |goto Grizzly Hills/0 21.48,88.72
step
talk Glimmerfin Oracle##169415
|tip He is down in the hull of the sunken ship.
turnin Trainer's Test##60617 |goto Grizzly Hills/0 17.06,93.76
accept Wrap it Up##60619 |goto Grizzly Hills/0 17.06,93.76
step
click Bulbous Seaweed Stalk##352926
|tip It is underwater.
|tip This is a fatigue zone so move quickly.
|tip Avoid touching the electrified seaweed.
collect Bulbous Seaweed Stalk##180031 |q 60619/3 |goto Grizzly Hills/0 12.72,96.72
step
click Young Seaweed Stalk##352925
|tip It is underwater.
|tip This is a fatigue zone so move quickly.
|tip Avoid touching the electrified seaweed.
collect Young Seaweed Stalk##180032 |q 60619/2 |goto Grizzly Hills/0 8.90,94.28
step
click Warm Seaweed Stalk##352924
|tip It is underwater.
|tip This is a fatigue zone so move quickly.
|tip Avoid touching the electrified seaweed.
collect Warm Seaweed Stalk##180033 |q 60619/1 |goto Grizzly Hills/0 11.16,95.02
step
talk Glimmerfin Oracle##169415
|tip He is down in the hull of the sunken ship.
turnin Wrap it Up##60619 |goto Grizzly Hills/0 17.06,93.76
accept Guardian of the Smallest##60620 |goto Grizzly Hills/0 17.06,93.76
step
kill Great Mua'kin##169520
|tip He is underwater.
Slay Great Mua'kin |q 60620/1 |goto Grizzly Hills/0 8.79,91.20
step
talk Glimmerfin Oracle##169415
|tip He is down in the hull of the sunken ship.
turnin Guardian of the Smallest##60620 |goto Grizzly Hills/0 17.06,93.76
step
...
QuestCore:RegisterGuide("Pets & Mounts\\Battle Pets\\Humanoid Pets\\Quest Pets\\Gurgl",{
pet=3107,
source='Quest',
...
Select _"The cat's out of the bag. Why are you spying on the shop?"_
Suspicious Onlooker spoken to |q 64167/2 |goto Dalaran L/10 47.99,31.89 |or
'|complete haspet(3107) |or
step
talk Precocious Onlooker##179517
|tip She is stealthed near the Flower Vendor by the entrance to the Violet Hold.
Select _"What are you doing, young lady?"_
Precocious Onlooker spoken to |q 64167/4 |goto Dalaran L/10 57.09,55.76 |or
'|complete haspet(3107) |or
step
talk Farsighted Onlooker##179518
|tip He is stealthed on the lawn outside the Dalaran wall.
Select _"Yeah, this isn't suspicious. What are you spying on?"_
Farsighted Onlooker spoken to |q 64167/6 |goto Dalaran L/10 55.47,82.12 |or
'|complete haspet(3107) |or
step
talk Breanni##96479
|tip Inside the building.
turnin Pets Detective##64167 |goto Dalaran L/10 58.46,39.14
accept Pet Up##64196 |goto Dalaran L/10 58.46,39.14 |or
'|complete haspet(3107) |or
step
...
|tip You may need help with this. |only if level <= 42
Speedy IV healed |q 64196/4 |goto Eye of Azshara Map/0 73.56,77.96 |or
'|complete haspet(3107) |or
step
clicknpc Stringfellowe##179905
|tip You may need help with this. |only if level <= 42
Stringfellowe healed |q 64196/3 |goto Eye of Azshara Map/0 74.25,67.71 |or
'|complete haspet(3107) |or
step
talk Zantini##179566
turnin Pet Up##64196 |goto Eye of Azshara Map/0 73.24,74.96
accept The Coast is Clear##64203 |goto Eye of Azshara Map/0 73.24,74.96 |or
'|complete haspet(3107) |or
step
talk Speedy IV##179587
Select _"Let's get some pet supplies."_
Ask Speedy IV for help |q 64203/1 |goto Eye of Azshara Map/0 73.41,74.65 |or
'|complete haspet(3107) |or
step
...
Pet Supplies collected |q 64203/2 |goto Eye of Azshara Map/0 70.56,63.82 |or
...
step
talk Zantini##179566
turnin The Coast is Clear##64203 |goto Eye of Azshara Map/0 73.23,74.96
accept Paw Patrol##64215 |goto Eye of Azshara Map/0 73.23,74.96 |or
'|complete haspet(3107) |or
step
Kill Violetsail enemies around this area
collect Violetsail Pet Cage Key##186772 |n
|tip Use the keys to unlock the pet cages.
Free #6# pets |q 64215/1 |goto Eye of Azshara Map/0 44.33,36.42 |or
'|complete haspet(3107) |or
step
talk Zantini##179566
turnin Paw Patrol##64215 |goto Eye of Azshara Map/0 73.23,74.96
accept Gurgl and the Bandit##64237 |goto Eye of Azshara Map/0 73.23,74.96 |or
'|complete haspet(3107) |or
step
talk Trainer Iris Greedsway##179694
|tip She has Magic, Flying, and Humanoid pets.
Defeat Trainer Iris Greedsway |q 64237/1 |goto Eye of Azshara Map/0 31.96,58.15 |or
'|complete haspet(3107) |or
step
clicknpc Gurgl##179813
collect Gurgl##186553 |n
0/1 Rescue Gurgl |q 64237/2 |goto Eye of Azshara Map/0 32.10,58.23 |or
'|complete haspet(3107) |or
step
talk Breanni##96479
|tip Inside the building.
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Lost Featherling",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Ruffle",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Spriggan Trickster",{
patch='90001',
source='Achievement',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Steward Featherling",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Trapped Stonefiend",{
patch='90001',
source='Discovery',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Winterleaf Spriggan",{
patch='90001',
source='Achievement',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Animated Cruor",{
patch='90001',
source='PetBattle',
description="This battle pet can be tamed in the wild around the Forgotten Wounds in Maldraxxus.",
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Animated Tome",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Archivist's Quill",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Bubbling Pustule",{
patch='90001',
source='Discovery',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Death Seeker",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Invertebrate Oil",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Iridescent Ooze",{
patch='90001',
source='Discovery',
...
|tip This pet is cageable, meaning you can purchase it from the Auction House.
Gain the Plaguefallen Debuff |havebuff Plaguefallen##330092 |goto Maldraxxus/0 62.55,76.56
step
Click the Plaguefallen Pipe |goto Maldraxxus/0 61.62,76.70 < 10 |walk
...
collect Iridescent Ooze##183515 |goto Maldraxxus/0 57.66,75.85
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Jiggles",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Lost Quill",{
patch='90001',
source='Discovery',
...
step
Follow the path carefully |goto Revendreth/0 38.75,68.06 < 10 |walk
Drop down to the ledge below |goto Revendreth/0 37.65,69.29 < 10
talk Lost Quill##173449
Choose _"Here, I found this ink bottle."_
collect Refilling Inkwell##182613 |goto Revendreth/0 37.73,69.25
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Maw Stalker",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Plagueborn Slime",{
patch='90001',
source='Quest',
...
|tip This pet is cageable, meaning you can purchase it from the Auction House.
accept The House of Plagues##59130 |goto Maldraxxus/0 50.20,67.60
step
talk Plague Deviser Marileth##159930
turnin The House of Plagues##59130 |goto Maldraxxus/0 56.48,57.27
accept Bug Bites##58011 |goto Maldraxxus/0 56.48,57.27
accept Spores Galore##58016 |goto Maldraxxus/0 56.48,57.27
stickystart "Collect_Stringy_Spore"
step
kill Virulent Pest##159856+
collect Bloated Venom Sac |q 58011/1 |goto Maldraxxus/0 53.19,59.17
step
...
collect Stringy Spore |q 58016/1 |goto Maldraxxus/0 53.19,59.17
step
talk Plague Deviser Marileth##159930
turnin Bug Bites##58011 |goto Maldraxxus/0 56.48,57.27
turnin Spores Galore##58016 |goto Maldraxxus/0 56.48,57.27
accept Slime, Anyone?##58027 |goto Maldraxxus/0 56.48,57.27
step
click Cauldron of Creation##338858
Stir the Cauldron |q 58027/1 |goto Maldraxxus/0 56.41,57.18
step
click Pile of Spores##340713
Incorporate the Spores |q 58027/2 |goto Maldraxxus/0 56.54,57.07
step
click Jar of Venom##340712
Imbue the Venom |q 58027/3 |goto Maldraxxus/0 56.52,57.15
step
click Cauldron of Creation##338858
Mix the Concoction |q 58027/4 |goto Maldraxxus/0 56.41,57.18
step
talk Plague Deviser Marileth##159930
turnin Slime, Anyone?##58027 |goto Maldraxxus/0 56.48,57.27
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Primordial Bogling",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Shy Melvin",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Sludge Feeler",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Will of Remornia",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Mechanical Pets\\PHA7-YNX",{
patch='90001',
source='Crafted',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Backbone",{
patch='90001',
source='Crafted',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Burdened Soul",{
patch='90001',
source='Discovery',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Carpal",{
patch='90001',
source='Discovery',
...
collect Flexing Phalanges##183113 |goto Maldraxxus/0 47.39,62.11 |or
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Clutch",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Lost Soul",{
patch='90001',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Lucy",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Maw Crawler",{
patch='90001',
source='Drop',
description="This battle pet has a chance to drop from any of the final bosses inside Skoldus Hall located in Torghast.",
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Micromancer",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Mu'Dud",{
patch='90001',
source='Crafted',
...
|tip It takes 10 Malleable Flesh, 5 Superior Parts, and 1.60k Reservoir Anima to create this pet.
|tip This pet is cageable, meaning you can purchase it from the Auction House.
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Oonar's Arm",{
patch='90001',
source='Discovery',
...
Gain the Edible Redcap Buff |havebuff Edible Redcap##327367 |goto Maldraxxus/0 76.86,57.06
step
...
collect Oonar's Arm##181164 |goto Maldraxxus/0 51.42,48.48
step
use the Oonar's Arm##181164
Learn the "Oonar's Arm" Battle Pet |learnpet Oonar's Arm##2944
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Putrid Geist",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Severs",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Sharpclaw",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Spinebug",{
patch='90001',
source='Discovery',
...
Continue following the path |goto Maldraxxus/0 40.71,32.88 < 30
Enter the cave |goto Maldraxxus/0 41.55,20.41 < 30
clicknpc Spinebug##174663
|tip Inside the cave.
collect Spinebug##174677 |n
|tip This pet is cageable, meaning you can purchase it from the Auction House.
Learn the "Spinebug" Battle Pet |learnpet Spinebug##3047 |goto Maldraxxus/0 41.51,19.48
step
_Congratulations!_
You Collected the "Spinebug" Battle Pet.
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Toenail",{
patch='90001',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Torghast Lurker",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Writhing Spine",{
patch='90001',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Amaranthine Stinger",{
patch='90100',
source='Drop',
...
collect Amaranthine Stinger##186449 |goto The Maw/0 28.60,48.40 |or
|tip This may take several attempts to get.
|tip This pet is cageable, meaning you can purchase it from the Auction House.
It can also be found around:
[22.20,50.80]
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Animite Broodling",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Anxious Nibbler",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Chompy",{
patch='90100',
source='Quest',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Clinging Remains",{
patch='90100',
source='PetBattle',
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
Learn the "Clinging Remains" Battle Pet |learnpet Clinging Remains##3115 |goto The Maw/0 28.80,33.60
You can also find it around:
[24.20,29.00]
[36.80,31.00]
[30.40,42.40]
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Copperback Etherwyrm",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Curious Purrkin",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Daisy",{
patch='90100',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Damp Skrat",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed inside the dungeon Tazavesh, the Veiled Market.",
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Deathroach",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Devourling",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Domestic Aunian",{
patch='90100',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Eye of Affliction",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Eye of Allseeing",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Eye of Extermination",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Flawless Amethyst Baubleworm",{
patch='90100',
source='Vendor',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Fodder",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Gilded Darknight",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Gizmo",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Gnashtooth",{
patch='90100',
source='Drop',
...
|tip Inside the cave.
turnin Supplies from The Archivists' Codex##64266 |goto Korthia/0 62.78,22.61 |future |or
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Golden Eye",{
patch='90100',
source='Drop',
...
collect Golden Eye##186564 |goto The Maw/0 65.80,58.00 |or
|tip This may take several attempts to get.
|tip This pet is cageable, meaning you can purchase it from the Auction House.
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Grappling Gauntlet",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Grip of Terror",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed in the wild in The Maw.",
keywords={"Undead","The","Maw"},
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
Learn the "Grip of Terror" Battle Pet |learnpet Grip of Terror##3120 |goto The Maw/0 33.00,35.40
You can also find it around:
[43.80,42.00]
[43.20,48.40]
[21.20,45.20]
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Infused Etherwyrm",{
patch='90100',
source='Drop',
...
Select _"I will join the hunt, Lord Herne."_
...
accept A Shady Place##63951 |goto The Maw/0 22.57,43.27 |or
'|learnpet Infused Etherwyrm##3099 |or
step
use the Unbalanced Riftstone##187012
Use the Unstable Rifstone to Enter the Rift |q 63951/1 |goto The Maw/0 22.05,36.91 |or
'|learnpet Infused Etherwyrm##3099 |or
step
kill Elusive Keybinder##179030
collect Etherwyrm Cage key##186190 |goto The Maw/0 23.68,40.50 |or
They can also be found around:
[19.60,43.60]
[20.00,32.80]
'|learnpet Infused Etherwyrm##3099 |or
step
Enter the cave |goto The Maw/0 21.10,38.90 < 30 |walk
click Etherwyrm Cage##368653
|tip Use the "Exit the Rift" action button on your screen to exit the rift.
|tip Inside the cave.
collect Infused Etherwyrm##186191 |goto The Maw/0 23.10,42.30 |or
|tip It may take several attempts to get.
|tip This pet is cageable, meaning you can purchase it from the Auction House.
'|learnpet Infused Etherwyrm##3099 |or
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Invasive Buzzer",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Irongrasp",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Korthian Specimen",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Lil'Abom",{
patch='90100',
source='Discovery',
...
Click Here to Open the "Ve'nari Daily Quests" |confirm |loadguide "Daily Guides\\Shadowlands (50-70)\\Ve'nari Daily Quests (The Maw)"
...
Click Here to Open "The Maw" Leveling Guide |confirm |loadguide "Leveling Guides\\Shadowlands (50-70)\\The Maw"
'|learnpet Lil'Abom##3098 |or
step
click Lil'Abom Head##186183
|tip This can only be collected during the Necrolord Assault in The Maw.
collect Lil'Abom Head##186183 |goto The Maw/0 32.20,56.00 |or
It can also be found around:
[27.40,56.60]
[30.30,63.30]
'|learnpet Lil'Abom##3098 |or
step
Enter the cave |goto The Maw/0 38.84,58.53 < 30 |walk
click Lil'Abom Right Hand##186186
|tip Inside the cave.
|tip This can only be collected during the Necrolord Assault in The Maw.
|tip There is a chance this won't be available.
collect Lil'Abom Right Hand##186186 |goto The Maw/0 37.93,62.63 |or
'|learnpet Lil'Abom##3098 |or
step
click Lil'Abom Spare Arm##186187
|tip These can only be collected during the Necrolord Assault in The Maw.
collect Lil'Abom Spare Arm##186187 |goto The Maw/0 39.20,66.50 |or
It can also be found around:
[33.30,65.80]
'|learnpet Lil'Abom##3098 |or
step
Enter the cave |goto The Maw/0 36.92,67.41 < 30 |walk
click Lil'Abom Torso##186184
|tip Inside the cave.
|tip This can only be collected during the Necrolord Assault in The Maw.
collect Lil'Abom Torso##186184 |goto The Maw/0 36.90,67.40 |or
It can also be found around:
[36.40,64.40]
[39.90,62.60]
'|learnpet Lil'Abom##3098 |or
...
|tip This can only be collected during the Necrolord Assault in The Maw.
collect Lil'Abom Legs##186185 |goto The Maw/0 29.40,67.20 |or
'|learnpet Lil'Abom##3098 |or
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Undead Pets\\Lost Limb",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed in the wild in The Maw.",
keywords={"Undead","The","Maw"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Mawsworn Minion",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Mosscoated Gromit",{
patch='90100',
source='Drop',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Rarity",{
patch='90100',
source='Vendor',
...
|tip This has a 1.40% chance to drop from River Terrapins.
...
step
use Rarity##186540
learnpet Rarity##3113
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Humanoid Pets\\Rook",{
patch='90100',
source='Drop',
...
|tip You can earn reputation by completing dailies, killing rares, and opening chests in The Maw.
|tip Use the "Ve'nari Daily Quests" guide to accomplish this.
Click to Open the "Ve'nari Daily Quests" guide |confirm |loadguide "Daily Guides\\Shadowlands (50-70)\\Ve'nari Daily Quests (The Maw)"
'|complete haspet(3133) |or
step
label "Turnin_Supply_Quest"
talk Ve'nari##162804
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Scavenging Skrat",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed inside the dungeon Tazavesh, the Veiled Market.",
keywords={"Critter","Tazavesh","The","Veiled","Market"},
...
Enter Tazavesh, the Veiled Market |c |goto Tazavesh, the Veiled Market/7 0.00,0.00
|tip Use the "Tazavesh, the Veiled Market Attunement" guide to unlock the dungeon.
Click Here to Load the "Tazavesh, the Veiled Market Attunement" guide |confirm |loadguide "Dungeon Guides\\Shadowlands Dungeons\\Tazavesh, the Veiled Market Attunement"
step
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Scavenging Skrat##3112
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Ruby Baubleworm",{
patch='90100',
source='Vendor',
...
learnpet Ruby Baubleworm##3104
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Scurrying Mawrat",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed in the wild in The Maw.",
keywords={"Critter","The","Maw"},
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Scurrying Mawrat##3118 |goto The Maw/0 33.20,45.80
You can also find it around:
[The Maw/0 46.80,57.60]
[The Maw/0 48.00,72.80]
[The Maw/0 45.80,65.20]
[The Maw/0 60.40,66.40]
[The Maw/0 57.40,83.80]
[The Maw/0 63.54,75.10]
[The Maw/0 65.20,78.60]
[The Maw/0 57.20,83.60]
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Silver Purrkin",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed inside the dungeon Tazavesh, the Veiled Market.",
keywords={"Beast","Tazavesh","The","Veiled","Market"},
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Silver Purrkin##3109
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Mechanical Pets\\Squibbles",{
patch='90100',
source='Drop',
...
'|complete haspet(3092) |or
step
talk Anthea##176655
Select _"Think you can take me in a pet battle? Let's fight!"_
Defeat Anthea |q 63435/1 |goto Kun-Lai Summit/0 70.37,51.35 |or
...
step
talk Anthea##176655
turnin Temple Throwdown##63435 |goto Kun-Lai Summit/0 70.36,51.35 |or
'|complete haspet(3092) |or
step
...
learnpet Squibbles##3092
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Topaz Baubleworm",{
patch='90100',
source='Vendor',
...
Follow the path |goto Burning Steppes/16 38.11,49.06 < 30
...
learnpet Topaz Baubleworm##3106
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Turquoise Baubleworm",{
patch='90100',
source='Vendor',
...
learnpet Turquoise Baubleworm##3105
]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Vile Deathroach",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed in the wild in The Maw.",
keywords={"Critter","The","Maw"},
...
|tip Reduce its health below 35% and use the "Trap" ability on your pet bar.
|tip You may need to attempt the trap several times.
learnpet Vile Deathroach##3124 |goto The Maw/0 33.40,46.20
You can also find it around:
[46.80,57.40]
[50.20,69.60]
[53.20,63.40]
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Wild Corpsefly",{
patch='90100',
source='PetBattle',
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Young Garnetgullet",{
patch='90100',
source='PetBattle',
description="This battle pet can be tamed in the wild around Seeker's Quorum in Korthia.",
keywords={"Critter","Korthia"},
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Ambystan Darter",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Ambystan Darter\" battle pet.",
keywords={"Aquatic","Zereth","Mortis","9.20"},
pet=3223,
},[[
...
collect Ambystan Darter##189363 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Archetype of Metamorphosis",{
patch='90200',
source='Profession',
...
collect Glimmer of Metamorphosis##189162 |goto Zereth Mortis/0 49.32,47.98
...
collect Archetype of Metamorphosis##187928 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Archetype of Renewal",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Archetype of Metamorphosis\" battle pet.",
keywords={"Aquatic","Zereth","Mortis","9.20"},
...
collect Glimmer of Renewal##189166 |goto Zereth Mortis/0 48.85,83.34
You can find more around: |notinsticky
...
|tip This is a rare mob.
|tip Use the POI rare guide to accomplish this.
collect Aurelid Lattice##187636 |goto Zereth Mortis/0 52.28,75.41
...
collect Archetype of Renewal##189371 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Archetype of Serenity",{
patch='90200',
source='Profession',
...
collect Glimmer of Serenity##189168 |goto Zereth Mortis/0 64.48,39.08
You can find more around: |notinsticky
...
collect Bufonid Lattice##187633 |goto Zereth Mortis/0 50.62,73.68
You can find more around:
[43.65,88.44]
[76.43,53.07]
[75.52,60.47]
...
collect Archetype of Serenity##189382 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Prototickles",{
patch='90200',
source='Profession',
...
collect Glimmer of Discovery##189159 |goto Zereth Mortis/0 55.96,75.91
You can find more around: |notinsticky
...
collect Prototickles##189373 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Aquatic Pets\\Terror Jelly",{
patch='90200',
source='Profession',
...
collect Glimmer of Predation##189165 |goto Zereth Mortis/0 47.07,24.56
You can find more around: |notinsticky
...
collect Terror Jelly##189372 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Archetype of Cunning",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Archetype of Cunning\" battle pet.",
keywords={"Beast","Zereth","Mortis","9.20"},
pet=3207,
},[[
...
collect Archetype of Cunning##189380 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Archetype of Discovery",{
patch='90200',
source='Profession',
...
collect Vombata Lattice##189156 |goto Zereth Mortis/0 43.96,59.04
...
collect Archetype of Discovery##187795 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Archetype of Predation",{
patch='90200',
source='Profession',
...
Enter the building |goto Zereth Mortis/0 55.93,32.65 < 10 |walk
Kill enemies around this area
|tip Inside the building.
|tip You can find more outside of the building.
collect Tarachnid Lattice##189152 |goto Zereth Mortis/0 54.09,34.93
step
Enter the building |goto Zereth Mortis/0 61.85,58.93 < 7 |walk
clicknpc Synthesis Forge##184172
|tip Inside the building.
|tip Select the Archetype of Predation pet and click the "Create" button.
collect Archetype of Predation##189381 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Tunneling Vombata",{
patch='90200',
source='Profession',
...
collect Tunneling Vombata##187798 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Beast Pets\\Viperid Menace",{
patch='90200',
source='Profession',
...
collect Viperid Menace##189379 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Archetype of Multiplicity",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Archetype of Multiplicity\" battle pet.",
keywords={"Critter","Zereth","Mortis","9.20"},
pet=3189,
},[[
...
collect Glimmer of Multiplicity##189164 |goto Zereth Mortis/0 62.79,59.23
You can find more around: |notinsticky
...
collect Leporid Lattice##189147 |goto Zereth Mortis/0 52.92,62.56
You can find more around: |notinsticky
...
collect Archetype of Multiplicity##189375 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Archetype of Survival",{
patch='90200',
source='Profession',
...
kill Creeping Brambles##182326+
collect Glimmer of Survival##189169 |goto Zereth Mortis/0 50.88,84.18
...
collect Archetype of Survival##189364 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Archetype of Vigilance",{
patch='90200',
source='Profession',
...
collect Helicid Lattice##189145 |goto Zereth Mortis/0 57.33,82.92
...
collect Archetype of Vigilance##189377 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Fierce Scarabid",{
patch='90200',
source='Profession',
...
collect Glimmer of Motion##189163 |goto Zereth Mortis/0 47.49,71.29
You can find more around: |notinsticky
...
collect Fierce Scarabid##189365 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Leaping Leporid",{
patch='90200',
source='Profession',
...
collect Leaping Leporid##189374 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Critter Pets\\Shelly",{
patch='90200',
source='Profession',
...
collect Shelly##189378 |goto Zereth Mortis/0 60.52,59.39
step
use Shelly##189378
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Archetype of Animation",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Archetype of Animation\" battle pet.",
keywords={"Elemental","Zereth","Mortis","9.20"},
pet=3179,
},[[
...
collect Archetype of Animation##189369 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Elemental Pets\\Stabilized Geomental",{
patch='90200',
source='PetBattle',
...
collect Stabilized Geomental##189370 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Archetype of Malice",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Archetype of Malice\" battle pet.",
keywords={"Flying","Zereth","Mortis","9.20"},
pet=3211,
},[[
...
collect Glimmer of Malice##189161 |goto Zereth Mortis/0 49.61,47.70
You can find more around [46.44,43.69] |notinsticky
step
label "Collect_Vespoid_Lattice"
Kill Vespoid enemies around these areas
collect Vespoid Lattice##189154 |goto Zereth Mortis/0 51.47,42.07
...
collect Archetype of Malice##189383 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Archetype of Motion",{
patch='90200',
source='Profession',
...
collect Proto Avian Lattice##189149 |goto Zereth Mortis/0 76.46,53.35
You can find more around: |notinsticky
...
collect Archetype of Motion##187803 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Archetype of Satisfaction",{
patch='90200',
source='Profession',
...
collect Poultrid Lattice##189148 |goto Zereth Mortis/0 35.49,52.05
You can find more around: |notinsticky
...
collect Archetype of Satisfaction##189367 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Multichicken",{
patch='90200',
source='Profession',
...
collect Multichicken##189368 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Flying Pets\\Violent Poultrid",{
patch='90200',
source='Profession',
...
collect Violent Poultrid##189366 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Archetype of Focus",{
patch='90200',
source='Profession',
description="This guide will walk you through collecting the \"Archetype of Focus\" battle pet.",
keywords={"Magic","Zereth","Mortis","9.20"},
pet=3169,
},[[
...
collect Archetype of Focus##187713 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Omnipotential Core",{
patch='90200',
source='Profession',
...
collect Omnipotential Core##187734 |goto Zereth Mortis/0 60.52,59.39
step
...
QuestCore:RegisterGuide("Pets & Mounts Guides\\Battle Pets\\Magic Pets\\Resonant Echo",{
patch='90200',
source='Profession',
...
collect Resonant Echo##187733 |goto Zereth Mortis/0 60.52,59.39
step
