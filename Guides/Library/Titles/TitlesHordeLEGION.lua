...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Archdruid",{
...
Click here to load the "Druid Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Druid\\Druid Order Hall Quests" |only Druid
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Archmage",{
...
Click here to load the "Mage Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Mage\\Mage Order Hall Quests" |only Mage
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Battlelord",{
...
Click here to load the "Warrior Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Warrior\\Warrior Order Hall Quests" |only Warrior
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Deathlord",{
...
Click here to load the "Death Knight Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Death Knight\\Death Knight Order Hall Quests" |only DeathKnight
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Farseer",{
...
Click here to load the "Shaman Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Shaman\\Shaman Order Hall Quests" |only Shaman
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Grandmaster",{
...
Click here to load the "Monk Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Monk\\Monk Order Hall Quests" |only Monk
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Guardian of G'Hanir",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\High Priest",{
...
Click here to load the "Priest Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Priest\\Priest Order Hall Quests" |only Priest
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Highlord",{
...
Click here to load the "Paladin Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Paladin\\Paladin Order Hall Quests" |only Paladin
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Huntmaster",{
...
Click here to load the "Hunter Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Hunter\\Hunter Order Hall Quests" |only Hunter
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\The Illidari",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Netherlord",{
...
Click here to load the "Warlock Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Warlock\\Warlock Order Hall Quests" |only Warlock
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Shadowblade",{
description="This guide will assist you in earning the Shadowblade title.",
},[[
step
...
Click here to load the "Rogue Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Rogue\\Rogue Order Hall Quests" |only Rogue
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Class Halls\\Slayer",{
...
Click here to load the "Demon Hunter Order Hall Quest" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Demon Hunter\\Demon Hunter Order Hall Quests" |only DemonHunter
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Dungeons & Raids\\The Chosen",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Dungeons & Raids\\The Darkener",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Dungeons & Raids\\The Dreamer",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Dungeons & Raids\\The Tomb Raider",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Dungeons & Raids\\Vengeance Incarnate",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\Crashin' Thrashin'",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\The Fabulous",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\The Gullible",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\Legionary",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\Lord of the Reins",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\Postmaster",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\Stylist",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\General\\Timelord",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Player versus Player\\Fearless Gladiator",{
description="This guide will assist you in earning the Fearless Gladiator title.",
},[[
step
This title is gained by finishing Legion arena PvP Season 2 in the top 0.10%
|tip You must also win at least 50 games.
Earn the _Fearless Gladiator_ title |achieve 11014
]])
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Player versus Player\\Patron of War",{
...
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Player versus Player\\Vindictive Gladiator",{
description="This guide will assist you in earning the Vindictive Gladiator title.",
},[[
step
This title is gained by finishing Legion arena PvP Season 1 in the top 0.10%
|tip You must also win at least 50 games.
Earn the _Vindictive Gladiator_ title |achieve 11012
]])
QuestCore:RegisterGuide("Title Guides\\Legion Titles\\Professions\\Archaeology\\The Groundbreaker",{
