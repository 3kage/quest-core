...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Dungeon & Raid\\The Purifier",{
...
Earn "The Purifier" Title |achieve 12533 |goto Uldir/0 52.10,91.39
step
_Congratulations!_
You Earned "The Purifier" Title.
]])
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\The Awakened",{
description="To earn this title, you will have to complete the following Battle for Azeroth "..
...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\Junkyard",{
...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\Renowned Explorer",{
description="To earn this title, your Recruit-a-Friend allies must purchase four months of game time in total.",
condition_end=function() return achieved(13555) end,
playertitle=410,
},[[
step
...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\General\\Veteran of the Fourth War",{
description="To earn this title, you will have to complete the War Campaign in its entirety.",
...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Island Expedition\\Expedition Leader",{
...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Reputation\\The Admired",{
...
QuestCore:RegisterGuide("Title Guides\\Battle for Azeroth Titles\\Reputation\\Esteemed",{
