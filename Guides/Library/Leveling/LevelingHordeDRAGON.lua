...
QuestCore:RegisterGuide("Leveling Guides\\Dragonflight (10-70)\\Orgrimmar Trading Post Unlock",{
...
Collect the Trader's Tender from the Collector's Cache |q 66959/1 |goto Orgrimmar/1 48.47,75.66
step
talk Zaa'je##199164
Speak to Zaa'je |q 66959/3 |goto Orgrimmar/1 48.22,75.01
step
talk Gothal##199115
Speak to Gothal |q 66959/2 |goto Orgrimmar/1 47.43,76.45
step
click Trading Post Post
Review the Trading Post Post |q 66959/4 |goto Orgrimmar/1 48.91,76.31
step
talk Zen'kala##185473
Select _"I'd like to see what you have to offer this month."_ |gossip 107826
|tip You will need to exit the interface after doing this to continue.
Look at Zen'kala's Inventory |q 66959/5 |goto Orgrimmar/1 48.76,75.96
step
talk Shiri##185472
turnin Tour the Trading Post##66959 |goto Orgrimmar/1 48.91,76.12
]])
QuestCore:RegisterGuide("Leveling Guides\\Dragonflight (10-70)\\Primal Storms Questline",{
...
|tip On the platform above the city, this quest might have been offered to you automatically.
accept The Dragon Isles Await##65435 |goto Orgrimmar/1 44.05,37.96
step
talk Ebyssian##190239
...
Speak with Ebyssian |q 65437/1 |goto Orgrimmar/1 44.05,37.96
step
talk Ebyssian##190239
|tip On the platform above the city.
turnin Aspectral Invitation##65437 |goto Orgrimmar/1 44.05,37.96
step
...
Deliver the Orders to Kodethi |q 72256/1 |goto Durotar/0 54.12,9.85
step
...
Recruit the Scholars |q 65443/3 |goto Durotar/0 55.97,13.23
step
...
Recruit the Explorers |q 65443/2 |goto Durotar/0 54.00,13.04
step
...
accept Legacy of Tyr: Secrets of the Past##66586 |goto Durotar/0 55.84,12.75
|only if level >= 70
step
talk Naleidea Rivergleam##197279
|tip On top of the tower.
accept Chasing Storms##69944 |goto Durotar/0 55.81,12.66
step
talk Archmage Khadgar##193450
|tip On top of the tower.
accept A Primal Threat##69923 |goto Durotar/0 55.92,12.60
step
talk Storm Huntress Suhrakka##195899
|tip On top of the tower.
turnin Chasing Storms##69944 |goto Durotar/0 55.95,12.32
...
talk Ebyssian##190239
|tip On top of the tower.
turnin Legacy of Tyr: Secrets of the Past##66586 |goto Durotar/0 55.84,12.75
|only if haveq(66586) or completedq(66586)
step
talk Archmage Khadgar##193450
|tip On top of the tower.
turnin A Primal Threat##69923 |goto Durotar/0 55.92,12.60
]])
QuestCore:RegisterGuide("Daily Guides\\Dragonflight (10-70)\\Primal Storms Daily Quest",{
