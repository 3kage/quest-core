...
QuestCore:RegisterGuide("Leveling Guides\\Starter Guides\\Pandaren (1-15)",{
condition_suggested=function() return raceclass('Pandaren') and level <= 15 and not completedq(31450) and not raceclass("DeathKnight") and not QC.InPhase("exilesreach") end,
startlevel=1,
endlevel=15,
...
collect Trainee's Axe##76391 |goto The Wandering Isle/0 56.87,19.68 |q 30038
collect Trainee's Shield##73213 |goto The Wandering Isle/0 56.87,19.68 |q 30038
|only if Pandaren Warrior
step
...
accept The Lesson of the Sandy Fist##29406 |next "All_Class_Start" |goto The Wandering Isle/0 56.66,18.20
|only if Pandaren Warrior
step
talk Master Shang Xi##53566
...
step
click Weapon Rack##210016
collect Trainee's Crossbow##73211 |goto The Wandering Isle/0 56.87,19.68 |q 30034
|only if Pandaren Hunter
step
...
step
click Weapon Rack##210016
collect Trainee's Dagger##73208 |goto The Wandering Isle/0 56.87,19.68 |q 30036
collect Trainee's Dagger##73212 |goto The Wandering Isle/0 56.87,19.68 |q 30036
|only if Pandaren Rogue
step
...
step
click Weapon Rack##210016
collect Trainee's Mace##73207 |goto The Wandering Isle/0 56.87,19.68 |q 30035
collect Trainee's Book of Prayers##76393 |goto The Wandering Isle/0 56.87,19.68 |q 30035
|only if Pandaren Priest
step
...
step
click Weapon Rack##210016
collect Trainee's Axe##76391 |goto The Wandering Isle/0 56.87,19.68 |q 30037
collect Trainee's Shield##73213 |goto The Wandering Isle/0 56.87,19.68 |q 30037
|only if Pandaren Shaman
step
'|equipped Trainee's Axe##76391 |n
...
step
click Weapon Rack##210016
collect Trainee's Hand-Fan##76392 |goto The Wandering Isle/0 56.87,19.68 |q 30033
collect Trainee's Spellblade##76390 |goto The Wandering Isle/0 56.87,19.68 |q 30033
|only if Pandaren Mage
step
...
accept The Lesson of the Sandy Fist##29406 |goto The Wandering Isle/0 56.66,18.20 |next "All_Class_Start"
|only if Pandaren Mage
step
talk Master Shang Xi##53566
...
step
click Weapon Rack##210016
collect Trainee's Staff##73209 |goto The Wandering Isle/0 56.87,19.68 |q 30027
|only if Pandaren Monk
step
...
kill 5 Training Target##53714 |q 29406/1 |goto The Wandering Isle/0 57.33,18.92
...
Defeat #6# Sparring Trainees |q 29524/1 |goto The Wandering Isle/0 60.33,19.42
step
talk Master Shang Xi##53566
...
step
Run up the stairs |goto The Wandering Isle/0 60.00,18.50 < 5 |walk
Follow the path around |goto The Wandering Isle/0 60.45,20.22 < 7 |q 29408
step
Continue up the stairs |goto The Wandering Isle/0 60.01,18.57 < 5 |walk
...
kill Amberleaf Scamp##54130+
collect 6 Stolen Training Supplies##72071 |q 29424/1 |goto The Wandering Isle/0 54.01,20.91
step
talk Merchant Lorvo##54943
...
Slay #8# Hozen Attackers |q 29417/1 |goto The Wandering Isle/0 49.75,22.50
step
talk Ji Firepaw##54568
...
step
Enter the cave |goto The Wandering Isle/0 41.46,25.02 < 7 |walk
...
step
Leave the cave |goto The Wandering Isle/0 41.46,25.02 < 7 |walk
Run up the stairs |goto The Wandering Isle/0 51.05,30.55 < 10 |only if walking
...
step
Step onto the blue circle |goto The Wandering Isle/0 79.62,41.87 < 5 |walk
Cross to the Pool of Reflection |q 29678/1 |goto The Wandering Isle/0 79.78,39.06
step
...
step
Watch the dialogue
Ride the Cart to the Dai-Lo Farmstead |outvehicle |goto The Wandering Isle/0 70.68,65.85 |q 29680
step
...
step
Enter the cave |goto The Wandering Isle/0 71.79,70.55 < 5 |walk
...
kill 10 Plump Virmen##55483 |q 29769/1 |goto The Wandering Isle/0 72.06,72.99
step
talk Gao Summerdraft##55479
...
step
talk Shu##55556
Select _"Shu, can you wake up Wuguo for me?"_
...
step
Watch the dialogue
Ride the Cart to the Temple of Five Dawns |outvehicle |goto The Wandering Isle/0 51.96,58.58 |q 29775
step
talk Master Shang Xi##54786
|tip Inside the building.
...
step
Cross the bridge |goto The Wandering Isle/0 50.16,48.63 < 10 |only if walking
...
step
Follow the path up |goto The Wandering Isle/0 30.15,39.26 < 10 |only if walking
...
collect 8 Stolen Firework Bundle##74631 |q 29781/1 |goto The Wandering Isle/0 24.23,30.71
step
label "Slay_FeFeng_Hozen"
Kill Fe-Feng enemies around this area
Slay #20# Fe-Feng Hozen |q 29779/1 |goto The Wandering Isle/0 24.23,30.71
step
_Next to you:_
...
step
Walk carefully on the brown ropes |goto The Wandering Isle/0 31.15,36.78 < 3 |only if walking
...
step
Enter the building |goto The Wandering Isle/0 28.20,64.06 < 7 |walk
...
step
Follow the path |goto The Wandering Isle/0 28.91,53.36 < 30 |only if walking
...
Start Carrying a Sailor |complete hasbuff(129340) or hasbuff(105520) |goto The Wandering Isle/0 38.52,86.34 |q 29794 |or
'|complete readyq(29794) |or
step
Rescue #3# Injured Sailors |q 29794/1 |goto The Wandering Isle/0 42.14,86.70 |or
...
collect 8 Alliance Medical Supplies##74958 |q 29797/1 |goto The Wandering Isle/0 38.52,86.34
step
label "Slay_Deepscale_Tormentors"
kill 8 Deepscale Tormentor##56360 |q 29665/1 |goto The Wandering Isle/0 37.68,84.98
step
talk Delora Lionheart##55944
...
step
Watch the dialogue
Ride the Cart to Mandori Village |outvehicle |goto The Wandering Isle/0 51.62,59.07 |q 29800
step
...
|tip Inside the building.
Select _"I'm ready to decide."_
...
|tip Inside the building.
turnin Joining the Alliance##30987 |goto Stormwind City/0 85.92,31.57
|only if rep('Stormwind') >= Friendly
step
label "Horde"
...
accept The Horde Way##31013 |goto Orgrimmar/1 48.76,70.77
|only if rep('Orgrimmar') >= Friendly
step
Watch the dialogue
|tip Inside the building.
...
|tip Inside the building.
turnin The Horde Way##31013 |goto Orgrimmar/1 48.75,70.81
|only if rep('Orgrimmar') >= Friendly
]])
if UnitFactionGroup("player")~="Neutral" then return end
QuestCore:RegisterGuide("Alliance Loremaster Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Daily Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Events Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Dungeon Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Alliance Gear Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Alliance Professions Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Achievement Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Pets & Mounts Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Title Guides\\Your guides will load after you choose a faction.",{},[[]])
QuestCore:RegisterGuide("Reputation Guides\\Your guides will load after you choose a faction.",{},[[]])
