...
kill Inquisitor Tivos##107269 |q 42376 |future |goto Azsuna/0 28.40,52.10
]],
},
{
rare=[[Bilebrain]],
...
steps=[[
step
Enter the cave |goto Azsuna 34.80,49.80 < 10 |walk
...
steps=[[
step
Follow the path |goto Azsuna 41.10,35.30 |only if walking
...
steps=[[
step
Go up the path |goto Azsuna 58.90,50.00 < 10 |only if walking
...
kill Oubdob Da Smasher##95204 |q 39435 |future |goto Highmountain 47.60,73.80
...
steps=[[
step
Enter the cave |goto Highmountain 51.60,37.50 < 10 |walk
...
steps=[[
step
Enter the cave |goto Highmountain/0 55.10,44.30 < 10 |walk
...
level=45,
spot="Mardum, the Shattered Abyss C/0 63.60,23.60",
item=128948,
quest=40231,
steps=[[
step
...
level=45,
spot="Mardum, the Shattered Abyss C/0 68.60,27.60",
item=128947,
quest=40234,
steps=[[
step
kill General Volroth##97370 |q 40234 |future |goto Mardum, the Shattered Abyss C/0 68.60,27.60
]],
},
{
rare=[[King Voras]],
level=45,
spot="Mardum, the Shattered Abyss C/0 74.40,57.20",
item=128944,
quest=40232,
steps=[[
step
Go up the path |goto Mardum, the Shattered Abyss C/0 73.32,56.05 < 10
kill King Voras##97059 |q 40232 |future |goto Mardum, the Shattered Abyss C/0 74.40,57.20
]],
},
{
rare=[[Overseer Brutarg]],
level=45,
spot="Mardum, the Shattered Abyss C/0 80.80,41.60",
item=133580,
quest=40233,
steps=[[
step
kill Overseer Brutarg##97057 |q 40233 |future |goto Mardum, the Shattered Abyss C/0 80.80,41.60
]],
},
{
...
steps=[[
step
Enter the cave |goto Stormheim 41.40,31.90 < 10 |walk
...
steps=[[
step
Enter the cave |goto Stormheim 57.70,34.80 < 10 |walk
...
steps=[[
step
Enter the building |goto Stormheim 61.80,60.90 < 10 |walk
...
steps=[[
step
Enter the cave |goto Suramar 29.30,50.80 < 10 |walk
...
steps=[[
step
Follow the path |goto Suramar 40.30,26.20 < 10 |only if walking
...
steps=[[
step
Enter the cave |goto Suramar 49.50,33.90 < 10 |walk
...
steps=[[
step
Enter the cave |goto Suramar 70.00,56.90 < 10 |walk
...
steps=[[
step
Follow the path |goto Val'sharah 45.90,85.06 < 10 |only if walking
...
rare=[[Kethrazor]],
level=45,
spot="Vault of the Wardens/1 48.80,31.40",
item=128945,
quest=40251,
...
kill Kethrazor##96997 |q 40251 |future |goto Vault of the Wardens/1 48.80,31.40
]],
},
{
rare=[[Wrath-Lord Lekos]],
level=45,
spot="Vault of the Wardens/1 69.00,26.80",
item=128958,
quest=40301,
condition=[[only if haveq(38672) or completedq(38672)]],
steps=[[
step
kill Wrath-Lord Lekos##97069 |q 40301 |future |goto Vault of the Wardens/1 69.00,26.80
]],
},
}
