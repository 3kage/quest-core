...
steps=[[
step
Enter the cave |goto Azsuna 47.80,23.70 < 10 |walk
...
steps=[[
step
Enter the cave |goto Azsuna 55.70,25.40 < 10 |walk
...
steps=[[
step
Enter the cave |goto Azsuna 64.00,52.90 < 10 |walk
...
steps=[[
step
Enter the cave |goto Mardum, the Shattered Abyss C/0 77.00,41.40 < 10 |walk
...
Enter the cave |goto Stormheim 31.40,57.10 < 10 |walk
...
steps=[[
step
Enter the cave |goto Suramar 19.40,19.40 < 10 |walk
...
steps=[[
step
Enter the Temple of Fal'adora |goto Suramar 22.90,35.80 < 10 |walk
Follow the path |goto Suramar/32 54.60,40.40 < 10 |walk
Go down the stairs |goto Suramar/32 45.80,32.10 < 10 |walk
...
click Legion Portal##267226 |goto Suramar 31.00,85.10 < 5 |walk
...
steps=[[
step
Enter the underwater cave |goto Suramar 79.30,57.40 < 10 |walk
...
steps=[[
step
Enter the cave |goto Val'sharah 43.70,89.90 < 10 |walk
...
steps=[[
step
Enter the cave |goto Val'sharah 50.90,77.00 < 10 |walk
...
steps=[[
step
Enter the cave |goto Val'sharah 53.20,38.00 < 10 |walk
...
steps=[[
step
Enter the cave |goto Val'sharah 65.90,56.30 < 10 |walk
