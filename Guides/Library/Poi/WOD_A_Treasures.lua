...
QC.Poi.Sets.PoiTreasureWOD={
{
level=45,
treasure=[[Doorog's Secret Stash]],
spot="Frostfire Ridge/2 37.10,69.80",
currency="GL",
item=113189,
quest=35370,
steps=[[
...
_Go up_ the road to Bladespire Citadel |goto Frostfire Ridge/0 20.90,43.50
_Follow_ the bridge and go to the ramp |goto Frostfire Ridge/1 33.00,73.80
_Go to_ the top of the ramp |goto Frostfire Ridge/2 59.90,77.70
click Doorog's Secret Stash##232218 |q 35370 |future |goto Frostfire Ridge/2 37.10,69.80
...
spot="Frostfire Ridge/3 31.30,66.60",
item=113108,
quest=35367,
steps=[[
step
...
_Follow_ the bridge and go to the ramp |goto Frostfire Ridge/1 33.00,73.80
_Go to_ the top of the ramp |goto Frostfire Ridge/2 59.90,77.70
_Enter_ the citadel here |goto Frostfire Ridge/2 45.90,59.70
_Go up_ the ramp just inside on the left |goto Frostfire Ridge/2 36.20,46.80
_Follow_ the ramp all the way around and up into the Bladespire Throne |goto Frostfire Ridge/3 67.40,56.50
click Gorr'thogg's Personal Reserve##232215 |q 35367 |future |goto Frostfire Ridge/3 31.30,66.60
...
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/2 52.10,52.00",
currency="GL",
quest=35373,
steps=[[
step
_Warning_: You may have to contend with 99 elite Horde wolves to get this treasure
_Go up_ the road to Bladespire Citadel |goto Frostfire Ridge/0 20.90,43.50
_Follow_ the bridge and enter the main room of the Citadel |goto Frostfire Ridge/1 36.90,45.00
_Go up_ the ramp |goto Frostfire Ridge/1 45.30,22.80 < 8
_Follow the ramp_ all the way to the top |goto Frostfire Ridge/2 59.80,29.30 < 10
_Go to_ this room |goto Frostfire Ridge/2 52.00,48.80 < 12
click Ogre Booty##232214 |q 35373 |future |goto Frostfire Ridge/2 52.60,52.90
...
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/2 46.20,15.60",
currency="GL",
quest=35371,
steps=[[
step
...
_Go up_ the ramp |goto Frostfire Ridge/1 45.30,22.80 < 8
_Follow the ramp_ all the way to the top |goto Frostfire Ridge/2 59.80,29.30 < 10
_Go to_ this room |goto Frostfire Ridge/2 46.40,19.90 < 12
click Ogre Booty##232214 |q 35371 |future |goto Frostfire Ridge/2 46.20,15.60
]],
},
{
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/1 45.50,67.20",
currency="GR",
quest=35570,
steps=[[
step
...
_Go up_ the road to Bladespire Citadel |goto Frostfire Ridge/0 20.90,43.50
_Follow_ the bridge and enter the main room of the Citadel |goto Frostfire Ridge/1 36.90,45.00
_Continue right_ through the Citadel |goto Frostfire Ridge/1 47.70,58.80
click Ogre Booty##232214 |q 35570 |future |goto Frostfire Ridge/1 45.50,67.20
...
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/1 53.20,28.30",
currency="GL",
quest=35368,
steps=[[
step
...
_Go up_ the road to Bladespire Citadel |goto Frostfire Ridge/0 20.90,43.50
_Follow_ the bridge and enter the main room of the Citadel |goto Frostfire Ridge/1 36.90,45.00
_Go left_ around the bonfire and enter this room |goto Frostfire Ridge/1 51.20,29.90
click Ogre Booty##232214 |q 35368 |future |goto Frostfire Ridge/1 53.20,28.30
...
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/1 48.60,67.10",
currency="GL",
quest=35369,
steps=[[
step
...
_Follow_ the bridge and enter the main room of the Citadel |goto Frostfire Ridge/1 36.90,45.00
_Continue right_ through the Citadel |goto Frostfire Ridge/1 47.70,58.80
click Ogre Booty##232214 |q 35369 |future |goto Frostfire Ridge/1 48.60,67.10
...
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/2 76.70,62.10",
currency="GR",
quest=35568,
steps=[[
step
...
_Go up_ the ramp |goto Frostfire Ridge/1 45.30,22.80 < 8
_Follow the ramp_ all the way to the top |goto Frostfire Ridge/2 59.80,29.30 < 10
_Enter_ this room |goto Frostfire Ridge/2 60.00,46.00 < 12
_Open_ the vault gate and enter the room |goto Frostfire Ridge/2 70.10,61.40 < 10
click Ogre Booty##232214 |q 35568 |future |goto Frostfire Ridge/2 76.70,62.10
...
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/2 70.50,67.70",
currency="GR",
quest=35569,
steps=[[
step
...
_Enter_ this room |goto Frostfire Ridge/2 60.00,46.00 < 12
_Open_ the vault gate and enter the room |goto Frostfire Ridge/2 70.10,61.40 < 10
click Ogre Booty##232214 |q 35569 |future |goto Frostfire Ridge/2 70.50,67.70
|tip It's located behind a pile of supplies.
]],
},
{
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/2 51.30,17.90",
currency="GR",
quest=35567,
steps=[[
step
...
_Go up_ the ramp |goto Frostfire Ridge/1 45.30,22.80 < 8
_Follow the ramp_ all the way to the top |goto Frostfire Ridge/2 59.80,29.30 < 10
_Go to_ this room |goto Frostfire Ridge/2 49.80,21.30 < 12
click Ogre Booty##232214 |q 35567 |future |goto Frostfire Ridge/2 51.30,17.90
]],
},
{
level=45,
treasure=[[Ogre Booty]],
spot="Frostfire Ridge/2 36.40,28.80",
currency="GR",
quest=35347,
steps=[[
step
...
_Go up_ the ramp |goto Frostfire Ridge/1 45.30,22.80 < 8
_Follow the ramp_ all the way to the top |goto Frostfire Ridge/2 59.80,29.30 < 10
_Go to_ this room |goto Frostfire Ridge/2 38.20,30.80 < 12
click Ogre Booty##232214 |q 35347 |future |goto Frostfire Ridge/2 36.40,28.80
]],
},
{
level=45,
...
steps=[[
step
_Go down_ the path along the water's edge |goto Frostfire Ridge/0 10.80,48.50
...
steps=[[
step
_Climb_ on this rock and use it to jump to the next one |goto Frostfire Ridge/0 15.20,50.70
...
steps=[[
step
_Go through_ the narrow pass |goto Frostfire Ridge 20.00,12.90 < 10
...
steps=[[
step
_Enter_ the cave |goto Frostfire Ridge/0 19.50,50.60
|tip Be careful, there are stealthed mobs throughout the cave.
_Continue around_ to the right and to the back of the cave |goto Frostfire Ridge/0 20.70,49.00
_Go up_ the ramp |goto Frostfire Ridge/0 21.10,50.40
...
steps=[[
step
_Go through_ the narrow pass |goto Frostfire Ridge/0 23.00,9.30
...
steps=[[
step
_Enter_ the building here |goto Frostfire Ridge/0 23.30,24.10
...
steps=[[
step
_Enter_ the cave |goto Frostfire Ridge/0 23.40,12.00
...
steps=[[
step
_Enter_ the cave here |goto Frostfire Ridge/0 25.30,51.40
...
steps=[[
step
_Enter the tower_ here |goto Frostfire Ridge/0 24.50,29.40
_Go up_ the ramp to the top of the tower |goto Frostfire Ridge/0 24.50,28.30
...
steps=[[
step
_Jump onto_ the small building here |goto Frostfire Ridge/0 27.40,42.40
...
steps=[[
step
_Jump onto_ the rocks |goto Frostfire Ridge/0 35.40,24.30
_Jump to_ the higher ridge on the rocks |goto Frostfire Ridge/0 35.10,24.00
...
steps=[[
step
_Enter_ the tower |goto Frostfire Ridge/0 37.50,59.80 < 10
_Follow the ramp_ to the top of the tower | goto Frostfire Ridge 37.10,59.90 < 10
...
steps=[[
step
_Enter_ the canyon |goto Frostfire Ridge/0 39.10,41.20 < 10
_Follow_ the ramp up |goto Frostfire Ridge/0 39.10,38.20 < 10
...
steps=[[
step
_Enter_ this building |goto Frostfire Ridge/0 40.00,18.10
...
steps=[[
step
_Go to_ the lava |goto Frostfire Ridge/0 42.80,19.30
...
steps=[[
step
_Go to_ this spot |goto Frostfire Ridge/0 43.00,31.20
...
steps=[[
step
_Go up_ the hill |goto Frostfire Ridge/0 44.20,58.70
...
spot="Frostfire Ridge 45.40,50.80",
access="Completionist",
item=106899,
quest=33011,
steps=[[
step
_Go up_ the hill |goto Frostfire Ridge/0 47.20,52.40
_Turn right_ at the top |goto Frostfire Ridge/0 46.20,51.90
...
steps=[[
step
_Follow_ the narrow path to the Clumsy Brute corpse |goto Frostfire Ridge/0 50.80,20.00
...
_Follow_ the path up the hill |goto Frostfire Ridge/0 63.30,16.00
...
steps=[[
step
_Go up_ the snowy hill, starting here |goto Frostfire Ridge/0 65.90,62.80
_Go to_ the peak between these two bones |goto Frostfire Ridge/0 65.00,65.70
_Jump down_ onto the snow-covered roof |goto Frostfire Ridge/0 64.50,65.60
...
steps=[[
step
_Go up_ the hill next to the cave entrance |goto Frostfire Ridge/0 64.10,31.20
_Go to_ this spot |goto Frostfire Ridge/0 65.00,31.30
_Follow_ the narrow path higher up the mountain |goto Frostfire Ridge/0 64.30,28.70
_Continue around_ the rocks |goto Frostfire Ridge/0 64.40,26.50
...
steps=[[
step
_Enter_ Magnarok |goto Frostfire Ridge/0 68.00,32.40
_Go to_ the canyon |goto Frostfire Ridge/0 69.70,23.10
_Start up_ the path |goto Frostfire Ridge/0 68.70,23.70
_Turn left_ when you go through the arch |goto Frostfire Ridge/0 65.80,23.20
_Continue up_ the path and enter the cave here |goto Frostfire Ridge/0 67.00,25.10
...
steps=[[
step
_Enter_ the building |goto Frostfire Ridge/0 67.90,46.00
...
spot="Gorgrond/19 60.50,43.10",
currency="GR",
quest=36723,
condition=[[only if garrisonability("TrainingPit")]],
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 43.50,48.00 < 15
_Go down_ the spiraling ramp to the bottom |goto Gorgrond/19 61.40,77.10 < 15
_Continue clockwise_ around the outside |goto Gorgrond/19 45.90,48.10 < 15
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
click Aged Stone Container##233455 |q 36723 |future |goto Gorgrond/19 60.50,43.10
]],
},
{
level=45,
treasure=[[Ancient Titan Chest]],
spot="Gorgrond/19 36.80,50.50",
currency="GR",
quest=36720,
condition=[[only if garrisonability("LumberMill")]],
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 43.30,47.80
_Go down_ to the bottom |goto Gorgrond/18 41.10,64.20
_Go around_ and enter the left chamber |goto Gorgrond/19 48.00,37.90
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
click Ancient Titan Chest##233139 |q 36720 |future |goto Gorgrond/19 37.10,51.50
]],
},
{
level=45,
...
steps=[[
step
_Enter_ the tower |goto Gorgrond/0 39.00,68.00
_Go to_ the top of the spiraling ramp |goto Gorgrond/0 39.00,68.90
...
steps=[[
step
_Enter_ Deadgrin |goto Gorgrond/0 38.80,73.50
_Go to_ the right |goto Gorgrond/0 39.90,72.20
...
steps=[[
step
_Cross_ The Fertile Ground |goto Gorgrond/0 42.20,75.70
...
steps=[[
step
_Enter_ the Stonemaul Arena |goto Gorgrond/0 41.90,65.30
_Go left_ at the fork |goto Gorgrond/0 40.30,66.40
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Follow_ the outside wall of Evermorn Springs |goto Gorgrond/0 42.60,76.70
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Go through_ the two stone pillars and turn right |goto Gorgrond/0 41.70,53.50
...
steps=[[
step
_Go up_ the road |goto Gorgrond/0 41.60,46.90
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Enter_ Evermorn Springs |goto Gorgrond/0 44.10,79.60
_Follow_ the path around to the right |goto Gorgrond/0 42.30,78.80
_Enter_ the hut and jump through the small opening on the right |goto Gorgrond/0 41.70,78.50 < 8
...
steps=[[
step
_Enter_ the Evermoon Springs |goto Gorgrond/0 44.10,79.50
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Go up_ the trail |goto Gorgrond/0 42.50,91.00
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Follow_ the road |goto Gorgrond/0 42.60,53.60
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
step
_Enter_ Evermorn Springs |goto Gorgrond/0 44.10,79.60
_Go right_, following the path |goto Gorgrond/0 42.60,81.70
_Go up_ the hill to the left of the hut |goto Gorgrond/0 42.50,83.40
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 43.40,47.90
_Follow_ the spiraling path and jump down at this spot |goto Gorgrond/19 62.30,62.90
...
steps=[[
step
_Ascend_ the hill |goto Gorgrond/0 43.90,43.90
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 42.80,44.40
...
steps=[[
step
_Get up_ on the small hill |goto Gorgrond/0 44.00,71.10
...
steps=[[
step
_Climb up_ on the tree trunk |goto Gorgrond/0 44.30,73.60 < 8
...
steps=[[
step
_Climb up_ the hill here |goto Gorgrond/0 44.60,42.30 < 10
...
steps=[[
step
_Walk across_ the stone |goto Gorgrond/0 44.70,70.30
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Go up_ the hill |goto Gorgrond/0 45.40,44.20 < 20
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Go up_ here |goto Gorgrond/0 46.30,88.30
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 44.70,50.70
...
steps=[[
step
_Jump up_ on this plateau |goto Gorgrond/0 48.20,40.70
_Cross_ the plateau |goto Gorgrond/0 46.60,42.10
...
steps=[[
step
_Follow_ the top ridge |goto Gorgrond/0 48.80,48.10
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the digsite |goto Gorgrond/0 47.70,93.40 < 15
_Go left_ and jump onto this stone |goto Gorgrond/0 48.00,93.30 < 5
_Jump onto_ this stone |goto Gorgrond/0 48.00,93.40 < 5
_Jump over_ to the platform |goto Gorgrond/0 48.10,93.40 < 5
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 48.60,47.20 < 15
...
steps=[[
step
_Go up_ the trail |goto Gorgrond/0 50.30,49.80 < 10
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the ruins |goto Gorgrond/0 49.60,80.50
_Cross_ the pond |goto Gorgrond/0 50.10,79.20
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 49.50,53.40
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Go up_ the hill |goto Gorgrond/0 50.90,41.10 < 20
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Enter_ Overlook Ruins |goto Gorgrond/0 50.40,73.00
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 51.30,77.60 < 15
_Go right_ at the intersection |goto Gorgrond/0 51.70,79.40 < 15
_Continue right_ along the wall |goto Gorgrond/0 52.40,80.40 < 15
_Follow_ right to the room with steam vents |goto Gorgrond/0 52.90,80.60 < 15
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 51.40,77.60 < 10
_Go left_ down the side passage |goto Gorgrond/0 52.00,78.60 < 10
_Continue down_ the passage |goto Gorgrond/0 52.80,78.50 < 10
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 51.50,74.40
...
steps=[[
step
_Go up_ the hill |goto Gorgrond/0 54.40,71.20
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Go up_ this hill towards the mushroom caps |goto Gorgrond/0 57.60,64.70 < 10
_Climb up_ onto this mushroom |goto Gorgrond/0 57.30,65.40 < 5
...
steps=[[
step
_Go up_ the hill and hug the wall |goto Gorgrond/0 57.80,52.30
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
click Vindicator's Hammer##236147 |q 36628 |future |goto Gorgrond 59.40,63.70
...
steps=[[
step
_Enter_ Tangleheart |goto Gorgrond/0 56.60,72.00
_Go right_ |goto Gorgrond/0 59.40,71.80
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
steps=[[
step
_Enter_ Tangleheart |goto Gorgrond/0 56.30,71.80
|tip Click the mass of vines to summon your shredder, allowing you to access the treasure.
...
steps=[[
step
_Follow_ the uppper ridge |goto Gorgrond/0 61.20,56.50
|tip Click the boulder and Beatface will break it, allowing you to access the treasure.
...
spot="Lunarfall/0 60.70,55.30",
currency="GR",
quest=35381,
condition=[[only if garrisonlvl(3)]],
steps=[[
step
click Pippers' Buried Supplies 1##232252 |q 35381 |future |goto Lunarfall/0 60.70,55.30
]],
},
{
level=45,
treasure=[[Pippers' Buried Supplies 2]],
spot="Lunarfall/0 37.40,74.90",
currency="GR, 200 OIL",
quest=35382,
condition=[[only if garrisonlvl(3)]],
steps=[[
step
click Pippers' Buried Supplies 2##232252 |q 35382 |future |goto Lunarfall/0 37.40,74.90
]],
},
{
level=45,
treasure=[[Pippers' Buried Supplies 3]],
spot="Lunarfall/0 37.90,43.80",
currency="GR",
quest=35383,
condition=[[only if garrisonlvl(3)]],
steps=[[
step
click Pippers' Buried Supplies 3##232252 |q 35383 |future |goto Lunarfall/0 37.90,43.80
]],
},
{
level=45,
treasure=[[Pippers' Buried Supplies 4]],
spot="Lunarfall/0 61.40,71.40",
currency="GR",
quest=35384,
condition=[[only if garrisonlvl(3)]],
steps=[[
step
click Pippers' Buried Supplies 4##232252 |q 35384 |future |goto Lunarfall/0 61.40,71.40
]],
},
{
level=45,
treasure=[[Adventurer's Pouch]],
spot="Nagrand D/12 66.00,57.50",
currency="GL",
item="RANDOM",
quest=36088,
steps=[[
step
_Enter_ the Underpale cave |goto Nagrand D/12 93.50,34.20 < 10
_Go to_ the bottom of the tunnel |goto Nagrand D/12 72.30,46.10 < 10
_Go up_ the ramp |goto Nagrand D/12 62.00,39.80 < 10
...
steps=[[
step
_Go up_ the path beneath the skull |goto Nagrand D/0 36.70,55.70 < 10
...
steps=[[
step
_Go up_ the ramp |goto Nagrand D/0 38.80,72.10 < 20
_Enter_ the building |goto Nagrand D/0 37.80,70.80 < 10
_Go towards_ the steps |goto Nagrand D/0 37.70,69.80 < 8
_Go down_ the steps |goto Nagrand D/0 37.20,70.00 < 8
_Enter_ the vault |goto Nagrand D/0 37.60,70.10 < 10
...
steps=[[
step
_Climb over_ the rocks and wait here for the parrot |goto Nagrand D/0 38.50,58.80 < 10
...
steps=[[
step
_Enter_ the cave |goto Nagrand D/0 41.80,68.20 < 10
...
steps=[[
step
_Click_ the goblin rocket |goto Nagrand D/0 58.50,76.30 < 5
_Click_ the Steamwheedle Exploration Glider |goto Nagrand D/0 53.40,73.30 < 5
...
steps=[[
step
_Cross_ the field |goto Nagrand D/0 59.10,74.60
_Drop down_ |goto Nagrand D/0 57.00,73.30 < 8
...
steps=[[
step
_Jump across_ the gap |goto Nagrand D/0 58.90,60.00 < 15
_Jump across_ the second gap |goto Nagrand D/0 58.30,60.90 < 15
_Jump down_ to the lower platform |goto Nagrand D/0 57.70,62.10 < 15
...
steps=[[
step
_Jump from_ the rock onto the tree |goto Nagrand D/0 57.70,52.80 < 8
...
steps=[[
step
_Go to_ this platform |goto Nagrand D/0 58.00,57.80 < 10
_Jump down_ onto the tree below |goto Nagrand D/0 58.10,59.20 < 5
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 61.40,65.80 < 20
Hug the mountain and _jump over_ the tree |goto Nagrand D/0 62.10,66.80 < 10
...
steps=[[
step
_Follow_ this path around to the right |goto Nagrand D/0 72.30,12.50 < 10
_Jump across_ the first gap |goto Nagrand D/0 71.50,13.20 < 15
_Jump across_ the second gap |goto Nagrand D/0 70.20,13.40 < 15
_Click_ the Steamwheedle Exploration Glider |goto Nagrand D/0 67.50,14.30 < 10
...
steps=[[
step
_Cross_ the waterfall here |goto Nagrand D/0 64.40,67.50 < 15
...
steps=[[
step
_Enter_ the warsong area |goto Nagrand D/0 69.00,64.30 < 20
_Continue_ through |goto Nagrand D/0 66.70,63.50 < 10
_Drop down_ carefully onto the lower ledge |goto Nagrand D/0 65.90,61.50 < 15
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 66.40,16.30 < 10
...
steps=[[
step
_Follow_ the canyon wall |goto Nagrand D/0 67.70,47.90
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 69.20,50.40 < 20
Carefully, _climb onto_ the tree and walk out on the limb |goto Nagrand D/0 69.70,52.20 < 5
...
steps=[[
step
_Climb over_ the rocks |goto Nagrand D/0 77.00,61.40 < 15
_Follow_ the ridge |goto Nagrand D/0 75.20,63.00 < 10
_Go out_ onto the outcropping |goto Nagrand D/0 73.50,63.20 < 10
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 77.30,72.70
_Climb over_ the rocks |goto Nagrand D/0 76.10,70.60
_Cross_ the bridge |goto Nagrand D/0 75.80,67.20
_Click_ the Steamwheedle Exploration Glider and use it to reach the treasure |goto Nagrand D/0 75.70,64.50
...
steps=[[
step
_Go up_ the path |goto Nagrand D/0 78.10,72.00 < 10
click Steamwheedle Exploration Glider##232567 |goto Nagrand D/0 76.10,73.00 < 5
...
steps=[[
step
_Go up_ the path |goto Nagrand D/0 78.10,72.00 < 20
click Steamwheedle Exploration Glider##232567 |goto Nagrand D/0 76.10,73.00 < 5
...
steps=[[
step
_Go up_ the path |goto Nagrand D/0 74.90,8.70
Very carefully, _drop down_ |goto Nagrand D/0 73.00,10.60 < 3
...
steps=[[
step
_Swim to_ the waterfall |goto Nagrand D/0 73.50,14.40
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 77.30,72.70 < 15
_Climb over_ the rocks |goto Nagrand D/0 76.10,70.60 < 10
_Cross_ the bridge |goto Nagrand D/0 75.80,67.20 < 10
_Drop down_ carefully by jumping and moving forward while in the air |goto Nagrand D/0 75.30,65.00 < 8
...
step
_Go up_ the hill |goto Nagrand D/0 77.30,72.70 < 15
_Climb over_ the rocks |goto Nagrand D/0 76.10,70.60 < 15
_Cross_ the bridge |goto Nagrand D/0 75.80,67.20 < 15
_Drop down_ to the cave below |goto Nagrand D/0 75.10,65.80 < 10
...
steps=[[
step
_Cross_ the tree bridge |goto Nagrand D/0 74.00,62.20 < 20
_Follow_ the path around |goto Nagrand D/0 74.00,62.80 < 10
_Climb_ up the rocks |goto Nagrand D/0 75.00,62.20 < 10
...
steps=[[
step
_Go up_ the narrow trail carefully |goto Nagrand D/0 75.90,15.20 < 5
_Enter_ the cave |goto Nagrand D/0 77.10,17.20 < 10
...
steps=[[
step
_Go to_ the earthen bridge |goto Nagrand D/0 78.80,26.40 < 20
_Cross_ the bridge and drop down here |goto Nagrand D/0 77.60,29.30 < 15
...
_Climb over_ the rocks |goto Nagrand D/0 76.10,70.60 < 10
_Cross_ the bridge |goto Nagrand D/0 75.80,67.20 < 10
_Click_ the Steamwheedle Exploration Glider |goto Nagrand D/0 75.70,64.50 < 10
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 77.40,12.00 < 10
_Jump from_ this spot to the next rock |goto Nagrand D/0 78.20,14.20 < 10
...
step
_Go up_ the path |goto Nagrand D/0 78.10,72.00 < 20
_Go over_ the hills |goto Nagrand D/0 76.40,71.30 < 15
_Cross_ the bridge |goto Nagrand D/0 75.80,67.40 < 15
click Steamwheedle Exploration Glider##232567 |goto Nagrand D/0 75.70,64.50 < 5
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 81.70,79.90 < 15
_Jump over_ onto the wall from here |goto Nagrand D/0 80.90,80.30 < 10
...
steps=[[
step
_Follow the path_ up |goto Nagrand D/0 83.40,33.10 < 10
_Continue up_ the mountain |goto 85.00,34.70 < 10
Proceed _along the mountain_ |goto 87.10,38.60 < 10
Continue _around_ |goto 88.40,36.70 < 10
Use the glider to reach the treasure |goto Nagrand D/0 83.70,33.70 < 5
...
steps=[[
step
_Drop down_ carefully here |goto Nagrand D/0 81.50,13.60 < 5
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 83.10,52.50 < 10
_Cross_ the bridge |goto Nagrand D/0 84.00,52.10 < 10
_Jump over_ to the top of the building from here |goto Nagrand D/0 84.90,53.10 < 5
click Burning Blade Cache##233137 |q 35696 |future |goto Nagrand D/0 85.40,53.50
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 83.50,68.80 < 8
_Follow_ the ridge and cross the waterfall |goto Nagrand D/0 85.20,70.10 < 5
...
steps=[[
step
_Follow_ the path around towards the glider |goto Nagrand D/0 88.30,37.90 < 20
_Continue_ towards the glider |goto Nagrand D/0 86.50,34.50 < 20
Click the Steamwheedle Exploration Glider |goto Nagrand D/0 83.70,33.70 < 10
...
steps=[[
step
_Cross_ the gap |goto Nagrand D/0 87.00,38.70 < 10
_Go up_ the hill |goto Nagrand D/0 86.30,41.30 < 10
_Click_ the Steamwheedle Exploration Glider |goto Nagrand D/0 87.30,41.10 < 5
...
steps=[[
step
_Cross_ the bridge |goto Nagrand D/0 87.10,39.40 < 10
_Go up_ the hill |goto Nagrand D/0 86.30,41.30 < 15
_Click_ the Steamwheedle Exploration Glider |goto Nagrand D/0 87.30,41.10 < 10
...
steps=[[
step
_Follow_ the path around towards the glider |goto Nagrand D/0 88.30,37.90 < 15
_Continue_ towards the glider |goto Nagrand D/0 86.50,34.50 < 15
Click the Steamwheedle Exploration Glider |goto Nagrand D/0 83.70,33.70 < 5
...
steps=[[
step
_Go down_ the hill |goto Nagrand D/0 88.50,33.40 < 20
_Enter_ the cave |goto Nagrand D/0 89.00,32.50 < 10
...
steps=[[
step
_Go up_ the hidden path |goto Nagrand D/0 88.90,65.80 < 10
...
spot="Shadowmoon Valley D/15 56.20,49.20",
item=113373,
quest=33572,
steps=[[
step
_Take the path_ through Bloodthorn Hill |goto Shadowmoon Valley D/0 25.80,32.60
_Enter_ Bloodthorn Cave |goto Shadowmoon Valley D/15 73.80,31.90
_Go through_ the side entrance |goto Shadowmoon Valley D/15 54.90,37.80
_Drop down_ and turn to the left |goto Shadowmoon Valley D/15 56.20,49.30
...
steps=[[
step
_Enter_ Gul'var |goto Shadowmoon Valley D/0 22.10,30.70
_Go up_ this path and take the first left |goto Shadowmoon Valley D/0 20.40,29.20
...
steps=[[
step
_Follow_ the road |goto Shadowmoon Valley D/0 24.90,9.70
_Enter_ the village |goto Shadowmoon Valley D/0 25.40,6.30
...
steps=[[
step
_Cross_ the water |goto Shadowmoon Valley D/0 27.40,5.80
_Enter_ the cave |goto Shadowmoon Valley D/0 27.70,4.30
...
steps=[[
step
_Enter_ Anguish Fortress here |goto Shadowmoon Valley D/0 34.90,38.10
_Turn right_ at the bottom of the stairs |goto Shadowmoon Valley D/0 34.00,39.60
_Continue along_ the path |goto Shadowmoon Valley D/0 32.30,38.90
_Go up_ the hill |goto Shadowmoon Valley D/0 30.30,39.00
_Enter_ the hut |goto Shadowmoon Valley D/0 28.80,39.50
...
steps=[[
step
_Follow_ the side of the boat |goto Shadowmoon Valley D/0 27.30,8.10
...
_Continue along_ the path |goto Shadowmoon Valley D/0 32.30,38.90
_Go up_ the hill |goto Shadowmoon Valley D/0 30.30,39.00
_Go up_ this path |goto Shadowmoon Valley D/0 28.20,38.60
_Jump onto_ the stone pillar here |goto Shadowmoon Valley D/0 27.90,40.50
...
_Continue along_ the path |goto Shadowmoon Valley D/0 32.30,38.90
_Go up_ the hill |goto Shadowmoon Valley D/0 30.30,39.00
_Go up_ this path |goto Shadowmoon Valley D/0 29.40,41.40
_Continue_ to the stairs |goto Shadowmoon Valley D/0 30.60,44.40
...
step
_Enter_ Anguish Fortress here |goto Shadowmoon Valley D/0 34.90,38.10
_Jump down_ here |goto Shadowmoon Valley D/0 33.50,40.10
_Go right_ |goto Shadowmoon Valley D/0 32.70,39.20
_Enter_ this room |goto Shadowmoon Valley D/0 31.80,40.10
...
_Enter_ Anguish Fortress here |goto Shadowmoon Valley D/0 34.90,38.10
_Jump down_ here |goto Shadowmoon Valley D/0 33.50,40.10
_Go left_ |goto Shadowmoon Valley D/0 34.10,41.40
_Enter_ this room |goto Shadowmoon Valley D/0 33.50,42.60
...
steps=[[
step
_Follow_ the path up the hill |goto Shadowmoon Valley D/0 39.50,53.60
_Continue right_ along the path |goto Shadowmoon Valley D/0 37.70,54.90
_Cross_ both bridges |goto Shadowmoon Valley D/0 36.10,50.60
_Go around_ the right side of the tree |goto Shadowmoon Valley D/0 35.60,47.60
_Cross_ the water to the shore and continue to the giant cone |goto Shadowmoon Valley D/0 34.40,46.20
...
step
_Enter_ Anguish Fortress here |goto Shadowmoon Valley D/0 34.90,38.10
_Turn left_ at the bottom of the stairs |goto Shadowmoon Valley D/0 34.00,39.60
_Proceed through_ the stone arch |goto Shadowmoon Valley D/0 34.90,42.30
_Enter_ this room |goto Shadowmoon Valley D/0 36.10,41.90
...
_Turn left_ at the bottom of the stairs |goto Shadowmoon Valley D/0 34.00,39.60
_Proceed through_ the stone arch |goto Shadowmoon Valley D/0 34.90,42.30
_Enter_ the room |goto Shadowmoon Valley D/0 36.50,43.40
...
_Turn left_ at the bottom of the stairs |goto Shadowmoon Valley D/0 34.00,39.60
_Proceed through_ the stone arch |goto Shadowmoon Valley D/0 34.90,42.30
_Enter_ this room |goto Shadowmoon Valley D/0 37.10,41.60
...
steps=[[
step
_Enter_ the cave here |goto Shadowmoon Valley D/0 37.80,22.30 < 5
_Go left_ inside the cave |goto Shadowmoon Valley D/0 37.20,22.50
...
steps=[[
step
_Go up_ the path |goto Shadowmoon Valley D/0 38.90,58.40
_Turn right_ at the top of the trail |goto Shadowmoon Valley D/0 38.20,60.60
_Enter_ this hut |goto Shadowmoon Valley D/0 37.10,59.60
...
_Enter_ Anguish Fortress here |goto Shadowmoon Valley D/0 34.90,38.10
_Turn left_ at the bottom of the stairs |goto Shadowmoon Valley D/0 34.00,39.60
_Proceed_ through the stone arch |goto Shadowmoon Valley D/0 34.90,42.30
_Enter_ this room |goto Shadowmoon Valley D/0 37.50,43.20
...
_Turn left_ at the bottom of the stairs |goto Shadowmoon Valley D/0 34.00,39.60
_Proceed through_ the stone arch |goto Shadowmoon Valley D/0 34.90,42.30
_Enter_ this room |goto Shadowmoon Valley D/0 38.10,42.30
...
steps=[[
step
_Travel to_ the Forgotten Shore |goto Shadowmoon Valley D/0 40.50,75.50
_Go to_ the Isle of Shadows |goto Shadowmoon Valley D/0 39.90,79.80
...
steps=[[
step
_Enter_ the cave at the base of Exile's Rise |goto Shadowmoon Valley D/0 46.20,27.00
...
steps=[[
step
_Cross_ the water and climb the rock |goto Shadowmoon Valley D/0 53.50,47.70
_Go up_ this path |goto Shadowmoon Valley D/0 50.90,48.00
_Turn right_ at the top |goto Shadowmoon Valley D/0 49.30,47.30
_Scale_ the rocks to reach the upper plateau |goto Shadowmoon Valley D/0 48.90,45.50
_Scale_ the rocks to reach to highest plateau |goto Shadowmoon Valley D/0 48.40,46.50
_Drop down_ |goto Shadowmoon Valley D/0 47.50,45.40
...
steps=[[
step
_Enter_ the cave |goto Shadowmoon Valley D/0 46.40,45.00
_Go right_ at the fork |goto Shadowmoon Valley D/0 48.20,46.60
...
steps=[[
step
_Go through_ the narrow pass here |goto Shadowmoon Valley D/0 47.50,39.50
_Turn left_ on the road |goto Shadowmoon Valley D/0 48.20,40.50
_Follow_ the path and enter the pavillion |goto Shadowmoon Valley D/0 49.20,37.90
_Go up_ the winding ramp |goto Shadowmoon Valley D/0 49.90,37.00 < 10
_Reach the top_ of the ramp |goto Shadowmoon Valley D/0 49.10,36.60 < 10
_Open_ the Astrologer's Box |goto Shadowmoon Valley D/0 49.40,37.60
click Astrologer's Box##226831 |q 33867 |future |goto Shadowmoon Valley D/0 49.40,37.60
...
steps=[[
step
_Go to_ the pond |goto Shadowmoon Valley D/0 50.40,78.90
...
steps=[[
step
_Follow_ the road |goto Shadowmoon Valley D/0 49.10,32.20
_Turn right_ here |goto Shadowmoon Valley D/0 52.10,33.90
...
steps=[[
step
_Dive down_ under the water here and enter the cave |goto Lunarfall/0 49.10,11.60
...
steps=[[
step
_Go up_ the path here |goto Shadowmoon Valley D/0 51.00,47.90
_Turn left_ at the top of the path |goto Shadowmoon Valley D/0 49.90,47.50
_Continue_ along the path |goto Shadowmoon Valley D/0 51.90,49.50
...
steps=[[
step
_Go to_ the Umbrafen Lake |goto Shadowmoon Valley D/0 52.20,26.10
...
steps=[[
step
_Go to_ the river |goto Shadowmoon Valley D/0 52.00,69.00
_Continue_ following the river southeast |goto Shadowmoon Valley D/0 53.50,73.00
...
steps=[[
step
_Go to_ the steps |goto Shadowmoon Valley D/0 60.00,26.60 < 30
_Climb_ the three flights of stairs |goto Shadowmoon Valley D/0 62.00,26.20 < 30
_Go up_ the next set of stairs |goto Shadowmoon Valley D/0 63.70,25.00 < 30
_Follow_ the path to the top of Exarch's Rise |goto Shadowmoon Valley D/0 60.50,20.60 < 20
Use this rock to _jump up_ |goto Shadowmoon Valley D/0 59.80,18.90 < 10
_Run up_ the hill here |goto Shadowmoon Valley D/0 59.90,17.60 < 5
_Continue up_ and onto the hill |goto Shadowmoon Valley D/0 59.30,17.90 < 20
_Continue around_ to the small grove of trees |goto Shadowmoon Valley D/0 56.50,17.90 < 20
...
steps=[[
step
_Go to_ the top of the waterfall in Elodor |goto Shadowmoon Valley D/0 59.70,24.30
...
steps=[[
step
_Follow_ this path |goto Shadowmoon Valley D/0 58.30,60.50
_Continue along_ the path |goto Shadowmoon Valley D/0 58.80,63.90
_Enter_ the clearing |goto Shadowmoon Valley D/0 60.70,67.10
...
_Cross_ the water to the Island here |goto Shadowmoon Valley D/0 64.30,84.80
_Follow_ this path around |goto Shadowmoon Valley D/0 66.10,84.40
_Enter_ the cave here |goto Shadowmoon Valley D/0 66.90,86.50
...
path	62.50,46.50	69.70,46.50	69.70,42.60
path	70.30,40.00	72.10,37.50	74.80,39.90
path	77.00,41.30	77.50,42.40	78.00,42.90
path	78.30,44.30	78.10,45.40	79.40,45.30
path	79.90,44.60	80.70,44.90	81.70,43.70
path	82.40,42.60	83.80,42.80	84.56,44.78
...
steps=[[
step
_Jump up_ here to get on the scaffolding |goto Spires of Arak/0 33.40,27.60
...
steps=[[
step
_Jump up_ here to get on the scaffolding |goto Spires of Arak/0 33.90,27.20
...
_Enter_ the Town Hall |goto Spires of Arak/0 36.40,53.60 < 10
...
steps=[[
step
_Enter_ the house |goto Spires of Arak/0 36.60,57.60 < 10
...
steps=[[
step
_Climb up_ the crevice |goto Spires of Arak/0 36.40,17.60
...
steps=[[
step
_Enter_ the small canyon |goto Spires of Arak/0 38.10,46.70
...
steps=[[
step
_Enter_ the inn |goto Spires of Arak/0 37.60,51.20 < 5 |only if itemcount(114835) < 3 and not completedq(36657)
_Go downstairs_ |goto Spires of Arak/0 37.40,50.70 < 5 |only if itemcount(114835) < 3 and not completedq(36657)
talk Miril Dumonde##82432 |only if itemcount(114835) < 3 and not completedq(36657)
buy 3 Rooby Treat##114835 |goto Spires of Arak/0 37.60,50.90 < 10 |only if itemcount(114835) < 1 and not completedq(36657)
clicknpc Rooby Roo##84332 |goto Spires of Arak/0 37.50,50.80 < 10 |use Rooby Treat##114835 |only if itemcount(114835) > 0
...
steps=[[
step
_Go up_ the hidden path |goto Spires of Arak/0 40.20,55.90
...
steps=[[
step
_Go up_ the ravine |goto Spires of Arak/0 41.60,22.10
...
_Go up_ the path |goto Spires of Arak/0 41.60,21.20
...
steps=[[
step
_Jump onto_ the wall from this point |goto Spires of Arak/0 43.40,15.30 < 8
_Drop down_ onto the rope and carefully walk to the far wall |goto Spires of Arak/0 43.40,15.80 < 5
...
steps=[[
step
_Jump onto_ the stump and walk the rope around to the treasure |goto Spires of Arak/0 44.60,27.60 < 10
...
steps=[[
step
_Enter_ the burning hut |goto Spires of Arak/0 43.80,25.10 < 8
...
steps=[[
step
_Enter_ the hovel |goto Spires of Arak/0 44.40,12.30
...
steps=[[
step
_Jump_ from this point on the rock to the rope tethered to the tree |goto Spires of Arak/0 46.90,43.60 < 7
_Walk across_ the rope to the treasure |goto Spires of Arak/0 46.40,43.80 < 8
...
steps=[[
step
_Climb up_ onto the chain and walk across to the tree |goto Spires of Arak/0 47.20,33.90
...
steps=[[
step
_Follow_ the path |goto Spires of Arak/0 47.10,37.80
...
steps=[[
step
_Go up_ the hill past Stonescale |goto Spires of Arak/0 49.10,52.30 < 15
...
steps=[[
step
_Go up_ the path here |goto Spires of Arak/0 48.90,55.90 < 15
...
spot="Spires of Arak 49.00,62.60",
item=115463,
quest=36399,
steps=[[
step
_Enter_ the hovel |goto Spires of Arak/0 48.80,62.00 < 10
click Elixir of Shadow Sight 4##234734 |q 36399 |future |goto Spires of Arak 49.00,62.60
...
steps=[[
step
_Go up_ the path |goto Spires of Arak 49.20,38.20
...
steps=[[
step
_Go up_ between these ridges |goto Spires of Arak/0 50.30,24.40 < 10
_Go right_ and follow the ridge |goto Spires of Arak/0 50.60,25.10 < 10
...
steps=[[
step
_Go up_ the hidden path |goto Spires of Arak/0 51.50,63.80 < 10
...
steps=[[
step
_Jump onto_ the wall here |goto Spires of Arak/0 52.10,49.00 < 5
_Jump down_ onto the rope from this point |goto Spires of Arak/0 52.40,49.40 < 5
_Jump onto_ the wall at the end of the rope |goto Spires of Arak/0 51.60,49.10 < 5
...
steps=[[
step
_Go up_ the hill |goto Spires of Arak/0 51.20,20.70 < 15 |only if itemcount(115463) > 0
use Elixir of Shadow Sight##115463 |only if itemcount(115463) > 0
...
step
|tip This treasure grants +1-4 to Archaeology skill level.
_Go up_ the ridge |goto Spires of Arak/0 54.00,47.80 < 5
_Continue up_ the path |goto Spires of Arak/0 53.80,43.90 < 5
...
steps=[[
step
_Go to_ the edge of the water |goto Spires of Arak/0 53.60,84.10 < 20
...
steps=[[
step
_Go through_ the small opening |goto Spires of Arak/0 52.70,55.40 < 10
_Go up_ the hill |goto Spires of Arak/0 53.30,55.70 < 5
...
steps=[[
step
_Go up_ the hill |goto Spires of Arak 56.90,90.90
_Enter_ the building |goto Spires of Arak/0 55.70,91.00 < 15
_Go up_ the steps |goto Spires of Arak/0 55.40,91.00 < 10
...
steps=[[
step
_Go around_ the small hills towards the tree |goto Spires of Arak/0 55.40,21.70 < 10
...
steps=[[
step
_Enter_ the hut |goto Spires of Arak/0 56.10,28.70 < 10
...
steps=[[
step
Take the _side path_ to the altar |goto Spires of Arak/0 57.50,77.60 < 20 |only if itemcount(115463) > 0
use Elixir of Shadow Sight##115463 |only if itemcount(115463) > 0
...
steps=[[
step
_Go up_ the narrow trail |goto Spires of Arak/0 56.80,25.40
_Continue_ going up |goto Spires of Arak/0 58.60,23.90
clicknpc Statue of Anzu##85165 |q 36374 |future |goto Spires of Arak/0 58.00,22.30
]],
},
{
level=45,
...
steps=[[
step
_Enter_ the little shack |goto Spires of Arak/0 59.10,90.60 < 5
...
steps=[[
step
_Jump onto_ the rope |goto Spires of Arak/0 60.20,53.20
...
steps=[[
step
click Escape Pod##232403 |goto Spires of Arak/0 60.90,88.00 < 8
...
steps=[[
step
_Go up_ the hidden path |goto Spires of Arak/0 61.90,64.00 < 10
...
steps=[[
step
_Go between_ these two ridges and continue up |goto Spires of Arak/0 63.20,66.50
...
steps=[[
step
_Swim through_ the channel |goto Spires of Arak/0 66.10,58.10
...
steps=[[
step
_Mount up_ and jump from this point onto the wall |goto Spires of Arak/0 68.00,39.60 < 5
_Follow_ the wall to the treasure |goto Spires of Arak/0 67.80,40.00 < 3
...
steps=[[
step
_Go up_ the path |goto Spires of Arak/0 67.30,38.60
...
steps=[[
step
_Go up_ the wall and drop down |goto Spires of Arak/0 68.90,43.40 < 10
...
steps=[[
step
_Go up_ the path |goto Spires of Arak/0 71.20,48.90
...
spot="Talador/14 28.20,34.90",
currency="GL",
item=117570,
quest=34254,
steps=[[
step
_Enter_ the crypt |goto Talador/14 47.40,86.70 < 15
_Go left_ into the room |goto Talador/14 38.70,51.60 < 15
...
steps=[[
step
_Go up_ the trail |goto Talador/0 27.30,75.90 < 20
_Enter_ the cave |goto Talador/0 27.90,75.40 < 15
...
steps=[[
step
_Enter_ the hut |goto Talador/0 33.60,76.20
...
steps=[[
step
_Follow_ the road |goto Talador/0 37.80,95.90
_Go around_ the building |goto Talador/0 35.90,96.80
...
steps=[[
step
_Follow_ the road |goto Talador/0 36.50,96.00
talk Aarko##77664
...
steps=[[
step
_Enter_ the cave |goto Talador/0 36.80,75.30
...
steps=[[
step
_Follow_ the pier |goto Talador/0 35.40,17.10
...
steps=[[
step
_Go to_ the ruins |goto Talador/0 38.80,83.60
...
steps=[[
step
_Enter_ the building |goto Talador/0 47.90,90.70 < 20
...
steps=[[
step
_Enter_ the cave |goto Talador/0 53.30,26.10
...
steps=[[
step
_Enter_ Archenon Siegeyard |goto Talador/0 57.20,29.70
_Jump up_ onto this scaffolding |goto Talador/0 57.60,28.20 < 3
_Jump up_ onto the right board and then the back of the scaffold, then over to the first pillar |goto Talador/0 57.60,28.40 < 2
_Jump to_ the second pillar |goto Talador/0 57.50,28.50 < 2
...
The treasure can be found _here_ at [61.10,71.70]
...
steps=[[
step
_Enter_ the building |goto Talador/0 65.20,79.10
...
steps=[[
step
_Cross_ the waterfall |goto Talador/0 65.60,14.30 < 15
...
steps=[[
step
_Enter_ the cave |goto Talador/0 61.30,84.20 < 15
_Go up_ the ramp |goto Talador/0 64.50,86.90 < 15
...
_Drop down_ and enter the cave |goto Talador/0 64.80,9.30 < 10
...
steps=[[
step
_Enter_ the cave |goto Talador/0 61.40,84.20 < 15
_Enter_ the main cavern |goto Talador/0 63.60,84.80 < 15
...
steps=[[
step
_Enter_ the cave |goto Talador/0 61.30,84.20
_Go to_ the main cavern |goto Talador/0 65.40,86.20
...
steps=[[
step
_Enter_ Bladefury's Command |goto Talador/0 68.30,5.60
_Follow_ the road right |goto Talador/0 69.50,4.50
_Enter_ the building |goto Talador/0 69.90,6.50
...
steps=[[
step
_Enter_ the building |goto Talador/0 76.10,44.40 < 10
...
steps=[[
step
_Enter_ the cave |goto Talador/0 75.60,22.00
_Go up_ the ramp |goto Talador/0 77.90,18.70
_Continue up and around_ the top level |goto Talador/0 79.30,16.00
...
steps=[[
step
_Enter_ the mine |goto Talador/0 78.50,35.50
_Continue right_ into the mine |goto Talador/0 80.40,34.80
_Go left_ in the main cave |goto Talador/0 81.20,35.40
_Drop down_ here |goto Talador/0 81.80,35.60
...
spot="Tanaan Jungle/0 46.90,42.20",
item=127328,
quest=38776,
steps=[[
step
click Sacrificial Blade##241760 |q 38776 |goto Tanaan Jungle/0 46.90,42.20 |future
...
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 15.40,54.90 < 10
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 17.10,50.60 < 10
_Go through_ the left passage |goto Tanaan Jungle/0 16.40,48.80 < 8
...
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 16.40,58.60 < 10
...
steps=[[
step
_Enter_ the Ruins of Kra'nak |goto Tanaan Jungle/0 24.90,39.80 < 8
_Go through_ the left passage |goto Tanaan Jungle/0 22.00,40.50 < 8
_Go to_ the water's edge |goto Tanaan Jungle/0 19.80,40.80
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 26.40,48.00 < 15
_Go to_ the crossroads |goto Tanaan Jungle/0 23.30,48.70 < 15
_Enter_ the hut |goto Tanaan Jungle/0 22.10,48.40 < 8
...
step
_Go up_ the path |goto Tanaan Jungle/0 26.40,48.00 < 15
_Go around_ the tree stump |goto Tanaan Jungle/0 24.80,49.30 < 8
click Grappling Hook and Rope##241659 |goto Tanaan Jungle/0 24.70,49.80 < 5
...
steps=[[
step
_Follow_ the path towards the tower |goto Tanaan Jungle/0 25.90,60.60 < 20
click Grappling Hook and Rope##241659 |goto Tanaan Jungle/0 26.40,62.00 < 5
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 27.60,47.40
_Follow_ the right path to the fork |goto Tanaan Jungle/0 27.60,44.70
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 29.20,31.10 < 8
...
steps=[[
step
_Go up_ the steps |goto Tanaan Jungle/0 30.60,71.00 < 8
...
steps=[[
step
_Go up_ the hill |goto Tanaan Jungle/0 26.00,33.80 < 8
_Cross_ the platform |goto Tanaan Jungle/0 28.70,32.70 < 15
_Jump_ from this point to the first small ledge on the side of the mountain |goto Tanaan Jungle/0 30.20,32.10 < 5
_Jump again_ to the next point |goto Tanaan Jungle/0 30.60,31.80 < 5
_Climb_ the small hill |goto Tanaan Jungle/0 30.90,31.30 < 10
...
step
_Go up_ the steps |goto Tanaan Jungle/0 30.60,71.00 < 8
_Enter_ the small building |goto Tanaan Jungle/0 32.10,70.80 < 5
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 37.40,75.90 < 10
_Go through_ the left passage |goto Tanaan Jungle/0 36.80,78.80 < 10
_Continue around_ the passage |goto Tanaan Jungle/0 34.60,80.30 < 10
_Jump across_ the rocks |goto Tanaan Jungle/0 35.00,78.00 < 5
_Jump over_ the gap |goto Tanaan Jungle/0 34.70,78.00 < 8
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 32.50,37.30 < 8
_Go down_ the spiraling path and into the cave |goto Tanaan Jungle/0 32.10,37.30 < 8
_Continue along_ the path |goto Tanaan Jungle/0 32.50,38.40 < 10
_Follow_ the path down to the next level |goto Tanaan Jungle/0 32.70,37.30 < 8
_Go through_ the side passage |goto Tanaan Jungle/0 33.80,36.30 < 10
...
_Jump across_ the rocks |goto Tanaan Jungle/0 35.00,78.00 < 5
_Jump over_ the gap |goto Tanaan Jungle/0 34.70,78.00 < 8
_Jump across_ to the small boulder |goto Tanaan Jungle/0 34.80,77.50 < 5
...
step
_Enter_ the cave |goto Tanaan Jungle/0 37.40,75.90 < 10
_Go through_ the right passage |goto Tanaan Jungle/0 35.40,76.40 < 10
_Jump into_ the water |goto Tanaan Jungle/0 34.80,77.00 < 12
_Swim underwater_ to the barrels |goto Tanaan Jungle/0 35.10,78.40 < 12
_Jump up_ the rocks |goto Tanaan Jungle/0 35.40,78.40 < 5
_Jump onto_ the broken stairs |goto Tanaan Jungle/0 35.90,78.90 < 5
...
steps=[[
step
_Go through_ the barricade |goto Tanaan Jungle/0 38.40,39.50 < 15
_Go up_ the little hill |goto Tanaan Jungle/0 36.60,43.10 < 10
...
steps=[[
step
_Enter_ Ironmonger's Hold |goto Tanaan Jungle/0 38.70,44.20 < 15
_Go between_ the crates |goto Tanaan Jungle/0 37.20,46.00 < 10
...
steps=[[
step
_Go down_ the short path |goto Tanaan Jungle/0 38.60,79.60 < 12
...
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 43.00,35.80 < 10
_Take the stairs_ all the way up |goto Tanaan Jungle/0 42.90,35.00 < 5
...
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 42.50,37.80 < 5
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 47.30,70.60 < 10 |walk
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 46.90,42.20 < 15
...
steps=[[
step
_Go up_ the path and onto the big rock |goto Tanaan Jungle/0 47.80,70.80 < 10
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 44.60,77.60 < 5
_Follow_ the tunnel |goto Tanaan Jungle/0 46.80,76.30 < 5
_Go up_ the ramp on the right |goto Tanaan Jungle/0 49.10,78.80 < 8
_Go down_ the passage and jump onto the rocks |goto Tanaan Jungle/0 51.00,75.70 < 5
Carefully _walk across_ the first vine |goto Tanaan Jungle/0 50.20,75.70 < 5
_Walk across_ the second vine |goto Tanaan Jungle/0 49.50,74.90 < 5
_Jump over_ the gap to the platform |goto Tanaan Jungle/0 49.10,75.20 < 5
...
steps=[[
step
_Enter_ the cavern |goto Tanaan Jungle/0 44.60,77.50 < 8
_Follow_ the tunnel |goto Tanaan Jungle/0 46.80,76.30 < 8
_Go up_ the vine |goto Tanaan Jungle/0 49.30,77.10 < 5
_Jump down_ to the platform with the barrel |goto Tanaan Jungle/0 50.00,77.20 < 5
...
steps=[[
step
_Go up_ the hill |goto Tanaan Jungle/0 51.50,79.40 < 8
_Go up_ the hidden path |goto Tanaan Jungle/0 50.80,81.30 < 8
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 51.20,79.60 < 8
...
steps=[[
step
_Follow_ the fel river |goto Tanaan Jungle/0 53.20,28.80 < 12
_Scale_ the rocks on the left side of the river |goto Tanaan Jungle/0 52.20,30.40 < 10
_Jump down_ carefully at the first waterfall towards the end |goto Tanaan Jungle/0 51.60,31.20 < 5
...
steps=[[
step
_Climb up_ onto the rocks |goto Tanaan Jungle/0 55.00,67.10 < 8
_Cross_ the tree and drop down to the spear |goto Tanaan Jungle/0 55.00,69.10 < 5
...
steps=[[
step
_Go through_ the narrow pass |goto Tanaan Jungle/0 54.60,83.20 < 8
_Drop down_ over the rocks |goto Tanaan Jungle/0 54.60,88.30 < 15
...
steps=[[
step
_Follow_ the mountain |goto Tanaan Jungle/0 56.60,63.90
_Go under_ the canopy of vines |goto Tanaan Jungle/0 56.70,65.90 < 15
...
steps=[[
step
_Follow_ the shore |goto Tanaan Jungle/0 59.90,74.00 < 8
_Go to_ the fel pool |goto Tanaan Jungle/0 61.90,72.20 < 8
_Stand on_ this rock |goto Tanaan Jungle/0 62.00,70.80 < 5
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 61.30,22.80 < 12
...
spot="Tanaan Jungle 64.60,42.10",
item=127396,
quest=38701,
steps=[[
step
click Loose Soil##241606 |goto Tanaan Jungle 64.70,42.80 < 8
click Strange Fruit##241599 |q 38701 |goto Tanaan Jungle 64.60,42.10 |future
...
_Go through_ the narrow pass |goto Tanaan Jungle/0 54.60,83.20 < 8
_Drop down_ over the rocks |goto Tanaan Jungle/0 54.60,88.30 < 15
_Follow_ the shore |goto Tanaan Jungle/0 62.20,87.90
...
steps=[[
step
_Go through_ the gates |goto Tanaan Jungle/0 69.30,53.40 < 8
_Enter_ the hut |goto Tanaan Jungle/0 69.90,55.90 < 5
...
steps=[[
step
_Cross_ the Bleeding Hollow grounds |goto Tanaan Jungle/0 70.80,53.60
_Climb up_ the rocks |goto Tanaan Jungle/0 73.40,43.80 < 10
