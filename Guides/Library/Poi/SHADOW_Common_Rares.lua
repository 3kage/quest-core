...
step
Go through the first gate |goto The Maw/0 33.00,57.00 < 10 |only if walking
Go through the second gate |goto 34.90,66.40 < 10 |only if walking
...
Go through the first gate |goto The Maw/0 33.00,57.00 < 10 |only if walking
Go through the second gate |goto 34.90,66.40 < 10 |only if walking
Enter the cave |goto 23.00,68.40 < 7 |walk
use Domination's Calling##182329
|tip Inside the cave.
click Portal to Dominion's Apex |goto 46.00,47.70 < 5 |walk
...
collect Flipper Fish##187922 |goto Nazjatar/0 72.80,24.30 |q 65039
step
cast Fishing##131474
...
collect Coilclutch Vine##187916 |goto Shimmering Expanse/0 34.70,75.00 |q 65039
step
