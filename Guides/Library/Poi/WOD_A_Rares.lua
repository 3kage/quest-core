...
QC.Poi.Sets.PoiRareWOD={
{
rare=[[Yaga the Scarred]],
level=45,
spot="Frostfire Ridge/0 40.60,27.60",
currency="GR",
item=111477,
quest=34559,
steps=[[
step
_Go to_ the top ridge |goto Frostfire Ridge/0 41.30,29.00
kill Yaga the Scarred##79145 |q 34559 |future |goto Frostfire Ridge/0 40.60,27.60
]],
},
{
...
steps=[[
step
_Enter_ the cave here |goto Frostfire Ridge/0 27.20,30.80 < 10
...
steps=[[
step
_Follow_ the road down |goto Frostfire Ridge/0 26.00,59.70
_Cross_ the water |goto Frostfire Ridge/0 27.50,63.80
_Enter_ the cave |goto Frostfire Ridge/0 27.80,65.90
...
steps=[[
step
_Go up_ this path |goto Frostfire Ridge/0 33.90,30.00
_Cross_ the stone bridge |goto Frostfire Ridge/0 36.20,32.20
_Continue following_ the path up and to the right |goto Frostfire Ridge/0 38.00,33.10
...
steps=[[
step
_Go around_ the small peak |goto Frostfire Ridge/0 39.40,63.50
_Enter_ the cave |goto Frostfire Ridge/0 38.20,63.60
...
At 60% health, Cindermaw will burrow southeast to this location |goto Frostfire Ridge/0 41.50,48.80
At 30% health, Cindermaw will burrow north to this location |goto Frostfire Ridge/0 41.70,46.30
kill Cindermaw##72294 |q 33014 |future |goto Frostfire Ridge/0 41.70,46.30
]],
},
{
...
steps=[[
step
_Go down_ to the water |goto Frostfire Ridge/0 41.30,64.50
_Cross_ the water |goto Frostfire Ridge/0 40.80,66.60
_Go to_ the cave |goto Frostfire Ridge/0 40.80,67.60
...
steps=[[
step
_Go down_ to the edge of the lava |goto Frostfire Ridge/0 42.80,19.50
...
steps=[[
step
_Follow_ the road down |goto Frostfire Ridge/0 45.80,12.70
_Cross_ the water |goto Frostfire Ridge/0 43.50,10.40
...
steps=[[
step
_Enter_ the cave |goto Frostfire Ridge/0 45.90,14.20
...
steps=[[
step
_Enter_ the cave |goto Frostfire Ridge/0 46.00,57.40
_Continue down_ into the cave |goto Frostfire Ridge/0 45.50,55.50
...
steps=[[
step
_Go to_ the small camp |goto Frostfire Ridge/0 54.30,21.80
...
steps=[[
step
_Go up_ the ramp |goto Frostfire Ridge/0 61.00,26.70
_Turn left_ at the top |goto Frostfire Ridge/0 62.10,27.10
_Jump onto_ the bones |goto Frostfire Ridge/0 62.00,26.30 < 8
_Climb up_ this rib bone and jump over to Jehil's area |goto Frostfire Ridge/0 61.50,25.80 < 4
...
steps=[[
step
_Enter_ the cave |goto Frostfire Ridge/0 64.20,32.40
_Run to_ the bottom of the ramp |goto Frostfire Ridge/0 65.30,31.50
...
steps=[[
step
_Go up_ the path |goto Frostfire Ridge/0 69.00,23.90 < 10
_Follow_ the path around to the left |goto Frostfire Ridge/0 66.80,22.20 < 10
_Go through_ the stone arch |goto Frostfire Ridge/0 65.80,23.30 < 10
_Enter_ the cave |goto Frostfire Ridge/0 67.10,25.00 < 10
...
steps=[[
step
_Go up_ the hill |goto Frostfire Ridge/0 69.70,23.20
_Go through_ the narrow pass |goto Frostfire Ridge/0 68.50,22.60
kill Hoarfrost##87348 |q 37382 |future |goto Frostfire Ridge/0 68.10,19.90
]],
},
{
...
steps=[[
step
_Start up_ the hill |goto Frostfire Ridge/0 74.00,29.80
_Continue_ going up the hill |goto Frostfire Ridge/0 73.60,34.90
...
steps=[[
step
_Climb up_ onto the cooled magma |goto Frostfire Ridge/0 70.20,53.80
_Go up_ the left side of the lava |goto Frostfire Ridge/0 70.90,51.20
_Continue up_ the left side to the stone |goto Frostfire Ridge/0 71.10,48.30
click Firefury Stone##224620 |goto Frostfire Ridge/0 71.00,47.40
...
steps=[[
step
_Go down_ this hill |goto Frostfire Ridge/0 70.70,32.50
...
steps=[[
step
_Go up_ into the camp |goto Frostfire Ridge/0 74.60,62.60
_Enter_ the building and go down the stairs |goto Frostfire Ridge/0 75.90,63.00
kill Scout Goreseeker##77526 |q 34132 |future |goto Frostfire Ridge/0 76.60,63.60
]],
},
{
...
steps=[[
step
_Enter_ the cave |goto Frostfire Ridge/0 87.10,49.50
...
steps=[[
step
_Go up_ the bridge |goto Frostfire Ridge/0 86.10,47.20 < 10
_Go inside_ and _up the steps_ |goto Frostfire Ridge/0 86.90,45.00 < 10
...
steps=[[
step
_Go up_ the road |goto Frostfire Ridge/0 87.00,56.20
_Enter_ the building |goto Frostfire Ridge/0 88.20,57.50
...
rare=[[Gnarljaw]],
level=45,
spot="Gorgrond/21 54.00,31.00",
currency="AC",
item=120945,
quest=37413,
steps=[[
step
_Start up_ the path here |goto Gorgrond/0 56.00,52.20 < 15
_Continue up_ |goto Gorgrond/0 54.40,54.90 < 15
_Enter_ the cave |goto Gorgrond/0 53.80,55.70 < 15
_Go to_ the bottom of the spiraling path |goto Gorgrond/20 64.80,38.50 < 15
_Continue down_ |goto Gorgrond/21 54.40,72.00 < 15
kill Gnarljaw##78269 |q 37413 |future |goto Gorgrond/21 54.00,31.00
]],
},
{
rare=[[King Slime]],
level=45,
spot="Gorgrond/21 42.00,75.10",
currency="AC",
item=120945,
quest=37412,
steps=[[
...
_Continue up_ |goto Gorgrond/0 54.40,54.90 < 15
_Enter_ the cave |goto Gorgrond/0 53.80,55.70 < 15
_Go to_ the bottom of the spiraling path |goto Gorgrond/21 59.20,72.60 < 15
_Continue down_ |goto Gorgrond/21 50.60,41.40 < 15
kill King Slime##78260 |q 37412 |future |goto Gorgrond/21 42.00,75.10
]],
},
{
rare=[[Roardan the Sky Terror (Alliance)]],
level=45,
spot="Gorgrond/0 53.00,63.10",
...
accept Trophy of Glory: Roardan the Sky Terror##35817 |use Ebony Feather##113458 |goto Gorgrond/0 53.00,63.10
...
steps=[[
step
_Go up_ the hill |goto Gorgrond/0 39.50,79.50 < 30
_Go between_ the stones |goto Gorgrond/0 38.30,79.80
...
steps=[[
step
_Go up_ this path |goto Gorgrond/0 39.00,65.70
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 39.70,76.30 < 20
...
steps=[[
step
_Go up_ the hill |goto Gorgrond/0 39.60,79.90
...
steps=[[
step
kill Sulfurious##80725 |q 36394 |future |goto Gorgrond/0 39.80,60.60
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 43.30,47.80 < 20
_Go to_ the bottom of the spiraling ramp |goto Gorgrond/18 62.70,74.80 < 15
_Continue clockwise_ around the chamber |goto Gorgrond/18 40.90,61.20 < 10
_Take a left_ at the side passage |goto Gorgrond/19 45.70,37.70 < 10
kill Gelgor of the Blue Flame##81038 |q 36391 |future |goto Gorgrond/19 32.50,38.20
]],
},
{
...
accept Trophy of Glory: Charl Doomwing##35816 |use Fang of the Doomwing##113457 |goto Gorgrond/0 45.80,50.00
...
rare=[[Horgg]],
level=45,
spot="Gorgrond 46.10,27.20",
access="Completionist",
item=120945,
quest=37365,
steps=[[
step
kill Horgg##86577 |q 37365 |future |goto Gorgrond/0 46.10,27.20
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 44.70,50.70 < 20
...
rare=[[Morgo Kain]],
level=45,
spot="Gorgrond 46.30,23.60",
access="Completionist",
item=120945,
quest=37364,
steps=[[
step
kill Morgo Kain##86582 |q 37364 |future |goto Gorgrond 46.30,23.60
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 46.40,45.40
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 49.40,53.40 < 20
...
turnin Trophy of Glory: Roardan the Sky Terror##35817 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113458) > 0
turnin Trophy of Glory: Biolante##36502 |goto Gorgrond/0 52.80,59.70 |only if itemcount(116159) > 0
turnin Trophy of Glory: Charl Doomwing##35816 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113457) > 0
turnin Trophy of Glory: Crater Lord Igneous##35812 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113449) > 0
turnin Trophy of Glory: Dessicus##35809 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113446) > 0
turnin Trophy of Glory: Erosian##35808 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113445) > 0
turnin Trophy of Glory: Fungal Praetorian##35813 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113453) > 0
turnin Trophy of Glory: Khargax the Devourer##35820 |goto Gorgrond/0 52.80,59.70 |only if itemcount(113461) > 0
]],
},
{
rare=[[Hive Queen Skrikka]],
level=45,
spot="Gorgrond 52.50,70.10",
currency="GR",
item=118209,
quest=35908,
steps=[[
step
kill Hive Queen Skrikka##83522 |q 35908 |future |goto Gorgrond/0 52.50,70.10
...
steps=[[
step
_Enter_ the cave |goto Gorgrond/0 52.40,77.00 < 20
...
steps=[[
step
kill Stompalupagus##86520 |q 36837 |future |goto Gorgrond/0 54.10,72.50
...
steps=[[
step
_Go through_ the opening in the thorns |goto Gorgrond/0 58.10,69.00 < 10
...
He can also be found _here_ |goto Gorgrond 72.80,35.80
...
Alkali can also spawn _here_ |goto Gorgrond 56.20,40.80
Or _here_ |goto Gorgrond 71.30,40.40
...
level=45,
spot="Gorgrond 59.60,32.00",
currency="AC",
item=120945,
quest=37374,
steps=[[
step
_Go up_ the hill |goto Gorgrond/0 62.10,34.70 < 15
_Continue up_ the hill |goto Gorgrond/0 61.10,33.50 < 15
_Enter_ the cave |goto Gorgrond/0 60.00,32.60 < 15
kill Swift Onyx Flayer##88582 |q 37374 |future |goto Gorgrond 59.60,32.00
]],
},
{
rare=[[Grove Warden Yal]],
level=45,
spot="Gorgrond 59.70,42.90",
currency="AC",
item=120945,
quest=37375,
steps=[[
step
kill Grove Warden Yal##88583 |q 37375 |future |goto Gorgrond 59.70,42.90
...
rare=[[Venolasix]],
level=45,
spot="Gorgrond 63.40,30.70",
access="Completionist",
item=120945,
quest=37372,
steps=[[
step
_Go towards_ the large pool of water |goto Gorgrond/0 63.80,33.60
kill Venolasix##86266 |q 37372 |future |goto Gorgrond 63.40,30.70
...
steps=[[
step
_Go through_ the narrow channel in the Cimson Fen |goto Gorgrond/0 62.10,61.80
...
rare=[[Depthroot]],
level=45,
spot="Gorgrond 72.60,40.90",
currency="AC",
item=120945,
quest=37370,
steps=[[
step
kill Depthroot##82058 |q 37370 |future |goto Gorgrond 72.60,40.90
...
level=45,
spot="Nagrand D 34.30,76.90",
currency="GR",
item=116809,
quest=34727,
steps=[[
step
_Swim towards_ the ship |goto Nagrand D/0 35.80,76.40 < 10
kill Captain Ironbeard##79725 |q 34727 |future |goto Nagrand D 34.30,76.90
...
_Enter_ the Broken Precipice |goto Nagrand D/0 39.30,24.30 < 10
_Go right_ up the path |goto Nagrand D/0 36.90,19.90 < 10
_Continue_ going right |goto Nagrand D/0 38.30,15.40 < 10
_Click_ the Pit Slayer's Trophy while under the effects of a transformation crystal |goto Nagrand D/0 39.80,14.50 < 5
kill Pit Slayer##87846 |q 37397 |future |goto Nagrand D/0 39.80,14.50
]],
},
{
...
steps=[[
step
_Go up_ the steps |goto Nagrand D/0 38.20,16.20 < 10
...
_Click_ the horn hanging from the right post of the building to summon Gortag |goto Nagrand D/0 42.10,36.80 |only if itemcount(120290) > 0
kill Krahl Deadeye##87239
kill Gortag Steelgrip##87344 |q 37472 |future |goto Nagrand D/0 42.40,36.50
...
kill Gaz'orda##80122 |q 34725 |future |goto Nagrand D/0 43.80,77.70
]],
},
{
rare=[[Ophiis]],
...
kill Mok'gol Pack-Leader##87584
collect 1 Secret Meeting Details##120290 |n |only if itemcount(120290) < 1
_Click_ the horn hanging from the right post of the building to summon Gortag |goto Nagrand D/0 42.10,36.80 < 10 |only if itemcount(120290) > 0
kill Krahl Deadeye##87239 |q 37473 |future |goto Nagrand D/0 42.40,36.50
...
steps=[[
step
_Go to_ the Cerulean Lagoon |goto Nagrand D/0 49.70,18.60 < 15
_Continue along_ the shore |goto Nagrand D/0 46.80,17.90 < 15
...
steps=[[
step
_Cross_ Earthshaker Gorge |goto Nagrand D/0 49.00,24.90 < 15
...
steps=[[
step
_Go up_ the path |goto Nagrand D/0 53.40,18.90 < 10
...
steps=[[
step
_Jump to_ this platform |goto Nagrand D/0 58.70,60.30 < 10
_Jump_ to the second platform |goto Nagrand D/0 58.00,60.90 < 10
_Go up_ the hill |goto Nagrand D/0 56.10,59.40 < 10
...
steps=[[
step
_Follow_ the shore |goto Nagrand D/0 54.00,79.50 < 15
_Continue_ through the canyon |goto Nagrand D/0 56.80,81.60 < 15
...
rare=[[Pit Beast]],
level=45,
spot="Nagrand D 58.10,18.60",
currency="AC",
item=120945,
quest=37637,
steps=[[
step
_Enter_ the Gorian Proving Grounds |goto Nagrand D/0 56.90,19.40 < 20
kill Pit Beast##88208 |q 37637 |future |goto Nagrand D 58.10,18.60
]],
},
{
currency="AC",
...
steps=[[
step
kill Krud the Eviscerator##88210 |q 37398 |future |goto Nagrand D/0 58.20,11.70
...
steps=[[
step
kill Direhoof##86729 |q 37222 |future |goto Nagrand D/0 60.20,38.70
...
steps=[[
step
_Cross_ the waterfall |goto Nagrand D/0 63.90,71.20 < 10
...
path	62.40,27.40	61.60,18.80	61.20,12.40
path	62.60,14.60	65.80,21.20	65.60,28.00
...
steps=[[
step
_Go out_ onto the isthmus |goto Nagrand D/0 67.90,50.30 < 10
...
rare=[[Flinthide]],
level=45,
spot="Nagrand D 69.80,42.00",
currency="GR",
item=116807,
quest=35893,
steps=[[
step
kill Flinthide##83483 |q 35893 |future |goto Nagrand D 69.80,42.00
...
steps=[[
step
_Go onto_ the ridge |goto Nagrand D/0 77.50,25.20 < 20
_Follow_ the path |goto Nagrand D/0 75.60,28.20 < 15
_Continue down_ |goto Nagrand D/0 72.40,31.30 < 15
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 73.60,56.80 < 10
...
steps=[[
step
_Click_ the abandoned fishing rod |goto Nagrand D/0 75.30,10.90
...
steps=[[
step
_Go up_ the path |goto Nagrand D/0 75.30,61.60 < 10
_Cross_ the fallen tree |goto Nagrand D/0 73.90,62.20 < 5
_Continue_ following the path |goto Nagrand D/0 74.50,62.60 < 10
_Go over_ the rocks and planks |goto Nagrand D/0 75.50,62.00 < 10
_Continue_ following the path |goto Nagrand D/0 76.20,61.50 < 10
_Enter_ the cave |goto Nagrand D/0 74.70,64.00 < 10
...
level=45,
spot="Nagrand D 76.90,64.40",
currency="GR",
item=116823,
quest=35735,
steps=[[
step
_Climb up_ the hill here |goto Nagrand D/0 77.30,65.10 < 5
kill Berserk T-300 Series Mark II##82826 |q 35735 |future |goto Nagrand D 76.90,64.40
...
steps=[[
step
_Go up_ the hill |goto Nagrand D/0 81.20,27.60 < 10
...
steps=[[
step
_Enter_ this building |goto Nagrand D/0 82.70,75.60 < 10
...
kill Graveltooth##84263 |q 36159 |future |goto Nagrand D/0 84.00,36.90
...
Light the first Summoning Brazier |goto Nagrand D/0 86.60,56.40 < 5
Light the second Summoning Brazier |goto Nagrand D/0 86.70,55.40 < 5
Light the third Summoning Brazier |goto Nagrand D/0 87.10,54.20 < 5
kill Hyperious##78161 |q 34862 |future |goto Nagrand D/0 87.20,55.20
...
steps=[[
step
_Drop down_ from the top of the waterfall here |goto Nagrand D/0 89.40,43.30 < 5
_Run and jump_ into the cave behind the waterfall |goto Nagrand D/0 88.80,42.70 < 8
...
rare=[[Grizzlemaw]],
level=45,
spot="Nagrand D 89.50,72.80",
currency="GR",
item=118687,
quest=35784,
steps=[[
step
kill Grizzlemaw##82912 |q 35784 |future |goto Nagrand D/0 89.50,72.80
...
steps=[[
step
_Follow_ the shore |goto Nagrand D/0 92.30,22.20 < 15
_Enter_ the cave |goto Nagrand D/0 94.10,26.50 < 10
...
rare=[[Nagidna]],
level=45,
spot="Shadowmoon Valley D/0 60.80,89.90",
currency="AC",
item=120945,
quest=37409,
steps=[[
step
_Climb_ the hill |goto Shadowmoon Valley D/0 59.10,88.10
_Enter_ the cave |goto Shadowmoon Valley D/0 59.20,89.80
kill Nagidna##85555 |q 37409 |future |goto Shadowmoon Valley D/0 60.80,89.90
...
steps=[[
step
_Go up_ the hill here |goto Shadowmoon Valley D/0 23.30,18.70
_Drop down_ here |goto Shadowmoon Valley D/0 22.20,19.40
...
steps=[[
step
_Enter_ the cave |goto Shadowmoon Valley D/15 79.60,34.40
_Go straight_ through the cave |goto Shadowmoon Valley D/15 39.00,17.20
_Go around_ the path |goto Shadowmoon Valley D/15 25.30,60.60
kill Gorum##76380 |q 33664 |future |goto Shadowmoon Valley D/15 31.10,34.80
]],
},
{
rare=[[Sneevel]],
...
steps=[[
step
_Follow the trail_ along the wall |goto Shadowmoon Valley D/0 28.10,38.50
kill Sneevel##86689 |q 36880 |future |goto Shadowmoon Valley D/0 27.50,43.70
...
steps=[[
step
_Swim around_ the boat |goto Shadowmoon Valley D/0 28.60,6.60
...
steps=[[
step
_Enter_ the Pillars of Fate |goto Spires of Arak/0 70.60,27.20
_Continue up_ the ramp |goto Spires of Arak/0 74.30,30.10
_Enter_ the cave |goto Spires of Arak/0 72.10,27.00
...
steps=[[
step
_Go through_ the gates |goto Shadowmoon Valley D/0 32.70,34.30
kill Ku'targ the Voidseer##72362 |q 33039 |future |goto Shadowmoon Valley D/0 32.50,35.10
...
steps=[[
step
_Enter Anguish Fortress_ here |goto Shadowmoon Valley D/0 34.90,38.10
_Jump down_ here |goto Shadowmoon Valley D/0 33.60,40.10
...
path follow smart; loop on; ants curved; dist 20
path	31.70,32.70	34.70,34.60	37.50,36.70
path	39.50,36.80	41.00,34.90	41.70,31.40
path	40.00,29.80	36.80,29.60	34.80,28.60
path	32.80,28.10	30.30,29.30	29.10,31.00
path	30.90,32.10
...
steps=[[
step
_Climb the rocks_ behind the waterfall up to the cave entrance |goto Shadowmoon Valley D/0 38.70,49.00
...
steps=[[
step
_Go down_ to the shore |goto Shadowmoon Valley D/0 38.80,17.00
_Cross_ the water to the small island |goto Shadowmoon Valley D/0 37.90,16.10
...
steps=[[
step
_Go to_ the Black Altar of Xan'tish |goto Shadowmoon Valley D/0 38.50,71.60
kill Morva Soultwister##82362 |q 35523 |future |goto Shadowmoon Valley D/0 38.60,70.50
]],
},
{
rare=[[Darkmaster Go'vid]],
level=45,
spot="Shadowmoon Valley D 38.70,83.60",
currency="GR",
item=113548,
quest=35448,
steps=[[
...
_Go to_ the far shore |goto Shadowmoon Valley D/0 38.70,83.60
kill Darkmaster Go'vid##82268 |q 35448 |future |goto Shadowmoon Valley D/0 38.70,83.60
]],
},
{
rare=[[Killmaw]],
...
steps=[[
step
kill Killmaw##74206 |q 33043 |future |goto Shadowmoon Valley D/0 40.80,44.60
...
steps=[[
step
talk Romuul##74741 |goto Shadowmoon Valley D/0 42.90,40.40
...
accept Artificer Romuul##35614 |goto Shadowmoon Valley D/0 42.90,40.40
]],
},
{
rare=[[Mother Om'ra]],
...
kill Mother Om'ra##88831 |q 33642 |future |goto Shadowmoon Valley D/0 44.00,57.70
]],
},
{
rare=[[Brambleking Fili]],
level=45,
spot="Shadowmoon Valley D 45.00,77.00",
currency="AC",
item=120945,
quest=33383,
steps=[[
step
kill Brambleking Fili##81639 |q 33383 |future |goto Shadowmoon Valley D/0 45.00,77.00
]],
},
{
...
steps=[[
step
_Follow_ the path |goto Shadowmoon Valley D/0 44.40,22.90
_Enter_ the cave |goto Shadowmoon Valley D/0 44.50,21.10
...
steps=[[
step
_Jump up_ the rocks here |goto Shadowmoon Valley D/0 47.20,73.60
...
steps=[[
step
_Climb_ the hill |goto Shadowmoon Valley D/0 47.70,23.90
_Cross_ the field |goto Shadowmoon Valley D/0 47.30,23.20
kill Rai'vosh##82374 |q 35553 |future |goto Shadowmoon Valley D/0 48.80,22.70
]],
},
{
rare=[[Dark Emanation]],
...
steps=[[
step
_Enter_ the cave |goto Shadowmoon Valley D/0 46.60,45.40
_Go down_ the left passage |goto Shadowmoon Valley D/0 48.70,44.80
...
steps=[[
step
_Go to_ the hill |goto Shadowmoon Valley D/0 47.60,43.80
_Continue up_ the hill |goto Shadowmoon Valley D/0 49.60,41.80
kill Darktalon##82411 |q 35555 |future |goto Shadowmoon Valley D/0 49.60,41.80
...
steps=[[
step
_Follow_ the road |goto Shadowmoon Valley D/0 48.90,73.30
...
steps=[[
step
_Go to_ Deadwalker Pass |goto Shadowmoon Valley D/0 51.10,24.20
_Follow_ the shore |goto Shadowmoon Valley D/0 52.20,18.00
...
steps=[[
step
_Go to_ the Verdant Mire |goto Shadowmoon Valley D/0 54.10,49.00
...
steps=[[
step
_Follow_ the path into the Blademoon Bloom |goto Shadowmoon Valley D/0 53.00,67.70
kill Venomshade##75492 |q 33643 |future |goto Shadowmoon Valley D/0 54.80,70.20
]],
},
{
rare=[[Insha'tar]],
...
steps=[[
step
_Follow_ the small trail |goto Shadowmoon Valley D/0 58.30,60.60
_Go up_ the hill through the small pass |goto Shadowmoon Valley D/0 60.40,62.50
...
rare=[[Slivermaw]],
level=45,
spot="Shadowmoon Valley D 61.70,89.00",
currency="AC",
item=120945,
quest=37411,
steps=[[
step
_Enter_ the cave |goto Shadowmoon Valley D/0 60.90,87.00
kill Slivermaw##85837 |q 37411 |future |goto Shadowmoon Valley D 61.70,89.00
...
rare=[[Avalanche]],
level=40,
spot="Shadowmoon Valley D 67.80,84.90",
currency="AC",
item=120945,
quest=37410,
steps=[[
step
_Cross the water_ to the island here |goto Shadowmoon Valley D/0 64.30,84.80
_Follow_ this path around |goto Shadowmoon Valley D/0 66.10,84.40
_Enter_ the cave |goto Shadowmoon Valley D/0 66.90,86.50
kill Avalanche##85568 |q 37410 |future |goto Shadowmoon Valley D 67.80,84.90
...
steps=[[
step
_Go to_ the small island |goto Shadowmoon Valley D/0 67.50,62.70
_Investigate the corpse_ on the ground |goto Shadowmoon Valley D/0 67.90,63.90
clicknpc Enavra##82742
kill Enavra##82676 |q 35688 |future |goto Shadowmoon Valley D/0 67.90,63.90
]],
},
{
rare=[[Gaze]],
...
steps=[[
step
_Go up_ the trail |goto Spires of Arak/0 28.10,24.60 < 10
click Fel Grimoire##236961 |goto Spires of Arak/0 24.90,25.60 < 8
...
steps=[[
step
_Swim around_ the rocks |goto Spires of Arak/0 32.50,56.40
...
steps=[[
step
_Go up_ the hidden path |goto Spires of Arak/0 33.40,23.80 < 5
...
steps=[[
step
_Go to_ Pinchwhistle Point |goto Spires of Arak/0 55.50,87.00
...
steps=[[
step
_Go up_ the hidden path |goto Spires of Arak/0 54.90,60.00
_Continue up_ the path |goto Spires of Arak/0 53.70,62.00
...
steps=[[
step
_Go through_ the pass |goto Spires of Arak/0 60.30,19.80
...
steps=[[
step
_Go around_ the shrine |goto Spires of Arak/0 60.50,38.00
...
steps=[[
step
_Go to_ the water |goto Spires of Arak/0 63.40,64.00
...
steps=[[
step
_Go through_ the pass |goto Spires of Arak/0 64.30,51.60
kill Oskiira the Vengeful##84872 |q 36288 |future |goto Spires of Arak/0 65.00,54.20
]],
},
{
rare=[[Sangrikass]],
...
steps=[[
step
_Go around_ the shore |goto Spires of Arak/0 68.30,57.30
...
steps=[[
step
_Click_ the portal to enter the shadow realm |goto Spires of Arak/0 72.30,23.60
...
steps=[[
step
_Enter_ the cave |goto Spires of Arak/0 73.40,34.80
_Take the center_ passage |goto Spires of Arak/0 71.80,34.60
...
rare=[[Grrbrrgle]],
level=45,
spot="Talador 22.20,74.20",
currency="GR",
item=120436,
quest=36919,
steps=[[
step
_Go through_ the pass |goto Talador/0 27.70,67.80
_Cross_ the water |goto Talador/0 24.10,71.50
click A Restless Crate##235673
kill Grrbrrgle##85572 |q 36919 |future |goto Talador/0 22.20,74.20
...
steps=[[
step
_Ride_ the elevator up |goto Talador/0 32.50,33.50
_Cross_ the bridge |goto Talador/0 31.30,28.70
...
steps=[[
step
_Ride_ the elevator up |goto Talador/0 35.70,45.60
_Go up_ the stairs |goto Talador/0 32.50,47.60
...
level=45,
spot="Talador 33.50,37.80",
access="Completionist",
item=120945,
quest=37348,
steps=[[
step
_Enter_ the Residential District |goto Talador/0 35.70,39.80
_Enter_ the building |goto Talador/0 35.70,38.30 < 8
_Go up_ the stairs |goto Talador/0 37.00,38.00 < 8
kill Kurlosh Doomfang##82988 |q 37348 |future |goto Talador 33.50,37.80
]],
},
{
currency="AC",
...
step
_Enter_ the Residential District |goto Talador/0 35.70,39.80
_Enter_ the building |goto Talador/0 33.80,38.30 < 10
...
level=45,
spot="Talador 37.30,70.50",
currency="GR",
item=116123,
quest=34165,
steps=[[
step
kill Cro Fleshrender##77620 |q 34165 |future |goto Talador 37.30,70.50
|tip He's in the pit.
]],
},
{
...
level=45,
spot="Talador 38.00,20.80",
access="Completionist",
item=120945,
quest=37342,
steps=[[
step
kill Legion Vanguard##88494 |q 37342 |future |goto Talador 38.00,20.80
...
steps=[[
step
_Go up_ the steps |goto Talador/0 40.80,49.70
...
steps=[[
step
_Enter_ the crypt |goto Talador/14 47.60,87.10 < 15
_Go straight_ into the large room |goto Talador/14 51.40,45.80 < 15
kill Shirzir##79543 |q 34671 |future |goto Talador/14 67.40,23.30
]],
},
{
currency="AC",
...
rare=[[Frenzied Golem]],
level=45,
spot="Talador 46.20,54.80",
currency="GR",
item=113287,
quest=34145,
steps=[[
step
kill Frenzied Golem##77614 |q 34145 |future |goto Talador 46.20,54.80
]],
},
{
currency="AC",
...
steps=[[
step
_Enter_ Shattrath Commons |goto Talador/0 50.10,35.10 < 20
...
steps=[[
step
_Enter_ Shattrath Commons |goto Talador/0 50.00,35.20 < 20
_Go up_ the steps |goto Talador/0 47.50,36.40 < 15
_Enter_ the building |goto Talador/0 47.60,37.80 < 10
...
steps=[[
step
_Enter_ the building |goto Talador/0 46.90,27.50 < 15
_Go up_ the stairs |goto Talador/0 47.50,25.80 < 7
_Go to_ the balcony |goto Talador/0 47.80,25.70 < 10
...
steps=[[
step
_Enter_ Telmor |goto Talador/0 48.70,87.40
_Ride_ the elevator to the top |goto Talador/0 49.10,91.90
kill Lo'marg Jawcrusher##77784 |q 34208 |future |goto Talador/0 49.20,92.30
]],
},
{
currency="AC",
...
level=45,
spot="Talador 53.80,91.40",
currency="GR",
item=116110,
quest=34668,
steps=[[
step
_Go up_ the road |goto Talador/0 53.20,89.00
kill Talonpriest Zorkra##79485 |q 34668 |future |goto Talador 53.80,91.40
]],
},
{
...
steps=[[
step
_Go up_ the hill |goto Talador/0 58.20,85.50
...
steps=[[
step
_Enter_ the cave |goto Talador/0 60.00,57.70 < 20
...
steps=[[
step
_Go up_ the hill |goto Talador/0 62.20,22.90 < 20
_Enter_ the building |goto Talador/0 63.20,22.10 < 10
...
_Go up_ the right ramp |goto Talador/0 64.40,86.60 < 15
_Continue_ going down the side passage with spider eggs |goto Talador/0 66.40,87.90 < 15
...
steps=[[
step
_Go through_ the stone passage |goto Talador/0 68.40,80.90
...
rare=[[Steeltusk]],
level=45,
spot="Talador 67.80,35.50",
currency="GR",
item=117562,
quest=36858,
steps=[[
step
kill Steeltusk##86549 |q 36858 |future |goto Talador 67.80,35.50
]],
},
{
rare=[[Dr. Gloom]],
level=45,
spot="Talador 68.40,15.80",
currency="GR",
item=112499,
quest=34142,
steps=[[
step
_Go through_ the pass |goto Talador/0 67.50,17.00 < 20
kill Dr. Gloom##77561 |q 34142 |future |goto Talador/0 68.40,15.80
]],
},
{
rare=[[Wandering Vindicator]],
level=45,
spot="Talador 69.70,33.20",
currency="GR",
item=112261,
quest=34205,
steps=[[
...
click Hope##227859 |q 34205 |future |goto Talador/0 69.70,33.20
...
steps=[[
step
_Cross_ the field |goto Tanaan Jungle/0 53.70,44.20
_Jump across_ the rocks |goto Tanaan Jungle/0 53.30,41.50 < 8
...
level=45,
spot="Tanaan Jungle/0 23.80,51.90",
currency="AC",
item=120945,
quest=38262,
steps=[[
step
kill Bilkor the Thrower##90884 |q 38262 |goto Tanaan Jungle/0 23.80,51.90 |future
...
level=45,
spot="Tanaan Jungle/0 48.60,57.40",
currency="AC",
item=120945,
quest=38820,
steps=[[
step
kill Captain Grok'mar##93264 |q 38820 |goto Tanaan Jungle/0 48.60,57.40 |future
...
rare=[[Drakum]],
level=45,
spot="Tanaan Jungle/0 83.60,43.60",
access="Completionist",
item=108631,
quest=40105,
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 84.40,43.80 < 10 |walk
kill Drakum##98283 |q 40105 |goto Tanaan Jungle/0 83.60,43.60 |future
...
rare=[[Gondar]],
level=45,
spot="Tanaan Jungle/0 80.60,56.40",
access="Completionist",
item=108633,
quest=40107,
steps=[[
step
_Jump onto_ the temple grounds |goto Tanaan Jungle/0 75.60,55.40 < 10
_Go up_ the sets of stairs |goto 76.80,55.20 < 15
_Reach_ the top of the temple |goto 78.80,54.30 < 15
_Enter_ the building |goto Tanaan Jungle/0 80.70,56.30 < 10 |walk
kill Gondar##98284 |q 40106 |goto Tanaan Jungle/0 80.60,56.40 |future
|tip This rare will require a group to defeat.
]],
},
{
...
level=45,
spot="Tanaan Jungle 12.70,56.90",
currency="AC",
item=120945,
quest=38751,
steps=[[
step
Click the Strongpoint banner |goto Tanaan Jungle/0 12.60,56.90 < 5
|tip Successfully defending the Strongpoint will spawn the Iron Houndmaster.
kill The Iron Houndmaster##92977 |goto Tanaan Jungle 12.70,56.90 |q 38751 |future
]],
},
{
...
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 15.40,54.80 < 8
...
steps=[[
step
_Go up_ the hill |goto Tanaan Jungle/0 13.70,60.20 < 15
...
steps=[[
step
Click the Strongpoint banner |goto Tanaan Jungle/0 15.80,57.50 < 5
...
steps=[[
step
_Enter_ the building |goto Tanaan Jungle/0 16.40,58.70 < 8
...
level=45,
spot="Tanaan Jungle 17.00,48.70",
currency="AC",
item=120945,
quest=38282,
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 17.10,50.50 < 8
kill Podlord Wakkawam##91374 |q 38282 |goto Tanaan Jungle 17.00,48.70 |future
]],
},
{
currency="AC",
rare=[[Rasthe]],
level=45,
spot="Tanaan Jungle 17.30,42.90",
access="Completionist",
item=120945,
quest=38034,
steps=[[
step
_Proceed_ through the arch |goto Tanaan Jungle/0 18.20,41.10 < 8
kill Rasthe##90782 |q 38034 |goto Tanaan Jungle 17.30,42.90 |future
|tip This rare will require a group to defeat.
]],
},
{
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 21.00,52.80 < 8
click Grappling Hook and Rope##241659 |goto Tanaan Jungle/0 20.60,53.50 < 5
...
level=45,
spot="Tanaan Jungle 20.50,49.60",
currency="AC",
item=120945,
quest=38263,
steps=[[
step
_Enter_ the hut |goto Tanaan Jungle/0 20.60,50.00 < 6
kill Rogond the Tracker##90885 |q 38263 |goto Tanaan Jungle/0 20.50,49.60 |future
]],
},
{
currency="AC",
...
rare=[[Deathtalon]],
level=45,
spot="Tanaan Jungle 23.00,40.20",
access="Completionist",
item=120945,
quest=39287,
steps=[[
step
kill Deathtalon##95053 |q 39287 |goto Tanaan Jungle/0 23.00,40.20 |future
...
level=45,
spot="Tanaan Jungle 24.70,50.10",
currency="AC",
item=120945,
quest=38266,
steps=[[
step
kill Bloodhunter Zulk##90936 |q 38266 |goto Tanaan Jungle/0 24.70,50.10 |future
...
steps=[[
step
_Go up_ the road |goto Tanaan Jungle/0 23.80,47.40 < 20
...
steps=[[
step
_Enter_ the mine |goto Tanaan Jungle/0 29.30,70.90 < 8
_Go up_ the ramp on the right |goto Tanaan Jungle/0 26.20,74.80 < 10
_Continue around_ the tunnel |goto Tanaan Jungle/0 24.20,75.70 < 12
...
rare=[[Jax'zor]],
level=45,
spot="Tanaan Jungle 26.60,75.30",
currency="AC",
item=120945,
quest=38030,
steps=[[
step
_Enter_ the mine |goto Tanaan Jungle/0 29.30,70.90 < 8
kill Jax'zor##90437 |q 38030 |goto Tanaan Jungle 26.60,75.30 |future
...
_Go through_ the arch |goto Tanaan Jungle/0 23.80,36.90 < 8
_Go up_ the hill |goto Tanaan Jungle/0 25.60,34.10 < 12
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 30.90,53.10 < 10
...
steps=[[
step
_Go up_ the steps |goto Tanaan Jungle/0 30.50,68.60 < 10
...
steps=[[
step
_Enter_ the Temple of Sha'naar |goto Tanaan Jungle/0 28.70,67.10 < 8
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 31.40,36.40
...
steps=[[
step
_Enter_ Ironmonger's Hold |goto Tanaan Jungle/0 32.40,48.90 < 12
_Go to_ the end of the hallway |goto Tanaan Jungle/0 34.80,47.20 < 12
_Continue along_ the left passage |goto Tanaan Jungle/0 34.50,45.50 < 12
_Drop down_ the hole |goto Tanaan Jungle/0 35.00,44.50 < 5
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 36.10,72.50 < 8
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 37.30,75.90 < 10
_Go into_ the big cavern |goto Tanaan Jungle/0 35.40,76.30 < 12
_Swim across_ the pool |goto Tanaan Jungle/0 34.40,79.60
_Follow_ the ledge |goto Tanaan Jungle/0 34.90,78.80 < 8
_Jump across_ the rocks |goto Tanaan Jungle/0 35.10,78.10
...
step
_Enter_ the cave |goto Tanaan Jungle/0 37.30,75.90 < 10
_Go down_ the left passage |goto Tanaan Jungle/0 36.90,77.80 < 10
...
steps=[[
step
_Go up_ the ramp |goto Tanaan Jungle/0 37.70,35.20
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 42.30,68.90 < 10
_Go through_ the side passage |goto Tanaan Jungle/0 40.50,69.30 < 8
...
_Enter_ the building |goto Tanaan Jungle/0 43.90,37.00 < 8
...
steps=[[
step
_Cross_ the fel water here |goto Tanaan Jungle/0 51.70,32.50 < 12
_Continue_ along the path |goto Tanaan Jungle/0 49.00,33.00 < 12
_Enter_ the Blighted Hollow |goto Tanaan Jungle/0 48.10,32.70 < 10
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 49.80,74.30 < 10
...
steps=[[
step
_Go up_ the hill |goto Tanaan Jungle/0 47.50,38.80
_Cross_ the bridge |goto Tanaan Jungle/0 48.60,36.60 < 10
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 44.70,77.60
_Proceed into_ the cavern |goto Tanaan Jungle/0 46.80,76.30 < 12
_Go up_ the ramp |goto Tanaan Jungle/0 48.80,77.90 < 12
_Continue around_ the path |goto Tanaan Jungle/0 51.10,77.40 < 15
...
level=45,
spot="Tanaan Jungle 52.00,83.90",
access="Completionist",
item=120945,
quest=38605,
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 51.50,79.80 < 12
kill Krell the Serene##92517 |q 38605 |goto Tanaan Jungle 52.00,83.90 |future
|tip This rare will require a group to defeat.
]],
},
{
...
steps=[[
step
_Go up_ the path |goto Tanaan Jungle/0 55.20,22.60
...
steps=[[
step
_Follow_ the path |goto Tanaan Jungle/0 55.60,65.60 < 15
kill Broodlord Ixkor##92429 |q 38589 |goto Tanaan Jungle/0 57.80,67.30 |future
]],
},
{
currency="AC",
...
steps=[[
step
_Follow_ the shore |goto Tanaan Jungle/0 59.40,74.70 < 12
kill Soulslicer##92495 |q 38600 |goto Tanaan Jungle/0 62.70,72.20 |future
|tip This rare will require a group to defeat.
]],
},
{
...
steps=[[
step
_Enter_ the cave |goto Tanaan Jungle/0 62.60,80.10 < 10
...
steps=[[
step
_Go up_ the hill |goto Tanaan Jungle/0 64.00,37.40
