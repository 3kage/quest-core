...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Halls of Atonement",{
mapid=1663,
achieveid={14370},
patch='90001',
...
step
kill Echelon##156827 |goto Halls of Atonement/0 26.51,54.23
_EVERYONE:_ |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Mists of Tirna Scithe",{
mapid=1669,
achieveid={14371},
patch='90001',
condition_suggested=function() return level >= 50 and level <= 60 end,
...
|popuptext youtu.be/ONT9DWfE6WI
...
Click Here to Continue |confirm
step
kill Mistcaller##170217 |goto Mists of Tirna Scithe/0 47.37,48.78
_EVERYONE:_ |grouprole EVERYONE
...
Click Here to Continue |confirm
step
kill Tred'ova##164517 |goto Mists of Tirna Scithe/0 15.11,74.45
_EVERYONE:_ |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\The Necrotic Wake",{
mapid=1666,
achieveid={14366},
patch='90001',
condition_suggested=function() return level >= 50 and level <= 60 end,
...
Click Here to Continue |confirm
step
kill Amarth##163157 |goto The Necrotic Wake/0 20.47,40.53
_EVERYONE:_ |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Plaguefall",{
mapid=1674,
achieveid={14369},
patch='90001',
condition_suggested=function() return level >= 50 and level <= 60 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\De Other Side",{
mapid=1680,
achieveid={14373},
patch='90001',
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Sanguine Depths",{
mapid=1675,
achieveid={14197},
patch='90001',
condition_suggested=function() return level == 60 end,
...
Click Here to Continue |confirm
step
kill Executor Tarvold##162103 |goto Sanguine Depths/1 47.76,86.04
_EVERYONE:_ |grouprole EVERYONE
...
Click Here to Continue |confirm
step
kill General Kaal##165318 |goto Sanguine Depths/0 15.78,17.38
_EVERYONE:_ |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Spires of Ascension",{
mapid=1692,
achieveid={14326},
patch='90001',
condition_suggested=function() return level == 60 end,
...
Click Here to Continue |confirm
step
kill Ventunax##162058 |goto Spires of Ascension/1 63.70,44.89
_EVERYONE:_ |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Tazavesh, the Veiled Market Attunement",{
...
accept Insider Trading##63977 |goto Oribos/2 56.67,31.83 |notravel
accept Things Best Kept Dark##63979 |goto Oribos/2 56.67,31.83 |notravel
step
Follow the path |goto Oribos/0 63.57,50.26 < 20 |walk
talk Overseer Ta'readon##156768
Select _"What can you tell me about Cartel So?"_
Speak to Cartel Ta |q 63977/4 |goto Oribos/0 64.39,68.34 |notravel
step
talk Emissary Ba'silk##164100
Select _"What can you tell me about Cartel So?"_
Speak to Cartel Ba |q 63977/1 |goto Oribos/0 47.73,72.63
step
talk Zo'sorg##168011
Select _"What can you tell me about Cartel So?"_
Speak to Cartel Zo |q 63977/2 |goto Oribos/0 34.46,57.46
step
talk Foreman Au'brak##167738
Select _"What can you tell me about Cartel So?"_
Speak to Cartel Au |q 63977/3 |goto Oribos/0 40.33,32.64
step
Follow the path |goto Oribos/0 52.15,25.06 < 20 |only if walking
...
collect Cartel So Shipping Manifest##186182 |q 63979/1 |goto Oribos/0 38.48,25.30
step
Enter the building |goto Oribos/0 73.47,50.21 < 20 |only if walking
talk Al'dalil##178908
turnin Insider Trading##63977 |goto Oribos/2 56.67,31.83 |notravel
turnin Things Best Kept Dark##63979 |goto Oribos/2 56.67,31.83
accept Seeking Smugglers##63980 |goto Oribos/2 56.67,31.83
step
...
accept Above My Station##63982 |goto Revendreth/0 51.34,82.71
step
...
step
Enter the building |goto Bastion/0 36.94,31.61 < 20 |walk
Find the Export Party |q 63983/1 |goto Bastion/0 37.11,30.93
step
kill Prototype Aquilon##178937 |q 63983/2 |goto Bastion/0 37.37,29.96
|tip Inside the building.
step
clicknpc Prototype Aquilon##178938
|tip Inside the building.
Mount the Prototype Aquilon |invehicle |goto Bastion/0 37.36,30.01 |q 63983
step
Watch the dialogue
...
step
talk Bounty Hunter Ta'oku##158890
turnin Dead Drop##63983 |goto Bastion/0 32.52,32.35
accept Coins for the Ferryman##63984 |goto Bastion/0 32.52,32.35
step
talk Ta'meri##178792
turnin Coins for the Ferryman##63984 |goto Oribos/0 29.86,66.60
accept The Veiled Market##63985 |goto Oribos/0 29.86,66.60
step
talk Ta'meri##178792
Select _"Take me to Tazavesh."_
Jump in the Barge |invehicle |goto Oribos/0 29.86,66.60 |q 63985
step
Watch the dialogue
Take the Barge to Tazavesh |outvehicle |q 63985
step
talk Zo'mezal##179144
Select _"I seek entrance into Tazavesh."_
Watch the dialogue
Speak to the Bouncer |q 63985/2 |goto The Gilded Landing/0 84.11,47.29
step
talk Al'dalil##178908
turnin The Veiled Market##63985 |goto The Gilded Landing/0 86.68,48.46
accept Tazavesh: Raiders of the Lost Artifact##63986 |goto The Gilded Landing/0 86.68,48.46
step
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Dungeons\\Theater of Pain",{
mapid=1683,
achieveid={14372},
patch='90001',
condition_suggested=function() return level == 60 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Raids\\Castle Nathria",{
mapid=1735,
achieveid={14715},
patch='90001',
condition_suggested=function() return level == 60 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Raids\\Sanctum of Domination",{
mapid=1998,
achieveid={15126},
patch='90100',
condition_suggested=function() return level >= 60 end,
...
Click Here to Continue |confirm |goto Sanctum of Domination/0 68.62,35.01
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/1 46.80,94.05
step
kill The Nine
_EVERYONE:_ |grouprole EVERYONE
...
Click Here to Continue |confirm |goto Sanctum of Domination/1 41.89,18.90
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/2 88.64,35.51
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/2 53.49,71.74
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/2 66.16,29.59
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/3 63.77,15.49
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/3 57.44,70.55
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/3 29.34,52.44
step
...
Click Here to Continue |confirm |goto Sanctum of Domination/4 51.70,53.08
]])
QuestCore:RegisterGuide("Dungeon Guides\\Shadowlands Raids\\Sepulcher of the First Ones",{
patch='90200',
condition_suggested=function() return level >= 60 end,
keywords={"Shadowlands"},
description="To complete this raid, you will need to kill the following bosses:\n\nVigilant Guardian\n"..
