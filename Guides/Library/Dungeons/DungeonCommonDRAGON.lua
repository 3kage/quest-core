...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Uldaman: Legacy of Tyr",{
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Ruby Life Pools",{
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\The Nokhud Offensive",{
description="To complete this dungeon, you will need to kill the following bosses:\n\nGranyth\n"..
"The Raging Tempest\nTeera and Maruuk\nBalakar Khan",
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Brackenhide Hollow",{
description="To complete this dungeon, you will need to kill the following bosses:\n\nHackclaw's War-Band\n"..
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Halls of Infusion",{
description="To complete this dungeon, you will need to kill the following bosses:\n\nWatcher Irideus\n"..
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Algeth'ar Academy",{
description="To complete this dungeon, you will need to kill the following bosses:\n\nVexamus\n"..
"Overgrown Ancient\nCrawth\nEcho of Doragosa",
...
_EVERYONE:_ |grouprole EVERYONE
|tip Vexamus casts "Mana Bombs" at up to 3 random players, exploding after 2.50 seconds, dealing moderate damage. |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Neltharus",{
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\The Azure Vault",{
description="To complete this dungeon, you will need to kill the following bosses:\n\nLeymor\n"..
"Azureblade\nTelash Greywing\nUmbrelskul",
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Raids\\Vault of the Incarnates",{
...
|tip "Elemental Surge" dealing moderate damage every 0.50 seconds when not be an altar. |grouprole TANK
...
|tip Additionally, he will gain "Elemental Surge" dealing moderate damage every 0.50 seconds. |grouprole EVERYONE
Click Here to Continue |confirm
step
kill Broodkeeper Diurna##190245 |goto Vault of the Incarnates/4 50.97,52.01
_EVERYONE:_ |grouprole EVERYONE
|tip "Greatstaff of the Broodkeeper" deals moderate damage to players within 50 yards every 1.50 seconds for 12. |grouprole EVERYONE
...
|tip She will also be protected by "Ruinous Shoroud", damaging the Vault 1% every 1.50 seconds.
_DAMAGE:_ |grouprole DAMAGE
_HEALER:_ |grouprole HEALER
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Raids\\Aberrus, The Shadowed Crucible",{
mapid=2166,
achieveid={18160},
patch='90200',
condition_suggested=function() return level >= 70 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Dawn of the Infinite Intro Questline",{
...
turnin Dawn of the Infinite##76140 |goto Thaldraszus/0 52.29,79.47
accept Align in the Sand##76141 |goto Thaldraszus/0 52.29,79.47
accept On Borrowed Time##76142 |goto Thaldraszus/0 52.29,79.47
stickystart "Collect_20_Time_Lost_Essence"
step
click Temporal Hourglass
|tip Under the bridge.
Place the Western Hourglass |q 76141/2 |goto Thaldraszus/0 56.37,83.23
step
click Temporal Hourglass
Place the Eastern Hourglass |q 76141/1 |goto Thaldraszus/0 57.98,85.97
step
click Temporal Hourglass
|tip Under the bridge.
Place the Northern Hourglass |q 76141/3 |goto Thaldraszus/0 59.43,78.89
step
...
collect 20 Time-Lost Essence##206269 |q 76142/1 |goto Thaldraszus/0 57.21,81.32
step
Watch the dialogue
talk Chromie##205707
turnin Align in the Sand##76141 |goto Thaldraszus/0 61.45,79.70
turnin On Borrowed Time##76142 |goto Thaldraszus/0 61.45,79.70
accept Chro-me?##76143 |goto Thaldraszus/0 61.45,79.70
step
...
Investigate the Alternate Chromie |q 76143/1 |count 1 |goto Thaldraszus/0 59.22,81.97
step
clicknpc Chromrgl##206053
|tip Running between two portals at this area.
use the Time Trap##206369
|tip Drop the trap here and wait for Chromrgl to run over it.
Investigate the Alternate Chromie |q 76143/1 |count 2 |goto Thaldraszus/0 58.19,86.03
step
clicknpc Growmie##206054
|tip Running between two portals at this area.
use the Time Trap##206369
|tip Drop the trap here and wait for Growmie to run over it.
Investigate the Alternate Chromie |q 76143/1 |count 3 |goto Thaldraszus/0 56.74,81.72
step
clicknpc Chromew##206055
|tip Running between two portals at this area.
use the Time Trap##206369
|tip Drop the trap here and wait for Chromew to run over it.
Investigate the Alternate Chromie |q 76143/1 |goto Thaldraszus/0 59.51,77.94
step
talk Chromie##205707
turnin Chro-me?##76143 |goto Thaldraszus/0 61.45,79.71
accept Morchie Mayhem##76144 |goto Thaldraszus/0 61.45,79.71
step
click Temporal Hourglass
Inspect the Hourglass |q 76144/1 |goto Thaldraszus/0 61.41,79.70
step
Enter the building |goto Thaldraszus/0 61.77,81.25 < 15
Confront Morchie |q 76144/2 |goto Thaldraszus/0 61.84,81.32
...
talk Chromie##206149
|tip Inside the building.
turnin Morchie Mayhem##76144 |goto Thaldraszus/0 62.05,81.53
accept Who's That Chromie?##76145 |goto Thaldraszus/0 62.05,81.53
step
Find Morchie |q 76145/1 |goto Thaldraszus/0 61.35,76.80
step
talk Chro-normie##205739
Select _"You're actually Morchie in disguise!"_
Accuse the Real Morchie |q 76145/2 |goto Thaldraszus/0 61.35,76.80
step
talk Chromie##205710
turnin Who's That Chromie?##76145 |goto Thaldraszus/0 61.29,83.28
accept Dawn of the Infinite: Chrono-Lord Deios##76146 |goto Thaldraszus/0 61.29,83.28
step
...
step
talk Chromie##205710
turnin Dawn of the Infinite: Chrono-Lord Deios##76146 |goto Dawn of the Infinite/4 61.29,83.28
]])
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Dungeons\\Dawn of the Infinite",{
description="To complete this dungeon, you will need to kill the following bosses:\n\nChronikar\n"..
...
kill Grommash Hellscream##209207 |goto Dawn of the Infinite/7 50.26,54.34 |only if Horde
_EVERYONE:_ |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Old Scholomance Unlock",{
...
Select _"What is written in your journal?"_
Speak with Eva Sarkhoff |q 76248 |goto Scholomance/3 54.21,75.04 |future
step
...
collect Eva's Femur##206364 |goto Scholomance/3 53.71,75.73 |q 76249 |future
step
...
collect The Road Ahead##206363 |goto Eastern Plaguelands/0 55.00,64.03 |q 76249 |future
step
...
step
Equip the Spectral Essence |equipped Spectral Essence##13544 |goto Western Plaguelands/0 63.40,75.42 |q 76249 |future
step
talk Rory##11285
buy Tobacco-Filled Candle##206355 |goto Western Plaguelands/0 63.34,75.62 |q 76249 |future
step
talk Artist Renfray##11936
|tip Inside the building.
buy Imported Candle##206358 |goto Western Plaguelands/0 65.78,75.36 |q 76249 |future
step
click Bucket of Fountain Water##403532
collect Caer Darrow Fountain Water##206359 |goto Western Plaguelands/0 68.90,78.82 |q 76249 |future
step
talk Sammy##11283
|tip She runs around the fountain.
buy Ghost-Warding Candle##206356 |goto Western Plaguelands/0 69.14,78.67 |q 76249 |future
step
talk Joseph Dirte##11316
buy Stinky Candle##206354 |goto Western Plaguelands/0 67.98,74.77 |q 76249 |future
step
talk Magistrate Marduke##11286
buy Authentic Andorhal Candle##206357 |goto Western Plaguelands/0 70.54,73.98 |q 76249 |future
step
...
Perform the Ritual |q 76249 |future |goto Western Plaguelands/0 69.76,71.77
]])
QuestCore:RegisterGuide("Dungeon Guides\\Dragonflight Raids\\Amirdrassil, The Dream's Hope",{
mapid=2166,
achieveid={18160},
patch='100200',
condition_suggested=function() return level >= 70 end,
