...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Atal'Dazar",{
mapid=934,
achieveid={12824},
patch='80001',
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Freehold",{
mapid=936,
achieveid={12831},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Kings' Rest",{
mapid=1004,
achieveid={12848},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\The MOTHERLODE!!",{
mapid=1010,
achieveid={12844},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Operation: Mechagon",{
mapid=1490,
...
|tip
Click Here to Continue |confirm |goto Mechagon/3 58.00,27.01
step
...
|tip
Click Here to Continue |confirm |goto Mechagon/3 60.83,39.73
step
kill Gunker##150222
_EVERYONE:_ |grouprole EVERYONE
...
|tip
Click Here to Continue |confirm |goto Mechagon/3 66.48,64.92
step
...
|tip
Click Here to Continue |confirm |goto Mechagon/3 56.43,59.27
step
...
|tip
Click Here to Continue |confirm |goto Mechagon/0 21.28,64.61
step
_Congratulations!_
You Completed the "Operation: Mechagon" Dungeon.
]])
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Shrine of the Storm",{
mapid=1039,
achieveid={12835},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Siege of Boralus",{
mapid=1162,
achieveid={12847},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Temple of Sethraliss",{
mapid=1038,
achieveid={12504},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Tol Dagor",{
mapid=974,
achieveid={12840},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\The Underrot",{
mapid=1041,
achieveid={12500},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Dungeons\\Waycrest Manor",{
mapid=1015,
achieveid={12483},
patch='80001',
condition_suggested=function() return level>=47 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Uldir - Halls of Containment",{
mapid=1148,
achieveid={12521},
patch='80001',
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Uldir - Crimson Descent",{
mapid=1148,
achieveid={12522},
patch='80001',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Uldir - Heart of Corruption",{
mapid=1148,
achieveid={12523},
patch='80001',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Battle of Dazar'alor - Defense of Dazar'alor",{
mapid=1352,
lfgid=1948,
achieveid={12523},
patch='80001',
...
|confirm |goto Battle of Dazar'alor/5 41.61,63.63
step
...
|confirm |goto Battle of Dazar'alor/5 48.78,66.21
step
_Congratulations!_
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Battle of Dazar'alor - Death's Bargain",{
mapid=1352,
lfgid=1949,
achieveid={12523},
patch='80001',
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Battle of Dazar'alor - Victory or Death",{
mapid=1352,
lfgid=1950,
achieveid={12523},
patch='80001',
...
|confirm |goto Battle of Dazar'alor/0 49.29,91.20
step
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Crucible of Storms",{
mapid=1363,
achieveid={13414},
patch='80100',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\The Eternal Palace - The Grand Reception",{
mapid=1528,
achieveid={13718},
patch='80200',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\The Eternal Palace - Depths of the Devoted",{
mapid=1528,
achieveid={13719},
patch='80200',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
kill Pashmar the Fanatical##152852 |goto The Eternal Palace/2 33.52,47.49
Damage: |grouprole DAMAGE
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\The Eternal Palace - The Circle of Stars",{
mapid=1528,
achieveid={13725},
patch='80200',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Ny'alotha, the Waking City - Vision of Destiny",{
mapid=1580,
achieveid={14193},
patch='80300',
condition_suggested=function() return level == 50 end,
...
|confirm
step
kill Maut##156523 |goto Ny'alotha, the Waking City/9 19.24,60.61
Everyone: |grouprole EVERYONE
...
|confirm
step
kill The Prophet Skitra##161901 |goto Ny'alotha, the Waking City/9 83.59,61.08
Everyone: |grouprole EVERYONE
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Ny'alotha, the Waking City - Halls of Devotion",{
mapid=1580,
achieveid={14194},
patch='80300',
condition_suggested=function() return level == 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Ny'alotha, the Waking City - Gift of Flesh",{
mapid=1580,
achieveid={14195},
patch='80300',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
QuestCore:RegisterGuide("Dungeon Guides\\Battle for Azeroth Raids\\Ny'alotha, the Waking City - The Waking Dream",{
mapid=1580,
achieveid={14196},
patch='80300',
condition_suggested=function() return level >= 50 and level <= 50 end,
...
|confirm
step
kill N'Zoth the Corruptor##158041 |goto Ny'alotha, the Waking City/3 47.80,25.29
Everyone: |grouprole EVERYONE
