...
|only if not QC.guidesets['AchievementsHMoP']
step
...
|only if QC.guidesets['AchievementsHMoP']
step
...
Click here to go to the Reputations guide to gain reputation with _The Tillers_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Tillers" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to gain reputation with _The Tillers_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Tillers Dailies" |only if QC.guidesets['DailiesHMOP']
...
step
label "route2"
Routing to proper section |next "clickroute" |only if QC.guidesets['ReputationsHMOP'] or QC.guidesets['DailiesHMOP']
Routing to proper section |next "done" |only if default
step
label "clickroute"
Click here to be taken to the Reputation guide to help you become _Exalted_ with _The Tillers_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Tillers Dailies" |only if QC.guidesets['DailiesHMOP']
Click here to be taken to the Dailies guide to help you become _Exalted_ with _The Tillers_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Tillers" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
|confirm |next |only if default
step
label "done"
...
Click here to go to the Reputations guide to gain reputation with _The Klaxxi_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Klaxxi" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to gain reputation with _The Klaxxi_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Klaxxi Dailies" |only if QC.guidesets['DailiesHMOP']
|confirm |next |only if default
...
Click here to go to the Reputations guide to gain reputation with _The Shado-Pan_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\Shado-Pan Assault" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to gain reputation with _The Shado-Pan_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Shado-Pan Dailies" |only if QC.guidesets['DailiesHMOP']
|confirm |next |only if default
...
Click here to go to the Reputations guide to gain reputation with _The Golden Lotus_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Golden Lotus" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to gain reputation with _The Golden Lotus_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Golden Lotus Dailies" |only if QC.guidesets['DailiesHMOP']
|confirm |next |only if default
...
Click here to go to the Reputations guide to gain reputation with _The August Celestials_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The August Celestials" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to gain reputation with _The August Celestials_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The August Celestials Dailies" |only if QC.guidesets['DailiesHMOP']
|confirm |next |only if default
step
label "tiger"
...
Click here to go to the Reputations guide to work toward this achievement with _The Shado-Pan_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\Shado-Pan Assault" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to work toward this achievement with _The Shado-Pan_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Shado-Pan Dailies" |only if QC.guidesets['DailiesHMOP']
...
Click here to go to the Reputations guide to gain reputation with _The Order of the Cloud Serpent_. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Order of the Cloud Serpent" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to gain reputation with _The Order of the Cloud Serpent_. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Order of the Cloud Serpent Dailies" |only if QC.guidesets['DailiesHMOP']
|confirm |next |only if default
...
Go to the Isle of Thunder and complete any dailies you can do today. For more information, please refer to QuestCore's Dailies or QuestCore's Reputations guides. |only if not QC.guidesets.DailiesHMOP
Click here to complete Sunreaver Onslaught dailies to help your realm move into the next stage. |next "Daily Guides\\Mists of Pandaria Dailies\\Sunreaver Onslaught Dailies" |confirm |only if QC.guidesets.DailiesHMOP
...
confirm |next |only if rep("Order of the Cloud Serpent")<Revered and not QC.guidesets['ReputationsHMOP']
confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\The Order of the Cloud Serpent" |only if rep("Order of the Cloud Serpent")<Revered and QC.guidesets['ReputationsHMOP']
|only if rep("Order of the Cloud Serpent")<Revered
step
...
Click here to go to the Reputations guide to attempt this achievement. |confirm |next "Reputation Guides\\Mists of Pandaria Reputations\\Shado-Pan Assault" |only if QC.guidesets['ReputationsHMOP'] and not QC.guidesets['DailiesHMOP']
Click here to go to the Dailies guide to attempt this achievement. |confirm |next "Daily Guides\\Mists of Pandaria Dailies\\The Shado-Pan Dailies" |only if QC.guidesets['DailiesHMOP']
|achieve 7307
step
...
Click here to be taken to the Dread Wastes leveling guide to work on this achievement. |confirm |next "Leveling Guides\\Pandaria (10-70)\\Dread Wastes (30-70)" |only if QC.guidesets['LevelingAMOP']
|confirm
...
QuestCore:RegisterGuide("Achievement Guides\\Reputation\\Mists of Pandaria\\Dominance Offensive",{
achieveid={8206},
patch='50200',
...
QuestCore:RegisterGuide("Achievement Guides\\Reputation\\Mists of Pandaria\\Sunreaver Onslaught",{
achieveid={8209},
patch='50200',
