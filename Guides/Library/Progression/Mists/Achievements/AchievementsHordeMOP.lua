...
Go to the Isle of Thunder and complete any dailies you can do today. For more information, please refer to QuestCore Dailies or QuestCore Reputations guides. |only if not QC.guidesets.DailiesHMOP
...
Click here to be taken to the Dread Wastes leveling guide to work on this achievement. |confirm |next "Leveling Guides\\Pandaria (85-90)\\Dread Wastes (89-90)" |only if QC.guidesets['LevelingAMOP']
|confirm
