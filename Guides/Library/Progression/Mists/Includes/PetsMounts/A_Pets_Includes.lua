...
QuestCore:RegisterInclude("Alliance_Battlepet_Quests",[[
	...
	step
		...
		Win a Pet Battle |q 31591/1 |goto 70.10,23.40
	...
	step
		...
		Heal your Battle Pets |q 31592/1 |goto 67.30,37.70
	step
		talk Audrey Burnhep##63596
	...
	step
		clicknpc Rabbit##61080
		|tip It could also be a Squirrel.
		Raise a Battle Pet to level 3 |q 31821/1 |goto 70.10,23.40
...
QuestCore:RegisterInclude("Alliance_Battlepet_Dailies",[[
	...
	label "ekpets"
		talk Julia Stevens##64330
		accept Julia Stevens##31693 |goto Elwynn Forest 41.60,83.70
	...
	step
		...
		Defeat Julia Stevens |q 31693/1 |goto Elwynn Forest 41.60,83.70
		only if completedq(31915)
	step
		talk Julia Stevens##64330
		turnin Julia Stevens##31693 |goto Elwynn Forest 41.60,83.70
		only if completedq(31915)
	step
		talk Old MacDonald##65648
		accept Old MacDonald##31780 |goto Westfall 60.90,18.60
		only if completedq(31915)
	step
		talk Old MacDonald##65648
		...
		Defeat Old MacDonald |q 31780/1 |goto Westfall 60.90,18.60
		only if completedq(31915)
	step
		talk Old MacDonald##65648
		turnin Old MacDonald##31780 |goto Westfall 60.90,18.60
		only if completedq(31915)
	step
		talk Eric Davidson##65655
		accept Eric Davidson##31850 |goto Duskwood 19.90,44.70
		only if completedq(31915)
	step
		talk Eric Davidson##65655
		...
		Defeat Eric Davidson |q 31850/1 |goto Duskwood 19.90,44.70
		only if completedq(31915)
	step
		talk Eric Davidson##65655
		turnin Eric Davidson##31850 |goto Duskwood 19.90,44.70
		only if completedq(31915)
	step
		talk Steven Lisbane##63194
		accept Steven Lisbane##31852 |goto Northern Stranglethorn 46.00,40.30
		only if completedq(31915)
	step
		talk Steven Lisbane##63194
		...
		Defeat Steven Lisbane |q 31852/1 |goto Northern Stranglethorn 46.00,40.30
		only if completedq(31915)
	step
		talk Steven Lisbane##63194
		turnin Steven Lisbane##31852 |goto Northern Stranglethorn 46.00,40.30
		only if completedq(31915)
	step
		talk Bill Buckler##65656
		accept Bill Buckler##31851 |goto The Cape of Stranglethorn 51.40,73.30
		only if completedq(31915)
	step
		talk Bill Buckler##65656
		...
		Defeat Bill Buckler |q 31851/1 |goto The Cape of Stranglethorn 51.40,73.30
		only if completedq(31915)
	step
		talk Bill Buckler##65656
		turnin Bill Buckler##31851 |goto The Cape of Stranglethorn 51.40,73.30
		only if completedq(31915)
	step
		talk Lydia Accoste##66522
	...
	step
		talk Lydia Accoste##66522
		turnin Grand Master Lydia Accoste##31916 |goto 40.10,76.40
		only if completedq(31915)
	step
		talk Everessa##66518
	...
	step
		...
		Defeat Everessa |q 31913/1 |goto Swamp of Sorrows 76.80,41.50
		only if completedq(31915)
	step
		talk Everessa##66518
	...
	step
		talk Lindsay##65651
		accept Lindsay##31781 |goto Redridge Mountains 33.20,52.60
		only if completedq(31915)
	step
		talk Lindsay##65651
		...
		Defeat Lindsay |q 31781/1 |goto Redridge Mountains 33.20,52.60
		only if completedq(31915)
	step
		talk Lindsay##65651
		turnin Lindsay##31781 |goto Redridge Mountains 33.20,52.60
		only if completedq(31915)
	step
		talk Durin Darkhammer##66520
	...
	step
		...
		Defeat Durin Darkhammer |q 31914/1 |goto Burning Steppes 25.50,47.40
		only if completedq(31915)
	step
		talk Durin Darkhammer##66520
	...
	step
		...
		Defeat Kortas Darkhammer |q 31912/1 |goto Searing Gorge 35.30,27.80
		only if completedq(31915)
	step
		talk Kortas Darkhammer##66515
	...
	step
		...
		Defeat David Kosse |q 31910/1 |goto The Hinterlands 63.00,54.60
		only if completedq(31915)
	step
		talk David Kosse##66478
	...
	step
		...
		Defeat Deiza Plaguehorn |q 31911/1 |goto Eastern Plaguelands 67.00,52.40
		only if completedq(31915)
	step
		talk Deiza Plaguehorn##66512
...
QuestCore:RegisterInclude("A_Beasts_of_Fable",[[
