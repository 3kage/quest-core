...
QuestCore:RegisterGuide("GOLD\\Farming\\Clefthoof Meat",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Ravager Flesh",{
expansion="tbc",
...
'|goto Hellfire Peninsula/0 42.22,83.00 < 25 |c |noway |next "Start_Farming_Ravager_Flesh" |or
step
...
QuestCore:RegisterGuide("GOLD\\Farming\\Bat Flesh, Crunchy Spider Leg",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Bear Flank",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Buzzard Meat",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Chunk o' Basilisk",{
expansion="tbc",
...
'|goto Zangarmarsh/0 88.03,36.74 < 30 |c |noway |or
step
map Zangarmarsh/0
path follow smart; loop off; ants curved; dist 30
...
|goldtracker
Click Here to Sell Chunks o' Basilisk |confirm |next "Sell_Chunk_o_Basilisk"
'|goto Zangarmarsh/0 74.34,28.90 < 30 |c |noway |next "Start_Farming_Chunk_o_Basilisk" |or
step
...
QuestCore:RegisterGuide("GOLD\\Farming\\Netherweave Cloth, Jaggal Clam Meat, Jaggal Pearl, Fish Oil, Shiny Fish Scales, Unidentified Plant Parts",{
expansion="tbc",
meta={goldtype="route",levelreq={62}},
...
QuestCore:RegisterGuide("GOLD\\Farming\\Raptor Ribs",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Serpent Flesh",{
expansion="tbc",
meta={goldtype="route",levelreq={64}},
items={{31671,46}},
maps={"Blade's Edge Mountains"},
...
QuestCore:RegisterGuide("GOLD\\Farming\\Talbuk Venison",{
expansion="tbc",
meta={goldtype="route",levelreq={63}},
items={{27682,141}},
maps={"Nagrand"},
...
QuestCore:RegisterGuide("GOLD\\Farming\\Warped Flesh",{
expansion="tbc",
meta={goldtype="route",levelreq={62}},
items={{27681,104}},
...
QuestCore:RegisterGuide("GOLD\\Farming\\Strange Spores, Fertile Spores, Unidentified Plant Parts",{
expansion="tbc",
meta={goldtype="route",levelreq={62}},
...
QuestCore:RegisterGuide("GOLD\\Farming\\Moongraze Stag Tenderloin",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Lynx Meat",{
expansion="tbc",
meta={goldtype="route",levelreq={4}},
items={{27668,164}},
maps={"Eversong Woods"},
...
QuestCore:RegisterGuide("GOLD\\Farming\\Sunfury Signet, Arcane Tome, Netherweave Cloth",{
expansion="tbc",
...
QuestCore:RegisterGuide("GOLD\\Farming\\Mark of Kil'jaeden, Fel Armament, Netherweave Cloth, Mote of Shadow",{
expansion="tbc",
meta={goldtype="route",levelreq={70}},
