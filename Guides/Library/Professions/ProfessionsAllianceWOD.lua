...
QuestCore:RegisterGuide("Profession Guides\\Alchemy\\Leveling Guides\\Draenor Alchemy 1-100",{
...
step
talk Katherine Joplin##87048
buy 1 Recipe: Draenic Armor Potion##112041 |goto Stormshield/0 36.71,68.58
...
step
talk Katherine Joplin##87048
buy 100 Crystal Vial##3371 |goto Stormshield/0 36.71,68.58
|only if skill("Draenor Alchemy") < 2
step
...
step
talk Katherine Joplin##87048
buy 1 Recipe: Draenic Agility Flask##112024 |goto Stormshield/0 36.71,68.58
|only if skill("Draenor Alchemy") < 100
step
...
QuestCore:RegisterGuide("Profession Guides\\Archaeology\\Leveling Guides\\Archaeology 600-700",{
...
step
talk Manda Darlowe##85927 |only if not QC.InPhase('BFA')
talk Jane Hudson##136106 |only if QC.InPhase('BFA')
|tip Inside the building. |only if QC.InPhase('BFA')
Train Draenor Archaeology |skillmax Archaeology,700 |goto Stormshield/0 49.03,33.18 |only if not QC.InPhase('BFA')
Train Draenor Archaeology |skillmax Archaeology,700 |goto Boralus/0 68.34,8.47 |only if QC.InPhase('BFA')
step
...
QuestCore:RegisterGuide("Profession Guides\\Blacksmithing\\Leveling Guides\\Draenor Blacksmithing 1-100",{
...
collect 1 Secrets of Draenor Blacksmithing##118720 |goto Stormshield/0 49.99,47.98
|only if skill("Draenor Blacksmithing") < 100
step
talk Royce Bigbeard##87062
buy 1 Recipe: Truesteel Grinder##116734 |goto Stormshield/0 48.95,48.73
|only if skill("Draenor Blacksmithing") < 100
step
...
Reach Level 100 Draenor Blacksmithing |skill Draenor Blacksmithing,100 |goto Stormshield/0 49.99,47.98
]])
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Leveling Guides\\Draenor Cooking 1-100",{
...
Train Draenor Cooking |skillmax Draenor Cooking,100 |goto Stormshield/0 35.14,76.16
...
QuestCore:RegisterGuide("Profession Guides\\Enchanting\\Leveling Guides\\Draenor Enchanting 1-100",{
...
QuestCore:RegisterGuide("Profession Guides\\Engineering\\Leveling Guides\\Draenor Engineering 1-100",{
...
collect 8 Gearspring Parts##111366 |goto Stormshield/0 74.64,37.62
|only if skill("Draenor Engineering") < 100
step
Open Your Engineering Crafting Panel:
...
step
talk Sean Catchpole##87065
buy 1 Schematic: Didi's Delicate Assembly##118493 |goto Stormshield/0 47.84,39.93
|only if skill("Draenor Engineering") < 100
step
...
QuestCore:RegisterGuide("Profession Guides\\Fishing\\Leveling Guides\\Draenor Fishing 1-100",{
...
step
_Go through_ the doorway |goto Lunarfall/0 59.40,41.30 < 10 |only if walking
talk Ron Ashton##77733
accept Looking For Help##34194 |goto Lunarfall/0 54.40,14.30
step
_Go through_ the doorway |goto Lunarfall/0 59.40,41.30 < 10 |only if walking
_Follow_ the road |goto Shadowmoon Valley D/0 23.20,13.90 < 20 |only if walking
talk Madari##84372
...
step
Stand at the edge of the pond in your garrison |goto Lunarfall 51.90,13.70
Use your Fishing skill to fish in the water |cast Fishing##131474
skill Draenor Fishing,100
]])
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Leveling Guides\\Draenor Herbalism 1-100",{
...
QuestCore:RegisterGuide("Profession Guides\\Inscription\\Leveling Guides\\Draenor Inscription 1-100",{
...
buy 1 Draenor Inscription##111923 |goto Stormshield/0 62.01,33.42
...
talk Joao Calhandro##87063
|tip Upstairs inside the building.
buy Technique: Volatile Crystal##118614 |goto Stormshield/0 62.01,33.42
...
QuestCore:RegisterGuide("Profession Guides\\Jewelcrafting\\Leveling Guides\\Draenor Jewelcrafting 1-100",{
...
step
talk Artificer Harlaan##87052
buy 1 Recipe: Haste Taladite##116097 |goto Stormshield/0 44.16,37.74
...
QuestCore:RegisterGuide("Profession Guides\\Leatherworking\\Leveling Guides\\Draenor Leatherworking 1-100",{
...
step
talk Leara Moonsilk##87057
buy 1 Recipe: Drums of Fury##120258 |goto Stormshield/0 51.98,41.52
...
step
talk Leara Moonsilk##87057
buy 1 Recipe: Leather Refurbishing Kit##116325 |goto Stormshield/0 51.98,41.52
|only if skill("Draenor Leatherworking") < 100
step
...
QuestCore:RegisterGuide("Profession Guides\\Mining\\Leveling Guides\\Draenor Mining 1-100",{
...
QuestCore:RegisterGuide("Profession Guides\\Mining\\Farming Guides\\Blackrock",{
...
QuestCore:RegisterGuide("Profession Guides\\Mining\\Farming Guides\\True Iron",{
...
QuestCore:RegisterGuide("Profession Guides\\Tailoring\\Leveling Guides\\Draenor Tailoring 1-100",{
...
step
talk Steven Cochrane##87049
buy 1 Pattern: Hexweave Embroidery##114852 |goto Stormshield/0 51.27,36.29
