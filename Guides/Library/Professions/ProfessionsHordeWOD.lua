...
step
talk Joshua Alvarez##87542
buy 1 Recipe: Draenic Armor Potion##112041 |goto Warspear/0 60.97,27.36
...
step
talk Joshua Alvarez##87542
buy 100 Crystal Vial##3371 |goto Warspear/0 60.97,27.36
|only if skill("Draenor Alchemy") < 2
step
...
step
talk Joshua Alvarez##87542
buy 1 Recipe: Draenic Agility Flask##112024 |goto Warspear/0 60.97,27.36
|only if skill("Draenor Alchemy") < 100
step
...
step
talk Reena Cogscrap##86033 |only if not QC.InPhase('BFA')
talk Examiner Alerinda##122701 |only if QC.InPhase('BFA')
|tip Inside the building.
|tip She walks around this area. |only if QC.InPhase('BFA')
Train Draenor Archaeology |skillmax Archaeology,700 |goto Warspear/0 73.61,31.19 |only if not QC.InPhase('BFA')
Train Draenor Archaeology |skillmax Archaeology,700 |goto Dazar'alor/1 32.23,36.12 |only if QC.InPhase('BFA')
step
...
collect 1 Secrets of Draenor Blacksmithing##118720 |goto Warspear/0 74.22,37.37
|only if skill("Draenor Blacksmithing") < 100
step
talk Nonn Threeratchet##87550
buy 1 Recipe: Truesteel Grinder##116734 |goto Warspear/0 74.96,37.91
|only if skill("Draenor Blacksmithing") < 100
step
...
Reach Level 100 Draenor Blacksmithing |skill Draenor Blacksmithing,100 |goto Warspear/0 74.22,37.37
]])
...
collect 8 Gearspring Parts##111366 |goto Warspear/0 74.64,37.62
|only if skill("Draenor Engineering") < 100
step
Open Your Engineering Crafting Panel:
...
step
talk Nik Steelrings##87552
buy 1 Schematic: Didi's Delicate Assembly##118493 |goto Warspear/0 70.50,38.93
|only if skill("Draenor Engineering") < 100
step
...
Reach 100 Draenor Fishing |skill Draenor Fishing,100  |goto Warspear/0 69.53,14.86
]])
...
step
talk Maru'sa##87551
buy Technique: Volatile Crystal##118614 |goto Warspear/0 75.24,47.59
...
step
talk Kaevan Highwit##87548
buy 1 Recipe: Haste Taladite##116097 |goto Warspear/0 60.41,40.64
step
...
step
talk Garm Gladestride##87549
buy 1 Recipe: Drums of Fury##120258 |goto Warspear/0 50.43,27.26
...
step
talk Garm Gladestride##87549
buy 1 Recipe: Leather Refurbishing Kit##116325 |goto Warspear/0 50.43,27.26
|only if skill("Draenor Leatherworking") < 100
step
...
description="Blackrock can be gathered from Frostfire Ridge.",
...
description="True Iron can be gathered from Frostfire Ridge.",
meta={goldtype="route",skillreq={draenor_mining=1},levelreq={10}},
maps={"Frostfire Ridge"},
items={109119},
},[[
...
step
talk Petir Starocean##87543
buy 1 Pattern: Hexweave Embroidery##114852 |goto Warspear/0 59.29,43.42
