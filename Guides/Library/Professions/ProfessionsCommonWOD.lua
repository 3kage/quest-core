...
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Farming Guides\\Fireweed",{
description="Fireweed can be gathered from Frostfire Ridge.",
...
'|goto Frostfire Ridge/0 42.29,18.90 < 20 |noway |c
step
map Frostfire Ridge/0
path follow smart; loop off; ants curved
...
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
collect Fireweed##109125 |n
'|goto Frostfire Ridge/0 34.02,22.09 < 20 |noway |c
step
map Frostfire Ridge/0
path follow smart; loop off; ants curved
...
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
collect Fireweed##109125 |n
'|goto Frostfire Ridge/0 17.18,33.28 < 20 |noway |c
step
...
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
collect Fireweed##109125 |n
'|goto Frostfire Ridge/0 46.43,44.92 |noway |c
step
map Frostfire Ridge/0
path follow smart; loop off; ants curved
map Frostwall/0
...
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
collect Fireweed##109125 |n
'|goto Frostwall/0 15.85,54.38 < 20 |noway |c
step
click Fireweed##228572+
|tip They spawn in areas with lava.
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
...
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
collect Fireweed##109125 |n
'|goto Frostfire Ridge/0 70.13,39.70 < 20 |noway |c
step
map Frostfire Ridge/0
path follow smart; loop off; ants curved
...
|tip Make sure you enable "Find Herbs" in the tracking menu on the minimap.
collect Fireweed##109125 |n
'|goto Frostfire Ridge/0 70.71,23.11 < 20 |noway |c |next "Start"
]])
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Farming Guides\\Frostweed",{
description="Frostweed can be gathered from Frostfire Ridge in Draenor.",
meta={goldtype="route",skillreq={draenor_herbalism=1},levelreq={10}},
maps={"Frostfire Ridge"},
items={109124},
},[[
...
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Farming Guides\\Gorgrond Flytrap",{
description="Gorgrond Flytrap can be gathered from Gorgrond in Draenor.",
meta={goldtype="route",skillreq={draenor_herbalism=1},levelreq={10}},
maps={"Gorgrond"},
items={109126},
},[[
...
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Farming Guides\\Nagrand Arrowbloom",{
description="Nagrand Arrowbloom can be gathered from Nagrand in Draenor.",
meta={goldtype="route",skillreq={draenor_herbalism=1},levelreq={10}},
maps={"Nagrand D"},
items={109128},
},[[
...
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Farming Guides\\Starflower",{
description="Starflower can be gathered from Shadowmoon Valley in Draenor.",
meta={goldtype="route",skillreq={draenor_herbalism=1},levelreq={10}},
...
QuestCore:RegisterGuide("Profession Guides\\Herbalism\\Farming Guides\\Talador Orchid",{
description="Talador Orchid can be gathered from Talador in Draenor.",
meta={goldtype="route",skillreq={draenor_herbalism=1},levelreq={10}},
maps={"Talador"},
items={109129},
},[[
...
QuestCore:RegisterGuide("Profession Guides\\Skinning\\Farming Guides\\Raw Beast Hide",{
description="Raw Beast Hide can be gathered from Nagrand in Draenor.",
meta={goldtype="route",skillreq={draenor_skinning=1},levelreq={10}},
maps={"Nagrand D"},
items={110609},
},[[
step
...
QuestCore:RegisterGuide("Profession Guides\\Skinning\\Leveling Guides\\Draenor Skinning 1-100",{
...
kill Tamed Clefthoof##79034
|tip Kill all Tamed Clefthoof nearby to force them to respawn.
Reach 100 Draenor Skinning |skill Draenor Skinning,100 |goto Nagrand D/0 78.79,72.24
step
_Congratulations!_
