...
QuestCore:RegisterInclude("Choose_Foothold_1",[[
...
QuestCore:RegisterInclude("Choose_Foothold_2",[[
...
QuestCore:RegisterInclude("Choose_Foothold_3",[[
...
QuestCore:RegisterInclude("Tiragarde_Sound_Foothold_Quests",[[
...
QuestCore:RegisterInclude("Drustvar_Foothold_Quests",[[
		_Click the Complete Quest Box:_
		|tip In the quest tracker area.
...
QuestCore:RegisterInclude("Stormsong_Valley_Foothold_Quests",[[
		_Click the Complete Quest Box:_
		|tip In the quest tracker area.
