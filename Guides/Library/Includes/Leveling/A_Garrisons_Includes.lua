...
QuestCore:RegisterInclude("Garrison_BAlexston",[[
		talk Baros Alexston##77209 |goto Lunarfall/0 41.20,49.30 |only if garrisonlvl(1)
		talk Baros Alexston##77209 |goto Lunarfall/0 31.70,31.10 |only if garrisonlvl(2)
		talk Baros Alexston##77209 |goto Lunarfall/0 29.20,33.10 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_BGrey",[[
		talk Bodrick Grey##81492 |goto Lunarfall/0 31.50,33.00 |only if garrisonlvl(1)
		talk Bodrick Grey##81492 |goto Lunarfall/0 38.30,37.00 |only if garrisonlvl(2)
		talk Bodrick Grey##81492 |goto Lunarfall/0 38.30,37.00 |only if garrisonlvl(3)
]])
...
QuestCore:RegisterInclude("Garrison_BlueprintVendor",[[
		...
		talk Sparz Boltwist##85839 |goto Lunarfall/0 31.90,30.50 |only if garrisonlvl(2)
		talk Sparz Boltwist##85839 |goto Lunarfall/0 29.60,32.60 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Brightstone",[[
		talk Assistant Brightstone##84455 |goto Lunarfall/0 44.80,53.50 |only if garrisonlvl(1)
		talk Assistant Brightstone##84455 |goto Lunarfall/0 31.40,32.50 |only if garrisonlvl(2)
		talk Assistant Brightstone##84455 |goto Lunarfall/0 29.00,35.40 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Crowler",[[
		talk Sergeant Crowler##88223 |goto Lunarfall/0 42.30,44.90 |only if garrisonlvl(1)
		talk Sergeant Crowler##88223 |goto Lunarfall/0 37.70,36.00 |only if garrisonlvl(2)
		talk Sergeant Crowler##88223 |goto Lunarfall/0 38.50,31.40 |only if garrisonlvl(3)
		|tip Outside, next to the building. |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_DLongdrink",[[
		talk Dungar Longdrink##81103 |goto Lunarfall/0 48.00,49.80 |only if garrisonlvl(1)
		talk Dungar Longdrink##81103 |goto Lunarfall/0 48.00,49.80 |only if garrisonlvl(2)
		talk Dungar Longdrink##81103 |goto Lunarfall/0 48.00,49.80 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Dorn",[[
		_Jr. Surveyor Dorn doesn't join your Garrison until Garrison level 2!_ |only if garrisonlvl(1)
		talk Jr. Surveyor Dorn##77217 |goto Lunarfall/0 64.50,69.90 |only if garrisonlvl(2)
		talk Jr. Surveyor Dorn##77217 |goto Lunarfall/0 64.50,69.90 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Harrison",[[
		talk Harrison Jones##89793 |goto Lunarfall/0 34.20,32.70
		|tip Inside the building.
]])

QuestCore:RegisterInclude("Garrison_Inkeeper",[[
		talk Deedree##82776 |goto Lunarfall/0 42.10,52.00 |only if garrisonlvl(1)
		talk Deedree##82776 |goto Lunarfall/0 32.20,32.90 |only if garrisonlvl(2)
		talk Deedree##82776 |goto Lunarfall/0 33.00,35.30 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_KenLoggin",[[
		talk Ken Loggin##80163 |goto Lunarfall/0 48.94,42.25 |only if garrisonlvl(1)
		talk Ken Loggin##80163 |goto Lunarfall/0 37.90,63.80 |only if garrisonlvl(2)
		talk Ken Loggin##80163 |goto Lunarfall/0 40.30,54.40 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Lioness",[[
		talk Lio the Lioness##85418 |goto Lunarfall/0 28.50,39.10 |only if garrisonlvl(2)
		talk Lio the Lioness##85418 |goto Lunarfall/0 28.50,39.10 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_LtThorn",[[
		talk Lieutenant Thorn##79953 |goto Lunarfall/0 40.20,53.60 |only if garrisonlvl(1)
		talk Lieutenant Thorn##79953 |goto Lunarfall/0 31.10,32.90 |only if garrisonlvl(2)
		talk Lieutenant Thorn##79953 |goto Lunarfall/0 28.70,35.10 |only if garrisonlvl(3)
		|tip Inside the building.
]])

QuestCore:RegisterInclude("Garrison_Maraad",[[
		talk Vindicator Maraad##79457 |goto Lunarfall/0 44.10,53.30 |only if garrisonlvl(1)
		talk Vindicator Maraad##79457 |goto Lunarfall/0 41.50,44.90 |only if garrisonlvl(2)
		talk Vindicator Maraad##79457 |goto Lunarfall/0 41.50,45.00 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Morthis",[[
		talk Morthis Whisperwing##88112 |goto Lunarfall/0 47.40,89.18 |only if garrisonlvl(2)
		talk Morthis Whisperwing##88112 |goto Lunarfall/0 47.42,89.20 |only if garrisonlvl(3)
		|tip Inside the cave.
]])

QuestCore:RegisterInclude("Garrison_Muradin",[[
		talk Muradin Bronzebeard##89763 |goto Lunarfall/0 34.20,32.70
		|tip Inside the building.
]])

QuestCore:RegisterInclude("Garrison_Nixxie",[[
		talk Nixxie##88892 |goto Lunarfall/0 53.14,69.55 |only if garrisonlvl(2)
		talk Nixxie##88892 |goto Lunarfall/0 61.10,79.30 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Pagle",[[
		talk Nat Pagle##85984 |goto Lunarfall/0 54.20,14.30 |only if garrisonlvl(2)
		talk Nat Pagle##85984 |goto Lunarfall/0 54.20,14.30 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_QMoonshadow",[[
		talk Qiana Moonshadow##81948 |goto Lunarfall/0 40.50,54.00 |only if garrisonlvl(1)
		talk Qiana Moonshadow##79611 |goto Lunarfall/0 50.30,49.40 |only if garrisonlvl(2)
		talk Qiana Moonshadow##79611 |goto Lunarfall/0 50.40,48.80 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(1)
]])

QuestCore:RegisterInclude("Garrison_RAshton",[[
		talk Ron Ashton##77733 |goto Lunarfall/0 54.20,14.30 |only if garrisonlvl() >= 2
]])

QuestCore:RegisterInclude("Garrison_ScoutValdez",[[
		_Scout Valdez doesn't join your Garrison until Garrison level 2!_ |only if garrisonlvl(1)
		talk Scout Valdez##81152 |goto Lunarfall/0 30.90,31.50 |only if garrisonlvl(2)
		talk Scout Valdez##81152 |goto Lunarfall/0 31.00,31.20 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Shelly",[[
		talk Shelly Hamby##81441 |goto Lunarfall/0 32.50,34.40 |only if garrisonlvl(1)
		talk Shelly Hamby##81441 |goto Lunarfall/0 31.70,31.10 |only if garrisonlvl(2) --
		talk Shelly Hamby##81441 |goto Lunarfall/0 29.20,33.10 |only if garrisonlvl(3) --
]])

QuestCore:RegisterInclude("Garrison_Shiv",[[
		talk Renzik "The Shiv"##89805 |goto Lunarfall/0 34.20,32.70
		|tip Inside the building.
]])

QuestCore:RegisterInclude("Garrison_Valdez",[[
		talk Scout Valdez##81152 |goto Lunarfall/0 46.50,54.30 |only if garrisonlvl(1)
		talk Scout Valdez##81152 |goto Lunarfall/0 30.90,31.50 |only if garrisonlvl(2)
		talk Scout Valdez##81152 |goto Lunarfall/0 31.00,31.10 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Yrel",[[
		talk Yrel##80568 |goto Lunarfall/0 47.00,51.00 |only if garrisonlvl(1)
		talk Yrel##80568 |goto Lunarfall/0 48.00,49.80 |only if garrisonlvl(2)--
		talk Yrel##80568 |goto Lunarfall/0 48.00,49.80 |only if garrisonlvl(3)--
]])
...
QuestCore:RegisterInclude("Garrison_ArchitectTable",[[
		clicknpc Architect Table##86018 |goto Lunarfall/0 41.10,49.00 |only if garrisonlvl(1)
		clicknpc Architect Table##86018 |goto Lunarfall/0 31.70,30.80 |only if garrisonlvl(2)
		clicknpc Architect Table##86018 |goto Lunarfall/0 29.30,32.70 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_BBoard",[[
		click Bounty Board##232398 |goto Lunarfall/0 42.90,44.50 |only if garrisonlvl(1)
		click Bounty Board##232398 |goto Lunarfall/0 42.70,44.80 |only if garrisonlvl(2)
		click Bounty Board##232398 |goto Lunarfall/0 42.70,44.80 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Cache",[[
		click Garrison Cache##237191 |goto Lunarfall/0 49.20,43.70 |only if garrisonlvl(1)
		click Garrison Cache##237191 |goto Lunarfall/0 37.16,31.78 |only if garrisonlvl(2)
		click Garrison Cache##237191 |goto Lunarfall/0 37.30,32.00 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_CommandTable",[[
		clicknpc Command Table##84698 |goto Lunarfall/0 40.40,53.50 |only if garrisonlvl(1)
		clicknpc Command Table##84698 |goto Lunarfall/0 31.30,32.70 |only if garrisonlvl(2)
		clicknpc Command Table##84698 |goto Lunarfall/0 28.90,34.90 |only if garrisonlvl(3)
		|tip Inside the building.
]])
...
QuestCore:RegisterInclude("Garrison_Warplans",[[
		...
		click War Planning Map##236206 |goto Lunarfall/0 30.70,31.80 |only if garrisonlvl(2)
		click War Planning Map##236206 |goto Lunarfall/0 31.50,31.00 |only if garrisonlvl(3)
		|tip Inside the building. |only if garrisonlvl(2) or garrisonlvl(3)
]])
...
QuestCore:RegisterInclude("Garrison_Small_Building",[[
		%action% |goto Lunarfall/0 46.30,59.60 |only if QC.Garrison_GetBuildingLocation("%building%")==18
		%action% |goto Lunarfall/0 50.40,57.30 |only if QC.Garrison_GetBuildingLocation("%building%")==19
		%action% |goto Lunarfall/0 51.80,63.00 |only if QC.Garrison_GetBuildingLocation("%building%")==20
		%action% |goto Lunarfall/0 48.50,58.70 |only if default
]])

QuestCore:RegisterInclude("Garrison_Finalize_Small",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 47.60,59.00 |only if QC.Garrison_GetBuildingLocation("%building%")==18
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 49.20,58.20 |only if QC.Garrison_GetBuildingLocation("%building%")==19
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 50.50,64.00 |only if QC.Garrison_GetBuildingLocation("%building%")==20
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 47.60,59.00 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])

QuestCore:RegisterInclude("Garrison_Medium_Building",[[
		%action% |goto Lunarfall/0 34.20,48.90 |only if QC.Garrison_GetBuildingLocation("%building%")==22
		%action% |goto Lunarfall/0 52.20,44.80 |only if QC.Garrison_GetBuildingLocation("%building%")==25
		%action% |goto Lunarfall/0 34.20,48.90 |only if default
]])

QuestCore:RegisterInclude("Garrison_Finalize_Medium",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 36.40,49.30 |only if QC.Garrison_GetBuildingLocation("%building%")==22
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 50.90,47.60 |only if QC.Garrison_GetBuildingLocation("%building%")==25
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 50.90,47.60 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])

QuestCore:RegisterInclude("Garrison_Large_Building",[[
		%action% |goto Lunarfall/0 45.00,42.80 |only if QC.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl(1)
		%action% |goto Lunarfall/0 45.80,39.80 |only if QC.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl() >= 2
		%action% |goto Lunarfall/0 39.40,58.10 |only if QC.Garrison_GetBuildingLocation("%building%")==24
		%action% |goto Lunarfall/0 45.00,42.80 |only if default
]])

QuestCore:RegisterInclude("Garrison_Finalize_Large",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 44.40,45.20 |only if QC.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl(1)
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 44.90,43.90 |only if QC.Garrison_GetBuildingLocation("%building%")==23 and garrisonlvl() >= 2
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 40.60,55.70 |only if QC.Garrison_GetBuildingLocation("%building%")==24
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 44.40,45.20 |only if default
		|tip It looks like a huge floating scroll in a column of yellow light.
]])

QuestCore:RegisterInclude("Garrison_HerbGarden",[[
		|goto Lunarfall/0 65.20,41.90 |only if garrisonlvl(2)
		|goto Lunarfall/0 58.90,53.50 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_LunarfallExcavation_Talk",[[
		talk %npc% |goto Lunarfall/0 65.20,41.90 |only if garrisonlvl(2)
		talk %npc% |goto Lunarfall/0 65.00,42.00 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_LunarfallExcavation_Finalize",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 66.30,40.50
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])

QuestCore:RegisterInclude("Garrison_LunarfallExcavation_EnterMine",[[
		Enter the mine |goto Lunarfall/23 69.40,67.60 < 10 |only if garrisonlvl(3)
		Follow the path down |goto Lunarfall/23 77.80,75.80 < 10 |only if garrisonlvl(3)
		Go down the stairs |goto Lunarfall/23 77.70,52.90 < 10 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_LunarfallExcavation_LeaveMine",[[
		_Go up_ the stairs |goto Lunarfall/23 71.30,53.20 < 10 |only if garrisonlvl(3)
		_Follow_ the winding path up |goto Lunarfall/23 77.80,75.80 < 10 |only if garrisonlvl(3)
		_Leave_ the mine |goto Lunarfall/23 69.40,67.60 < 10 |only if garrisonlvl(3)
		_Run further_ into your garrison |goto Lunarfall/23 68.00,63.50 < 20 |only if garrisonlvl(3)
]])

QuestCore:RegisterInclude("Garrison_Fishing_Talk",[[
		talk %npc% |goto Lunarfall/0 54.60,14.90 |only if garrisonlvl() >= 2
]])

QuestCore:RegisterInclude("Garrison_Fishing_Finalize",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 54.40,15.50
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])

QuestCore:RegisterInclude("Garrison_HerbGarden_Talk",[[
		talk %npc% |goto Lunarfall/0 58.90,53.40 |only if garrisonlvl() >= 2
]])

QuestCore:RegisterInclude("Garrison_HerbGarden_Finalize",[[
		click Finalize Garrison Plot##236190 |goto Lunarfall/0 58.70,52.20
		|tip It looks like a huge floating scroll in a column of yellow light. |only if garrisonlvl() >= 2
]])
...
QuestCore:RegisterInclude("Garrison_Weldon_Barov",[[
...
QuestCore:RegisterInclude("Garrison_Campaign",[[
	...
	step
	label "Seismic"
		_Go through_ the garrison gate |goto Lunarfall/0 52.60,72.10 < 10 |only if garrisonlvl(3)
	...
	step
		_Jump down_ here |goto Gorgrond/0 69.50,28.40 < 10 |only if walking
		_Enter_ the cave here |goto Gorgrond/0 69.70,23.90 < 10 |walk
		Find Thaelin Darkanvil's Workshop | q These Look Familiar...##34028/1 |goto Gorgrond/0 69.70,25.70
	step
	...
	step
		_Enter_ the building |goto Frostfire Ridge/0 87.80,48.90 < 10 |walk
		_Jump down_ here |goto Frostfire Ridge/0 88.20,48.90 < 7 |walk
	...
	step
		_Go up_ the stairs and _through the doorway_ |goto 88.80,49.20 < 10
		clicknpc Mole Machine##88475
		|tip It looks like a big metal drilling machine with a pointed metal top.
		Send the Mole Machine Home |q 34048/1 |goto Frostfire Ridge/0 87.60,51.20 |count 1
	step
		clicknpc Mole Machine##88475
		|tip It looks like a big metal drilling machine with a pointed metal top.
		Send the Mole Machine Home |q 34048/1 |goto Frostfire Ridge/0 86.40,56.10 |count 2
	step
		clicknpc Mole Machine##88475
		|tip It looks like a big metal drilling machine with a pointed metal top.
		Send the Mole Machine Home |q 34048/1 |goto Frostfire Ridge/0 88.00,58.20 |count 3
	step
		clicknpc Mole Machine##88475
		|tip It looks like a big metal drilling machine with a pointed metal top.
		Send the Mole Machine Home |q 34048/1 |goto Frostfire Ridge/0 86.20,60.50 |count 4
	step
		_Follow_ the path down |goto 87.40,59.00 < 10
		_Go up_ the path |goto 86.00,54.90 < 10
		clicknpc Mole Machine##88475
		|tip It looks like a big metal drilling machine with a pointed metal top.
		Send the Mole Machine Home |q 34048/1 |goto Frostfire Ridge/0 84.70,53.30 |count 5
	step
	label "MoleMachine"
	...
	step
		_Jump down_ here |goto 85.60,53.20 < 10 |only if walking
		_Follow_ the path up |goto Frostfire Ridge/0 86.30,51.30 < 20 |only if walking
		_Go up_ the wooden ramp |goto Frostfire Ridge/0 86.00,47.60 < 10 |only if walking
	...
	step
		_Follow_ the path down |goto 85.80,49.10 < 20 |only if walking
		_Follow_ the road |goto 87.40,51.70 < 20 |only if walking
		_Enter_ the cave |goto Frostfire Ridge/0 87.10,49.50 < 10 |walk
		Return to Hansel Heavyhands |q 34033/1
	step
		click Prototype Mole Machine##227270 |goto Frostfire Ridge/0 86.40,49.00
	...
	label "Roost"
		...
		Ask Dungar to _"Take me to Darktide Roost"_ |goto Shadowmoon Valley D/0 59.40,83.60 |c |noway
	...
	step
		...
		Destroy the Shredders |q 34353/1 |goto Shadowmoon Valley D/0 57.70,86.50
	step
		kill 5 Darktide Engineer##78999
		kill 5 Darktide Pilferer##78148
		Deal with the Pilferers |q 34352/1 |goto Shadowmoon Valley D/0 57.70,86.50
		Deal with the Engineers |q 34352/2 |goto Shadowmoon Valley D/0 57.70,86.50
	step
	...
	step
		use Rat Bait##110268
		Use the Rat Bait near Unmanned Darktide Shredders to destroy them |q 34355/1 |goto Shadowmoon Valley D/0 55.80,89.20
	step
		talk Rexxar##78258
	...
	step
		click Rylak Cage##229042
		Free the the Rylak |q 34365/1 |goto 59.50,95.80 |count 2
	step
		click Rylak Cage##229042
		Free the the Rylak |q 34365/1 |goto 61.60,95.50 |count 3
	step
		kill Assistant Fexfuse##78409
		Deal with Assistant Fexfuse |q 34397/1 |goto 60.70,93.00
	step
	...
	step
		kill Razz Ricketroz##78973 |q 34450/2 |q 34450/2 |goto 60.10,90.50
	step
		clicknpc Nisha##79168 |goto 60.34,90.33
		Ride Nisha to Safety |goto 67.90,90.00 |c |noway
		|only if not completedq(34450)
	step
		talk Rexxar##78937
	...
	label "Sargerei"
		...
		turnin Garrison Campaign: The Sargerei##35185 |goto Shadowmoon Valley D 43.60,77.20
	...
	step
		...
		Sargerei Slippers |q 35187/1 |goto Shadowmoon Valley D/0 48.60,76.50
		Sargerei Robe |q 35187/2 |goto Shadowmoon Valley D/0 48.60,76.50
		Sargerei Cowl |q 35187/3 |goto Shadowmoon Valley D/0 48.60,76.50
	step
		use Sargerei Cowl##112791
		Create a Sargerei Disguise |q 35187/4 |goto Shadowmoon Valley D/0 48.60,76.50
	step
		use Sargerei Disguise##112904
		Put on the Sargerei Disguise |q 35187/5 |goto Shadowmoon Valley D/0 48.60,76.50
	step
	...
	step
		...
		Speak to Anchorite Laanda |q 35187/7 |goto Shadowmoon Valley D/0 50.00,81.20
	step
		talk Anchorite Laanda##81530
		turnin Infiltrating the Sargerei##35187/7 |goto Shadowmoon Valley D/0 50.00,81.20
	step
		talk Anchorite Laanda##81530
	...
	step
		...
		Eldermoos Slain |q 35190/1 |goto Shadowmoon Valley D/0 45.40,73.80
	step
	label "spear"
		kill 1 Shadowglen Thornshooter##81502+
		kill 1 Shadowglen Spitter##81637+
		Wooden Spear |q 35188/1 |goto Shadowmoon Valley D/0 47.10,77.70
	stickystart "crystals"
	step
		clicknpc The Eredar Destiny##88388
		"The Eredar Destiny" read |q 35189/1 |goto Shadowmoon Valley D/0 51.40,75.70
	step
		clicknpc The Purpose of Unity##88389
		"The Purpose of Unity" read |q 35189/2 |goto Shadowmoon Valley D/0 50.10,72.50
	step
		clicknpc The Promise of Eternity##88390
		"The Promise of Eternity" read |q 35189/3 |goto Shadowmoon Valley D/0 50.80,79.70
	step
	label "crystals"
		clicknpc Felstorm Crystal##88370 |tip These can bef found inside the buildings or small tents in this area.
		Felstorm Crystal destroyed |q 35191/1 |goto Shadowmoon Valley D/0 49.60,73.20
	step
		talk Anchorite Laanda##81530
	...
	step
		Follow the path up |goto Shadowmoon Valley D/0 46.90,79.80 < 10 |only if walking
		kill 1 Invokaz##81697
		Invokaz slain |q 35194/1 |goto Shadowmoon Valley D/0 46.10,80.60
		clicknpc Demon Gate##88399
		Demon Gate destroyed |q 35194/2 |goto Shadowmoon Valley D/0 46.30,80.60
	step
	...
	step
		...
		Socrethar confronted |q 35195/1 |goto Shadowmoon Valley D/0 50.40,82.10
	step
		kill 1 Soulbinder Zamaya##81858
		Sargerei Battle Plans |q 35195/2 |goto Shadowmoon Valley D/0 50.70,82.40
	step
		talk Anchorite Laanda##81530
		turnin Socrethar's Fury##35195 |goto Shadowmoon Valley D/0 50.60,82.30
		accept Forging Ahead##35196 |goto Shadowmoon Valley D/0 50.60,82.30
	step
	label "Rise"
	...
	step
		...
		Retrieve Lug'dol's Head |q 36220/1 |goto 64.30,22.60
	...
	step
	label "GProving"
		accept Assault on the Gorian Proving Grounds##36820 |goto 56.90,19.10
		Dominate the Gorian Proving Grounds |q 36820/1 |goto 56.90,19.10
	step
	...
	step
		Ride the elevator up here |goto Talador/0 47.40,44.00 |only if walking
		talk Exarch Maladaar##75028
		turnin Reclaiming the City##35683 |goto 49.79,48.65
		accept Socrethar's Demise##35685 |goto 49.79,48.65
	step
		Ride the elevator down |goto 47.40,44.00 |only if walking
		_Go down_ the steps |goto Talador/0 44.80,37.00 |only if walking
		_Cross_ the bridge |goto Talador/0 43.90,34.10 |only if walking
		click Sons of Lothar Banner
		Challenge Socrethar |q 35685/1 |goto 42.35,32.99
	step
		kill 1 Socrethar##82662
		Defeat Socrethar |q 35685/2 |goto Talador/0 41.80,32.60
	step
		_Cross_ the bridge |goto Talador/0 43.90,34.10 |only if walking
		_Go up_ the steps |goto Talador/0 44.80,37.00 |only if walking
		Ride the elevator up |goto 47.40,44.00 |only if walking
		talk Exarch Maladaar##75028
	...
	label "ShadowAssault"
		...
		Shadow Council assaulted |q 37635/1 |goto Talador/0 44.30,39.20
	step
	...
	label "Bloodmaul"
		#include "Garrison_DLongdrink"
		Tell Dungar _"I'm searching for Owynn Graddock. Take me to Frostfire Ridge."_ |goto Frostfire Ridge/0 51.50,21.40 |c |noway
		|only if not completedq(34284)
	step
		_Go down_ the path |goto Frostfire Ridge/0 52.10,18.80 < 20 |only if walking
		_Go up_ the hill |goto Frostfire Ridge/0 49.70,17.10 |only if walking
		Follow the path |goto Frostfire Ridge/0 47.60,16.10 |only if walking
		Locate Owynn Graddock |q 34284/1 |goto Frostfire Ridge/0 48.70,14.70
	stickystart "Stonefury"
	step
		talk Owynn Graddock##78056
		turnin Garrison Campaign: The Search for Owynn Graddock##34284 |goto Frostfire Ridge/0 48.70,14.70
		accept Out of the Chains##34281 |goto Frostfire Ridge/0 48.70,14.70
	step
		kill 1 Nub the Torturer##78174
		Bloodmaul Slave Key |q 34281/1 |goto Frostfire Ridge/0 49.90,15.40
	step
		click Owynn's Shackle##228534
		Owynn's Shackle unlocked |q 34281/2 |goto Frostfire Ridge/0 48.70,14.70
	step
		talk Owynn Graddock##78056
		turnin Out of the Chains##34281 |goto Frostfire Ridge/0 48.70,14.70
		accept Gearing Up##34285 |goto Frostfire Ridge/0 48.70,14.70
	step
		click Owynn's Noggenknocker##228577
		Retrieve Owynn's Mace |q 34285/3 |goto 43.87,15.23 |tip It is behind the tower.
	step
		_Go up_ the ramp |goto Frostfire Ridge/0 45.10,19.10 |only if walking
		click Owynn's Dagger##229019
		Retrieve Owynn's Dagger |q 34285/2 |goto 45.23,21.06
	step
		_Cross_ the stone bridge here |goto Frostfire Ridge/0 47.60,20.70 |only if walking
		click Ogre Chest##229416
		Retrieve Owynn's Armor |q 34285/1 |goto Frostfire Ridge/0 49.80,21.30
	step
		_Cross_ the rocks here |goto Frostfire Ridge/0 49.00,16.90 |only if walking
		talk Owynn Graddock##78056
		turnin Gearing Up##34285 |goto Frostfire Ridge/0 48.70,14.70
		accept Seeking the Truth##34286 |goto Frostfire Ridge/0 48.70,14.70
	step
		Locate Borgal Doomfist |q 34286/1 |goto Frostfire Ridge/0 40.40,21.80
	step
		talk Owynn Graddock##78056
		turnin Seeking the Truth##34286 |goto Frostfire Ridge/0 40.20,21.50
		accept The Shadow Gate##34362 |goto Frostfire Ridge/0 40.20,21.50
	step
		kill Grubnor Wargut##78003
		Grubnor Wargut slain |q 34362/1 |goto Frostfire Ridge/0 39.50,23.20
		click Shadow Gate##229026
		Enter the Shadow Gate |q 34362/2 |goto Frostfire Ridge/0 39.60,23.80
	step
		talk Owynn Graddock##78056
		turnin The Shadow Gate##34362 |goto Frostfire Ridge/0 39.50,23.60
	step
		talk Orlana Strongbrow##78428
		accept The Totems That Bind##34288 |goto Frostfire Ridge/0 39.40,23.50
		accept Cleansing the Souls##34287 |goto Frostfire Ridge/0 39.40,23.50
	step
		...
		Crazed Soul Cleansed |q 34287/1 |goto Frostfire Ridge/0 40.60,17.70
		click Borgal's Totem##229131
		Borgal's Totems |q 34288/1 |goto Frostfire Ridge/0 40.60,17.70
	step
		talk Orlana Strongbrow##78428
		turnin The Totems That Bind##34288 |goto Frostfire Ridge/0 39.40,23.50
		turnin Cleansing the Souls##34287 |goto Frostfire Ridge/0 39.40,23.50
		accept Soulgrinder Survivor##34289 |goto Frostfire Ridge/0 39.40,23.50
	step
		clicknpc Borgal's Spiritbinder Totems##78386
		|tip These are two totems you must place.
		Borgal's Totems Placed |q 34289/1 |goto Frostfire Ridge/0 38.00,13.80
		kill Borgal Doomfist##77997
		Borgal Doomfist slain |q 34289/2 |goto Frostfire Ridge/0 38.00,13.80
	step
		talk Owynn Graddock##78056
		turnin Soulgrinder Survivor##34289 |goto Frostfire Ridge/0 38.00,14.80
	step
	label "Stonefury"
	...
	step
		Click the Portal to Auchindoun Entrance |goto Talador/0 46.20,74.00 |noway |c
	step
		talk Yrel##84542
	...
	step
		...
		path	49.40,16.70	49.50,17.20	49.00,16.40
		path	47.60,13.80	46.60,10.90
	...
	label "Precipice"
		#include "Garrison_DLongdrink"
		Speak to Dungar and ask him: "_Take me to the Broken Precipice in Nagrand_" |goto Nagrand D/0 41.90,28.10 < 10 |noway |c
	stickystart "PrecAssault"
	step
		talk Greblin Fastfizzle##83686
		turnin Garrison Campaign: The Broken Precipice##35985 |goto Nagrand D/0 39.60,24.60
		accept Greblin Fastfizzle##35945 |goto Nagrand D/0 39.63,24.61
	step
		talk Greblin Fastfizzle##83686
		turnin Greblin Fastfizzle##35945 |goto Nagrand D/0 39.60,24.50
		accept Preservation Capitalization##35970 |goto Nagrand D/0 39.60,24.50
		accept Ogre Onslaught##35972 |goto Nagrand D/0 39.60,24.50
	stickystart "Ogre"
	step
		Retrieve a Redtooth Necklace |q 35970/1 |goto Nagrand D/0 37.90,25.70
		|tip It is hanging from a bone sticking out of the pile.
	step
		Retrive an Ogre Bust |q 35970/3 |goto Nagrand D/0 36.70,21.20
	step
		Retrieve a Purpletooth Necklace |tip It is hanging from a bone. |q 35970/2 |goto Nagrand D/0 35.70,18.80
	step
	label "Ogre"
		kill Arcanist Earthsmasher##83577+, Slave-Grinder##88187+, Broken Drudge##83831+, Sledgebasher##83575+
		Slay 3 Ogres |q 35972/1 |goto Nagrand D/0 36.60,20.00
		Slay 3 Ogron |q 35972/2 |goto Nagrand D/0 36.60,20.00
	step
		talk Greblin Fastfizzle##83686
		turnin Preservation Capitalization##35970 |goto Nagrand D/0 39.60,24.50
		turnin Ogre Onslaught##35972 |goto Nagrand D/0 39.60,24.50
		accept Dizzy Sparkshift##37511 |goto Nagrand D/0 39.60,24.50
	step
	...
	step
		kill 1 Brokyo##83655
		Provoke Brokyo |q 35973/1 |goto Nagrand D/0 42.00,14.40
		Retrieve Brokyo's Ring |q 35973/2 |goto Nagrand D/0 42.00,14.40
	step
		talk Dizzy Sparkshift##76508
	...
	step
		...
		Wait to be teleported |goto Nagrand D/0 41.90,37.00 |noway |c
	step
		You will need to wait until Flint Shadowmore releases you from the cage
		Discover the Iron Horde's plans |q 35838/1 |goto Nagrand D/0 41.90,37.00
	step
	...
	step
		...
		Slay Packleader Vor'gash |q 35841/1 |goto Nagrand D/0 44.80,37.70
	step
	...
	step
		Retrieve the Frostfire Mission Orders |q 35840/1 |goto Nagrand D/0 45.20,36.40
		Retrieve the Shadowmoon Mission Orders |q 35840/2 |goto Nagrand D/0 45.20,36.40
		Retrieve the Spires of Arak Mission Orders |q 35840/3 |goto Nagrand D/0 45.20,36.40
	...
	label "Post"
		...
		accept Assault on Mok'gol Watchpost##37629 |goto Nagrand D/0 45.20,36.40
		Fill the assault bar by killing mobs and clicking objects in the Broken Precipice
		Disrupt the Warsong |q 37629/1 |goto Nagrand D/0 45.20,36.40
	step
		#include "Garrison_BGrey"
	...
	step
		...
		turnin Garrison Campaign: Every Rose Has Its Thorn##36160 |goto Lunarfall/0 29.30,34.80
	step
		talk Lieutenant Thorn##84684
		accept Where There Is Smoke...##36161 |goto 29.67,34.22
	step
		kill 1 Rag'sla Thunkblade##84352
		Rag'sla Thunkblade |q 36161/1 |goto Lunarfall/0 58.70,52.50
	step
		kill 1 Akatha Blazeburn##84354
		Akatha Blazeburn |q 36161/2 |goto Lunarfall/0 45.90,66.60
	step
		kill 1 Drek the Firecaller##84355
		Drek the Firecaller |q 36161/3 |goto Lunarfall/0 56.90,83.20
	step
	...
	step
		...
		Defeat Azuka Bladefury |q 36162/1 |goto Lunarfall/0 41.40,46.60
	step
	...
	label "Fury"
		...
		Ask her: "_What's the situation?_" |q 36134/1 |goto Gorgrond/0 40.90,43.10
	step
		kill 1 Duurg##84153
		Defeat Duurg |q 36134/2 |goto Gorgrond/0 37.80,44.70
	step
		talk Thisalee Crow##84185
	...
	step
		...
		Tell him: "_Reporting for battle!_" |q 36341/1 |goto Talador/0 66.90,9.10
	step
		kill Gorgorek##85042
		Defeat Gorgorek |q 36341/2 |goto Talador/0 69.20,3.20
	step
		kill Azuka Bladefury##85046
		|tip Do not allow the Burning Blade Initiate's to reach Azuka.
		Defeat Azuka Bladefury |q 36341/3 |goto Talador/0 69.20,3.20
	step
		talk Sanketsu##87764
		accept Sanketsu, The Burning Blade##37191 |goto 69.46,5.80
	step
		talk Thisalee Crow##85251
		Ask her: "_Where is the rest of the army?_" |q 36341/4 |goto Talador/0 67.50,7.60
	step
		tip This will take a short time.
		Witness Hellscream's challenge |q 36341/5 |goto Talador/0 69.40,9.10
	step
...
QuestCore:RegisterInclude("Garrison_Inn_Quests",[[
	...
	step
		...
		collect Nightmare Bell##118648 |q 37146/1 |goto Auchindoun/1 65.00,55.00
	step
	...
	step
		...
		Return to your Garrison |goto Lunarfall/0 30.00,30.00 < 1000 |c
		|only if haveq(37146) or haveq(37156) or haveq(37154)
	step
	...
	step
		_Jump down_ the hole |goto Shadowmoon Burial Grounds/1 52.50,77.60 < 10 |walk
	...
	step
		...
		collect Dark Parchment##118625 |q 37163/1 |goto Shadowmoon Burial Grounds/1 30.50,43.80
	step
	...
	step
		...
		collect Bottled Windstorm##118649 |q 37147/1 |goto Skyreach/1 42.60,80.30
	step
	...
	step
		kill High Sage Viryx##76266 |q 37147/2 |goto Skyreach/2 48.80,33.30
