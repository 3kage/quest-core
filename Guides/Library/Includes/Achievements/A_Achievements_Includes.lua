...
QuestCore:RegisterInclude("the_cake_is_not_a_lie",[[
	...
	label "create"
		...
		buy 4 Ice Cold Milk##1179 |goto Stormwind City 75.70,54.10
	step
		talk Reese Langston##1327
		buy 1 Flask of Port##2593 |goto Stormwind City 76.30,53.00
	step
		talk Erika Tate##5483
		buy 8 Simple Flour##30817 |goto Stormwind City 77.60,53.00
		buy 4 Mild Spices##2678 |goto Stormwind City 77.60,53.00
	step
	...
	step
		...
		collect 8 Small Egg##6889 |goto Westfall 55.80,30.20
		You can find more at [55.00,18.90]
	step
	label "HaveEggs"
		Build a Basic Campfire |cast Basic Campfire##818
...
QuestCore:RegisterInclude("Captain_Rumsey's_Lager",[[
	...
	step
		talk Reese Langston##1327
		buy 1 Flask of Port##2593 |goto Stormwind City 76.30,53.00
		buy 1 Flagon of Mead##2594 |goto Stormwind City 76.30,53.00
		buy 1 Skin of Dwarven Stout##2596 |goto Stormwind City 76.30,53.00
	step
...
QuestCore:RegisterInclude("Critter_Gitter",[[
	...
	step
		...
		buy 1 Recipe: Critter Bites##43029 |goto Dalaran 41.60,64.80
	step
...
QuestCore:RegisterInclude("The_Northrend_Gourmet",[[
	...
	step
		...
		accept Northern Cooking##13088 |goto Borean Tundra 57.80,71.40
	step
		kill Wooly Rhino Matriarch##25487+,Wooly Rhino Calf##25488+
		collect 4 Chilled Meat##43013 |q 13088 |goto 45,47.40
	step
		talk Rollick MacKreel##26989
		turnin Northern Cooking##13088
		learn Northern Stew##57421 |goto 57.80,71.40
	//Emotions food
	step
	...
	step
		...
		collect Orange##38656 |q 12634/1 |goto 37.60,61.80
		collect 2 Banana Bunch##38653 |q 12634/2 |goto 37.60,61.80
		collect Papaya##38655 |q 12634/3 |goto 37.60,61.80
	step
		talk Grimbooze Thunderbrew##29157
	...
	step
		talk Erika Tate##5483
		buy 2 Simple Flour##30817 |goto 77.60,53.10
	step
		talk Innkeeper Allison##6740
		buy 2 Tundra Berries##35949 |goto Stormwind City 60.80,74.80
		buy 1 Savory Snowplum##35948 |goto Stormwind City 60.80,74.80
	step
		Build a Basic Campfire |cast Basic Campfire##818
...
QuestCore:RegisterInclude("Our_Daily_Bread",[[
	...
	step
		...
		collect 1 Aged Dalaran Limburger##43137 |q 13103 |goto 54.70,31.50
		...
		collect 6 Half Full Dalaran Wine Glass##43138 |q 13103 |goto 54.70,31.50
	...
	step
		...
		collect 1 Jug of Wine##43128 |q 13101/2 |goto 55.00,30.80
	step
	...
	step
		Enter the Dalaran sewers |goto Dalaran,60.20,47.70 < 10 |walk
...
QuestCore:RegisterInclude("The_Outland_Gourmet",[[
	...
	step
		...
		learn Golden Fish Sticks##33295 |goto Terokkar Forest 56.60,53.20
		use Recipe: Spicy Crawdad##27700
		learn Spicy Crawdad##33296 |goto Terokkar Forest 56.60,53.20
	...
	step
		talk Innkeeper Allison##6740
		buy 5 Goldenbark Apple##4539 |goto Stormwind City 60.80,74.80
		buy 4 Ice Cold Milk##1179 |goto Stormwind City 60.80,74.80
	step
		talk Erika Tate##5483
		buy 8 Simple Flour##30817 |goto 77.60,53.10
		buy 4 Mild Spices##2678 |goto 77.60,53.10
	step
		talk Reese Langston##1327
		buy 1 Flask of Port##2593 |goto Stormwind City 76.30,53.00
	step
...
QuestCore:RegisterInclude("Old_Gnome_and_the_Sea",[[
		...
		_Successfully fish_ from a school |achieve 153 |goto Redridge Mountains 27.60,48.70
	step
...
QuestCore:RegisterInclude("Northrend_Fisherman",[[
...
QuestCore:RegisterInclude("Thousand_Fish",[[
		_Use_ your fishing ability |cast Fishing##7620
		_Catch_ #1000# fish |achieve 1561 |goto Stormwind City 54.90,69.70
	step
...
QuestCore:RegisterInclude("Master_Angler_of_Northrend",[[
	...
	step
		...
		buy 1 Fishing Pole##6256 |goto Stormwind City 55.00,69.70
		buy 10 Shiny Bauble##6529 |goto Stormwind City 55.00,69.70
	step
		talk Isirami Fairwind##32413
		home Dalaran |goto Dalaran 44.70,63.30
	step
		talk Elder Clearwater##38294
		turnin Kalu'ak Fishing Derby##24803 |goto Dalaran 52.40,65.20
	step
		click Teleport to Violet Stand Crystal##191229 |goto Dalaran 56.00,46.80 < 7
	...
	step
		...
		Earn the Achievement Master Angler of Northrend |achieve 306 |goto Dalaran 52.40,65.20
]])

QuestCore:RegisterInclude("Northrend_Angler_Angler",[[
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from an Imperial Manta Ray school |achieve 1517/7 |goto Borean Tundra 49.50,79.00
		|tip Check around this area.
		_Fish_ from a Borean Man O' War school |achieve 1517/1 |goto Borean Tundra 40.30,77.00
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Musselback Scuplin school |achieve 1517/9 |goto Borean Tundra 51.20,42.40
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Deep Sea Monsterbelly school |achieve 1517/2 |goto Borean Tundra 82.70,59.50
		|tip Check around this area.
		_Fish_ from a Moonglow Cuttlefish school |achieve 1517/8 |goto Borean Tundra 82.70,59.50
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Nettlefish school |achieve 1517/10 |goto Sholazar Basin 46.80,64.70
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Dragonfin Angelfish school |achieve 1517/3 |goto Dragonblight 42.30,67.80
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Glassfin Minnow school |achieve 1517/6 |goto Crystalsong Forest 49.00,54.10
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Glacial Salmon school |achieve 1517/5 |goto Grizzly Hills 28.60,60.80
		|tip Check around this area.
	step
		_Use_ your fishing ability |cast Fishing##7620
		_Fish_ from a Fangtooth Herring school |achieve 1517/4 |goto Howling Fjord 60.80,60.30
		|tip Check around this area.
	step
