...
QuestCore:RegisterInclude("A_Baradin_Hold_Dailies",[[
	step
	label "begin"
	...
	step
		...
		accept Claiming The Keep##28059 |goto 73.40,59.20
		accept Leave No Weapon Behind##28063 |goto 73.40,59.20
		accept Not The Friendliest Town##28130 |goto 73.40,59.20
		accept Teach A Man To Fish.... Or Steal##28137 |goto 73.40,59.20
		accept Walk A Mile In Their Shoes##28065 |goto 73.40,59.20
		Click here when no more quests are available |confirm --noquest
	step
		talk Camp Coordinator Brack##48255
		accept A Sticky Task##27948 |goto 73.70,57.60
		accept Boosting Morale##27972 |goto 73.70,57.60
		accept Captain P. Harris##27970 |goto 73.70,57.60
		accept Rattling Their Cages##27971 |goto 73.70,57.60
		accept Shark Tank##28050 |goto 73.70,57.60
		accept Thinning the Brood##27944 |goto 73.70,57.60
		Click here when no more quests are available |confirm --noquest
	step
		talk Lieutenant Farnsworth##48250
		accept Finish The Job##28046 |goto 74.80,59.60
		accept First Lieutenant Connor##27967 |goto 74.80,59.60
		accept Magnets, How Do They Work?##27992 |goto 74.80,59.60
		accept Salvaging the Remains##27966 |goto 74.80,59.60
		accept The Forgotten##27949 |goto 74.80,59.60
		Click here when no more quests are available |confirm --noquest
	stickystart "largosghosts"
	step
		Follow the path up |goto 74.30,42.80 < 10 |only if walking
		kill Commander Largo##47304 |q 27991/1 |goto 78.60,42.00
	...
	label "largosghosts"
		...
		Slay #14# Largo's Overlook Ghosts |q 27978/1 |goto 78.20,49.00 |only if haveq(27978)
		click Cannonball Stack##176215 |only if haveq(27987)
		collect 4 Stack of Cannonballs##62818 |q 27987/1 |goto 78.20,49.00 |only if haveq(27987)
	...
	step
		...
		kill 14 Rustberg Village Residents |q 28130/1 |goto 67.60,37.10
		|only if haveq(28130)
	stickystart "stickysilk"
	step
		kill 12 Darkwood Lurker##46508+ |q 27944/1 |goto 54.20,47.00
		|only if haveq(27944)
	step
	label "stickysilk"
		kill Darkwood Broodmother##46507+
		collect 4 Sticky Silk Gland##62803 |q 27948/1 |goto 54.20,47.00
		|only if haveq(27948)
	step
		kill Captain P. Harris##47287 |q 27970/1 |goto 47.90,8.10
	...
	step
		...
		collect 6 Barrel of Southsea Rum##62810 |q 27972/1 |goto 49.40,19.80 |only if haveq(27972)
		|only if haveq(28050) or haveq(27972)
	step
		kill 8 Shipwrecked Sailor##46605+ |q 27971/1 |goto 49.00,29.40
		|only if haveq(27971)
	step
		kill Keep Lord Farson##47447 |q 28059/1 |goto 36.10,27.30
		|tip He's upstairs in the fort.
		|only if haveq(28059)
	step
		talk Farson Hold Prisoner##48308
		Tell you're here to help him escape
		Escort the Farson Prisoner |q 28065/1 |goto 37.80,29.10
		|tip Follow the Farson Hold Prisoner and protect him.
		|only if haveq(28065)
	step
		click Rack of Rifles##206664
		collect 12 Rusty Rifle##62921 |q 28063/1 |goto 41.20,35.80
		|only if haveq(28063)
	step
		kill Foreman Wellson##46648 |q 27975/1 |goto 27.20,47.70
		|only if haveq(27975)
	step
		clicknpc Wellson Cannon##48283
		Shoot the boats
		Destroy #10# Wellson Supply Boats |q 28275/1 |goto 22.20,36.30
		|only if haveq(28275)
	step
		click Shipyard Lumber##206583
		collect 15 Shipyard Lumber##62811 |q 27973/1 |goto 30.10,43.90
		|only if haveq(27973)
	step
		kill 5 Restless Infantry##46823 |q 28046/1 |goto 40.20,57.90 |only if haveq(28046)
		...
		collect 7 Siege Engine Scrap##52285 |q 27992/1 |goto 40.20,57.90 |only if haveq(27992)
		|only if haveq(28046) or haveq(27992)
	step
		kill First Lieutenant Connor##46571 |q 27967/1 |goto 38.40,77.60
		|only if haveq(27967)
	step
		kill Wandering Soul##46586+, Forgotten Ghoul##46569+ |only if haveq(27966)
		collect 9 Cursed Femur##62808 |q 27966/1 |goto 38.10,71.50 |only if haveq(27966)
		click Forgotten Soldier's Tombstone##206570 |only if haveq(27949)
		Release #6# Tortured Souls |q 27949/1 |goto 38.10,71.50 |only if haveq(27949)
		|only if haveq(27966) or haveq(27949)
	step
		talk Sergeant Gray##48254
		turnin Bomb's Away!##28275 |goto 72.90,60.90 |only if haveq(28275)
		turnin Cannonball!##27987 |goto 72.90,60.90 |only if haveq(27987)
		turnin Ghostbuster##27978 |goto 72.90,60.90 |only if haveq(27978)
		turnin Taking the Overlook Back##27991 |goto 72.90,60.90 |only if haveq(27991)
		turnin WANTED: Foreman Wellson##27975 |goto 72.90,60.90 |only if haveq(27975)
		turnin Watch Out For Splinters!##27973 |goto 72.90,60.90 |only if haveq(27973)
	step
		talk Commander Marcus Johnson##47240
		turnin Claiming The Keep##28059 |goto 73.40,59.20 |only if haveq(28059)
		turnin Leave No Weapon Behind##28063 |goto 73.40,59.20 |only if haveq(28063)
		turnin Not The Friendliest Town##28130 |goto 73.40,59.20 |only if haveq(28130)
		turnin Teach A Man To Fish.... Or Steal##28137 |goto 73.40,59.20 |only if haveq(28137)
		turnin Walk A Mile In Their Shoes##28065 |goto 73.40,59.20 |only if haveq(28065)
	step
		talk Camp Coordinator Brack##48255
		turnin A Sticky Task##27948 |goto 73.70,57.60 |only if haveq(27948)
		turnin Boosting Morale##27972 |goto 73.70,57.60 |only if haveq(27972)
		turnin Captain P. Harris##27970 |goto 73.70,57.60 |only if haveq(27970)
		turnin Rattling Their Cages##27971 |goto 73.70,57.60 |only if haveq(27971)
		turnin Shark Tank##28050 |goto 73.70,57.60 |only if haveq(28050)
		turnin Thinning the Brood##27944 |goto 73.70,57.60 |only if haveq(27944)
	step
		talk Lieutenant Farnsworth##48250
		turnin Finish The Job##28046 |goto 74.80,59.60 |only if haveq(28046)
		turnin First Lieutenant Connor##27967 |goto 74.80,59.60 |only if haveq(27967)
		turnin Magnets, How Do They Work?##27992 |goto 74.80,59.60 |only if haveq(27992)
		turnin Salvaging the Remains##27966 |goto 74.80,59.60 |only if haveq(27966)
		turnin The Forgotten##27949 |goto 74.80,59.60 |only if haveq(27949)
	step
	...
	label "wansworth_is_here"
		...
		accept D-Block##28165 |goto 51.40,49.60
		accept Svarnos##28185 |goto 51.40,49.60
		accept Cursed Shackles##28186 |goto 51.40,49.60
		|next "exit"
	step
	label "stevens_is_here"
		talk Commander Stevens##48039
		accept Clearing the Depths##28117 |goto 51.50,49.50
		accept Learning From The Past##28120 |goto 51.50,49.50
		accept The Imprisoned Archmage##28118 |goto 51.50,49.50
		|next "exit"
	step
	...
	label "exit"
		Continuing...
	step
		Enter the underground jail |goto 42.70,39.10 < 10 |walk
		|only if haveq(28185) or haveq(28165) or haveq(28186)
	stickystart "slaydemons"
	step
		kill Svarnos##47544+
		collect Svarnos' Cursed Collar##63143 |q 28185/1 |goto 48.30,30.70
		|only if haveq(28185)
	step
	label "slaydemons"
		kill Imprisoned Imp##47549+, Cell Watcher##47542+, Shivan Destroyer##47540+, Jailed Wrathguard##47548+ |only if haveq(28165)
		Slay #10# Demons |q 28165/1 |goto 44.40,30.50 |only if haveq(28165)
		click Cursed Shackle##181 |only if haveq(28186)
		collect 8 Cursed Shackles##63149 |q 28186/1 |goto 44.40,30.50 |only if haveq(28186)
		|only if haveq(28165) or haveq(28186)
	step
		kill Baradin Crocolisk##47591+
		collect 8 Crocolisk Hide##63103 |q 28162/1 |goto 42.10,41.80
		|only if haveq(28162)
	step
		Enter the underground jail |goto 44.00,69.20 |walk
		kill Warden Silva##48036
		collect Warden's Keys##63309 |q 28223/1 |goto 37.50,71.70
		|only if haveq(28223)
	step
		kill Imprisoned Worker##47550+, Exiled Mage##47552+ |only if haveq(28188)
		Slay 10 Prisoners |q 28188/1 |goto 40.90,78.20 |only if haveq(28188)
		click Crate of Cellblock Rations##206996 |only if haveq(28232)
		collect 12 Cellblock Ration##63315 |q 28232/1 |goto 40.90,78.20 |only if haveq(28232)
		|only if haveq(28188) or haveq(28232)
	step
		Enter the underground jail |goto 60.80,50.10 |walk
		kill Archmage Galus##47537
		collect Archmage Galus' Staff##63033 |q 28118/1 |goto 56.80,54.80
		|only if haveq(28118)
	step
		kill Captive Spirit##47531+, Ghastly Convict##47590+ |only if haveq(28117)
		Slay #9# Ghosts |q 28117/1 |goto 51.40,49.50 |only if haveq(28117)
		click Dusty Prison Journal##206890 |only if haveq(28120)
		collect 4 Dusty Prison Journal##63034 |q 28120/1 |goto 51.40,49.50 |only if haveq(28120)
	...
	step
		...
		Kill #12# Horde Infantry |q 28163/1 |goto 51.10,29.70
		|only if haveq(28163)
	step
		kill Problim##47593 |q 28122/1 |goto 52.80,36.70
	...
	step
		talk 2nd Lieutenant Wansworth##48061
		turnin D-Block##28165 |goto 51.40,49.60
		turnin Svarnos##28185 |goto 51.40,49.60
		turnin Cursed Shackles##28186 |goto 51.40,49.60
		|only if haveq(28165) or haveq(28185) or haveq(28186)
	step
		talk Commander Stevens##48039
		turnin Clearing the Depths##28117 |goto 51.50,49.50
		turnin Learning From The Past##28120 |goto 51.50,49.50
		turnin The Imprisoned Archmage##28118 |goto 51.50,49.50
		|only if haveq(28117) or haveq(28120) or haveq(28118)
	step
		talk Marshal Fallows##48074
		turnin Food From Below##28232 |goto 51.50,49.60
		turnin Prison Revolt##28188 |goto 51.50,49.60
		turnin The Warden##28223 |goto 51.50,49.60
...
QuestCore:RegisterInclude("SW_Cooking_Dailies",[[
...
QuestCore:RegisterInclude("IF_Cooking_Dailies",[[
	step
...
QuestCore:RegisterInclude("Darn_Cooking_Dailies",[[
		talk Alegorn##4210
...
QuestCore:RegisterInclude("A_Shattrath_Cooking_Dailies",[[
	step
		talk The Rokk##24393
...
QuestCore:RegisterInclude("A_Firelands_PreQuests", [[
	...
	step
		clicknpc Aronus##39128 |goto Moonglade 46.10,45.60
	...
	step
		...
		kill 30 Unbound Flame Spirit##40065 |q 25323/1 |goto Mount Hyjal 48.50,29.20
	step
		talk Malfurion Stormrage##15362
	...
	step
		...
		turnin A Prisoner of Interest##25324 |goto Mount Hyjal 56.80,18.80 |indoors Hyjal Barrow Dens
		accept Through the Dream##25325 |goto Mount Hyjal 56.80,18.80 |indoors Hyjal Barrow Dens
	step
	...
	step
		...
		accept Gar'gol's Gotta Go##25328 |goto Mount Hyjal 27.20,40.80 |indoors Gar'gol's Hovel
	step
		click Gar'gol's Personal Treasure Chest##204580
		collect Rusted Skull Key##52789 |q 25328/1 |goto Mount Hyjal 26.50,38.50 |indoors Gar'gol's Hovel
	step
		click The Twilight Apocrypha##202712
		turnin Mastering Puppets##25301 |goto Mount Hyjal 25.80,41.70 |indoors Gar'gol's Hovel
		accept Elementary!##25303 |goto Mount Hyjal 25.80,41.70 |indoors Gar'gol's Hovel
	step
	...
	step
		talk Kristoff Manheim##39797
		turnin Gar'gol's Gotta Go##25328 |goto Mount Hyjal 27.20,40.80 |indoors Gar'gol's Hovel
		accept Get Me Outta Here!##25332 |goto Mount Hyjal 27.20,40.80 |indoors Gar'gol's Hovel
	step
		Escort Kristoff Out |q 25332/1 |goto Mount Hyjal 27.10,36.00 |indoors Gar'gol's Hovel
	step
		talk Royce Duskwhisper##39435
	...
	step
		kill 8 Twilight Stormcaller |q 25352/1 |goto Mount Hyjal 27.40,39.20
		kill 5 Howling Riftdweller |q 25352/2 |goto Mount Hyjal 27.40,39.20
	...
	step
		...
		kill Forgemaster Pyrendius |q 25600/1 |goto Mount Hyjal 31.60,46.00
	step
		talk Jordan Olafson##40834
	...
	step
		...
		accept Aviana's Legacy##27874 |goto Mount Hyjal 28.20,29.80
	step
		talk Rio Duran##39434
	...
	label "ragingfirestorm"
		kill 10 Raging Firestorm |q 25381/1 |goto Mount Hyjal 13.30,41.40
		kill 6 Twilight Inferno Lord |q 25382/1 |goto Mount Hyjal 13.30,41.40
	...
	step
		kill 8 Charbringer |q 25490/1 |goto 21.60,59.10
	step
	...
	step
		...
		kill 3 Twilight Juggernaut |q 25761/1 |goto 31.60,75.80
	...
	step
		...
		kill 10 Twilight Knight Rider |q 25525/1 |goto 35.40,51.70
	step
		Use your Flap ability on your hotbar repeatedly to fly to this spot
		talk Farden Talonshrike##40578
	...
	step
		...
		kill 10 Twilight Lancer |q 25544/1 |goto 35.40,51.70
	step
		Use your Flap ability on your hotbar repeatedly to fly to this spot
		talk Farden Talonshrike##40578
	...
	step
		kill 5 Fiery Tormentor |q 25842/1 |goto 27.10,54.50
	step
		talk Nordu##41381
...
QuestCore:RegisterInclude("A_Frenzyheart_PreQuests", [[
	...
	label "hardmatriarch"
		...
		kill Hardknuckle Matriarch |q 12530/1 |goto Sholazar Basin 66.90,73.20
	step
		talk High-Shaman Rakjak##28082
...
QuestCore:RegisterInclude("A_Frenzyheart_Dailies", [[
		talk Zepik the Gorloc Hunter##28668
...
QuestCore:RegisterInclude("Hodir_Quests",[[
...
QuestCore:RegisterInclude("A_Therazane_PreQuest",[[
	step
		ding 30
	step
...
QuestCore:RegisterInclude("Tillers_Dailies",[[
	...
	label "infested"
		...
		collect Vintage Bug Sprayer##80513 |n |goto 52.20,48.30
	...
	step
	label "wild"
		clicknpc Wild Scallions##63170 |goto 52.00,48.40
	...
	step
	label "tangled"
		clicknpc Tangled Scallions##63168 |goto 52.00,48.40 |n
		Run here |goto 51.70,48.90 < 5 |walk
	step
		Click here to return to the information page |next "info" |confirm
		Click here when you are have tilled your crops |next "bursting" |confirm
	step
	...
	step
		...
		accept The Kunzen Hunter-Chief##30336 |or |goto 53.00,51.80
		accept Stealing is Bad... Re-Stealing is OK##30334 |or |goto 53.00,51.80
		accept Stalling the Ravage##30335 |or |goto 53.00,51.80
		accept The Lesser of Two Evils##30333 |or |goto 53.00,51.80
		accept Simian Sabotage##30337 |or |goto 53.00,51.80
		|only if not completedq(32682)
	step
		talk Andi##64464
		|tip He will only have 1 quest a day.
		accept A Gift For Fung##30475 |or |goto 52.70,50.50
		accept A Gift For Chee Chee##30471 |or |goto 52.70,50.50
		accept A Gift For Haohan##30477 |or |goto 52.70,50.50
		accept A Gift For Jogu##30478 |or |goto 52.70,50.50
		accept A Gift For Sho##30472 |or |goto 52.70,50.50
		accept A Gift For Tina##30470 |or |goto 52.70,50.50
		accept A Gift For Ella##30474 |or |goto 52.70,50.50
		accept A Gift For Old Hillpaw##30476 |or |goto 52.70,50.50
		accept A Gift For Fish##30473 |or |goto 52.70,50.50
		accept A Gift For Gina##30479 |or |goto 52.70,50.50
	step
		talk Ella##58647
	...
	step
		...
		|only if haveq(31673)
	step
		talk Wing Nga##60231 |goto 56.50,50.40
	...
	step
		...
		You can also find this here: [41.60,42.80]
		or here: [37.50,37.30]
		|only if haveq(30479)
	step
		talk Lost Dog##59533
	...
	step
		...
		You can deliver lost hens to the chicken coop here [30.40,52.50]
	...
	label "yupingsoup"
		...
		Kick 4 Blazing Ember |q 30325/2 |goto 29.70,34.50
	...
	step
		...
		Trave to the Past |complete QC.InPhase('OldVale') |goto Vale of Eternal Blossoms New/0 80.97,29.48 |q 30337
		|only if haveq(30337)
	step
	...
	step
		Enter this warren |goto 46.90,21.10 < 5 |walk
		kill Springtail Warren-Mother##59516 |q 30333/1 |goto 48.70,18.70
		|only if haveq(30333)
	step
		Leave the warren |goto 46.90,21.10 < 5 |walk
		Enter this warren |goto 44.00,22.30 < 5 |walk
	...
	label "uncutchrysoberyl"
		Leave the warren |goto 44.00,22.30 < 5 |walk
	...
	step
		...
		turnin A Gift For Fung##30475 |only if haveq(30475) |goto 52.90,51.70
	step
		talk Fish Fellreed##58705
		turnin The Kunzen Legend-Chief##30326 |goto 52.80,51.80
		turnin A Gift For Fish##30473 |only if haveq(30473) |goto 52.80,51.80
	step
		talk Ella##58647
		turnin You Have to Burn the Ropes##30327 |goto  53.00,51.70
		turnin A Gift For Ella##30474 |only if haveq(30474) |goto  53.00,51.70
	step
		talk Sho##58708
		turnin Where It Counts##30325 |goto 53.10,52.10
		turnin A Gift For Sho##30472 |only if haveq(30472) |goto 53.10,52.10
	step
		talk Gina Mudclaw##58706
		turnin Money Matters##30322 |goto 53.20,51.80
		turnin A Gift For Gina##30479 |only if haveq(30479) |goto 53.20,51.80
	step
		talk Old Hillpaw##58707
		turnin Chasing the Chicken##30318 |goto 53.10,51.90
		turnin A Gift For Old Hillpaw##30476 |only if haveq(30476) |goto 53.10,51.90
	step
		talk Tina Mudclaw##58761
		turnin A Gift For Tina##30470 |only if haveq(30470) |goto 53.10,51.70
		turnin They Don't Even Wear Them##30323 |goto 53.10,51.70
	step
		talk Haohan Mudclaw##57402
		turnin Pest Problems##30319 |goto 53.00,51.70
		turnin A Gift For Haohan##30477 |only if haveq(30477) |goto 53.00,51.70
	step
		talk Jogu the Drunk##58710
		turnin Weed War II##30321 |goto 53.60,52.50
		turnin A Gift For Jogu##30478 |only if haveq(30478) |goto 53.60,52.50
	step
		talk Chee Chee##58709
		turnin Not in Chee-Chee's Backyard##30324 |goto 53.10,52.10
		turnin A Gift For Chee Chee##30471 |only if haveq(30471) |goto 53.10,52.10
	...
	step
		When you arrive at Sunsong Ranch you will get a buff. After 15 minutes your ranch will be expanded |goto 51.90,48.30
	...
	step
	label "revered"
		talk Gina Mudclaw##58706 |goto 53.20,51.80
		buy 1 Grand Commendation of the Tillers##93226 |n
		Use the Commendation of the Tillers you just purchased |complete QC:GetReputation("The Tillers").hasBonus |use Grand Commendation of the Tillers##93226
	...
	step
		...
		Ride 5 Escaped Shagskin to [50.40,34.70] |q 30518/1 |goto 51.00,36.70
	step
		talk Farmer Fung##57298
	...
	step
		Enter this warren |goto 47.00,20.90 < 5 |walk
		click Cave Lily##210969
		collect Cave Lily##80141 |q 30525/2
	step
		Leave this warren |goto 47.00,20.90 < 5 |walk
		Enter this warren |goto 44.00,22.20 < 5 |walk
		click Bloodbloom##210968
		collect Bloodbloom##80140 |q 30525/1
	step
		Leave this warren |goto 44.00,22.20 < 5 |walk
		click Violet Lichen##210971
		collect Violet Lichen##80143 |q 30525/4 |goto 42.50,22.30
	step
		Enter this warren |goto 39.40,20.40 < 5 |walk
		click Ghostcap##210970
		collect Ghostcap##80142 |q 30525/3
	step
		Leave this warren |goto 39.40,20.40 < 5 |walk
		talk Farmer Yoon##58646
	...
	step
		...
		accept Haohan's Vote V: Chief Yip-Yip##30528 //20000 Revered? |goto 52.20,48.80
	step
		Enter the cave here |goto 33.10,20.20 < 5 |walk
	...
	step
		...
		click Offering Bowl##241877 |goto 52.00,49.00
		confirm
		|next "end"
	step
	label "exalted"
...
QuestCore:RegisterInclude("WAccord_Quests",[[
	...
	step
		...
		12 Frigid Ghoul Attackers |kill 12 Frigid Ghoul Attacker |q 12448/1 |goto Dragonblight/0 50.40,52.20
		8 Frigid Geist Attackers |kill 8 Frigid Geist Attacker |q 12448/2 |goto Dragonblight/0 50.40,52.20
		1 Frigid Abomination Attacker |kill 1 Frigid Abomination Attacker |q 12448/3 |goto Dragonblight/0 50.40,52.20
	step
		talk Ceristrasz##27506
...
QuestCore:RegisterInclude("WAccord_Dailies", [[
	...
	step
		...
		kill 3 Azure Dragon |q 12372/1 |goto 58.30,55.20
		kill 5 Azure Drake |q 12372/2 |goto 58.30,55.20
	step
...
QuestCore:RegisterInclude("A_Beasts_of_Fable_D",[[
...
-- LEGION
QuestCore:RegisterInclude("Legion_Choose_World_Quests",[[
		...
		'|confirm |next "Court_of_Farondis_WQ" |complete readyq(42420) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Dreamweavers_WQ" |complete readyq(42170) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Highmountain_Tribe_WQ" |complete readyq(42233) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Valarjar_WQ" |complete readyq(42234) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Nightfallen_WQ" |complete readyq(42421) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Wardens_WQ" |complete readyq(42422) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Kirin_Tor_WQ" |complete readyq(43179) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Armies_of_Legionfall_WQ" |complete readyq(48641) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Argussian_Reach_WQ" |complete readyq(48642) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Army_of_the_Light_WQ" |complete readyq(48639) and not QC.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

QuestCore:RegisterInclude("Legion_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if QC.WorldQuests:QuestsQueued()
	step
...
-- BATTLE FOR AZEROTH
QuestCore:RegisterInclude("BFA_Choose_World_Quests",[[
		Choose a World Quest to Complete |confirm
		|tip With the "World Quests" guide loaded, open your world map.
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "Tortollan_Seekers_WQ" |complete (readyq(50604) or readyq(54451)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Alliance_War_Effort_WQ" |complete (readyq(50605) or readyq(54454)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Order_of_Embers_WQ" |complete (readyq(50600) or readyq(54456)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Proudmoore_Admiralty_WQ" |complete (readyq(50599) or readyq(54458)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Storms_Wake_WQ" |complete (readyq(50601) or readyq(54457)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Champions_of_Azeroth_WQ" |complete (readyq(50562) or readyq(54453)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Nevin_Tideheart_Turnin" |complete (readyq(55663) or readyq(55768)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Lieutenant_Hawkins_Turnin" |complete (readyq(55845) or readyq(55777) or readyq(55770) or readyq(55776) or readyq(55773) or readyq(55775) or readyq(55774) or readyq(55772) or readyq(55750) or readyq(55771)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "The_Ankoan_WQ" |complete (readyq(56119) or readyq(55976)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Rustbolt_Resistance_WQ" |complete readyq(55348) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Rajani_WQ" |complete readyq(58096) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Uldum_Accord_WQ" |complete readyq(58097) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Nazjatar_Battle_Pet_Drop_Q" |complete (haveq(56444,56446,56447,56448,56449,56450,56451,56452,56453,56454,56455,56456)) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Mechagon_Battle_Pet_Drop_Q" |complete (haveq(56437,56443,56442,56440,56441,56438,56439,56436)) and not QC.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

QuestCore:RegisterInclude("BFA_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if QC.WorldQuests:QuestsQueued()
	step
	...
	label "Champions_of_Azeroth_WQ"
		...
		Return to the Present |complete not QC.InPhase("Old Silithus") |goto Silithus/0 78.93,21.97
...
--SHADOWLANDS
QuestCore:RegisterInclude("Shadow_Choose_World_Quests",[[
		Choose a World Quest to Complete |confirm
		|tip With the "World Quests" guide loaded, open your world map.
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "The_Ascended_WQ" |complete readyq(61097) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Court_of_Harvesters_WQ" |complete readyq(61100) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "The_Undying_Army_WQ" |complete readyq(61095) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "The_Wild_Hunt_WQ" |complete readyq(61098) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Death's_Advance_WQ" |complete readyq(64012) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Enlightened_WQ" |complete readyq(64867) and not QC.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

QuestCore:RegisterInclude("Shadow_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if QC.WorldQuests:QuestsQueued()
	step
