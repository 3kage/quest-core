...
QuestCore:RegisterInclude("ArgentT_Quests",[[
	step
...
QuestCore:RegisterInclude("MoP_Cooking_Dailies",[[
...
QuestCore:RegisterInclude("Nomi_Dailies",[[
...
QuestCore:RegisterInclude("SSO_PreQuest_Dailies",[[
...
QuestCore:RegisterInclude("Oracles_PreQuests",[[
...
QuestCore:RegisterInclude("Oracles_Dailies",[[
...
QuestCore:RegisterInclude("CS_PreQuests",[[
...
QuestCore:RegisterInclude("Therazane_Dailies", [[
		Starting Dailies |complete true
	step
	label "dailies"
	...
	step
		...
		accept The Restless Brood##28391 |goto 56.60,14.10
	...
	step
		...
		accept Lost In The Deeps##26710 |goto 55.40,14.20
		|tip This quest can be offered at random and may not be offered everyday.
	step
		talk Gorsik the Tumultuous##43804
		accept Soft Rock##27049 |goto 57.30,12.50
		accept Fungal Fury##27050 |goto 57.30,12.50
	step
		talk Ruberick##44973
		accept Through Persistence##27051 |goto 59.60,14.00
		accept Glop, Son of Glop##28390 |only if rep ('Therazane') >= Revered |goto 59.60,14.00
		|tip This quest can be offered at random if you have at least Revered reputation with Therazane. However, the quest may not be offered everyday.
	step
		...
		Strike the Pale Resonating Crystal |q 28391/1 |goto 32.70,24.30
		kill Aeosera##43641
	...
	step
		talk Terrath the Steady##43806
		turnin The Restless Brood##28391 |goto 56.60,14.10
		|only if rep ('Therazane') >= Revered
	stickystart "painitemote"
	step
		Enter the cave |goto 58.30,25.60 < 10 |walk
		talk Ricket##44968
		accept Underground Economy##27048 |goto 61.30,26.20
		|tip This quest can be offered at random and may not be offered everyday.
	step
		...
		collect Ruby Crystal Cluster##64404 |q 28488/1 |goto 66.10,28.10
	step
		...
		collect 3 Deep Alabaster Crystal##65504 |q 27048/1 |goto 63.60,23.00
	step
		Follow this path |goto 62.60,23.90 < 10 |only if walking
		...
		collect 3 Deep Celestite Crystal##65507 |q 27048/2 |goto 61.80,19.70
	step
		Follow this path |goto 62.00,18.00 < 10 |only if walking
		...
		collect 3 Deep Amethyst Crystal##65508 |q 27048/3 |goto 64.40,18.60
	step
		Follow this path |goto 65.30,18.40 < 10 |only if walking
		...
		collect 3 Deep Garnet Crystal##65510 |q 27048/4 |goto 66.40,20.20
	step
	label "painitemote"
		All around inside this cave:
		kill Gorged Gyreworm##42766+, Gyreworm##44257+
		kill 10 Gyreworm |q 27046/1 |goto 63.60,23.90
		Click Painite Shards
		|tip They look like small green glowing crystals sitting on the ground all around inside this cave.
		collect 10 Painite Mote##60791 |q 27047/1 |goto 63.60,23.90
	step
		talk Pebble##49956 |goto 63.10,20.80
		Tell him to follow you
	step
		Follow this path |goto 64.20,17.60 < 10 |only if walking
		talk Ricket##44968
		turnin Underground Economy##27048 |goto 61.30,26.20
	step
		Leave the cave |goto 58.30,25.60 < 10 |walk
		Wait in this spot until Pebble bobbles around appreciatively and then disappears into the distance
		Bring Pebble to safety |q 26710/1 |goto 58.30,25.60
	step
		kill 8 Fungal Behemoth |q 27049/1 |goto 74.00,41.20
		kill Verlok Grubthumper##43367+, Verlok Shroomtender##43368+
		collect Bag of Verlok Miracle-Grow##60767 |q 27051/1 |goto 74.00,41.20
		...
		Destroy 10 Freshly Sprouted Mushrooms |q 27050/1 |goto 74.00,41.20
	step
		Enter the cave |goto 68.60,29.10 < 10 |walk
		talk Earthmender Norsala##43503
		Tell her you're ready when she is
		kill Fungalmancer Glop |q 28390/1 |goto 69.80,31.90
	...
	step
		...
		Leave the cave |goto 68.60,29.10 < 10 |walk
		talk Felsen the Enduring##43805
	...
	step
		talk Pyrite Stonetender##44945
		turnin Lost In The Deeps##26710 |goto 55.40,14.20
	step
		talk Gorsik the Tumultuous##43804
		turnin Soft Rock##27049 |goto 57.30,12.50
		turnin Fungal Fury##27050 |goto 57.30,12.50
	step
		talk Ruberick##44973
		turnin Through Persistence##27051 |goto 59.60,14.00
		turnin Glop, Son of Glop##28390 |only if rep ('Therazane') >= Revered |goto 59.60,14.00
	step
		You have reached the end of the dailies for today.
		Click here to be taken back to the beginning of the dailies |confirm |next "dailies"
]])

QuestCore:RegisterInclude("Sunreavers_dailies_Conqueror_Terrace_Objectives",[[
	step
		confirm
]])
...
QuestCore:RegisterInclude("Tillers_Quests",[[
...
--DRAGONFLIGHT
QuestCore:RegisterInclude("Dragon_Choose_World_Quests",[[
		...
		'|confirm |next "Valdrakken_Accord_WQ" |complete readyq(71023) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Maruuk_Centaur_WQ" |complete readyq(65606) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Iskaara_Tuskarr_WQ" |complete readyq(66511) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Dragonscale_Expedition_WQ" |complete readyq(66156) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Loamm_Niffen_WQ" |complete readyq(75290) and not QC.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

QuestCore:RegisterInclude("Dragon_World_Quest_Emissaries",[[
...
--TWW
QuestCore:RegisterInclude("TWW_Choose_World_Quests",[[
		Choose a World Quest to Complete |confirm
		|tip With the "World Quests" guide loaded, open your world map.
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "Council_of_Dornogal_WQ" |complete readyq(79219) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Hallowfall_Arathi_WQ" |complete readyq(79218) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Assembly_of_the_Deeps_WQ" |complete readyq(79634) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Severed_Threads_WQ" |complete readyq(79196) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Cartels_of_Undermine_WQ" |complete readyq(85805) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Notorious_with_the_General_WQ" |complete readyq(83739) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Notorious_with_the_Vizier_WQ" |complete readyq(83740) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Notorious_with_the_Weaver_WQ" |complete readyq(83738) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Renowned_with_the_K'aresh_Trust_WQ" |complete readyq(85109) and not QC.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

QuestCore:RegisterInclude("TWW_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if QC.WorldQuests:QuestsQueued()
	step
	label "Council_of_Dornogal_WQ"
		...
		|tip Inside the building.
		turnin Renowned with the Council of Dornogal##79219 |goto Dornogal/0 39.09,24.16
	...
	label "Hallowfall_Arathi_WQ"
		...
		turnin Renowned with the Hallowfall Arathi##79218
		|only if readyq(79218)
	step
	label "Assembly_of_the_Deeps_WQ"
		talk Waxmonger Quiwik##223726
		|tip Inside the building.
		turnin Renowned with The Assembly of the Deeps##79634 |goto The Ringing Deeps/0 43.36,32.79
		|only if readyq(79634)
	step
	label "Severed_Threads_WQ"
		talk Lady Vinazian##223750
		turnin Renowned with The Severed Threads##79196 |goto Azj-Kahet/0 55.33,41.22
		|only if readyq(79196)
	step
	label "Cartels_of_Undermine_WQ"
		talk Smaks Topskimmer##231409
		|tip Inside the building.
		turnin Renowned with the Cartels of Undermine##85805 |goto Undermine/0 43.85,50.82
		|only if readyq(85805)
	step
	label "Notorious_with_the_General_WQ"
		talk Aspirant Kiipka##229184
		turnin Notorious with The General##83739 |goto Azj-Kahet/0 55.89,42.13
		|only if readyq(83739)
	step
	label "Notorious_with_the_Vizier_WQ"
		talk Tulumun##224733
		turnin Notorious with The Vizier##83740 |goto Azj-Kahet/0 56.20,42.24
		|only if readyq(83740)
	step
	label "Notorious_with_the_Weaver_WQ"
		talk Bobbin##224734
		turnin Notorious with The Weaver##83738 |goto Azj-Kahet/0 56.37,43.33
		|only if readyq(83738)
	step
	label "Renowned_with_the_K'aresh_Trust_WQ"
		--talk Bobbin##224734
		turnin Renowned with the K'aresh Trust##85109 --|goto Azj-Kahet/0 56.37,43.33
		|only if readyq(85109)
	step
		|next "Choose_World_Quest"
]])

--Midnight
QuestCore:RegisterInclude("MID_Choose_World_Quests",[[
		Choose a World Quest to Complete |confirm
		|tip With the "World Quests" guide loaded, open your world map.
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "Amani_Tribe_WQ" |complete readyq(93566) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Blood_Knights_WQ" |complete readyq(92411) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Farstriders_WQ" |complete readyq(92412) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Hara'ti_WQ" |complete readyq(89035) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Magisters_WQ" |complete readyq(92410) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Shades_of_the_Row_WQ" |complete readyq(92413) and not QC.WorldQuests:QuestsQueued()
		'|confirm |next "Silvermoon_Court_WQ" |complete readyq(93811) and not QC.WorldQuests:QuestsQueued()
		|worldquestqueue
]])

QuestCore:RegisterInclude("MID_World_Quest_Emissaries",[[
		-- if we are running queued world quests, do not move to emissary turnins
		'|confirm |next "Choose_World_Quest" |complete true |only if QC.WorldQuests:QuestsQueued()
	step
	label "Amani_Tribe_WQ"
		talk Magovu##240279
		--|tip Inside the building.
		turnin Renowned with the Amani Tribe##93566 |goto Zul Aman M/0 45.8,65.8
		|only if readyq(93566)
	step
	label "Blood_Knights_WQ"
		talk Armorer Goldcrest##242725
		--|tip Inside the tent.
		turnin Renowned with the Blood Knights##92411 |goto Eversong Woods M/0 43.4,47.4
		|only if readyq(92411)
	step
	label "Farstriders_WQ"
		talk Ranger Allorn##242724
		--|tip Inside the building.
		turnin Renowned with the Farstriders##92412 |goto Eversong Woods M/0 43.4,47.6
		|only if readyq(92412)
	step
	label "Hara'ti_WQ"
		talk Naynar##240407
		turnin Renowned with the Hara'ti##89035 |goto Harandar/0 51.0,50.8
		|only if readyq(89035)
	step
	label "Magisters_WQ"
		talk Apprentice Diell##242723
		--|tip Inside the building.
		turnin Renowned with the Magisters##92410 |goto Eversong Woods M/0 43.4.47.4
		|only if readyq(92410)
	step
	label "Shades_of_the_Row_WQ"
		talk Neriv##242726
		turnin Renowned with the Shades of the Row##92413 |goto Eversong Woods M/0 43.4,47.6
		|only if readyq(92413)
	step
	label "Silvermoon_Court_WQ"
		talk Naynar##240407
		turnin Renowned with the Silvermoon Court##93811 |goto Harandar/0 51.0,50.8
		|only if readyq(93811)
	step
		|next "Choose_World_Quest"
]])