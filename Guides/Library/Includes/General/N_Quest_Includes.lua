...
QuestCore:RegisterInclude("celestial_tournament",[[
...
QuestCore:RegisterInclude("Toraan_the_Revered",[[
		turnin Argussian Reach##48642 |goto Antoran Wastes/5 56.32,28.70 |only if (QC.CurrentMapID==885 or QC.CurrentMapID==886 or QC.CurrentMapID==887)
		turnin Argussian Reach##48642 |goto Eredath/3 66.69,58.99 |only if (QC.CurrentMapID==882 or QC.CurrentMapID==883 or QC.CurrentMapID==884)
		turnin Argussian Reach##48642 |goto Krokuun/1 68.20,56.95 |only if default
]])

QuestCore:RegisterInclude("Vindicator_Jaelaana",[[
		turnin Army of the Light##48639 |goto Antoran Wastes/5 62.61,63.91 |only if (QC.CurrentMapID==885 or QC.CurrentMapID==886 or QC.CurrentMapID==887)
		turnin Army of the Light##48639 |goto Eredath/3 43.37,67.09 |only if (QC.CurrentMapID==882 or QC.CurrentMapID==883 or QC.CurrentMapID==884)
		turnin Army of the Light##48639 |goto Krokuun/1 43.25,74.39 |only if default
]])

QuestCore:RegisterInclude("Toraan_the_Revered_Paragon",[[
		turnin Supplies From the Argussian Reach##48976 |goto Antoran Wastes/5 56.32,28.70 |only if (QC.CurrentMapID==885 or QC.CurrentMapID==886 or QC.CurrentMapID==887)
		turnin Supplies From the Argussian Reach##48976 |goto Eredath/3 66.69,58.99 |only if (QC.CurrentMapID==882 or QC.CurrentMapID==883 or QC.CurrentMapID==884)
		turnin Supplies From the Argussian Reach##48976 |goto Krokuun/1 68.20,56.95 |only if default
]])

QuestCore:RegisterInclude("Vindicator_Jaelaana_Paragon",[[
		turnin Supplies From the Army of the Light##48977 |goto Antoran Wastes/5 62.61,63.91 |only if (QC.CurrentMapID==885 or QC.CurrentMapID==886 or QC.CurrentMapID==887)
		turnin Supplies From the Army of the Light##48977 |goto Eredath/3 43.37,67.09 |only if (QC.CurrentMapID==882 or QC.CurrentMapID==883 or QC.CurrentMapID==884)
