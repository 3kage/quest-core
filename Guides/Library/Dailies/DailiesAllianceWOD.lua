...
QuestCore:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Lunarfall Inn Dungeon Dailies",{
...
accept Fat Sleeper##36513 |or |goto Lunarfall/0 54.00,14.80
accept Fire Ammonite##36510 |or |goto Lunarfall/0 54.00,14.80
accept Blind Lake Sturgeon##36514 |or |goto Lunarfall/0 54.00,14.80
accept Abyssal Gulper Eel##36517 |or |goto Lunarfall/0 54.00,14.80
accept Blackwater Whiptail##36515 |or |goto Lunarfall/0 54.00,14.80
accept Jawless Skulker##36511 |or |goto Lunarfall/0 54.00,14.80
...
collect 10 Fat Sleeper Egg##112631 |q 36513/1 |goto Nagrand D 72.50,26.50
step
...
collect 10 Fire Ammonite Eg##112628 |q 36510/1 |goto Frostfire Ridge/0 51.60,59.05
step
Fish in the water here |cast Fishing##131474
...
collect 10 Blind Lake Sturgeon Egg##112629 |q 36514/1 |goto Shadowmoon Valley D 48.50,34.15
step
Fish in the water here |cast Fishing##131474
...
collect 10 Abyssal Gulper Eel Egg##112627 |q 36517/1 |goto Spires of Arak 63.70,21.80
step
Fish in the water here |cast Fishing##131474
...
collect 10 Blackwater Whiptail Egg##112626 |q 36515/1 |goto Talador 63.00,34.65
step
...
collect 10 Jawless Skulker Egg##112630 |q 36511/1 |goto Gorgrond 43.50,81.00
step
talk Ron Ashton##77733
turnin Jawless Skulker##36511 |goto Lunarfall/0 54.00,14.80 |only if haveq(36511)
turnin Blackwater Whiptail##36515 |goto Lunarfall/0 54.00,14.80 |only if haveq(36515)
turnin Abyssal Gulper Eel##36517 |goto Lunarfall/0 54.00,14.80 |only if haveq(36517)
turnin Blind Lake Sturgeon##36514 |goto Lunarfall/0 54.00,14.80 |only if haveq(36514)
turnin Fire Ammonite##36510 |goto Lunarfall/0 54.00,14.80 |only if haveq(36510)
turnin Fat Sleeper##36513 |goto Lunarfall/0 54.00,14.80 |only if haveq(36513)
step
talk Nat Pagle##85984
accept Abyssal Gulper Lunker##36802 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(116818) > 0
accept Blackwater Whiptail Lunker##36803 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(116817) > 0
accept Blind Lake Lunker##36804 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(116820) > 0
accept Fat Sleeper Lunker##36805 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(116821) > 0
accept Felmouth Frenzy Lunker##39283 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(127994) > 0
accept Fire Ammonite Lunker##36800 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(116819) > 0
accept Jawless Skulker Lunker##36806 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(116822) > 0
accept Sea Scorpion Lunker##38406 |or |goto Lunarfall/0 38.20,72.00 |only if itemcount(122696) > 0
...
accept Battle Pet Roundup##36483 |or |only if hasbuilding(42) or hasbuilding(167) |goto Lunarfall 29.20,40.40
accept Mastering the Menagerie##37644 |or |only if hasbuilding(168) |goto Lunarfall 29.20,40.40
step
...
Defeat the Pets in the Small Arena |q 36483/1 |or |only if hasbuilding(42) or hasbuilding(167) | goto Lunarfall/0 28.70,43.50
Defeat the Pets in the Small Arena |q 36483/1 |or |only if hasbuilding(168) |goto Lunarfall/0 28.70,43.50
step
talk Lio the Lioness##85418
turnin Battle Pet Roundup##36483 |only if haveq(36483) or hasbuilding(167) |goto Lunarfall 29.20,40.40
turnin Mastering the Menagerie##37644 |only if haveq(37644) |goto Lunarfall 29.20,40.40
step
talk Erris the Collector##91014
accept Critters of Draenor##38299 |goto Lunarfall/0 31.10,39.60
step
talk Erris the Collector##91014
Tell her "_Let's do this!_"
...
Defeat Erris the Collector In a Pet Battle |q 38299/1 |goto Lunarfall/0 31.10,39.60
step
talk Erris the Collector##91014
turnin Critters of Draenor##38299 |goto Lunarfall/0 31.10,39.60
|next "start"
]])
...
collect Grimoire of the Nameless Void##121834 |q 37885/2 |goto Shadowmoon Valley D/0 43.70,75.00
|next "Turnin"
step
label "Thunderlord"
...
Receive the Blessing of Frost |q 37918/1 |goto Frostfire Ridge/0 42.60,12.60
step
Click the _Quest Complete_ Box:
...
kill Gutrek##89824
collect Gutrek's Cleaver##121814 |q 37811/3 |goto Nagrand D/0 52.80,26.60
|next "Turnin"
step
label "Infected"
...
Find Gu'rakh and Ride to Skulltaker |q 37945/2 |goto Gorgrond/0 62.10,31.80
step
kill Skulltaker##90262
collect Silent Skull##122150 |q 37945/3 |goto Gorgrond/0 57.20,26.90
|next "Turnin"
step
label "Turnin"
...
QuestCore:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Muradin Bronzebeard Dailies",{
...
Defeat Teron'gor in Heroic Auchindoun |q 37796/1 |goto Auchindoun/1 49.60,33.50 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Teron'gor in Heroic Auchindoun |q 37796/1 |goto Auchindoun/1 49.60,33.50 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "BSM"
kill Gug'rokk##74790
Defeat Gug'rokk in Heroic Bloodmaul Slag Mines |q 37795/1 |goto Bloodmaul Slag Mines/1 65.40,22.70 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Gug'rokk in Heroic Bloodmaul Slag Mines |q 37795/1 |goto Bloodmaul Slag Mines/1 65.40,22.70 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "SBG"
kill Ner'zhul##76407
Defeat Ner'zhul in Heroic Shadowmoon Burial Ground |q 37792/1 |goto Shadowmoon Burial Grounds/3 48.10,47.10 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Ner'zhul in Heroic Shadowmoon Burial Ground |q 37792/1 |goto Shadowmoon Burial Grounds/3 48.10,47.10 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "Skyreach"
kill High Sage Viryx##76266
Defeat High Sage Viryx in Heroic Skyreach |q 37791/1 |goto Skyreach/2 48.80,33.30 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat High Sage Viryx in Heroic Skyreach |q 37791/1 |goto Skyreach/2 48.80,33.30 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "Everbloom"
kill Yalnu##83846
Defeat Yalnu in Heroic Everbloom |q 37790/1 |goto The Everbloom/2 47.00,67.00 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Yalnu in Heroic Everbloom |q 37790/1 |goto The Everbloom/2 47.00,67.00 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "UBRS"
kill Warlord Zaela##77120
Defeat Warlord Zaela in Heroic Upper Blackrock Spire |q 37789/1 |goto Upper Blackrock Spire 2/3 14.10,47.70 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Warlord Zaela in Heroic Upper Blackrock Spire |q 37789/1 |goto Upper Blackrock Spire 2/3 14.10,47.70 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "GD"
kill Skylord Tovra##80005
Defeat Skylord Tovra in Heroic Grimrail Depot |q 37794/1 |goto Grimrail Depot/4 15.30,51.70 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Skylord Tovra in Heroic Grimrail Depot |q 37794/1 |goto Grimrail Depot/4 15.30,51.70 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "Iron"
kill Skulloc##83612
Defeat Skulloc in Heroic Iron Docks |q 37793/1 |goto Iron Docks/1 68.40,43.60 |next "Turnin_1_2" |only if garrisonlvl(1) or garrisonlvl(2)
Defeat Skulloc in Heroic Iron Docks |q 37793/1 |goto Iron Docks/1 68.40,43.60 |next "Turnin_3" |only if garrisonlvl(3)
|tip If you have our dungeon guide, load it when prompted after entering the instance.
step
label "Turnin_1_2"
#include "Garrison_BGrey"
...
Defeat Ko'ragh in Highmaul: Arcane Sanctum |q 37767/1 |goto Highmaul/4 37.90,65.30 |next "Turnin2"
step
label "Blackhand"
...
Defeat Blackhand in Blackrock Foundry: Blackrock Crucible |q 37772/1 |goto Blackrock Foundry/5 48.70,41.70 |next "Turnin2"
step
label "Imperator"
...
Defeat Imperator Mar'gok in Highmaul: Imperator's Rise |q 37768/1 |goto Highmaul/6 45.30,75.20 |next "Turnin2"
step
label "Admiral"
...
Defeat Admiral Gar'an in Blackrock Foundry: Iron Assembly |q 37771/1 |goto Blackrock Foundry/1 82.30,28.30 |next "Turnin2"
step
label "Heart"
...
Defeat the Heart of the Mountain in Blackrock Foundry: Slagworks |q 37769/1 |goto Blackrock Foundry/2 46.30,53.80 |next "Turnin2"
step
label "Kromog"
kill Kromog##77692
_Tank_:
...
Defeat Kromog in Blackrock Foundry: The Black Forge |q 37770/1 |goto Blackrock Foundry/1 33.20,43.10 |next "Turnin2"
step
label "Brackenspore"
...
Defeat Brackenspore in Highmaul: Walled City |q 37766/1 |goto Highmaul/1 50.80,16.40 |next "Turnin2"
step
label "Turnin2"
#include "Garrison_BGrey"
...
QuestCore:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Renzik Daily Quests",{
...
collect Humming Draenite Spike##122133 |q 37773/1 |goto Talador/0 78.60,21.00
|next "Turnin"
step
label "Gor'thul"
...
kill Gor'thul##89843 |q 37774/1 |goto Spires of Arak/0 50.00,72.00
|next "Turnin"
step
label "Tremor"
kill Tremor##90070
...
collect Pile of Partially Digested Lobstrok Meat##122132 |q 37777/1 |goto Gorgrond/0 35.20,42.00
|next "Turnin"
step
label "Undertow"
...
kill Undertow##89825 |q 37776/1 |goto Shadowmoon Valley D/0 52.80,8.60
|next "Turnin"
step
label "Hivelord"
kill Hivelord Ik'rix##89827
|tip Periodically, the Hivelord will summon baby adds. These adds deal minimal damage.
collect Iceshatter Carapace##122134 |q 37778/1 |goto Frostfire Ridge/0 66.70,81.50
|next "Turnin"
step
label "Darkoor"
...
Win the Exhibition Match |q 37775/1 |goto Nagrand D/0 56.20,13.60 |only if haveq(37775)
Win the Exhibition Match |q 37948/1 |goto Nagrand D/0 56.20,13.60 |only if haveq(37948)
|next "Turnin"
step
label "Turnin"
#include "Garrison_BGrey"
...
Assault the Botani Forces in the Everbloom Wilds |q 36676/1 |goto Gorgrond/0 57.50,44.00 |only if haveq(36676)
Assault the Botani Forces in the Everbloom Wilds |q 38192/1 |goto Gorgrond/0 57.50,44.00 |only if haveq(38192)
...
Assault the Iron Horde forces at the Iron Siegeworks |q 36674/1 |goto Frostfire Ridge/0 85.70,51.40 |only if haveq(36674)
Assault the Iron Horde forces at the Iron Siegeworks |q 38191/1 |goto Frostfire Ridge/0 85.70,51.40 |only if haveq(38191)
|tip You will see a progress bar in your quest tracking area.
...
step
_Follow_ the snow path up |goto Frostfire Ridge/0 65.50,35.10 < 40
...
Assault the Stone Monstrosities at Magnarok |q 36675/1 |goto Frostfire Ridge/0 69.40,29.40 |only if haveq(36675)
Assault the Stone Monstrosities at Magnarok |q 38190/1 |goto Frostfire Ridge/0 69.40,29.40 |only if haveq(38190)
|tip You will see a progress bar in your quest tracking area.
...
Assault the Bloodmaul Forces at Stonefury Cliffs |q 36648/1 |goto Frostfire Ridge/0 47.40,17.10 |only if haveq(36648)
Assault the Bloodmaul Forces at Stonefury Cliffs |q 38189/1 |goto Frostfire Ridge/0 47.40,17.10 |only if haveq(38189)
|tip You will see a progress bar in your quest tracking area.
...
Exploit the Conflict at the Broken Precipice |q 36677/1 |goto Nagrand D/0 38.70,24.10 |only if haveq(36677)
Exploit the Conflict at the Broken Precipice |q 38193/1 |goto Nagrand D/0 38.70,24.10 |only if haveq(38193)
|tip You will see a progress bar in your quest tracking area.
...
Assault the Iron Horde Forces at Darktide Roost |q 36679/1 |goto Shadowmoon Valley D 59.10,86.00 |only if haveq(36679)
Assault the Iron Horde Forces at Darktide Roost |q 38196/1 |goto Shadowmoon Valley D 59.10,86.00 |only if haveq(38196)
|tip You will see a progress bar in your quest tracking area.
...
Assault the Shadowmoon Orcs at the Pillars of Fate |q 36682/1 |goto Spires of Arak/0 73.40,30.80 |only if haveq(36682)
Assault the Shadowmoon Orcs at the Pillars of Fate |q 38199/1 |goto Spires of Arak/0 73.40,30.80 |only if haveq(38199)
|tip You will see a progress bar in your quest tracking area.
...
Assault the Sargerei Forces at Socrethar's Rise |q 36680/1 |goto Shadowmoon Valley D/0 49.30,78.20 |only if haveq(36680)
Assault the Sargerei Forces at Socrethar's Rise |q 38197/1 |goto Shadowmoon Valley D/0 49.30,78.20 |only if haveq(38197)
|tip You will see a progress bar in your quest tracking area.
...
Assault the Hostile Creatures at Lost Veil Anzu |q 36681/1 |goto Spires of Arak 73.30,45.40 |only if haveq(36681)
Assault the Hostile Creatures at Lost Veil Anzu |q 38198/1 |goto Spires of Arak 73.30,45.40 |only if haveq(38198)
|tip You will see a progress bar in your quest tracking area.
...
Assault the Arakkoa Forces at Skettis |q 36683/1 |goto Spires of Arak/0 58.00,11.50 |only if haveq(36683)
Assault the Arakkoa Forces at Skettis |q 38200/1 |goto Spires of Arak/0 58.00,11.50 |only if haveq(38200)
|tip You will see a progress bar in your quest tracking area.
...
Dominate the Gorian Proving Grounds |q 38194/1 |goto Nagrand D/0 57.20,17.60
|tip You will see a progress bar in your quest tracking area.
...
Assault the Sargerei Forces in Shattrath City |q 36809/1 |goto Talador/0 41.20,42.30
|tip You will see a progress bar in your quest tracking area.
...
Assault the Sargerei Forces at Shattrath City |q 36649/1 |goto Talador/0 44.60,37.30 |only if haveq(36649)
Assault the Sargerei Forces at Shattrath City |q 38201/1 |goto Talador/0 44.60,37.30 |only if haveq(38201)
|tip You will see a progress bar in your quest tracking area.
...
step
collect 5 Iron Horde Scraps##113681 |q 37092/1 |goto Talador 68.40,4.60
...
step
collect 25 Iron Horde Scraps##113681 |q 38175/1 |goto Talador 68.40,4.60
|tip These can be looted from dungeons and Grom'kar mobs in northern Talador.
step
#include "Garrison_Large_Building", action="talk Kristen Stoneforge##77377", building="Armory"
|tip She is located inside your Dwarven Bunker.
...
collect 10 Abyssal Gulper Eel Egg##112627 |q 36517/1 |goto Spires of Arak/0 60.90,17.80 |next "FishTurnin"
step
label "Gulper2"
...
use Blackwater Whiptail##111663 |only if itemcount(111663) > 4
use Enormous Blackwater Whiptail##111670 |only if itemcount(111670) > 4
collect 10 Blackwater Whiptail Egg##112626 |q 36515/1 |goto Talador 63.00,34.65 |next "FishTurnin"
step
label "Whiptail2"
#include "Garrison_Pagle"
...
use Blind Lake Sturgeon##111667 |only if itemcount(111667) > 4
use Enormous Blind Lake Sturgeon##111674 |only if itemcount(111674) > 4
collect 10 Blind Lake Sturgeon Egg##112629 |q 36514/1 |goto Shadowmoon Valley D 48.50,34.15 |next "FishTurnin"
step
label "Sturgeon2"
#include "Garrison_Pagle"
...
use Fat Sleeper##111668 |only if itemcount(111668) > 4
use Enormous Fat Sleeper##111675 |only if itemcount(111675) > 4
collect 10 Fat Sleeper Egg##112631 |q 36513/1 |goto Nagrand D 72.50,26.50 |next "FishTurnin"
step
label "Sleeper2"
#include "Garrison_Pagle"
...
use Fire Ammonite##111666 |only if itemcount(111666) > 4
use Enormous Fire Ammonite##111673 |only if itemcount(111673) > 4
collect 10 Fire Ammonite Eg##112628 |q 36510/1 |goto Frostfire Ridge/0 51.60,59.05 |next "FishTurnin"
step
label "Fire2"
#include "Garrison_Pagle"
...
use Jawless Skulker##111669 |only if itemcount(111669) > 4
use Enormous Jawless Skulker##111676 |only if itemcount(111676) > 4
collect 10 Jawless Skulker Egg##112630 |q 36511/1 |goto Gorgrond 43.50,81.00 |next "FishTurnin"
step
label "Skulker2"
#include "Garrison_Pagle"
...
Obtain the Mark of Pet Mastery by defeating the challenge team |q 36483/1 |goto Lunarfall/0 28.80,42.90
step
#include "Garrison_Lioness"
...
Obtain the Mark of Pet Mastery |q 37644/1 |goto Lunarfall/0 29.00,42.70
step
#include "Garrison_Lioness"
...
QuestCore:RegisterGuide("Daily Guides\\Warlords of Draenor Dailies\\Tanaan Jungle (100)\\Hand of the Prophet Dailies",{
