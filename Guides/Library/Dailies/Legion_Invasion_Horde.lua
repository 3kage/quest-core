...
QuestCore:RegisterGuide("Horde Event Guides\\Legion\\Pre-Launch Invasion Event",{
	author="QuestCore",
...
QuestCore:RegisterGuide("Leveling Guides\\Legion (10-50)\\Legion Intro",{
	...
	step
		click Ribs##251255
		Eat your Last Meal |q 44281/3 |goto Durotar/0 47.65,13.54
		|only if not haveq(44543)
	step
		click Keg of Armor Polish##251195
		Polish your Armor |q 44281/1 |goto Durotar/0 49.62,14.15
		|only if not haveq(44543)
	step
		click Light-Infused Crystals##251235
		Empower your Weapon |q 44281/2 |goto Durotar/0 51.37,12.28
		|only if not haveq(44543)
	step
		talk Arienne Black##113948
		|tip Fight her.
		Warm Up with a Duel |q 44281/4 |goto Durotar/0 52.82,11.32
		|only if not haveq(44543)
	step
		talk Stone Guard Mukar##113547
		turnin To Be Prepared##44281 |goto Durotar/0 55.63,11.03
		accept The Battle for Broken Shore##40518 |goto Durotar/0 55.63,11.03
		|only if not haveq(44543)
	step
		talk Captain Russo##113118
		Take the Ship to the Broken Shore |q 40518/1 |goto Durotar/0 57.77,10.49
		|only if not haveq(44543)
	step
	...
	step
		...
		Kill #33# Demons |scenariogoal 2/27653 |goto Broken Shore/0 52.46,64.91 |q 40518 |only if haveq(40518) or completedq(40518)
		Kill #33# Demons |scenariogoal 2/27653 |goto Broken Shore/0 52.46,64.91 |q 44543 |only if haveq(44543) or completedq(44543)
	step
	label "fel_lords1"
		Kill enemies around this area
		|tip Follow the group.
		Kill #3# Fel Lords |scenariogoal 2/29377 |goto Broken Shore/0 52.46,64.91 |q 40518 |only if haveq(40518) or completedq(40518)
		Kill #3# Fel Lords |scenariogoal 2/29377 |goto Broken Shore/0 52.46,64.91 |q 44543 |only if haveq(44543) or completedq(44543)
	step
	label "spires_of_woe"
		kill Anchoring Crystal##91704+
		|tip Follow the group.
		Destroy #3# Spires of Woe |scenariogoal 2/27619 |goto Broken Shore/0 52.46,64.91 |q 40518 |only if haveq(40518) or completedq(40518)
		Destroy #3# Spires of Woe |scenariogoal 2/27619 |goto Broken Shore/0 52.46,64.91 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		kill Fel Commander Azgalor##93719 |scenariogoal 3/30883 |goto Broken Shore/0 52.46,64.91 |q 40518 |only if haveq(40518) or completedq(40518)
		kill Fel Commander Azgalor##93719 |scenariogoal 3/30883 |goto Broken Shore/0 52.46,64.91 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		Run up the path |goto Broken Shore/0 53.36,62.66 < 30
		Watch the dialogue
		|tip Follow the group.
		Find Sylvanas and Baine |scenariostage 4 |goto Broken Shore/0 53.98,51.09 |q 40518 |only if haveq(40518) or completedq(40518)
		Find Sylvanas and Baine |scenariostage 4 |goto Broken Shore/0 53.98,51.09 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		kill Shielded Anchor##101667+
		|tip They look like big floating green crystals.
		Shatter #4# Shielded Anchors |scenariogoal 5/32861 |goto Broken Shore/0 54.43,49.64 |q 40518 |only if haveq(40518) or completedq(40518)
		Shatter #4# Shielded Anchors |scenariogoal 5/32861 |goto Broken Shore/0 54.43,49.64 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		Watch the dialogue
		|tip Follow the group.
		Kill enemies all around this area
		Assault the Demon City |scenariostage 6 |goto Broken Shore/0 56.72,50.14 |q 40518 |only if haveq(40518) or completedq(40518)
		Assault the Demon City |scenariostage 6 |goto Broken Shore/0 56.72,50.14 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		Watch the dialogue
		|tip Follow the group.
		Find Tirion |scenariostage 7 |goto Broken Shore/0 57.18,35.03 |q 40518 |only if haveq(40518) or completedq(40518)
		Find Tirion |scenariostage 7 |goto Broken Shore/0 57.18,35.03 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		Kill enemies around this area
		kill Krosus##90544
		Slay Krosus |scenariostage 8 |goto Broken Shore/0 57.18,35.03 |q 40518 |only if haveq(40518) or completedq(40518)
		Slay Krosus |scenariostage 8 |goto Broken Shore/0 57.18,35.03 |q 44543 |only if haveq(44543) or completedq(44543)
	step
		Follow the path up |goto Broken Shore/0 58.08,34.78 < 20
		Follow the path up |goto Broken Shore/0 64.05,33.37 < 20
		Watch the dialogue
		|tip Follow the group
		Kill the enemies that attack in waves
		Confront Gul'dan |scenarioend |goto Broken Shore/0 63.31,30.97 |q 40518 |only if haveq(40518) or completedq(40518)
		Confront Gul'dan |scenarioend |goto Broken Shore/0 63.31,30.97 |q 44543 |only if haveq(44543) or completedq(44543)
		Assault the Broken Shore |q 40518/2 |goto Broken Shore/0 63.31,30.97 |only if haveq(40518) or completedq(40518)
		Assault the Broken Shore |q 44543/1 |goto Broken Shore/0 63.31,30.97 |only if haveq(44543) or completedq(44543)
	step
		talk Eitrigg##100453
	...
	step
		Fly into Orgrimmar |goto Durotar/0 48.01,11.63 > 10000 |walk
	...
	step
		Watch the dialogue
		Learn the Fate of the Horde |q 40522/3 |goto Orgrimmar/1 48.35,71.33
	step
		talk Lady Sylvanas Windrunner##100866
		Pledge to Warchief Sylvanas |q 40522/4 |goto Durotar/0 45.71,15.88
	step
		talk Lady Sylvanas Windrunner##100866
		turnin Fate of the Horde##40522 |goto Durotar/0 45.71,15.88
		accept Emissary##40760 |goto Durotar/0 45.71,15.88
	step
		talk Allari the Souleater##100873
		turnin Emissary##40760 |goto Durotar/0 45.82,15.11
		accept Demons Among Us##40607 |goto Durotar/0 45.82,15.11
	step
		talk Allari the Souleater##100873
		Learn what Allari the Souleater Knows |q 40607/1 |goto Durotar/0 45.82,15.11
	step
		Kill enemies around this area
		Slay #12# Demons |q 40607/2 |goto Durotar/0 45.94,14.70
	step
		talk Lady Sylvanas Windrunner##101035
		turnin Demons Among Us##40607 |goto Durotar/0 45.68,15.92
		accept Keep Your Friends Close##40605 |goto Durotar/0 45.68,15.92
	step
		Fly into Orgrimmar |goto Durotar/0 45.95,12.19 > 10000 |walk
	...
	step
		...
		accept Calling of the Council##40718 |goto Orgrimmar/1 52.91,56.51
	step
		Enter the Cleft of Shadow |goto Orgrimmar/1 45.79,66.88 > 10000 |walk
	...
	step
		...
		Watch the dialogue
		Have Khadgar Address the Council of Six |q 40718/3 |goto Deadwind Pass/21 30.55,48.97
	step
		talk Archmage Khadgar##113637
		turnin Calling of the Council##40718 |goto Deadwind Pass/21 29.76,48.83
	step
		Watch the dialogue
