...
step
Enter the building |goto Stormwind City 45.77,78.03 < 7 |walk |only if Human
talk Tel'Athir##5500 |goto Stormwind City 46.25,79.10 |only if Human
Enter the building |goto Ironforge/0 67.67,53.52 |only if Dwarf or Gnome
talk Vosur Brakthel##1246 |goto Ironforge/0 66.33,55.68 |only if Dwarf or Gnome
Enter the building |goto Darnassus/0 55.55,21.21 |only if NightElf
talk Milla Fairancora##11041 |goto Darnassus/0 55.38,22.72 |only if NightElf
|tip Inside the building. |only if Human or Dwarf or Gnome
|tip inside the building, on the ground floor. |only if NightElf
...
step
Enter the building |goto Stormwind City 45.77,78.03 < 7 |walk |only if Human
talk Eldraeith##5503 |goto Stormwind City 46.66,78.64 |only if Human
Enter the building |goto Ironforge/0 67.67,53.52 |only if Dwarf or Gnome
talk Soolie Berryfizz##5178 |goto Ironforge/0 66.24,54.52 |only if Dwarf or Gnome
Enter the building |goto Darnassus/0 55.55,21.21 |only if NightElf
talk Ulthir##4226 |goto Darnassus/0 55.84,24.49 |only if NightElf
|tip Inside the building. |only if Human or Dwarf or Gnome
|tip inside the building, on the ground floor. |only if NightElf
...
step
Enter the building |goto Stormwind City 45.77,78.03 < 7 |walk |only if Human
talk Lilyssia Nightbreeze##5499 |goto Stormwind City 46.50,79.67 |only if Human
Enter the building |goto Ironforge/0 67.67,53.52 |only if Dwarf or Gnome
talk Tally Berryfizz##5177 |goto Ironforge/0 66.62,55.68 |only if Dwarf or Gnome
Enter the building |goto Darnassus/0 55.55,21.21 |only if NightElf
talk Sylvanna Forestmoon##11042 |goto Darnassus/0 56.38,24.23 |only if NightElf
|tip Inside the building. |only if Human or Dwarf or Gnome
|tip inside the building, on the ground floor. |only if NightElf
...
|tip Use the leveling guides to accomplish this.
step
talk Smith Argus##514 |goto Elwynn Forest/0 41.71,65.55 |only if Human
Enter the building. |goto Dun Morogh/0 45.90,51.84 < 7 |walk |only if Dwarf or Gnome
talk Tognus Flintfire##1241 |goto Dun Morogh/0 45.32,51.92 |only if Dwarf or Gnome
talk Delfrum Flintbeard##6299 |goto Darkshore/0 38.19,40.94 |only if NightElf
|tip Inside the building. |only if Human or Dwarf or Gnome
...
'|complete skill("Blacksmithing") >= 300 |or
step
talk Edna Mullby##1286 |goto Stormwind City/0 58.23,60.52 |only if Human
Enter the building. |goto Ironforge/0 42.05,33.24 < 5 |walk |only if Dwarf or Gnome
talk Bombus Finespindle##5128 |goto Ironforge/0 39.61,34.48 |only if Dwarf or Gnome
Enter the building. |goto Darkshore/0 37.77,41.36 < 5 |walk |only if NightElf
talk Valdaron##4189 |goto Darkshore/0 38.15,40.60 |only if NightElf
|tip Inside the building.
buy 35 Green Dye##2605 |or
'|complete skill("Blacksmithing") >= 165 |or
step
label "Begin_Profession_Leveling"
talk Tharynn Bouden##66 |goto Elwynn Forest/0 41.82,67.17 |only if Human
Enter the building. |goto Dun Morogh/0 45.90,51.84 < 7 |walking |only if Dwarf or Gnome
talk Thrawn Boltar##1690 |goto Dun Morogh/0 45.30,51.53 |only if Dwarf or Gnome
talk Elisa Steelhand##6300 |goto Darkshore/0 38.14,41.11 |only if NightElf
|tip Inside the building. |only if Dwarf or Gnome
...
|tip Use the leveling guides to accomplish this.
step
talk Rotgath Stonebeard##10276 |goto Ironforge 52.36,42.55 |only if Dwarf or Gnome or NightElf
talk Therum Deepforge##5511 |goto Stormwind City/0 56.84,16.24 |only if Human
...
goto Ironforge 52.36,42.55 |only if Dwarf or Gnome or NightElf
goto Stormwind City/0 57.05,16.39 |only if Human
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Small Spider Leg",{
expansion="classic_era",
meta={goldtype="route",levelreq=5},
items={5465},
maps={"Teldrassil"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Crag Boar Rib",{
expansion="classic_era",
meta={goldtype="route",levelreq=5},
items={2886},
maps={"Dun Morogh"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Spider Ichor",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={3174},
maps={"Loch Modan"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Boar Intestines",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={3172},
maps={"Westfall"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Stringy Vulture Meat",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={729},
maps={"Westfall"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Murloc Eye",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={730},
maps={"Westfall"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Goretusk Snout",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={731},
maps={"Westfall"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Goretusk Liver",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={723},
maps={"Westfall"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Boar Ribs",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={2677},
maps={"Loch Modan"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Crocolisk Meat",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={2924},
maps={"Loch Modan"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Tough Condor Meat",{
expansion="classic_era",
meta={goldtype="route",levelreq=14},
items={1080},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Soft Frenzy Flesh",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={5468},
maps={"Darkshore"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Raw Loch Frenzy",{
expansion="classic_era",
meta={goldtype="route",levelreq=15},
items={6317},
maps={"Loch Modan"},
...
QuestCore:RegisterGuide("Profession Guides\\Cooking\\Farming Guides\\Lean Wolf Flank",{
expansion="classic_era",
meta={goldtype="route",levelreq=24},
items={1015},
maps={"Duskwood"},
...
|tip Use the leveling guides to accomplish this.
step
Enter the building |goto Stormwind City 43.68,63.87 < 5 |walk |only if Human
talk Betty Quin##11068 |goto Stormwind City 43.11,63.71 |only if Human
Enter the building |goto Ironforge/0 58.05,45.34 < 5 |walk |only if Dwarf or Gnome
talk Thonys Pillarstone##11065 |goto Ironforge/0 60.29,45.36 |only if Dwarf or Gnome
Enter the building |goto Darnassus/0 61.14,10.52 < 5 |walk |only if NightElf
talk Lalina Summermoon##11070 |goto Darnassus/0 58.79,12.75 |only if NightElf
|tip Inside the building.
...
step
label "Begin_Profession_Leveling"
talk Jessara Cordell##1318 |goto Stormwind City 42.81,64.39 |only if Human
talk Tilli Thistlefuzz##5158 |goto Ironforge/0 61.03,44.01 |only if Dwarf or Gnome
talk Vaean##4228 |goto Darnassus/0 58.57,14.74 |only if NightElf
|tip Inside the building.
...
step
Enter the building |goto Stormwind City 43.68,63.87 < 5 |walk |only if Human
talk Lucan Cordell##1317 |goto Stormwind City 42.94,64.64 |only if Human
Enter the building |goto Ironforge/0 58.05,45.34 < 5 |walk |only if Dwarf or Gnome
talk Gimble Thistlefuzz##5157 |goto Ironforge/0 59.77,45.45 |only if Dwarf or Gnome
Enter the building |goto Darnassus/0 61.14,10.52 < 5 |walk |only if NightElf
talk Taladan##4213 |goto Darnassus/0 58.40,13.11 |only if NightElf
|tip Inside the building.
...
talk Dalria##3954
|tip Inside the building.
buy Formula: Enchant Cloak - Minor Agility##11039 |goto Ashenvale 35.12,52.12 |or 2 |only if not knowsrecipe(13419)
buy Formula: Enchant Bracer - Lesser Strength##11101 |goto Ashenvale 35.12,52.12 |or 2 |only if not knowsrecipe(13536)
|tip These are limited supply items that can also be purchased from the auction house. |only if not selfmade()
|tip These are limited supply items. |only if selfmade()
...
|only if skill("Enchanting") < 165 or itemcount(11101) > 0
step
Enter the building |goto Elwynn Forest/0 64.42,69.12 < 7 |walk
talk Kitta Firewind##11072
|tip Upstairs inside the building, at the top.
...
|tip Inside the building.
buy Formula: Enchant Cloak - Superior Defense##16224 |goto Moonglade 48.24,40.14 |or 2 |only if not knowsrecipe(20015)
buy Formula: Runed Arcanite Rod##16243 |goto Moonglade 48.24,40.14 |or 2 |only if not knowsrecipe(20051)
|tip These are limited supply items that can also be purchased from the auction house. |only if not selfmade()
|tip These are limited supply items. |only if selfmade()
...
|tip Use the leveling guides to accomplish this.
step
talk Sprite Jumpsprocket##11026 |goto Stormwind City/0 54.56,7.92 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Jenna Lemkenilli##11037 |goto Darkshore/0 38.31,41.12 |only if dist("Darkshore/0 38.31,41.12") < 5000
talk Jemma Quikswitch##11028 |goto Ironforge/0 67.65,44.20 |only if default
...
|tip These totals are approximate.
|tip You may need slightly more or less than the indicated amount.
'|complete skill("Engineering") >= ((Gnome and 45) or 30) |or
step
label "Collect_Coarse_Stone_Total"
map Wetlands
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 110) or 95) |or
step
label "Collect_Heavy_Stone_Total"
map Arathi Highlands
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 161) or 146) |or
step
label "Collect_Solid_Stone_Total"
map Badlands
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 210) or 195) |or
step
label "Collect_Dense_Stone_Total"
map Un'Goro Crater
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 275) or 260) |or
step
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 150) or 135) |or
step
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 175) or 160) |or
stickystart "Collect_Silver_Bar_Total"
stickystart "Collect_Bronze_Bar_Total"
...
|tip These totals are approximate.
|tip You may need slightly more or less than the indicated amount.
'|complete skill("Engineering") >= ((Gnome and 90) or 75) |or
step
label "Collect_Silver_Bar_Total"
map Wetlands
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 120) or 105) |or
step
label "Collect_Bronze_Bar_Total"
map Elwynn Forest
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 190) or 175) |or
step
map Wetlands
path follow smart; loop on; ants curved; dist 20
path	34.74,16.82	36.33,18.75	39.75,20.23	43.44,23.27	46.05,22.77
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 315) or 300) or (itemcount(10498) >= 1) |or
step
label "Collect_Mithril_Bar_Total"
map Badlands
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 253) or 238) |or
step
label "Collect_Thorium_Bar_Total"
map Un'Goro Crater
path follow smart; loop on; ants curved; dist 20
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 315) or 300) |or
...
|tip These totals are approximate.
|tip You may need slightly more or less than the indicated amount.
'|complete skill("Engineering") >= ((Gnome and 115) or 100) |or
step
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 231) or 216) |or
step
...
|tip These totals are approximate. |notinsticky
|tip You may need slightly more or less than the indicated amount. |notinsticky
'|complete skill("Engineering") >= ((Gnome and 300) or 285) |or
step
label "Begin_Profession_Leveling"
talk Billibub Cogspinner##5519 |goto Stormwind City/0 55.24,7.08 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Elisa Steelhand##6300 |goto Darkshore/0 38.14,41.11 |only if dist("Darkshore/0 38.31,41.12") < 5000
talk Gearcutter Cogspinner##5175 |goto Ironforge/0 67.83,42.51 |only if dist("Darkshore/0 38.31,41.12") >= 5000 and dist("Elwynn Forest/0 42.32,65.85") >= 2500
buy Blacksmith Hammer##5956 |or
|tip Save this, you will need it later.
'|complete skill("Engineering") >= ((Gnome and 315) or 300) |or
step
...
Reach Skill 30 in Engineering |skill Engineering,30 |only if not Gnome |or
...
|tip Create them with Mining or purchase them from the auction house. |only if not selfmade()
|tip Create them with Mining. |only if selfmade()
'|complete skill("Engineering") >= ((Gnome and 65) or 50) |or
step
Open Your Engineering Crafting Panel:
_<Create 30 Handful of Copper Bolts>_
|tip Stand next to an anvil.
|tip Save these, you will need them later.
goto Stormwind City/0 56.79,15.95 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
goto Darkshore/0 38.22,40.94 |only if dist("Darkshore/0 38.31,41.12") < 5000
goto Ironforge 49.83,44.12 |only if default
...
goto Stormwind City/0 56.79,15.95 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
goto Darkshore/0 38.22,40.94 |only if dist("Darkshore/0 38.31,41.12") < 5000
goto Ironforge 49.83,44.12 |only if (dist("Elwynn Forest/0 42.32,65.85") >= 2500) and (dist("Darkshore/0 38.31,41.12") >= 5000)
Reach Skill 50 in Engineering |skill Engineering,50 |only if not Gnome |or
Reach Skill 65 in Engineering |skill Engineering,65 |only if Gnome |or
step
talk Sprite Jumpsprocket##11026 |goto Stormwind City/0 54.56,7.92 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Jenna Lemkenilli##11037 |goto Darkshore/0 38.31,41.12 |only if dist("Darkshore/0 38.31,41.12") < 5000
talk Jemma Quikswitch##11028 |goto Ironforge/0 67.65,44.20 |only if default
...
|tip Create them with Mining or purchase them from the auction house. |only if not selfmade()
|tip Create them with Mining. |only if selfmade()
'|complete (skill("Engineering") >= ((Gnome and 66) or 51)) or (itemcount(6219) >= 1) |or
step
Open Your Engineering Crafting Panel:
...
goto Darkshore/0 38.22,40.94 |only if dist("Darkshore/0 38.31,41.12") < 5000
goto Ironforge 49.83,44.12 |only if (dist("Elwynn Forest/0 42.32,65.85") >= 2500) and (dist("Darkshore/0 38.31,41.12") >= 5000)
Reach Skill 51 in Engineering |skill Engineering,51 |only if not Gnome |or
Reach Skill 66 in Engineering |skill Engineering,66 |only if Gnome |or
step
talk Sprite Jumpsprocket##11026 |goto Stormwind City/0 54.56,7.92 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Jenna Lemkenilli##11037 |goto Darkshore/0 38.31,41.12 |only if dist("Darkshore/0 38.31,41.12") < 5000
talk Jemma Quikswitch##11028 |goto Ironforge/0 67.65,44.20 |only if default
Train Rough Copper Bomb |learn Rough Copper Bomb##3923
...
goto Darkshore/0 38.22,40.94 |only if dist("Darkshore/0 38.31,41.12") < 5000
goto Ironforge 49.83,44.12 |only if (dist("Elwynn Forest/0 42.32,65.85") >= 2500) and (dist("Darkshore/0 38.31,41.12") >= 5000)
Reach Skill 75 in Engineering |skill Engineering,75 |only if not Gnome |or
Reach Skill 90 in Engineering |skill Engineering,90 |only if Gnome |or
step
Reach Level 10 |ding 10
|tip You must be at least level 10 to train Journeyman professions.
|tip Use the leveling guides to accomplish this.
step
talk Lilliam Sparkspindle##5518 |goto Stormwind City/0 54.81,7.60 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Trixie Quikswitch##11029 |goto Ironforge/0 67.48,42.91 |only if default
...
Reach Skill 95 in Engineering |skill Engineering,95 |only if not Gnome |or
...
Reach Skill 100 in Engineering |skill Engineering,100 |only if not Gnome |or
...
Reach Skill 105 in Engineering |skill Engineering,105 |only if not Gnome |or
...
|tip Create them with Mining or purchase them from the auction house. |only if not selfmade()
|tip Create them with Mining. |only if selfmade()
'|complete skill("Engineering") >= ((Gnome and 140) or 125) |or
step
map Wetlands
path follow smart; loop on; ants curved; dist 20
path	34.74,16.82	36.33,18.75	39.75,20.23	43.44,23.27	46.05,22.77
...
step
talk Billibub Cogspinner##5519 |goto Stormwind City/0 55.24,7.08 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Gearcutter Cogspinner##5175 |goto Ironforge/0 67.83,42.51 |only if default
...
goto Stormwind City/0 56.79,15.95 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
goto Ironforge 49.83,44.12 |only if dist("Elwynn Forest/0 42.32,65.85") >= 2500
Reach Skill 125 in Engineering |skill Engineering,125 |only if not Gnome |or
Reach Skill 140 in Engineering |skill Engineering,140 |only if Gnome |or
step
talk Lilliam Sparkspindle##5518 |goto Stormwind City/0 54.81,7.60 |only if dist("Elwynn Forest/0 42.32,65.85") < 2500
talk Trixie Quikswitch##11029 |goto Ironforge/0 67.48,42.91 |only if default
...
Reach Skill 135 in Engineering |skill Engineering,135 |only if not Gnome |or
...
Reach Skill 150 in Engineering |skill Engineering,150 |goto Ironforge 49.83,44.12 |only if not Gnome |or
...
|tip Save 15 of these, you will need them later.
Reach Skill 160 in Engineering |skill Engineering,160 |only if not Gnome |or
...
Reach Skill 175 in Engineering |skill Engineering,175 |goto Ironforge 49.83,44.12 |only if not Gnome |or
...
'|complete skill("Engineering") >= ((Gnome and 265) or 250) |or
step
Open Your Engineering Crafting Panel:
...
Reach Skill 195 in Engineering |skill Engineering,195 |only if not Gnome |or
...
|tip Create them with Mining or purchase them from the auction house. |only if not selfmade()
|tip Create them with Mining. |only if selfmade()
'|complete skill("Engineering") >= ((Gnome and 215) or 200) |or
step
Open Your Engineering Crafting Panel:
...
Reach Skill 200 in Engineering |skill Engineering,200 |goto Ironforge 49.83,44.12 |only if not Gnome |or
...
Reach Skill 216 in Engineering |skill Engineering,216 |goto Ironforge 49.83,44.12 |only if not Gnome |or
...
Reach Skill 238 in Engineering |skill Engineering,238 |goto Tanaris 51.40,28.72 |only if not Gnome |or
...
Reach Skill 250 in Engineering |skill Engineering,250 |goto Tanaris 51.40,28.72 |only if not Gnome |or
...
Reach Skill 260 in Engineering |skill Engineering,260 |only if not Gnome |or
...
|tip This is a limited supply item that can also be purchased from the auction house. |only if not selfmade()
|tip This is a limited supply item. |only if selfmade()
'|complete skill("Engineering") >= ((Gnome and 300) or 285) or knowsrecipe(19791) |or
step
...
Reach Skill 285 in Engineering |skill Engineering,285 |goto Ironforge 49.83,44.12 |only if not Gnome |or
...
|tip This is a limited supply item that can also be purchased from the auction house. |only if not selfmade()
|tip This is a limited supply item. |only if selfmade()
'|complete skill("Engineering") >= ((Gnome and 315) or 300) or knowsrecipe(19795) |or
step
...
Reach Skill 300 in Engineering |skill Engineering,300 |goto Ironforge 49.83,44.12 |only if not Gnome |or
Reach Skill 315 in Engineering |skill Engineering,315 |goto Ironforge 49.83,44.12 |only if Gnome |or
step
_Congratulations!_
You Reached Skill 300 in Engineering. |only if not Gnome
...
|tip Use the leveling guides to accomplish this.
step
Run up the stairs |goto Ironforge 41.98,33.37 < 7 |walk |only if Dwarf or Gnome
Enter the building |goto Ironforge 40.36,35.48 < 5 |walk |only if Dwarf or Gnome
talk Gretta Finespindle##1466 |goto Ironforge 38.82,32.86 |only if Dwarf or Gnome
Enter the building |goto Stormwind City/0 68.46,48.63 < 5 |walk |only if Human
talk Randal Worth##11096 |goto Stormwind City/0 67.81,49.66 |only if Human
Enter the building |goto Darnassus/0 61.09,23.39 < 5 |walk |only if NightElf
talk Darianna##11083 |goto Darnassus/0 64.45,20.88 |only if NightElf
|tip Downstairs inside the building. |only if Dwarf or Gnome
|tip Inside the building. |only if Human
|tip Upstairs inside the building. |only if NightElf
...
Run up the stairs |goto Ironforge 41.98,33.37 < 7 |walk |only if Dwarf or Gnome
Enter the building |goto Ironforge 40.36,35.48 < 5 |walk |only if Dwarf or Gnome
talk Bombus Finespindle##5128 |goto Ironforge 39.62,34.47 |only if Dwarf or Gnome
Enter the building |goto Stormwind City/0 68.46,48.63 < 5 |walk |only if Human
talk Jillian Tanner##5565 |goto Stormwind City/0 67.07,49.54 |only if Human
Enter the building |goto Darnassus/0 61.09,23.39 < 5 |walk |only if NightElf
talk Saenorion##4225 |goto Darnassus/0 63.68,22.29 |only if NightElf
|tip Downstairs inside the building. |only if Dwarf or Gnome
|tip Inside the building. |only if Human
|tip Upstairs inside the building. |only if NightElf
...
Run up the stairs |goto Ironforge 41.98,33.37 < 7 |walk |only if Dwarf or Gnome
Enter the building |goto Ironforge 40.36,35.48 < 5 |walk |only if Dwarf or Gnome
talk Fimble Finespindle##5127 |goto Ironforge 40.23,33.66 |only if Dwarf or Gnome
Enter the building |goto Stormwind City/0 68.46,48.63 < 5 |walk |only if Human
talk Simon Tanner##5564 |goto Stormwind City/0 67.22,49.84 |only if Human
Enter the building |goto Darnassus/0 61.09,23.39 < 5 |walk |only if NightElf
talk Faldron##11081 |goto Darnassus/0 64.78,21.83 |only if NightElf
|tip Downstairs inside the building. |only if Dwarf or Gnome
|tip Inside the building. |only if Human
|tip Upstairs inside the building. |only if NightElf
...
|tip Use the leveling guides to accomplish this.
step
Enter the building |goto Ironforge 43.88,29.71 < 5 |walk |only if Dwarf or Gnome
talk Uthrar Threx##1703 |goto Ironforge 43.81,27.86 |only if Dwarf or Gnome
Enter the building |goto Stormwind City/0 44.59,73.90 < 5 |walk |only if Human
talk Lawrence Schneider##1300 |goto Stormwind City/0 43.69,73.73 |only if Human
Enter the building |goto Darnassus/0 61.30,23.23 |only if NightElf
talk Trianna##11050 |goto Darnassus/0 63.55,21.22 |only if NightElf
|tip Inside the building.
...
step
talk Poranna Snowbraid##5154 |goto Ironforge 42.94,28.31 |only if Dwarf or Gnome
talk Alexandra Bolero##1347 |goto Stormwind City/0 43.25,74.08 |only if Human
talk Elynna##4168 |goto Darnassus/0 64.58,21.58 |only if NightElf
|tip Inside the building.
buy 40 Coarse Thread##2320 |or
|tip Save these, you will need them later.
'|complete skill("Tailoring") >= 70 |or
step
Open Your Tailoring Crafting Panel:
...
|tip Use the leveling guides to accomplish this.
step
talk Jormund Stonebrow##5153 |goto Ironforge 43.15,29.35 |only if Dwarf or Gnome
Enter the building |goto Stormwind City/0 41.12,78.11 |only if Human
talk Sellandus##5567 |goto Stormwind City/0 41.99,75.85 |only if Human
talk Me'lynn##4159 |goto Darnassus/0 63.41,22.38 |only if NightElf
|tip Inside the building.
...
|tip Upstairs inside the building.
|tip You must be at least level 35 to train artisan skills.
|tip Use the leveling guides to accomplish this.
