...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Fishing\\Ilyssia of the Waters",{
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Fishing\\Impus",{
keywords={"fishing, reputation"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Fishing\\Corbyn",{
keywords={"fishing, reputation"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Fishing\\Keeper Raynae",{
keywords={"fishing, reputation"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Fishing\\Sha'leth",{
keywords={"fishing, reputation"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Fishing\\Akule Riverhorn",{
keywords={"fishing, reputation"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Argussian Reach",{
keywords={"reputation"},
...
Click here to load the Argus guide |next "Leveling Guides\\Legion (10-70)\\Argus Campaign"
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Armies of Legionfall",{
...
Click here to load the "Excavator Karla" guide |confirm |next "Leveling Guides\\Legion (10-70)\\Broken Shore\\Excavator Karla Quests"
...
Click here to load the "Demon Hunter Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Demon Hunter\\Demon Hunter Order Hall Quests" |only DemonHunter
Click here to load the "Druid Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Druid\\Druid Order Hall Quests" |only Druid
...
Click here to load the "Mage Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Mage\\Mage Order Hall Quests" |only Mage
Click here to load the "Monk Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Monk\\Monk Order Hall Quests" |only Monk
...
Click here to load the "Priest Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Priest\\Priest Order Hall Quests" |only Priest
...
Click here to load the "Shaman Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Shaman\\Shaman Order Hall Quests" |only Shaman
...
Click here to load the "Warrior Order Hall Quests" leveling guide |confirm |next "Leveling Guides\\Legion (10-70)\\Warrior\\Warrior Order Hall Quests" |only Warrior
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Army of the Light",{
keywords={"reputation"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Conjurer Margoss",{
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Court of Farondis",{
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Dreamweavers",{
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Highmountain Tribe",{
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\The Nightfallen",{
...
|tip Use the "Suramar (45-70)" leveling guide to accomplish this.
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\Valarjar",{
keywords={"Valarjar"},
...
QuestCore:RegisterGuide("Reputation Guides\\Legion Reputations\\The Wardens",{
keywords={"Wardens"},
